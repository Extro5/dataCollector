...
public class InstrumentParticipant extends com.pullenti.ner.Referent {
    ...
    public String setTyp(String value) {
        addSlot(ATTR_TYPE, (value == null ? null : value.toUpperCase()), true, 0);
        return value;
    }
    ...
    public Object setGround(Object value) {
        addSlot(ATTR_GROUND, value, false, 0);
        return value;
    }
    ...
    public String toString(boolean shortVariant, com.pullenti.morph.MorphLang lang, int lev) {
        ...
        com.pullenti.ner.Referent org = (com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(getValue(ATTR_REF), com.pullenti.ner.Referent.class);
        com.pullenti.ner.Referent del = (com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(getValue(ATTR_DELEGATE), com.pullenti.ner.Referent.class);
        if (org != null) {
            res.append(": ").append(org.toString(shortVariant, lang, 0));
    ...
    public boolean canBeEquals(com.pullenti.ner.Referent obj, com.pullenti.ner.Referent.EqualType _typ) {
        InstrumentParticipant p = (InstrumentParticipant)com.pullenti.n2j.Utils.cast(obj, InstrumentParticipant.class);
        if (p == null) 
            return false;
    ...
    public boolean containsRef(com.pullenti.ner.Referent r) {
        for(com.pullenti.ner.Slot s : getSlots()) {
            if (((com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), ATTR_REF) || com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), ATTR_DELEGATE))) && (s.getValue() instanceof com.pullenti.ner.Referent)) {
                if (r == s.getValue() || r.canBeEquals((com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(s.getValue(), com.pullenti.ner.Referent.class), com.pullenti.ner.Referent.EqualType.WITHINONETEXT)) 
                    return true;
            }
        }
        return false;
    ...
    public static InstrumentParticipant _new1330(String _arg1) {
