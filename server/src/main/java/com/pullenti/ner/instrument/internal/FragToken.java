...
public class FragToken extends com.pullenti.ner.MetaToken {
    ...
    private static FragToken createDocTitle(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        if (title != null && title.children.size() == 1 && title.children.get(0).kind == com.pullenti.ner.instrument.InstrumentKind.NAME) {
            ...
            if (title2 != null && doc.getTyp() != null) {
                title.children.addAll(title2.children);
    ...
    private static FragToken _createDocTitle_(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        if (t0 == null) 
            return null;
        FragToken title = _new1206(t0, t0, com.pullenti.ner.instrument.InstrumentKind.HEAD);
        ...
        java.util.ArrayList<FragToken> unknownOrgs = new java.util.ArrayList< >();
        boolean isContract = false;
        boolean startOfName = false;
        t = t0;
        if (t0.getReferent() != null) {
            if (com.pullenti.n2j.Utils.stringsEq(t0.getReferent().getTypeName(), "PERSON")) 
                return null;
        }
        ...
        if (t != null && t.isValue("ДЕЛО", "СПРАВА")) {
            ...
            if (dt != null && dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER) {
                dt.setBeginToken(t);
                title.children.add(_new1246(t, t, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, "ДЕЛО"));
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.isNewlineBefore() || ((t.getPrevious() != null && t.getPrevious().isTableControlChar()))) {
                ...
                if (t.isCharOf("[") && _name == null) 
                    break;
                InstrToken1 iii = InstrToken1.parse(t, true, null, 0, null, false, 0, false);
                if (iii != null && iii.typ == InstrToken1.Types.COMMENT) {
                    FragToken cmt = _new1206(iii.getBeginToken(), iii.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.COMMENT);
                    title.children.add(cmt);
                    t = (t1 = title.setEndToken(iii.getEndToken()));
                    continue;
                }
                if (iii != null && iii.getEndToken().isChar('?')) {
                    FragToken cmt = _new1206(iii.getBeginToken(), iii.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NAME);
                    cmt.value = FragToken.getRestoredNameMT(iii);
                    title.children.add(cmt);
                    t = (t1 = title.setEndToken(iii.getEndToken()));
                    break;
                }
                if ((((t.isValue("ЗАЯВИТЕЛЬ", "ЗАЯВНИК") || t.isValue("ИСТЕЦ", "ПОЗИВАЧ") || t.isValue("ОТВЕТЧИК", "ВІДПОВІДАЧ")) || t.isValue("ДОЛЖНИК", "БОРЖНИК") || t.isValue("КОПИЯ", "КОПІЯ"))) && t.getNext() != null && ((t.getNext().isChar(':') || t.getNext().isTableControlChar()))) {
                    ...
                    if (ptt != null) {
                        ...
                        FragToken ft = _new1206(t, t1, com.pullenti.ner.instrument.InstrumentKind.INITIATOR);
                ...
                if (t.isValue("ЦЕНА", "ЦІНА") && t.getNext() != null && t.getNext().isValue("ИСК", "ПОЗОВ")) {
                    ...
                    if (tt != null && hasMoney) {
                        ...
                        title.children.add(_new1206(t, tt, com.pullenti.ner.instrument.InstrumentKind.CASEINFO));
                ...
                if (t.isValue("В", "У")) {
                    ...
                    if (tt != null && (tt.getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) {
                        ...
                        FragToken ooo = _new1206(t, t1, com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION);
                        ooo.referents = new java.util.ArrayList< >();
                        ooo.referents.add(r);
                ...
                if (t.getLengthChar() == 1 && t.chars.isLetter() && t.isWhitespaceAfter()) {
                    ...
                    for(ii = 0; ii < InstrToken.m_DirectivesNorm.size(); ii++) {
                        ...
                        if (ee != null && ee.isNewlineAfter()) {
                            FragToken ooo = _new1246(t, ee, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, InstrToken.m_DirectivesNorm.get(ii));
                            title.children.add(ooo);
            ...
            if (casinf != null) 
                break;
            com.pullenti.ner.decree.DecreeReferent dr0 = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreeReferent.class);
            if (dr0 != null) {
                ...
                com.pullenti.ner.decree.DecreePartReferent dpr = (com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreePartReferent.class);
                if (dpr != null) {
                    if (((dpr.getPart() == null && dpr.getDocPart() == null)) || dpr.getSlots().size() != 2) 
                        break;
                    if ((t.getNext() instanceof com.pullenti.ner.TextToken) && (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.TextToken.class))).isPureVerb()) 
                        break;
                    dr0 = dpr.getOwner();
                }
            }
            if (dr0 != null) {
                if (doc.getTyp() == null || com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), dr0.getTyp())) {
                    com.pullenti.ner.Token tt1 = (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class))).getBeginToken();
                    ...
                    if (li != null && li.size() > 0 && li.get(li.size() - 1).isNewlineAfter()) {
                        ...
                        if (ttt.endChar < t.endChar) {
                            nT0 = ttt.getNext();
                            _name = FragToken.getRestoredName(ttt.getNext(), (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class))).getEndToken());
                        }
                        t1 = t;
                        ...
                        if (com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), "КОДЕКС")) {
                            ...
                            if (pt != null && pt.values.size() > 0) {
                                ...
                                title.children.add(_new1246(pt.getBeginToken(), pt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCPART, pt.values.get(0).value));
                                t = pt.getEndToken();
                                continue;
                            }
                        }
                ...
                else if (com.pullenti.n2j.Utils.stringsEq(dr0.getTyp(), "КОДЕКС")) {
                    com.pullenti.ner.decree.internal.PartToken pt = com.pullenti.ner.decree.internal.PartToken.tryAttach(t.getNext(), null, false, false);
                    ...
                    if (pt != null && pt.values.size() > 0) 
                        doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_PART, pt.values.get(0).value, false, 0);
                    doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_NAME, nam, false, 0);
                    doc.setTyp(dr0.getTyp());
                    Object _geo = dr0.getValue(com.pullenti.ner.decree.DecreeReferent.ATTR_GEO);
                    if (_geo != null) 
                        doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_GEO, _geo, false, 0);
                    t1 = t;
                    title.children.add(_new1246(t, t, com.pullenti.ner.instrument.InstrumentKind.NAME, nam));
                    if (pt != null && pt.values.size() > 0) {
                        title.children.add(_new1246(pt.getBeginToken(), pt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCPART, pt.values.get(0).value));
                        t1 = pt.getEndToken();
                    }
            ...
            if (doc.getTyp() == null) {
                ...
                if (ttt1 != null && ttt1.isNewlineAfter()) {
                    ...
                    if (doc.getTyp() == null) 
                        doc.setTyp(typ);
                    title.children.add(_new1246(t, ttt1, com.pullenti.ner.instrument.InstrumentKind.TYP, typ));
                    dt0 = com.pullenti.ner.decree.internal.DecreeToken._new807(t, ttt1, com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP, typ);
                    canBeOrgs = false;
                    t1 = (t = ttt1);
                    continue;
                }
            ...
            if (dt == null && dt0 != null && ((dt0.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.OWNER || dt0.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.ORG))) {
                if ((t instanceof com.pullenti.ner.NumberToken) && t.isNewlineAfter() && t.isNewlineBefore()) 
                    dt = com.pullenti.ner.decree.internal.DecreeToken._new807(t, t, com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER, ((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value).toString());
            }
            ...
            if ((dt == null && (t instanceof com.pullenti.ner.NumberToken) && t.isNewlineBefore()) && t.isNewlineAfter()) {
                if (dt0 != null && dt0.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.ORG && (((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT))) 
                    dt = com.pullenti.ner.decree.internal.DecreeToken._new807(t, t, com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER, ((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value).toString());
            }
                ...
                if (!t.isNewlineBefore()) 
                    ...
                    for(com.pullenti.ner.Token ttt = dt.getEndToken().getNext(); ttt != null; ttt = ttt.getNext()) {
                        if (ttt.isNewlineBefore()) 
                            break;
                        else if ((ttt instanceof com.pullenti.ner.TextToken) && (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(ttt, com.pullenti.ner.TextToken.class))).isPureVerb()) {
                            dt = null;
                            break;
                        }
                    }
            ...
            if (dt == null) {
                ...
                if (t.isValue("ДАТА", null)) {
                    ...
                    for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                        ...
                        if ((tt instanceof com.pullenti.ner.TextToken) && !tt.chars.isLetter()) 
                            continue;
                        com.pullenti.ner.date.DateReferent da = (com.pullenti.ner.date.DateReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.date.DateReferent.class);
                        if (da != null) {
                            FragToken frdt = _new1206(t, tt, com.pullenti.ner.instrument.InstrumentKind.DATE);
                ...
                if (((r instanceof com.pullenti.ner.address.AddressReferent) || (r instanceof com.pullenti.ner.uri.UriReferent) || (r instanceof com.pullenti.ner.phone.PhoneReferent)) || (r instanceof com.pullenti.ner.person.PersonIdentityReferent) || (r instanceof com.pullenti.ner.bank.BankDataReferent)) {
                    FragToken cnt = _new1206(t, t, com.pullenti.ner.instrument.InstrumentKind.CONTACT);
                    cnt.referents = new java.util.ArrayList< >();
                    cnt.referents.add(r);
                ...
                if (canBeOrgs) {
                    if (t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) {
                        ...
                        if (org != null) {
                            unknownOrgs.add(org);
                            t1 = (t = org.getEndToken());
                            continue;
                        }
                    }
                }
                InstrToken stok = InstrToken.parse(t, 0, null);
                if (stok != null && stok.noWords) {
                    if (t0 == t) 
            ...
            if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) {
                ...
                if (typ == com.pullenti.ner.decree.DecreeKind.CONTRACT || com.pullenti.n2j.Utils.stringsEq(dt.value, "ДОВЕРЕННОСТЬ") || com.pullenti.n2j.Utils.stringsEq(dt.value, "ДОВІРЕНІСТЬ")) 
                    isContract = true;
                else if (com.pullenti.n2j.Utils.stringsEq(dt.value, "ПРОТОКОЛ") && !dt.isNewlineAfter()) {
            ...
            if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER && unknownOrgs.size() > 0) {
                for(FragToken org : unknownOrgs) {
                    title.children.add(org);
                    doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_SOURCE, org.value, false, 0);
                }
                unknownOrgs.clear();
            }
        ...
        if (t == null || (((doc.getTyp() == null && doc.getRegNumber() == null && appr0 == null) && !startOfName))) {
            if (t == t0) {
                ...
                if (nam != null) {
                    _name = FragToken.getRestoredName(t0, nam.getEndToken());
                    if (!com.pullenti.n2j.Utils.isNullOrEmpty(_name)) {
                        t1 = nam.getEndToken();
                        doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_NAME, _name.trim(), true, 0);
                        title.children.add(_new1246(t0, t1, com.pullenti.ner.instrument.InstrumentKind.NAME, _name.trim()));
        ...
        if (endEmptyLines != null && doc.findSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_SOURCE, null, true) == null) {
            ...
            title.children.add(0, _new1246(t0, endEmptyLines, com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION, val));
        }
        ...
        if ((((_name != null || t.isNewlineBefore() || ((t.getPrevious() != null && t.getPrevious().isTableControlChar()))) || ((!t.isNewlineBefore() && title.children.size() > 0 && title.children.get(title.children.size() - 1).kind == com.pullenti.ner.instrument.InstrumentKind.TYP)))) && !isCase) {
            ...
            for(; t != null; t = t.getNext()) {
                ...
                if (t.isNewlineBefore()) {
                    ...
                    if (pt != null && pt.typ != com.pullenti.ner.decree.internal.PartToken.ItemType.PREFIX) 
                        break;
                    InstrToken1 ltt = InstrToken1.parse(t, false, null, 0, null, false, 0, false);
                    if (ltt == null) 
                        break;
                    ...
                    if (t.getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) {
                        com.pullenti.ner.decree.DecreeReferent dr = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreeReferent.class);
            ...
            String val = (t1 != null && t1 != tt0 ? FragToken.getRestoredName(tt0, t1) : null);
            if (!com.pullenti.n2j.Utils.isNullOrEmpty(val) && Character.isLetter(val.charAt(0)) && Character.isLowerCase(val.charAt(0))) 
            ...
            if (_name == null && title.children.size() > 0 && title.children.get(title.children.size() - 1).kind == com.pullenti.ner.instrument.InstrumentKind.TYP) {
                ...
                if (npt != null) {
                    if (npt.getMorph().getCase().isGenitive()) {
                        _name = (String)com.pullenti.n2j.Utils.cast(title.children.get(title.children.size() - 1).value, String.class);
            ...
            if (val != null) {
                ...
                doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_NAME, val.trim(), true, 0);
                title.children.add(_new1246(tt0, t1, com.pullenti.ner.instrument.InstrumentKind.NAME, val.trim()));
        ...
        for(t1 = t1.getNext(); t1 != null; t1 = t1.getNext()) {
            if (t1.isNewlineBefore() && t1.isValue("ЧАСТЬ", "ЧАСТИНА")) {
                ...
                if (pt != null && pt.isNewlineAfter()) {
                    ...
                    if (pt2 != null && (((pt2.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.SECTION || pt2.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.SUBSECTION || pt2.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.CHAPTER) || pt2.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.CLAUSE))) {
                        ...
                        doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_PART, pt.values.get(0).value, false, 0);
                        title.children.add(_new1246(t1, pt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCPART, pt.values.get(0).value));
            ...
            if ((t1.getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) && (((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t1.getReferent(), com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER && t1.isNewlineAfter()) {
                FragToken pub = _new1206(t1, t1, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
                pub.referents = new java.util.ArrayList< >();
            ...
            if (dt != null && ((dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.DATE || dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TERR || ((dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER && ((dt.isDelo() || com.pullenti.ner.core.MiscHelper.checkNumberPrefix(tt) != null))))))) {
                ...
                if (!dt.isNewlineAfter()) {
                    InstrToken1 lll = InstrToken1.parse(tt, true, null, 0, null, false, 0, false);
            ...
            if (tt.isCharOf("([") && tt.isNewlineBefore()) {
                ...
                if (br != null) {
                    ...
                    title.children.add(_new1206(br.getBeginToken(), br.getEndToken(), (tt.isChar('[') ? com.pullenti.ner.instrument.InstrumentKind.NAME : com.pullenti.ner.instrument.InstrumentKind.COMMENT)));
                    continue;
                }
            }
            break;
        ...
        if (t1 != null && t1.isNewlineBefore() && com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), "КОДЕКС")) {
            com.pullenti.ner.decree.internal.PartToken pt = com.pullenti.ner.decree.internal.PartToken.tryAttach(t1, null, false, false);
            if (pt != null && ((pt.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.PART || pt.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.DOCPART)) && pt.values.size() > 0) {
                ...
                com.pullenti.ner.decree.DecreePartReferent dr0 = (com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(t1.getReferent(), com.pullenti.ner.decree.DecreePartReferent.class);
    ...
    private static FragToken createAppendixTitle(com.pullenti.ner.Token t0, FragToken app, com.pullenti.ner.instrument.InstrumentReferent doc, boolean isApp) {
        if (t0 == null) 
            return null;
        if (t0 != t0.kit.firstToken) {
            if (t0.getReferent() instanceof com.pullenti.ner.decree.DecreePartReferent) {
                if ((((com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(t0.getReferent(), com.pullenti.ner.decree.DecreePartReferent.class))).getAppendix() != null) 
        ...
        if (rr != null) {
            if (com.pullenti.n2j.Utils.stringsEq(rr.getTypeName(), "PERSON")) 
                return null;
        }
        FragToken title = _new1206(t0, t, com.pullenti.ner.instrument.InstrumentKind.HEAD);
        for(; t != null; t = t.getNext()) {
            InstrToken1 fr = InstrToken1.parse(t, true, null, 0, null, false, 0, false);
            if (fr == null) 
                break;
            ...
            if (t instanceof com.pullenti.ner.TextToken) 
                title.children.add(_new1224(t, t2, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, true));
            title.setEndToken((t = fr.getEndToken()));
            if (fr.typ == InstrToken1.Types.APPENDIX && fr.numBeginToken == null) {
                InstrToken1 fr1 = InstrToken1.parse(t.getNext(), true, null, 0, null, false, 0, false);
                if (fr1 != null && fr1.typ == InstrToken1.Types.APPROVED) {
                    t = fr1.getBeginToken();
                    title.children.add(_new1246(t, t, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, t.getSourceText().toUpperCase()));
                    title.setEndToken((t = fr1.getEndToken()));
                    fr = fr1;
                }
            }
            if (fr.numBeginToken != null && fr.numEndToken != null) {
                FragToken num = _new1246(fr.numBeginToken, fr.numEndToken, com.pullenti.ner.instrument.InstrumentKind.NUMBER, com.pullenti.ner.core.MiscHelper.getTextValue(fr.numBeginToken, fr.numEndToken, com.pullenti.ner.core.GetTextAttr.KEEPREGISTER));
                ...
                if (isApp) 
                    doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_APPENDIX, (Object)com.pullenti.n2j.Utils.notnull(num.value, "1"), false, 0);
            }
            else if (t.getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) {
                if ((((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER) {
                    FragToken ff = _new1206(t, t, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
                    ff.referents = new java.util.ArrayList< >();
                    ...
                    FragToken appr = _new1206(kw.getBeginToken(), t, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
                    title.children.remove(title.children.size() - 1);
                    appr.children.add(kw);
                    appr.children.add(_new1206(t, t, com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE));
                    title.children.add(appr);
                }
                else 
                    title.children.add(_new1206(t, t, com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE));
            }
            else if (fr.typ == InstrToken1.Types.APPROVED && fr.getLengthChar() > 15 && fr.getBeginToken() != fr.getEndToken()) 
                title.children.add(_new1206(fr.getBeginToken().getNext(), t, com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE));
            else {
                ...
                if (dts != null && dts.size() > 0 && dts.get(0).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) {
                    FragToken dref = _new1206(dts.get(0).getBeginToken(), dts.get(0).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE);
        ...
        if (t == null) 
            return null;
        if (t.isValue("К", "ДО")) {
            java.util.ArrayList<InstrToken> toks = new java.util.ArrayList< >();
            for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                ...
                if (tt.isNewlineBefore()) {
                    if (tt.getNewlinesBeforeCount() > 1) 
                        break;
                    InstrToken1 it1 = InstrToken1.parse(tt, false, null, 0, null, false, 0, false);
            ...
            for(int ii = 0; ii < toks.size(); ii++) {
                ...
                if (tok.typ == ILTypes.TYP && ((com.pullenti.n2j.Utils.stringsEq(tok.value, doc.getTyp()) || ii == 0))) 
                    maxInd = ii;
                else if (tok.typ == ILTypes.REGNUMBER && (((com.pullenti.n2j.Utils.stringsEq(tok.value, doc.getRegNumber()) || tok.isNewlineBefore() || tok.isNewlineAfter()) || tok.getHasTableChars()))) 
                    maxInd = ii;
                else if (tok.typ == ILTypes.DATE && doc.getDate() != null) {
                    if ((tok.ref instanceof com.pullenti.ner.date.DateReferent) && (((com.pullenti.ner.date.DateReferent)com.pullenti.n2j.Utils.cast(tok.ref, com.pullenti.ner.date.DateReferent.class))).getDt().compareTo(doc.getDate()) == 0) 
                        maxInd = ii;
                    else if (tok.ref instanceof com.pullenti.ner.ReferentToken) {
                        com.pullenti.ner.date.DateReferent dre = (com.pullenti.ner.date.DateReferent)com.pullenti.n2j.Utils.cast((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(tok.ref, com.pullenti.ner.ReferentToken.class))).referent, com.pullenti.ner.date.DateReferent.class);
                    ...
                    com.pullenti.ner.decree.DecreePartReferent part = (com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(tok.getBeginToken().getReferent(), com.pullenti.ner.decree.DecreePartReferent.class);
                    ...
                    maxInd = ii;
                else if (tok.typ == ILTypes.UNDEFINED && ((tok.getBeginToken().isValue("ОТ", null) || !tok.isNewlineBefore()))) 
                    maxInd = ii;
                else if (tok.typ == ILTypes.GEO) 
                    maxInd = ii;
            }
            ...
            if (maxInd >= 0) {
                ...
                te = t.getNext();
            if (te != null) {
                FragToken dr = _new1206(t, te, com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE);
            ...
            if (t.isNewlineBefore()) {
                ...
                if (dd != null && ((dd.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.DATE || dd.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TERR)) && dd.isNewlineAfter()) {
                    ...
                    if (dd.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TERR && (t instanceof com.pullenti.ner.ReferentToken)) 
                        npt0 = com.pullenti.ner.core.NounPhraseHelper.tryParse((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class))).getBeginToken(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                ...
                InstrToken1 ltt = InstrToken1.parse(t, true, null, 0, null, false, 0, false);
                if (ltt == null) 
                    break;
                if (ltt.numbers.size() > 0) 
                    break;
                if (ltt.typ == InstrToken1.Types.APPROVED) {
                    title.children.add(_new1206(ltt.getBeginToken(), ltt.getBeginToken(), com.pullenti.ner.instrument.InstrumentKind.APPROVED));
                    if (ltt.getBeginToken() != ltt.getEndToken()) 
                        title.children.add(_new1206(ltt.getBeginToken().getNext(), ltt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE));
                    t = ltt.getEndToken();
                ...
                if (ltt.hasVerb && !ltt.allUpper) {
                    if (t.chars.isLetter() && t.chars.isAllLower()) {
                        ...
                        com.pullenti.ner.decree.DecreeChangeReferent dch = (com.pullenti.ner.decree.DecreeChangeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreeChangeReferent.class);
                ...
                if (t.chars.isLetter() && t != tt0) {
                    if (!t.chars.isAllLower() && !t.chars.isAllUpper()) {
                        if (!((t.getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) && !((t.getReferent() instanceof com.pullenti.ner.geo.GeoReferent))) {
                            if (com.pullenti.ner.decree.internal.DecreeToken.isKeyword(t.getPrevious(), false) == null) {
                ...
                for(com.pullenti.ner.Token ttt = ltt.getBeginToken(); ttt != null; ttt = ttt.getNext()) {
                    ...
                    if ((r instanceof com.pullenti.ner.org.OrganizationReferent) || (r instanceof com.pullenti.ner.geo.GeoReferent) || (r instanceof com.pullenti.ner.decree.DecreeChangeReferent)) {
                        hasWords = true;
                        break;
                    }
                }
        ...
        String val = (t1 != null && tt0 != null ? FragToken.getRestoredName(tt0, t1) : null);
        if (val != null) {
            if (nT0 != null) 
                tt0 = nT0;
            title.children.add(_new1246(tt0, t1, com.pullenti.ner.instrument.InstrumentKind.NAME, val.trim()));
                    ...
                    for(com.pullenti.ner.Token tt = ch.getBeginToken(); tt != null && tt.endChar <= ch.endChar; tt = tt.getNext()) {
                        if (tt.getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) {
                            for(com.pullenti.ner.Slot s : tt.getReferent().getSlots()) {
                                if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.decree.DecreeReferent.ATTR_TYPE)) 
                                    doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_TYPE, s.getValue(), false, 0);
                                else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.decree.DecreeReferent.ATTR_NUMBER)) 
                                    doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_REGNUMBER, s.getValue(), false, 0);
                                else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.decree.DecreeReferent.ATTR_DATE)) 
                                    doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_DATE, s.getValue(), false, 0);
                                else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.decree.DecreeReferent.ATTR_SOURCE)) 
                                    doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_SOURCE, s.getValue(), false, 0);
                                else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.decree.DecreeReferent.ATTR_GEO)) 
    ...
    private static boolean _isStartOfBody(com.pullenti.ner.Token t) {
        ...
        InstrToken1 it = InstrToken1.parse(t, false, null, 0, null, false, 0, false);
        if (it != null) {
        ...
        if ((t.getReferent() instanceof com.pullenti.ner.org.OrganizationReferent) && t.getNext() != null) {
    ...
    private static boolean _addTitleAttr(com.pullenti.ner.instrument.InstrumentReferent doc, FragToken title, com.pullenti.ner.decree.internal.DecreeToken dt) {
        if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) {
            if (doc != null) {
                if (doc.getTyp() != null && com.pullenti.n2j.Utils.stringsNe(dt.value, doc.getTyp())) {
                    if (com.pullenti.n2j.Utils.stringsNe(doc.getTyp(), "ПРОЕКТ")) 
                        return false;
                    ...
                    doc.setTyp(dt.value);
                if (dt.fullValue != null && com.pullenti.n2j.Utils.stringsNe(dt.fullValue, dt.value) && doc.getName() == null) 
                    doc.setName(dt.fullValue);
            }
            if (title != null) 
                title.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TYP, (String)com.pullenti.n2j.Utils.notnull(dt.fullValue, dt.value)));
        }
            ...
            if (dt.isDelo()) {
                if (doc != null) {
                    ...
                    if (com.pullenti.n2j.Utils.stringsEq(doc.getRegNumber(), dt.value)) 
                        doc.setRegNumber(null);
                }
                if (title != null) 
                    title.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CASENUMBER, dt.value));
            }
            else {
                if (com.pullenti.n2j.Utils.stringsNe(dt.value, "?") && doc != null) {
                    if (com.pullenti.n2j.Utils.stringsEq(doc.getStringValue(com.pullenti.ner.instrument.InstrumentReferent.ATTR_CASENUMBER), dt.value)) {
                    }
                    else 
                        doc.addSlot(com.pullenti.ner.instrument.InstrumentBlockReferent.ATTR_NUMBER, dt.value, false, 0);
                }
                if (title != null) 
                    title.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NUMBER, dt.value));
            ...
            if (title != null) 
                title.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NAME, dt.value));
        }
        else if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.DATE) {
            if (doc == null || doc.addDate(dt)) {
                if (title != null) 
                    title.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DATE, dt));
            }
        }
        else if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TERR) {
            if (title != null) 
                title.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.PLACE, dt));
            if (doc != null && dt.ref != null) {
                String _geo = doc.getStringValue(com.pullenti.ner.instrument.InstrumentReferent.ATTR_GEO);
                if (com.pullenti.n2j.Utils.stringsEq(_geo, "Россия")) {
            ...
            if (title != null) 
                title.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.ORG ? com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION : com.pullenti.ner.instrument.InstrumentKind.INITIATOR), dt));
            if (doc != null) {
                if (dt.ref != null) {
    ...
    public boolean _analizeTables() {
        if (children.size() > 0) {
            ...
            java.util.ArrayList<FragToken> changed = new java.util.ArrayList< >();
            for(FragToken ch : children) {
            ...
            for(int i = changed.size() - 1; i >= 0; i--) {
                if (changed.get(i).kind == com.pullenti.ner.instrument.InstrumentKind.CONTENT) {
                    ...
                    if (j < 0) 
                        continue;
                    children.remove(j);
                    children.addAll(j, changed.get(i).children);
                }
            }
            return false;
        }
        ...
        for(com.pullenti.ner.Token tt = getBeginToken(); tt != null && tt.endChar <= _endChar; tt = tt.getNext()) {
            ...
            if (t0.endChar < rows.get(0).beginChar) 
                children.add(_new1206(t0, rows.get(0).getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
            FragToken tab = _new1206(rows.get(0).getBeginToken(), rows.get(rows.size() - 1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TABLE);
            children.add(tab);
            for(int i = 0; i < rows.size(); i++) {
                FragToken rr = _new1222(rows.get(i).getBeginToken(), rows.get(i).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TABLEROW, i + 1);
                tab.children.add(rr);
                tabs = true;
                int no = 0;
                int cols = 0;
                for(com.pullenti.ner.core.internal.TableCellToken ce : rows.get(i).cells) {
                    FragToken cell = _new1222(ce.getBeginToken(), ce.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TABLECELL, ++no);
                    if (ce.colSpan > 1) 
        ...
        if ((t0 != null && (t0.endChar < endChar) && tabs) && t0 != getEndToken()) 
            children.add(_new1206(t0, getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
        return tabs;
    }
    ...
    public void _analizeContent(FragToken topDoc, boolean isCitat, com.pullenti.ner.instrument.InstrumentKind rootKind) {
        ...
        if (getBeginToken().getPrevious() != null && getBeginToken().getPrevious().isChar((char)0x1E)) 
            setBeginToken(getBeginToken().getPrevious());
                ...
                for(FragToken chh : ch.children) {
                    if (chh.kind == com.pullenti.ner.instrument.InstrumentKind.EDITIONS && chh.referents != null) {
                        if (topDoc.referents == null) 
                            topDoc.referents = new java.util.ArrayList< >();
    ...
    public java.util.ArrayList<FragToken> children = new java.util.ArrayList< >();
        ...
        for(int k = 0; k < children.size(); k++) {
            ...
            for(int i = 0; i < (children.size() - 1); i++) {
                if (children.get(i).compareTo(children.get(i + 1)) > 0) {
                    ...
                    com.pullenti.n2j.Utils.putArrayValue(children, i, children.get(i + 1));
                    com.pullenti.n2j.Utils.putArrayValue(children, i + 1, v);
                }
            }
            if (!ch) 
                break;
    ...
    public boolean setDefVal(boolean _value) {
        String str = getSourceText();
        while(str.length() > 0) {
            char last = str.charAt(str.length() - 1);
            if (((int)last) == 0x1E || ((int)last) == 0x1F || ((int)last) == 7) 
    ...
    public boolean setDefVal2(boolean _value) {
        value = getRestoredNameMT(this);
        return _value;
    }


    public static String getRestoredNameMT(com.pullenti.ner.MetaToken mt) {
        return getRestoredName(mt.getBeginToken(), mt.getEndToken());
    }

    public static String getRestoredName(com.pullenti.ner.Token b, com.pullenti.ner.Token e) {
        ...
        String str = com.pullenti.ner.core.MiscHelper.getTextValue(b, e, com.pullenti.ner.core.GetTextAttr.of((com.pullenti.ner.core.GetTextAttr.RESTOREREGISTER.value()) | (com.pullenti.ner.core.GetTextAttr.KEEPREGISTER.value()) | (com.pullenti.ner.core.GetTextAttr.KEEPQUOTES.value())));
        ...
        if (m_Doc != null) 
            ...
            if (value != null && kind != com.pullenti.ner.instrument.InstrumentKind.CONTACT) {
                if (value instanceof String) 
                    ...
                    com.pullenti.ner.Referent r = (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(value, com.pullenti.ner.ReferentToken.class))).referent;
                    (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(value, com.pullenti.ner.ReferentToken.class))).saveToLocalOntology();
                    res.addSlot(com.pullenti.ner.instrument.InstrumentBlockReferent.ATTR_REF, (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(value, com.pullenti.ner.ReferentToken.class))).referent, false, 0);
                    res.addExtReferent((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(value, com.pullenti.ner.ReferentToken.class));
                    com.pullenti.ner.Slot s = bas.m_Doc.findSlot(null, r, true);
                    if (s != null) 
                        s.setValue((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(value, com.pullenti.ner.ReferentToken.class))).referent);
                }
                else if (value instanceof com.pullenti.ner.decree.internal.DecreeToken) {
                    com.pullenti.ner.decree.internal.DecreeToken dt = (com.pullenti.ner.decree.internal.DecreeToken)com.pullenti.n2j.Utils.cast(value, com.pullenti.ner.decree.internal.DecreeToken.class);
                    if (dt.ref instanceof com.pullenti.ner.ReferentToken) {
                        com.pullenti.ner.Referent r = (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(dt.ref, com.pullenti.ner.ReferentToken.class))).referent;
                        (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(dt.ref, com.pullenti.ner.ReferentToken.class))).saveToLocalOntology();
                        res.addSlot(com.pullenti.ner.instrument.InstrumentBlockReferent.ATTR_REF, (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(dt.ref, com.pullenti.ner.ReferentToken.class))).referent, false, 0);
                        res.addExtReferent((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(dt.ref, com.pullenti.ner.ReferentToken.class));
                        com.pullenti.ner.Slot s = bas.m_Doc.findSlot(null, r, true);
                        if (s != null) 
                            s.setValue((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(dt.ref, com.pullenti.ner.ReferentToken.class))).referent);
                    }
    ...
    public void fillByContentChildren() {
        sortChildren();
        if (children.size() == 0) {
            children.add(_new1206(getBeginToken(), getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
            return;
        }
        if (beginChar < children.get(0).beginChar) 
            children.add(0, _new1206(getBeginToken(), children.get(0).getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
        for(int i = 0; i < (children.size() - 1); i++) {
            if (children.get(i).getEndToken().getNext() != children.get(i + 1).getBeginToken() && (children.get(i).getEndToken().getNext().endChar < children.get(i + 1).beginChar)) 
                children.add(i + 1, _new1206(children.get(i).getEndToken().getNext(), children.get(i + 1).getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
        }
        if (children.get(children.size() - 1).endChar < endChar) 
            children.add(_new1206(children.get(children.size() - 1).getEndToken().getNext(), getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
    }
    ...
    public static FragToken createDocument(com.pullenti.ner.Token t, int maxChar, com.pullenti.ner.instrument.InstrumentKind rootKind) {
        ...
        if (t.getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) {
            com.pullenti.ner.decree.DecreeReferent dec0 = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreeReferent.class);
        ...
        if (res != null) 
            return res;
        res = _new1206(t, t, com.pullenti.ner.instrument.InstrumentKind.DOCUMENT);
        ...
        if (maxChar > 0 && !isApp) {
            ...
            head1 = createAppendixTitle(t, res, res.m_Doc, isApp);
        if (head == null) 
            head = head1;
        else if (head1 != null && head1.endChar > head.endChar && ((com.pullenti.n2j.Utils.stringsEq(res.m_Doc.getTyp(), "ПРИЛОЖЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(res.m_Doc.getTyp(), "ДОДАТОК")))) 
            head = head1;
        if (head != null) {
            if (maxChar == 0) 
        ...
        if (isApp) {
            for(i = 0; i < li.size(); i++) {
                ...
                else if (li.get(i).typ == ILTypes.APPENDIX && com.pullenti.n2j.Utils.stringsNe(li.get(i).value, "ПРИЛОЖЕНИЕ") && com.pullenti.n2j.Utils.stringsNe(li.get(i).value, "ДОДАТОК")) 
                    li.get(i).typ = ILTypes.UNDEFINED;
            }
        }
        for(i = 0; i < (li.size() - 1); i++) {
            if (li.get(i).typ == ILTypes.APPENDIX) {
                InstrToken1 num1 = InstrToken1.parse(li.get(i).getBeginToken(), true, null, 0, null, false, 0, false);
                for(int j = i + 1; j < li.size(); j++) {
                    if (li.get(j).typ == ILTypes.APPENDIX) {
                        if (com.pullenti.n2j.Utils.stringsNe(li.get(j).value, li.get(i).value)) {
                            if (com.pullenti.n2j.Utils.stringsEq(li.get(i).value, "ПРИЛОЖЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(li.get(i).value, "ДОДАТОК")) 
                                li.get(j).typ = ILTypes.UNDEFINED;
                        }
                        else {
                            int le = li.get(j).beginChar - li.get(i).beginChar;
                            if (le > 400) 
                                break;
                            li.get(i).typ = ILTypes.UNDEFINED;
                            i = j;
                            InstrToken1 num2 = InstrToken1.parse(li.get(j).getBeginToken(), true, null, 0, null, false, 0, false);
        ...
        for(i = 0; i < li.size(); i++) {
            if (li.get(i).typ == ILTypes.APPENDIX || li.get(i).typ == ILTypes.APPROVED) {
                ...
                if (li.get(i).ref instanceof com.pullenti.ner.decree.DecreeReferent) {
                    com.pullenti.ner.decree.DecreeReferent drApp = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(li.get(i).ref, com.pullenti.ner.decree.DecreeReferent.class);
                    if (com.pullenti.n2j.Utils.stringsNe(drApp.getTyp(), res.m_Doc.getTyp())) 
                        continue;
                    if (drApp.getNumber() != null && res.m_Doc.getRegNumber() != null) {
                        if (com.pullenti.n2j.Utils.stringsNe(drApp.getNumber(), res.m_Doc.getRegNumber())) 
                            continue;
                    }
                }
                break;
                ...
                if (li.get(i).typ == ILTypes.PERSON && li.get(i).isNewlineBefore() && !li.get(i).getHasTableChars()) {
                    ...
                    for(j = i + 1; j < li.size(); j++) {
                        if (li.get(j).typ == ILTypes.GEO) 
                            ...
                            if (((li.get(j).isNewlineBefore() || li.get(j - 1).typ == ILTypes.PERSON)) && ((li.get(j).isNewlineAfter() || ((((j + 1) < li.size()) && li.get(j + 1).typ == ILTypes.PERSON))))) 
                                pers++;
                            else 
                                break;
                        }
        ...
        if ((maxChar == 0 && (i1 < li.size()) && (i1 + 10) > li.size()) && !hasApp && ((li.get(li.size() - 1).endChar - li.get(i1).endChar) < 200)) {
            for(int ii = li.size() - 1; ii > i; ii--) {
                if (li.get(ii).typ == ILTypes.PERSON || li.get(ii).typ == ILTypes.DATE || li.get(ii).typ == ILTypes.REGNUMBER) {
                    i1 = ii + 1;
                    break;
                }
            }
        ...
        int cMax = i1 - 1;
        FragToken tail = null;
        java.util.ArrayList<com.pullenti.ner.Referent> persList = new java.util.ArrayList< >();
        for(i = i1 - 1; i > 0; i--) {
            if (maxChar > 0) 
                break;
            ...
            if ((lii.typ == ILTypes.PERSON || lii.typ == ILTypes.REGNUMBER || lii.typ == ILTypes.DATE) || lii.typ == ILTypes.GEO) {
                if (persList.size() > 0 && ((((lii.typ != ILTypes.PERSON && lii.typ != ILTypes.DATE)) || ((!lii.isNewlineBefore() && !lii.getHasTableChars()))))) 
                    break;
                if (lii.typ == ILTypes.PERSON && (lii.ref instanceof com.pullenti.ner.ReferentToken)) {
                    if (persList.contains((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(lii.ref, com.pullenti.ner.ReferentToken.class))).referent)) 
                        break;
                }
                ...
                if (tail == null) {
                    tail = _new1206(li.get(i).getBeginToken(), li.get(i1 - 1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TAIL);
                    if ((i1 - 1) > i) {
                    }
                }
                ...
                if (li.get(i).typ == ILTypes.PERSON) {
                    ...
                    if (li.get(i).ref instanceof com.pullenti.ner.ReferentToken) {
                        res.m_Doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_SIGNER, (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(li.get(i).ref, com.pullenti.ner.ReferentToken.class))).referent, false, 0);
                        res.m_Doc.addExtReferent((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(li.get(i).ref, com.pullenti.ner.ReferentToken.class));
                        fr.value = li.get(i).ref;
                        persList.add((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(li.get(i).ref, com.pullenti.ner.ReferentToken.class))).referent);
                    }
                }
                else if (li.get(i).typ == ILTypes.REGNUMBER) {
                    if (li.get(i).isNewlineBefore()) {
                        if (res.m_Doc.getRegNumber() == null || com.pullenti.n2j.Utils.stringsEq(res.m_Doc.getRegNumber(), li.get(i).value)) {
                            fr.kind = com.pullenti.ner.instrument.InstrumentKind.NUMBER;
                            fr.value = li.get(i).value;
                            res.m_Doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_NUMBER, li.get(i).value, false, 0);
                        }
                    }
                }
                ...
                if (li.get(i).isPodpisStoron() && tail != null) {
                    ...
                    tail.children.add(0, _new1246(li.get(i).getBeginToken(), li.get(i).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NAME, ss));
                    cMax = i - 1;
                    break;
                }
                int jj;
        ...
        if (cMax < 0) {
            ...
            FragToken content = _new1206(li.get(0).getBeginToken(), li.get(cMax).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT);
        ...
        if (tail != null) {
            ...
            for(; i1 < li.size(); i1++) {
                if (li.get(i1).getBeginToken() == li.get(i1).getEndToken() && (li.get(i1).getBeginToken().getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) && (((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(li.get(i1).getBeginToken().getReferent(), com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER) {
                    FragToken ap = _new1206(li.get(i1).getBeginToken(), li.get(i1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.APPROVED);
                    ap.referents = new java.util.ArrayList< >();
                    ap.referents.add((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(li.get(i1).getBeginToken().getReferent(), com.pullenti.ner.decree.DecreeReferent.class));
            ...
            if (tail.children.size() > 0 && (tail.children.get(tail.children.size() - 1).endChar < tail.endChar)) {
                FragToken unkw = _new1206(tail.children.get(tail.children.size() - 1).getEndToken().getNext(), tail.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
        ...
        for(i = i1; i < li.size(); i++) {
            int j;
            for(j = i + 1; j < li.size(); j++) {
                if (li.get(j).typ == ILTypes.APPENDIX || li.get(j).typ == ILTypes.APPROVED) {
                    if ((li.get(j).beginChar - li.get(i).endChar) > 200) 
                        break;
                }
            }
            FragToken app = new FragToken(li.get(i).getBeginToken(), li.get(j - 1).getEndToken());
            tail = null;
            if (li.get(j - 1).typ == ILTypes.PERSON && li.get(j - 1).isNewlineBefore() && li.get(j - 1).isNewlineAfter()) {
                tail = _new1206(li.get(j - 1).getBeginToken(), li.get(j - 1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TAIL);
                for(int jj = j - 1; jj > i; jj--) {
                    if (li.get(jj).typ != ILTypes.PERSON || !li.get(jj).isNewlineBefore() || !li.get(jj).isNewlineAfter()) 
                        break;
                    else {
                        FragToken fr = _new1206(li.get(jj).getBeginToken(), li.get(jj).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.SIGNER);
            ...
            FragToken title = createAppendixTitle(app.getBeginToken(), app, res.m_Doc, isAllApps);
            if (title == null) {
                boolean ok = true;
                ...
                if (isApp && app.kind == com.pullenti.ner.instrument.InstrumentKind.APPENDIX) {
                    ...
                    FragToken res0 = _new1308(res.getBeginToken(), res.getEndToken(), res.m_Doc, com.pullenti.ner.instrument.InstrumentKind.DOCUMENT);
                    res.m_Doc = null;
                ...
                if (title.getEndToken().getNext() != null) {
                    if (title.getEndToken().endChar < app.getEndToken().beginChar) {
                        FragToken acontent = _new1206(title.getEndToken().getNext(), app.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT);
        ...
        if (res.children.size() > 0) 
            res.setEndToken(res.children.get(res.children.size() - 1).getEndToken());
        java.util.ArrayList<FragToken> appendixes = new java.util.ArrayList< >();
                ...
                if (ch.kind == com.pullenti.ner.instrument.InstrumentKind.APPENDIX || ch.kind == com.pullenti.ner.instrument.InstrumentKind.INTERNALDOCUMENT || ch.kind == com.pullenti.ner.instrument.InstrumentKind.HEAD) {
                    ...
                    if (hi != null) {
                        ...
                        if (hi != null && hi.value != null && hi.value.toString().length() > 20) 
                            res.m_Doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_NAME, hi.value, false, 0);
                    }
                }
            }
        }
                ...
                if (ch.kind == com.pullenti.ner.instrument.InstrumentKind.APPENDIX) {
                    ...
                    if (hi != null) {
                        ...
                        if (t1.isValue("К", "ДО") && t1.getNext() != null) 
                            t1 = t1.getNext();
                        com.pullenti.ner.decree.DecreeReferent dr = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t1.getReferent(), com.pullenti.ner.decree.DecreeReferent.class);
                        if (dr != null && com.pullenti.n2j.Utils.stringsEq(dr.getNumber(), res.m_Doc.getRegNumber())) 
            ...
            if ((res.children.size() > 1 && res.children.get(1).kind == com.pullenti.ner.instrument.InstrumentKind.CONTENT && res.children.get(1).children.size() > 0) && res.children.get(1).children.get(res.children.get(1).children.size() - 1).kind == com.pullenti.ner.instrument.InstrumentKind.DOCPART) {
                ...
                for(FragToken ch : part.children) {
                    if (ch.kind == com.pullenti.ner.instrument.InstrumentKind.DIRECTIVE && ch.value != null) {
                        res.m_Doc.setTyp((String)com.pullenti.n2j.Utils.cast(ch.value, String.class));
                        break;
                    }
                }
            }
    ...
    private static FragToken _createCaseInfo(com.pullenti.ner.Token t) {
        ...
        if ((t instanceof com.pullenti.ner.ReferentToken) && (t.getReferent() instanceof com.pullenti.ner.decree.DecreePartReferent)) {
            com.pullenti.ner.decree.DecreePartReferent dpr = (com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreePartReferent.class);
            if (com.pullenti.n2j.Utils.stringsEq(dpr.getPart(), "резолютивная")) 
                t1 = t;
        }
        ...
        if ((!hasDate && t1.getNext() != null && (t1.getNext().getReferent() instanceof com.pullenti.ner.date.DateReferent)) && t1.getNext().isNewlineAfter()) 
            t1 = t1.getNext();
        return _new1206(t, t1, com.pullenti.ner.instrument.InstrumentKind.CASEINFO);
    }
    ...
    private static FragToken _createApproved(com.pullenti.ner.Token t) {
        ...
        if (tt != null) 
            res = _new1206(t, tt, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
        else if (t.isValue("ОДОБРИТЬ", "СХВАЛИТИ") || t.isValue("ПРИНЯТЬ", "ПРИЙНЯТИ") || t.isValue("УТВЕРДИТЬ", "ЗАТВЕРДИТИ")) {
            if (t.getMorph().containsAttr("инф.", new com.pullenti.morph.MorphClass(null)) && t.getMorph().containsAttr("сов.в.", new com.pullenti.morph.MorphClass(null))) {
            }
            else 
                res = _new1206(t, t, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
        }
        ...
        if (t.getNext() == null) 
            return res;
        if (!t.isNewlineAfter() && com.pullenti.n2j.Utils.stringsEq(t.getNext().getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false), res.getBeginToken().getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false))) {
            for(t = t.getNext(); t != null; t = t.getNext()) {
                if (t.isNewlineBefore() || com.pullenti.n2j.Utils.stringsNe(t.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false), res.getBeginToken().getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false))) 
                    break;
                else 
                    res.setEndToken(t);
            }
        ...
        if (dts != null && dts.size() > 0) {
            for(int i = 0; i < dts.size(); i++) {
                ...
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.ORG) 
                    res.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION, dt));
                else if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.OWNER) 
                    res.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.INITIATOR, dt));
                else if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.DATE) 
                    res.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DATE, dt));
                    ...
                    res.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NUMBER, dt));
                    ...
                    res.children.add(_new1246(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.PLACE, dt));
                else 
                    break;
            ...
            res.referents = new java.util.ArrayList< >();
            for(; t != null; t = t.getNext()) {
                if (t.isCommaAnd()) 
                    continue;
                com.pullenti.ner.decree.DecreeReferent dr = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreeReferent.class);
        ...
        if (res.children.size() == 0) {
            if (!res.getBeginToken().isNewlineBefore() || !res.getEndToken().isNewlineAfter()) 
                return null;
        }
    ...
    public static FragToken _createMisc(com.pullenti.ner.Token t) {
        ...
        if (t.isValue("ФОРМА", null) && t.getNext().isValue("ДОКУМЕНТА", null)) {
            ...
            if (num != null && num.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER) 
                return _new1206(t, num.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
            if ((t.getNext().getNext() instanceof com.pullenti.ner.NumberToken) && t.getNext().getNext().isNewlineAfter()) 
                return _new1206(t, t.getNext().getNext(), com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
        }
        if (t.isValue("С", null) && t.getNext().isValue("ИЗМЕНЕНИЕ", null) && t.getNext().getNext() != null) {
            ...
            if (tt.getReferent() instanceof com.pullenti.ner.date.DateReferent) {
                if (tt.getNext() != null && tt.getNext().isChar('.')) 
                    tt = tt.getNext();
                return _new1206(t, tt, com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
            }
        }
        return null;
    }
    ...
    public static FragToken _createEditions(com.pullenti.ner.Token t) {
        ...
        if (t.isValue("РЕДАКЦИЯ", "РЕДАКЦІЯ")) 
            ...
            com.pullenti.ner.Token tt = (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken();
        ...
        if (!ok || t == null) 
            return null;
        java.util.ArrayList<com.pullenti.ner.decree.DecreeReferent> decrs = new java.util.ArrayList< >();
        for(t = t.getNext(); t != null; t = t.getNext()) {
            if (isInBracks) {
                if (t.isChar('(')) {
                    com.pullenti.ner.core.BracketSequenceToken br = com.pullenti.ner.core.BracketHelper.tryParse(t, com.pullenti.ner.core.BracketParseAttr.NO, 100);
        ...
        if (decrs.size() > 0) 
            isDoubt = false;
        if (ok && !isDoubt) {
            FragToken eds = _new1206(t0, t, com.pullenti.ner.instrument.InstrumentKind.EDITIONS);
            eds.referents = new java.util.ArrayList< >();
    ...
    private static FragToken _createOwner(com.pullenti.ner.Token t) {
        ...
        if (t1 == null) 
            return null;
        FragToken fr = _new1224(t, t1, com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION, true);
        return fr;
    }

    private int calcOwnerCoef(FragToken owner) {
        java.util.ArrayList<String> ownTyps = new java.util.ArrayList< >();
            ...
            if (ch.kind == com.pullenti.ner.instrument.InstrumentKind.HEAD) {
                for(FragToken chh : ch.children) {
                    if (chh.kind == com.pullenti.ner.instrument.InstrumentKind.TYP || chh.kind == com.pullenti.ner.instrument.InstrumentKind.NAME || chh.kind == com.pullenti.ner.instrument.InstrumentKind.KEYWORD) {
                        ...
                        if (t instanceof com.pullenti.ner.TextToken) 
                            ownTyps.add((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).getLemma());
                ...
                for(FragToken chh : ch.children) {
                    if (chh.kind == com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE) {
                        ...
                        if (tt instanceof com.pullenti.ner.TextToken) {
                            String ty = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getLemma();
                            ...
                            if (pt.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.APPENDIX) {
                                if (owner.number > 0) {
                                    for(com.pullenti.ner.decree.internal.PartToken.PartValue nn : pt.values) {
                                        if (com.pullenti.n2j.Utils.stringsEq(nn.value, ((Integer)owner.number).toString())) 
                                            return 3;
                                    }
                                }
                            }
                        ...
                        if (ownName != null && (ownName.value instanceof String)) {
                            String val0 = (String)com.pullenti.n2j.Utils.cast(ownName.value, String.class);
                            ...
                            if (com.pullenti.n2j.Utils.stringsEq(val1, val0)) 
                                return 3;
    ...
    public com.pullenti.ner.MetaToken getMultilineChangesValue() {
        for(com.pullenti.ner.Token t = getBeginToken(); t != null && (t.beginChar < endChar); t = t.getNext()) {
            if (t.getReferent() instanceof com.pullenti.ner.decree.DecreeChangeReferent) {
                com.pullenti.ner.decree.DecreeChangeReferent dcr = (com.pullenti.ner.decree.DecreeChangeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreeChangeReferent.class);
                for(com.pullenti.ner.Token tt = (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken(); tt != null && tt.endChar <= t.endChar; tt = tt.getNext()) {
                    com.pullenti.ner.decree.DecreeChangeValueReferent dval = (com.pullenti.ner.decree.DecreeChangeValueReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.decree.DecreeChangeValueReferent.class);
                    ...
                    for(t = (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.MetaToken.class))).getBeginToken(); t != null && t.endChar <= tt.endChar; t = t.getNext()) {
                    ...
                    com.pullenti.ner.Token t1 = (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.MetaToken.class))).getEndToken();
                    if (com.pullenti.ner.core.BracketHelper.isBracket(t1, true)) 
                        t1 = t1.getPrevious();
                    if (t0 != null && ((t0.endChar + 50) < t1.endChar)) 
                        return com.pullenti.ner.MetaToken._new799(t0, t1, dcr);
                    return null;
                }
            }
            if (t.endChar > endChar) 
    ...
    private static FragToken createZapiskaTitle(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        for(com.pullenti.ner.Token t = t0; t != null && (cou < 30); t = t.getNext(),cou++) {
            InstrToken1 li = InstrToken1.parse(t, true, null, 0, null, false, 0, false);
            if (li == null) 
                break;
            ...
            if (ok) {
                FragToken res = _new1206(t0, li.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.HEAD);
                if (li.getBeginToken() != t0) {
                    FragToken hh = _new1206(t0, li.getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.APPROVED);
                    res.children.add(hh);
                }
                res.children.add(_new1230(li.getBeginToken(), li.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.KEYWORD, true));
                return res;
            }
            t = li.getEndToken();
        }
    ...
    private static String[] m_ZapiskaKeywords = new String[] {"ЗАЯВЛЕНИЕ", "ЗАПИСКА", "РАПОРТ", "ДОКЛАД", "ОТЧЕТ"};
    ...
    private static FragToken createContractTitle(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        for(t = t0; t != null; t = t.getNext()) {
            if (t instanceof com.pullenti.ner.ReferentToken) {
                com.pullenti.ner.ReferentToken rtt = (com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class);
        ...
        for(t = t0; t != null && (cou < 300); t = t.getNext(),cou++) {
            ...
            if (t.isNewlineBefore()) {
                ...
                com.pullenti.ner.decree.internal.DecreeToken dt = com.pullenti.ner.decree.internal.DecreeToken.tryAttach(t, null, false);
                if (dt != null && dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) {
                    if (((((com.pullenti.n2j.Utils.stringsEq(dt.value, "ОПРЕДЕЛЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(dt.value, "ПОСТАНОВЛЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(dt.value, "РЕШЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(dt.value, "ПРИГОВОР") || com.pullenti.n2j.Utils.stringsEq(dt.value, "ВИЗНАЧЕННЯ")) || com.pullenti.n2j.Utils.stringsEq(dt.value, "ПОСТАНОВА") || com.pullenti.n2j.Utils.stringsEq(dt.value, "РІШЕННЯ")) || com.pullenti.n2j.Utils.stringsEq(dt.value, "ВИРОК") || dt.value.endsWith("ЗАЯВЛЕНИЕ")) || dt.value.endsWith("ЗАЯВА")) 
                        return null;
                }
                if (t.getReferent() instanceof com.pullenti.ner.org.OrganizationReferent) {
                    com.pullenti.ner.org.OrganizationKind ki = (((com.pullenti.ner.org.OrganizationReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.org.OrganizationReferent.class))).getKind();
                    if (ki == com.pullenti.ner.org.OrganizationKind.JUSTICE) 
                        return null;
                }
            }
        ...
        for(; t != null && (cou < 100); t = t.getNext(),cou++) {
            ...
            if (par2 != null) {
                if (par2.kind == ParticipantToken.Kinds.NAMEDAS && com.pullenti.n2j.Utils.stringsNe(par2.typ, par1.typ)) 
                    break;
                if (par2.kind == ParticipantToken.Kinds.PURE && com.pullenti.n2j.Utils.stringsNe(par2.typ, par1.typ)) {
        ...
        if (par1 != null && par2 != null && ((par1.typ == null || par2.typ == null))) {
            ...
            for(com.pullenti.ner.Token tt = t; tt != null; tt = tt.getNext()) {
                ...
                if (tt instanceof com.pullenti.ner.MetaToken) 
                    ttt = (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.MetaToken.class))).getBeginToken();
                ...
                if (com.pullenti.n2j.Utils.stringsEq(key, par1.typ) || com.pullenti.n2j.Utils.stringsEq(key, par2.typ) || com.pullenti.n2j.Utils.stringsEq(key, "СТОРОНА")) 
                    continue;
        ...
        if (t1 == null) 
            return null;
        com.pullenti.ner.instrument.InstrumentParticipant p1 = com.pullenti.ner.instrument.InstrumentParticipant._new1330(par1.typ);
        if (par1.parts != null) {
        ...
        java.util.ArrayList<com.pullenti.ner.instrument.InstrumentParticipant> allParts = new java.util.ArrayList< >();
        allParts.add(p1);
        if (par1.kind == ParticipantToken.Kinds.NAMEDASPARTS) {
            p1.setTyp("СТОРОНА 1");
            ...
            for(int ii = 1; ii < par1.parts.size(); ii++) {
                com.pullenti.ner.instrument.InstrumentParticipant pp = com.pullenti.ner.instrument.InstrumentParticipant._new1330("СТОРОНА " + (ii + 1));
        ...
        for(t = t0; t != null && t.endChar <= t1.endChar; t = t.getNext()) {
            ...
            if (newLineBef && t != t0) {
                ...
                InstrToken1 it1 = InstrToken1.parse(t, true, null, 0, null, false, 0, false);
                ...
                if (namBeg == null && ((t.isValue("О", "ПРО") || t.isValue("ОБ", null) || t.isValue("НА", null)))) {
                    namBeg = t;
                    continue;
                }
                if (add) 
            ...
            if ((dttyp != null && namBeg == null && t.chars.isCyrillicLetter()) && (t instanceof com.pullenti.ner.TextToken)) {
                if (t.isValue("МЕЖДУ", "МІЖ")) {
                    ...
                    if (pp != null && pp.getEndToken().getNext() != null && pp.getEndToken().getNext().isAnd()) {
                        ...
                        if (pp2 != null) {
                            FragToken fr = _new1206(t, pp2.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.PLACE);
                            if (fr.referents == null) 
                                fr.referents = new java.util.ArrayList< >();
            ...
            else if (((t.isValue("МЕЖДУ", "МІЖ") || t.isValue("ЗАКЛЮЧИТЬ", "УКЛАСТИ"))) && namBeg != null && namEnd == null) 
                namEnd = t.getPrevious();
            if ((newLineBef && t.getWhitespacesBeforeCount() > 15 && namBeg != null) && namEnd == null) 
                namEnd = t.getPrevious();
        }
        ...
        if (namEnd != null && namBeg != null) {
            ...
            if (val != null && val.length() > 3) {
                FragToken nam = _new1246(namBeg, namEnd, com.pullenti.ner.instrument.InstrumentKind.NAME, val);
                title.children.add(nam);
                title.sortChildren();
                if (namEnd.endChar > title.endChar) 
                    title.setEndToken(namEnd);
                val = nam.getSourceText().toUpperCase().replace('\r', ' ').replace('\n', ' ');
                while((val.indexOf("  ") >= 0)) {
                    val = val.replace("  ", " ");
                }
        ...
        if (title.children.size() > 0 && title.children.get(0).beginChar > title.beginChar) 
            title.children.add(0, _new1206(title.getBeginToken(), title.children.get(0).getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.UNDEFINED));
        if (((com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), "ДОГОВОР") || com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), "ДОГОВІР"))) && par1.kind != ParticipantToken.Kinds.NAMEDASPARTS) {
            if (title.children.size() > 0 && title.children.get(0).kind == com.pullenti.ner.instrument.InstrumentKind.TYP) {
                    ...
                    if (ch.kind == com.pullenti.ner.instrument.InstrumentKind.NAME) {
                        if (ch.getBeginToken().getMorph()._getClass().isPreposition()) {
                            ...
                            if (npt != null) {
                                ...
                                java.util.ArrayList<com.pullenti.morph.MorphWordForm> vvv = com.pullenti.morph.Morphology.getAllWordforms(addi, new com.pullenti.morph.MorphLang(null));
                ...
                if (addi != null) {
                    ...
                    if (com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), doc.getName())) 
                        doc.setName(null);
                }
        ...
        if (com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), "ДОГОВОР УСЛУГ")) 
            doc.setTyp("ДОГОВОР ОКАЗАНИЯ УСЛУГ");
        if (com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), "ДОГОВІР ПОСЛУГ")) 
        ...
        if (par2 == null) {
            ...
            if (tt2 != null && par1 != null) {
                ...
                for(com.pullenti.ner.Token ttt = tt2; ttt != null; ttt = ttt.getNext()) {
                    ...
                    com.pullenti.ner.core.TerminToken tok = ParticipantToken.m_Ontology.tryParse(ttt, com.pullenti.ner.core.TerminParseAttr.NO);
                    if (tok != null && tok.termin.tag != null && com.pullenti.n2j.Utils.stringsNe(tok.termin.getCanonicText(), "СТОРОНА")) {
                ...
                if (typ2 != null) 
                    par2 = ParticipantToken._new1336(tt2, tt2, typ2);
            }
        }
        rt.referent = (p1 = (com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast(ad.registerReferent(p1), com.pullenti.ner.instrument.InstrumentParticipant.class));
        t0.kit.embedToken(rt);
        if (par2 != null) {
            p2 = com.pullenti.ner.instrument.InstrumentParticipant._new1330(par2.typ);
            if (par2.parts != null) {
            ...
            p2 = (com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast(ad.registerReferent(p2), com.pullenti.ner.instrument.InstrumentParticipant.class);
            ...
            for(com.pullenti.ner.instrument.InstrumentParticipant pp : allParts) {
                com.pullenti.ner.instrument.InstrumentParticipant ppp = (com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast(ad.registerReferent(pp), com.pullenti.ner.instrument.InstrumentParticipant.class);
        ...
        for(t = rt.getNext(); t != null; t = ((t == null ? null : t.getNext()))) {
            ...
            if (t.isNewlineBefore()) {
                if ((t instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value == ((long)6)) {
                }
                InstrToken1 ii = InstrToken1.parse(t, true, null, 0, null, false, 0, true);
                if (ii != null && ii.isStandardTitle) {
                    reqRegim = 5;
                    t = ii.getEndToken();
                    continue;
                }
            ...
            java.util.ArrayList<com.pullenti.ner.instrument.InstrumentParticipant> ps = new java.util.ArrayList< >();
            ps.add((com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast(rt.referent, com.pullenti.ner.instrument.InstrumentParticipant.class));
            if (reqRegim > 0) {
            ...
            if (rt.getEndToken().getNext() != null && rt.getEndToken().getNext().isTableControlChar() && !rt.getEndToken().getNext().isChar((char)0x1E)) {
                for(com.pullenti.ner.Token tt = rt.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                    if (tt.isTableControlChar()) {
                        ...
                        if (rt1 != null) {
                            ps.add((com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast(rt1.referent, com.pullenti.ner.instrument.InstrumentParticipant.class));
            ...
            for(; t != null; t = t.getNext()) {
                ...
                if (!t.isNewlineAfter()) 
                    continue;
                InstrToken1 it1 = InstrToken1.parse(t.getNext(), true, null, 0, null, false, 0, false);
                if (it1 != null) {
                    if (it1.allUpper || it1.isStandardTitle || it1.numbers.size() > 0) 
                        break;
                }
            }
        }
    ...
    private static FragToken createProjectTitle(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        for(t = t0; t != null; t = t.getNext()) {
            ...
            if ((t instanceof com.pullenti.ner.TextToken) && ((com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "ПРОЕКТ") || com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "ЗАКОНОПРОЕКТ")))) {
                if ((t.isValue("ПРОЕКТ", null) && t == t0 && (t.getNext() instanceof com.pullenti.ner.ReferentToken)) && (t.getNext().getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) 
                    return null;
                isProject = true;
                title.children.add(_new1224(t, t, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, true));
            ...
            if (tt != null) {
                isEntered = true;
                title.children.add(_new1206(t, tt, com.pullenti.ner.instrument.InstrumentKind.APPROVED));
                t = tt;
                continue;
            }
            tt = _attachProjectMisc(t);
            if (tt != null) {
                title.children.add(_new1206(t, tt, (tt.isValue("ЧТЕНИЕ", "ЧИТАННЯ") ? com.pullenti.ner.instrument.InstrumentKind.EDITIONS : com.pullenti.ner.instrument.InstrumentKind.UNDEFINED)));
                t = tt;
                continue;
            }
        ...
        for(t = t00; t != null; t = t.getNext()) {
            ...
            if (!t.isNewlineBefore()) 
                continue;
            InstrToken1 it = InstrToken1.parse(t, true, null, 0, null, false, 0, false);
        ...
        if (t11 == null) 
            return null;
        FragToken nam = _new1224(t00, t11, com.pullenti.ner.instrument.InstrumentKind.NAME, true);
        doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_NAME, nam.value, false, 0);
        title.children.add(nam);
    ...
    private static void _createJusticeParticipants(FragToken title, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        boolean ok = ((((com.pullenti.n2j.Utils.stringsEq(typ, "ПОСТАНОВЛЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(typ, "РЕШЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(typ, "ОПРЕДЕЛЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(typ, "ПРИГОВОР") || (((String)com.pullenti.n2j.Utils.notnull(typ, ""))).endsWith("ЗАЯВЛЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(typ, "ПОСТАНОВА") || com.pullenti.n2j.Utils.stringsEq(typ, "РІШЕННЯ")) || com.pullenti.n2j.Utils.stringsEq(typ, "ВИЗНАЧЕННЯ") || com.pullenti.n2j.Utils.stringsEq(typ, "ВИРОК")) || (((String)com.pullenti.n2j.Utils.notnull(typ, ""))).endsWith("ЗАЯВА");
        for(com.pullenti.ner.Slot s : doc.getSlots()) {
            if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.instrument.InstrumentReferent.ATTR_SOURCE) && (s.getValue() instanceof com.pullenti.ner.org.OrganizationReferent)) {
                com.pullenti.ner.org.OrganizationKind ki = (((com.pullenti.ner.org.OrganizationReferent)com.pullenti.n2j.Utils.cast(s.getValue(), com.pullenti.ner.org.OrganizationReferent.class))).getKind();
                if (ki == com.pullenti.ner.org.OrganizationKind.JUSTICE) 
                    ok = true;
            }
            else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.instrument.InstrumentReferent.ATTR_CASENUMBER)) 
                ok = true;
        }
            ...
            if (t.getNext() != null && ((t.getNext().isChar(':') || t.getNext().isTableControlChar()))) {
                if (t.isValue("ЗАЯВИТЕЛЬ", "ЗАЯВНИК")) {
                    ...
                    if (pZayav != null) {
                        ...
                        (((com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast(pZayav.referent, com.pullenti.ner.instrument.InstrumentParticipant.class))).setTyp("ЗАЯВИТЕЛЬ");
                    }
                }
                    ...
                    if (pIst != null) {
                        ...
                        (((com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast(pIst.referent, com.pullenti.ner.instrument.InstrumentParticipant.class))).setTyp("ИСТЕЦ");
                    }
                }
                    ...
                    if (pOtv != null) {
                        ...
                        (((com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast(pOtv.referent, com.pullenti.ner.instrument.InstrumentParticipant.class))).setTyp("ОТВЕТЧИК");
                    }
                }
            }
        }
        ...
        while(t != null) {
            ...
            java.util.ArrayList<com.pullenti.ner.Referent> arefs = new java.util.ArrayList< >();
            com.pullenti.ner.Token t1 = null;
            for(; t != null; t = t.getNext()) {
                ...
                if (t instanceof com.pullenti.ner.TextToken) {
                    ...
                    if (com.pullenti.n2j.Utils.stringsEq(term, "ИП")) 
                        continue;
                }
                if (t.isAnd()) {
                    if (t.getNext() == null) 
            ...
            if (tmp.length() > 10 && t1 != null) {
                com.pullenti.ner.instrument.InstrumentArtefact art = com.pullenti.ner.instrument.InstrumentArtefact._new1343("предмет");
        ...
        for(t = (pOtv == null ? t : pOtv.getNext()); t != null; t = t.getNext()) {
            ...
            if (t.isValue("ИСТЕЦ", "ПОЗИВАЧ") && pIst != null) {
                ...
                com.pullenti.ner.Referent r = t.getReferent();
                if (!((r instanceof com.pullenti.ner.org.OrganizationReferent)) && !((r instanceof com.pullenti.ner.person.PersonReferent))) 
                    continue;
            ...
            if (checkDel && t.getPrevious() != null && t.getPrevious().isValue("ОТ", null)) {
                ...
                if (tt.isWhitespaceBefore()) {
                    ...
                    if (tt1.getReferent() instanceof com.pullenti.ner.person.PersonReferent) {
                        rt.setBeginToken(tt);
                        rt.setEndToken(tt1);
                        rt.referent.addSlot(com.pullenti.ner.instrument.InstrumentParticipant.ATTR_DELEGATE, (com.pullenti.ner.person.PersonReferent)com.pullenti.n2j.Utils.cast(tt1.getReferent(), com.pullenti.ner.person.PersonReferent.class), false, 0);
                    }
                }
            }
            if (rt != null && rt.getEndToken().getNext() != null && rt.getEndToken().getNext().isChar('(')) {
                ...
                if (tt != null && tt.getNext() != null && tt.getNext().isChar(')')) {
                    if (tt.isValue("ИСТЕЦ", "ПОЗИВАЧ") && pIst != null && rt.referent == pIst.referent) 
                        ...
                        rt.setEndToken(tt.getNext());
                    else if ((tt.getReferent() instanceof com.pullenti.ner.person.PersonReferent) || (tt.getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) {
    ...
    private static com.pullenti.ner.ReferentToken _createJustParticipant(com.pullenti.ner.Token t, String typ) {
        ...
        for(; t != null; t = t.getNext()) {
            ...
            com.pullenti.ner.Referent r = t.getReferent();
            if ((r instanceof com.pullenti.ner.person.PersonReferent) || (r instanceof com.pullenti.ner.org.OrganizationReferent)) {
                if (r0 == null) {
                    refs.add(r);
                    r0 = r;
                    t1 = t;
            ...
            if (r instanceof com.pullenti.ner.uri.UriReferent) {
                com.pullenti.ner.uri.UriReferent ur = (com.pullenti.ner.uri.UriReferent)com.pullenti.n2j.Utils.cast(r, com.pullenti.ner.uri.UriReferent.class);
                if (com.pullenti.n2j.Utils.stringsEq(ur.getScheme(), "ИНН") || com.pullenti.n2j.Utils.stringsEq(ur.getScheme(), "ИИН") || com.pullenti.n2j.Utils.stringsEq(ur.getScheme(), "ОГРН")) 
                    ok = true;
                refs.add(r);
                t1 = t;
                continue;
            ...
            com.pullenti.ner.org.internal.OrgItemTypeToken ty = com.pullenti.ner.org.internal.OrgItemTypeToken.tryAttach(t, true, null);
            if (ty != null) {
                t1 = (t = ty.getEndToken());
                ok = true;
                continue;
        ...
        if (!ok) 
            return null;
        com.pullenti.ner.instrument.InstrumentParticipant pat = com.pullenti.ner.instrument.InstrumentParticipant._new1330(typ);
    ...
    private void _createJusticeResolution() {
        ...
        for(com.pullenti.ner.Token t = res.getBeginToken(); t != null && t.endChar <= res.endChar; t = t.getNext()) {
            ...
            if (t.getMorph()._getClass().isPreposition() && t.getNext() != null) 
                t = t.getNext();
            java.util.ArrayList<com.pullenti.ner.ReferentToken> arts = new java.util.ArrayList< >();
            ...
            if (t.isValue("ВЗЫСКАТЬ", "СТЯГНУТИ")) {
                ...
                for(tt = t.getNext(); tt != null && tt.endChar <= res.endChar; tt = tt.getNext()) {
                    ...
                    if (tt.getReferent() instanceof com.pullenti.ner.money.MoneyReferent) {
                        te = tt;
                        sum = (com.pullenti.ner.money.MoneyReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.money.MoneyReferent.class);
                    }
                }
                if (sum != null) {
                    com.pullenti.ner.instrument.InstrumentArtefact art = com.pullenti.ner.instrument.InstrumentArtefact._new1343("РЕЗОЛЮЦИЯ");
                    if (gosposh) 
        ...
        for(int i = 0; i < children.size(); i++) {
            if (children.get(i).kind == com.pullenti.ner.instrument.InstrumentKind.DIRECTIVE && ((i + 1) < children.size())) {
                ...
                if (v == null) 
                    continue;
                String s = v.toString();
                if ((((com.pullenti.n2j.Utils.stringsEq(s, "РЕШЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(s, "ОПРЕДЕЛЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(s, "ПОСТАНОВЛЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(s, "ПРИГОВОР") || com.pullenti.n2j.Utils.stringsEq(s, "РІШЕННЯ")) || com.pullenti.n2j.Utils.stringsEq(s, "ВИЗНАЧЕННЯ") || com.pullenti.n2j.Utils.stringsEq(s, "ПОСТАНОВА")) || com.pullenti.n2j.Utils.stringsEq(s, "ВИРОК")) {
                    int ii = i + 1;
                    for(int j = ii + 1; j < children.size(); j++) {
                        if (children.get(j).kind != children.get(ii).kind) 
                            break;
                        else 
                            ii = j;
                    }
                    if (ii == (i + 1)) 
                        ...
                        return _new1206(children.get(i + 1).getBeginToken(), children.get(ii).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT);
                }
                dir = true;
            }
        }
    ...
    private static FragToken __createActionQuestion(com.pullenti.ner.Token t, int maxChar) {
        java.util.ArrayList<InstrToken> li = new java.util.ArrayList< >();
        boolean ok = false;
        for(com.pullenti.ner.Token tt = t; tt != null; tt = tt.getNext()) {
        ...
        java.util.ArrayList<InstrToken> li2 = new java.util.ArrayList< >();
        ok = false;
        for(com.pullenti.ner.Token tt = t1.getNext(); tt != null; tt = tt.getNext()) {
            if (!tt.isNewlineBefore()) 
                continue;
            ...
            if (it.typ != ILTypes.TYP) 
                continue;
            InstrToken1 it1 = InstrToken1.parse(tt, true, null, 0, null, false, maxChar, false);
        ...
        if (res == null) 
            return null;
        FragToken ques = _new1206(t, t2.getPrevious(), com.pullenti.ner.instrument.InstrumentKind.QUESTION);
        res.children.add(0, ques);
        ques.children.add(_new1206(li.get(li.size() - 1).getBeginToken(), li.get(li.size() - 1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.KEYWORD));
        FragToken content = _new1206(li.get(li.size() - 1).getEndToken().getNext(), t2.getPrevious(), com.pullenti.ner.instrument.InstrumentKind.CONTENT);
        ques.children.add(content);
        content._analizeContent(res, maxChar > 0, com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
        if (li.size() > 1) {
            FragToken fr = _new1230(t, li.get(li.size() - 2).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NAME, true);
    ...
    public static FragToken _new1206(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        return res;
    }
    public static FragToken _new1207(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, InstrToken1 _arg3, boolean _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.itok = _arg3;
        res.isExpired = _arg4;
        return res;
    }
    public static FragToken _new1208(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, boolean _arg4, InstrToken1 _arg5) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
    ...
    public static FragToken _new1214(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, InstrToken1 _arg3) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.itok = _arg3;
        return res;
    }
    public static FragToken _new1215(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, InstrToken1 _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.itok = _arg4;
        return res;
    }
    public static FragToken _new1222(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, int _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.number = _arg4;
        return res;
    }
    public static FragToken _new1224(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, boolean _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.setDefVal2(_arg4);
        return res;
    }
    public static FragToken _new1230(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, boolean _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.setDefVal(_arg4);
        return res;
    }
    public static FragToken _new1234(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, Object _arg4, InstrToken1 _arg5) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.value = _arg4;
        res.itok = _arg5;
    ...
    public static FragToken _new1239(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, int _arg4, boolean _arg5, java.util.ArrayList<com.pullenti.ner.Referent> _arg6) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.number = _arg4;
        res.isExpired = _arg5;
    ...
    public static FragToken _new1246(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, Object _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.value = _arg4;
        return res;
    }
    public static FragToken _new1308(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentReferent _arg3, com.pullenti.ner.instrument.InstrumentKind _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.m_Doc = _arg3;
        res.kind = _arg4;
        return res;
    }
    public static FragToken _new1406(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, boolean _arg4, InstrToken1 _arg5) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.setDefVal(_arg4);
        res.itok = _arg5;
