...
public class ParticipantToken extends com.pullenti.ner.MetaToken {
    ...
    public String toString() {
        ...
        res.append(kind.toString()).append(": ").append(((String)com.pullenti.n2j.Utils.notnull(typ, "?")));
        if (parts != null) {
            for(com.pullenti.ner.Referent p : parts) {
                res.append("; ").append(p.toString(true, new com.pullenti.morph.MorphLang(null), 0));
            }
        }
        return res.toString();
    }
    ...
    public static ParticipantToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant p1, com.pullenti.ner.instrument.InstrumentParticipant p2, boolean isContract) {
        ...
        if (p1 == null && p2 == null && isContract) {
            ...
            if ((r1 != null && t.getNext() != null && t.getNext().isCommaAnd()) && (t.getNext().getNext() instanceof com.pullenti.ner.ReferentToken)) {
                ...
                if (com.pullenti.n2j.Utils.stringsEq(r1.getTypeName(), r2.getTypeName())) {
                    ...
                    for(; ttt != null; ttt = ttt.getNext()) {
                        if ((ttt.isCommaAnd() && ttt.getNext() != null && ttt.getNext().getReferent() != null) && com.pullenti.n2j.Utils.stringsEq(ttt.getNext().getReferent().getTypeName(), r1.getTypeName())) {
                            ttt = ttt.getNext();
                    ...
                    for(; ttt != null; ttt = ttt.getNext()) {
                        ...
                        if (npt != null && npt.noun.isValue("СТОРОНА", null) && npt.getMorph().getNumber() != com.pullenti.morph.MorphNumber.SINGULAR) {
                            ParticipantToken re = _new1417(t, npt.getEndToken(), Kinds.NAMEDASPARTS);
                            re.parts = refs;
                            return re;
                        }
                        break;
            ...
            if ((r1 instanceof com.pullenti.ner.org.OrganizationReferent) || (r1 instanceof com.pullenti.ner.person.PersonReferent)) {
                boolean hasBr = false;
                ...
                if (r1 instanceof com.pullenti.ner.person.PersonReferent) {
                    ...
                    return null;
                for(com.pullenti.ner.Token ttt = (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class))).getBeginToken(); ttt != null && (ttt.endChar < t.endChar); ttt = ttt.getNext()) {
                    if (ttt.isChar('(')) 
                        hasBr = true;
                        ...
                        ParticipantToken re = _new1417(t, t, Kinds.NAMEDAS);
                        re.typ = npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                        re.parts = new java.util.ArrayList< >();
                        re.parts.add(r1);
                        return re;
                    }
                }
                ...
                for(com.pullenti.ner.Token ttt = t.getNext(); ttt != null; ttt = ttt.getNext()) {
                    if ((ttt instanceof com.pullenti.ner.NumberToken) && (ttt.getNext() instanceof com.pullenti.ner.TextToken) && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(ttt.getNext(), com.pullenti.ner.TextToken.class))).term, "СТОРОНЫ")) {
                    ...
                    if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(ttt, false, false)) {
                        ...
                        if (npt != null) {
                            ...
                            if (ttt instanceof com.pullenti.ner.MetaToken) 
                                ttok = m_Ontology.tryParse((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(ttt, com.pullenti.ner.MetaToken.class))).getBeginToken(), com.pullenti.ner.core.TerminParseAttr.NO);
                            if (ttok != null) 
                        ...
                        ParticipantToken re = _new1417(t, ttt, Kinds.NAMEDAS);
                        re.typ = (String)com.pullenti.n2j.Utils.notnull(typ22, (npt != null ? npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), true, com.pullenti.morph.MorphGender.UNDEFINED, false) : null));
                        re.parts = new java.util.ArrayList< >();
                        re.parts.add(r1);
                        return re;
                    }
                    else if (ttt.isValue("ЗАРЕГИСТРИРОВАННЫЙ", null) || ttt.isValue("КАЧЕСТВО", null) || ttt.isValue("ПРОЖИВАЮЩИЙ", null)) {
                    }
                        ...
                        if (addRefs == null) 
                            addRefs = new java.util.ArrayList< >();
                        addRefs.add(ttt.getReferent());
                    }
                    else {
                        com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(ttt, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                        if (npt != null) {
                            if (npt.noun.isValue("МЕСТО", null) || npt.noun.isValue("ЖИТЕЛЬСТВО", null)) {
                                ttt = npt.getEndToken();
                                continue;
                            }
                        }
                ...
                if (endSide != null || ((addRefs != null && t.getPrevious() != null && t.getPrevious().isAnd()))) {
                    ParticipantToken re = _new1417(t, (com.pullenti.ner.Token)com.pullenti.n2j.Utils.notnull(endSide, t), Kinds.NAMEDAS);
                    re.typ = null;
                    re.parts = new java.util.ArrayList< >();
                    re.parts.add(r1);
                    if (addRefs != null) 
                        re.parts.addAll(addRefs);
                    return re;
                }
            }
            com.pullenti.ner.core.TerminToken too = m_Ontology.tryParse(t, com.pullenti.ner.core.TerminParseAttr.NO);
            if (too != null && too.termin.tag != null && com.pullenti.n2j.Utils.stringsNe(too.termin.getCanonicText(), "СТОРОНА")) {
                ...
                if (tt1 instanceof com.pullenti.ner.ReferentToken) {
                    r1 = tt1.getReferent();
                    if ((r1 instanceof com.pullenti.ner.person.PersonReferent) || (r1 instanceof com.pullenti.ner.org.OrganizationReferent)) {
                        ParticipantToken re = _new1417(t, tt1, Kinds.NAMEDAS);
        ...
        if (addTyp1 != null && addTyp1.indexOf(' ') > 0 && !addTyp1.startsWith("СТОРОНА")) 
            term1 = new com.pullenti.ner.core.Termin(addTyp1, new com.pullenti.morph.MorphLang(null), false);
        if (addTyp2 != null && addTyp2.indexOf(' ') > 0 && !addTyp2.startsWith("СТОРОНА")) 
            term2 = new com.pullenti.ner.core.Termin(addTyp2, new com.pullenti.morph.MorphLang(null), false);
        boolean named = false;
        String _typ = null;
        ...
        for(; tt != null; tt = tt.getNext()) {
            ...
            if (com.pullenti.ner.core.BracketHelper.isBracket(tt, false)) 
                continue;
            com.pullenti.ner.core.TerminToken tok = m_Ontology.tryParse(tt, com.pullenti.ner.core.TerminParseAttr.NO);
            if (tok == null) {
                if (addTyp1 != null && ((com.pullenti.ner.core.MiscHelper.isNotMoreThanOneError(addTyp1, tt) || ((((tt instanceof com.pullenti.ner.MetaToken)) && (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.MetaToken.class))).getBeginToken().isValue(addTyp1, null)))))) {
                    if (_typ != null) {
                ...
                if (addTyp2 != null && ((com.pullenti.ner.core.MiscHelper.isNotMoreThanOneError(addTyp2, tt) || ((((tt instanceof com.pullenti.ner.MetaToken)) && (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.MetaToken.class))).getBeginToken().isValue(addTyp2, null)))))) {
                    if (_typ != null) {
                    ...
                    if ((tt instanceof com.pullenti.ner.TextToken) && tt.chars.isCyrillicLetter() && tt.chars.isCapitalUpper()) {
                        ...
                        if (dc.isUndefined() || dc.isNoun()) {
                            ...
                            if (dt != null) 
                                ...
                                ok = false;
                            if (ok) {
                                _typ = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getLemma();
                                t1 = tt;
                                continue;
                            }
                        }
                        if (dc.isAdjective()) {
                            ...
                            if (npt != null && npt.adjectives.size() > 0 && npt.noun.getMorphClassInDictionary().isNoun()) {
                                _typ = npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                                t1 = npt.getEndToken();
                                continue;
                            }
                        }
            ...
            if (tok.termin.tag == null) 
                ...
                if (_typ != null) 
                    break;
                if (com.pullenti.n2j.Utils.stringsEq(tok.termin.getCanonicText(), "СТОРОНА")) {
                    ...
                    if (tt1.isNewlineBefore()) 
                        break;
                    _typ = tok.termin.getCanonicText() + " " + (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt1, com.pullenti.ner.NumberToken.class))).value;
                    t1 = tt1;
                }
                else {
        ...
        if (br && t1.getNext() != null && com.pullenti.ner.core.BracketHelper.canBeEndOfSequence(t1.getNext(), false, null, false)) 
            t1 = t1.getNext();
        ParticipantToken res = _new1422(t, t1, (named ? Kinds.NAMEDAS : Kinds.PURE), _typ);
        if (t.isChar(':')) 
    ...
    private static boolean _isTypesEqual(String t1, String t2) {
        if (com.pullenti.n2j.Utils.stringsEq(t1, t2)) 
            return true;
        if (com.pullenti.n2j.Utils.stringsEq(t1, "ЗАЙМОДАВЕЦ") || com.pullenti.n2j.Utils.stringsEq(t1, "ЗАИМОДАВЕЦ")) 
            t1 = "ЗАИМОДАТЕЛЬ";
        if (com.pullenti.n2j.Utils.stringsEq(t2, "ЗАЙМОДАВЕЦ") || com.pullenti.n2j.Utils.stringsEq(t2, "ЗАИМОДАВЕЦ")) 
            t2 = "ЗАИМОДАТЕЛЬ";
        if (com.pullenti.n2j.Utils.stringsEq(t1, "ПРОДАВЕЦ")) 
            t1 = "ПОСТАВЩИК";
        if (com.pullenti.n2j.Utils.stringsEq(t2, "ПРОДАВЕЦ")) 
            t2 = "ПОСТАВЩИК";
        if (com.pullenti.n2j.Utils.stringsEq(t1, "ПОКУПАТЕЛЬ")) 
            t1 = "ЗАКАЗЧИК";
        if (com.pullenti.n2j.Utils.stringsEq(t2, "ПОКУПАТЕЛЬ")) 
            t2 = "ЗАКАЗЧИК";
        return com.pullenti.n2j.Utils.stringsEq(t1, t2);
    }
    ...
    public static com.pullenti.ner.ReferentToken tryAttachToExist(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant p1, com.pullenti.ner.instrument.InstrumentParticipant p2) {
        ...
        if (pp == null || pp.kind != Kinds.PURE) {
            ...
            if ((pers instanceof com.pullenti.ner.person.PersonReferent) || (pers instanceof com.pullenti.ner.geo.GeoReferent) || (pers instanceof com.pullenti.ner.org.OrganizationReferent)) {
        ...
        while(rt.getEndToken().getNext() != null && (rt.getEndToken().getNext().getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) {
            com.pullenti.ner.org.OrganizationReferent org = (com.pullenti.ner.org.OrganizationReferent)com.pullenti.n2j.Utils.cast(rt.getEndToken().getNext().getReferent(), com.pullenti.ner.org.OrganizationReferent.class);
    ...
    public static com.pullenti.ner.ReferentToken tryAttachRequisites(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant cur, com.pullenti.ner.instrument.InstrumentParticipant other, boolean cantBeEmpty) {
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.getWhitespacesBeforeCount() > 25 && !isInTabCell) {
                ...
                if ((t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) || (t.getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) {
    ...
    public com.pullenti.ner.ReferentToken attachFirst(com.pullenti.ner.instrument.InstrumentParticipant p, int minChar, int maxChar) {
        ...
        if (refs.size() > 0) {
            for(com.pullenti.ner.Referent r : refs) {
                if (r != refs.get(0) && (refs.get(0) instanceof com.pullenti.ner.org.OrganizationReferent) && (((r instanceof com.pullenti.ner.person.PersonReferent) || (r instanceof com.pullenti.ner.person.PersonPropertyReferent)))) 
        ...
        for(; t != null && ((maxChar == 0 || t.beginChar <= maxChar)); t = t.getNext()) {
            ...
            if (((((r instanceof com.pullenti.ner.org.OrganizationReferent) || (r instanceof com.pullenti.ner.phone.PhoneReferent) || (r instanceof com.pullenti.ner.person.PersonReferent)) || (r instanceof com.pullenti.ner.person.PersonPropertyReferent) || (r instanceof com.pullenti.ner.address.AddressReferent)) || (r instanceof com.pullenti.ner.uri.UriReferent) || (r instanceof com.pullenti.ner.person.PersonIdentityReferent)) || (r instanceof com.pullenti.ner.bank.BankDataReferent)) {
                if ((((r instanceof com.pullenti.ner.person.PersonPropertyReferent) && t.getNext() != null && t.getNext().isComma()) && (t.getNext().getNext() instanceof com.pullenti.ner.ReferentToken) && (t.getNext().getNext().getReferent() instanceof com.pullenti.ner.person.PersonReferent)) && !t.getNext().isNewlineAfter()) {
                    com.pullenti.ner.person.PersonReferent pe = (com.pullenti.ner.person.PersonReferent)com.pullenti.n2j.Utils.cast(t.getNext().getNext().getReferent(), com.pullenti.ner.person.PersonReferent.class);
            ...
            if (t.isAnd() && t.getNext().getReferent() != null) {
                if (t.getNext().getReferent() instanceof com.pullenti.ner.org.OrganizationReferent) 
                    break;
                com.pullenti.ner.person.PersonReferent pe = (com.pullenti.ner.person.PersonReferent)com.pullenti.n2j.Utils.cast(t.getNext().getReferent(), com.pullenti.ner.person.PersonReferent.class);
                if (pe != null) {
                    boolean hasIp = false;
                    for(com.pullenti.ner.Slot s : pe.getSlots()) {
                        if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.person.PersonReferent.ATTR_ATTR)) {
    ...
    private static com.pullenti.ner.Token _tryAttachContractGround(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant ip, boolean canBePassport) {
        ...
        for(; t != null; t = t.getNext()) {
            ...
            com.pullenti.ner.person.PersonIdentityReferent pir = (com.pullenti.ner.person.PersonIdentityReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.person.PersonIdentityReferent.class);
            ...
            if (t.isValue("ДОВЕРЕННОСТЬ", null)) {
                ...
                if (dts != null && dts.size() > 0) {
                    ...
                    com.pullenti.ner.ReferentToken rt = new com.pullenti.ner.ReferentToken((com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(ip.getGround(), com.pullenti.ner.Referent.class), t0, t, null);
                    t.kit.embedToken(rt);
                    return rt;
                }
    ...
    public static java.util.ArrayList<String> getDocTypes(String name, String name2) {
        ...
        if (name == null) 
            return res;
        if (com.pullenti.n2j.Utils.stringsEq(name, "АРЕНДОДАТЕЛЬ")) {
            res.add("ДОГОВОР АРЕНДЫ");
            res.add("ДОГОВОР СУБАРЕНДЫ");
        }
        else if (com.pullenti.n2j.Utils.stringsEq(name, "АРЕНДАТОР")) 
            res.add("ДОГОВОР АРЕНДЫ");
        else if (com.pullenti.n2j.Utils.stringsEq(name, "СУБАРЕНДАТОР")) 
            res.add("ДОГОВОР СУБАРЕНДЫ");
        else if (com.pullenti.n2j.Utils.stringsEq(name, "НАЙМОДАТЕЛЬ") || com.pullenti.n2j.Utils.stringsEq(name, "НАНИМАТЕЛЬ")) 
            res.add("ДОГОВОР НАЙМА");
        else if (com.pullenti.n2j.Utils.stringsEq(name, "АГЕНТ") || com.pullenti.n2j.Utils.stringsEq(name, "ПРИНЦИПАЛ")) 
            res.add("АГЕНТСКИЙ ДОГОВОР");
        else if (com.pullenti.n2j.Utils.stringsEq(name, "ПРОДАВЕЦ") || com.pullenti.n2j.Utils.stringsEq(name, "ПОКУПАТЕЛЬ")) 
            res.add("ДОГОВОР КУПЛИ-ПРОДАЖИ");
        else if (com.pullenti.n2j.Utils.stringsEq(name, "ЗАКАЗЧИК") || com.pullenti.n2j.Utils.stringsEq(name, "ИСПОЛНИТЕЛЬ") || com.pullenti.morph.LanguageHelper.endsWith(name, "ПОДРЯДЧИК")) 
            res.add("ДОГОВОР УСЛУГ");
        else if (com.pullenti.n2j.Utils.stringsEq(name, "ПОСТАВЩИК")) 
            res.add("ДОГОВОР ПОСТАВКИ");
        else if (com.pullenti.n2j.Utils.stringsEq(name, "ЛИЦЕНЗИАР") || com.pullenti.n2j.Utils.stringsEq(name, "ЛИЦЕНЗИАТ")) 
            res.add("ЛИЦЕНЗИОННЫЙ ДОГОВОР");
        else if (com.pullenti.n2j.Utils.stringsEq(name, "СТРАХОВЩИК") || com.pullenti.n2j.Utils.stringsEq(name, "СТРАХОВАТЕЛЬ")) 
    ...
    public static void initialize() {
        ...
        for(String s : new String[] {"АРЕНДОДАТЕЛЬ", "АРЕНДАТОР", "СУБАРЕНДАТОР", "НАЙМОДАТЕЛЬ", "НАНИМАТЕЛЬ", "АГЕНТ", "ПРИНЦИПАЛ", "ПРОДАВЕЦ", "ПОКУПАТЕЛЬ", "ЗАКАЗЧИК", "ИСПОЛНИТЕЛЬ", "ПОСТАВЩИК", "ПОДРЯДЧИК", "СУБПОДРЯДЧИК", "СТОРОНА", "ЛИЦЕНЗИАР", "ЛИЦЕНЗИАТ", "СТРАХОВЩИК", "СТРАХОВАТЕЛЬ", "ПРОВАЙДЕР", "АБОНЕНТ", "ЗАСТРОЙЩИК", "УЧАСТНИК ДОЛЕВОГО СТРОИТЕЛЬСТВА", "КЛИЕНТ", "ЗАЕМЩИК", "УПРАВЛЯЮЩИЙ"}) {
            m_Ontology.add(com.pullenti.ner.core.Termin._new118(s, m_Ontology));
        }
        t = com.pullenti.ner.core.Termin._new118("ГЕНПОДРЯДЧИК", m_Ontology);
        t.addVariant("ГЕНЕРАЛЬНЫЙ ПОДРЯДЧИК", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new118("ЗАИМОДАТЕЛЬ", m_Ontology);
        t.addVariant("ЗАЙМОДАТЕЛЬ", false);
        t.addVariant("ЗАЙМОДАВЕЦ", false);
        t.addVariant("ЗАИМОДАВЕЦ", false);
        m_Ontology.add(t);
        t = new com.pullenti.ner.core.Termin("ИМЕНУЕМЫЙ", new com.pullenti.morph.MorphLang(null), false);
    ...
    public static ParticipantToken _new1336(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }
    public static ParticipantToken _new1417(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Kinds _arg3) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.kind = _arg3;
        return res;
    }
    public static ParticipantToken _new1422(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Kinds _arg3, String _arg4) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.kind = _arg3;
        res.typ = _arg4;
        return res;
