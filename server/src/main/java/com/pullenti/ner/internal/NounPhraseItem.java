...
public class NounPhraseItem extends com.pullenti.ner.MetaToken {
        ...
        for(com.pullenti.morph.MorphBaseInfo it : getMorph().getItems()) {
            ...
            if (singleNumber && v.singleNumberValue != null) {
                if (mc != null && ((gender == com.pullenti.morph.MorphGender.NEUTER || gender == com.pullenti.morph.MorphGender.FEMINIE)) && mc.isAdjective()) {
                    com.pullenti.morph.MorphBaseInfo bi = com.pullenti.morph.MorphBaseInfo._new1443(new com.pullenti.morph.MorphClass(mc), gender, com.pullenti.morph.MorphNumber.SINGULAR, com.pullenti.morph.MorphCase.NOMINATIVE, getMorph().getLanguage());
            ...
            if (Character.isDigit(v.normalValue.charAt(0)) && mc != null && mc.isAdjective()) {
                int val;
                com.pullenti.n2j.Outargwrapper<Integer> inoutarg1444 = new com.pullenti.n2j.Outargwrapper< >();
                boolean inoutres1445 = com.pullenti.n2j.Utils.parseInteger(v.normalValue, inoutarg1444);
                val = (inoutarg1444.value != null ? inoutarg1444.value : 0);
                if (inoutres1445) {
    ...
    public static NounPhraseItem tryParse(com.pullenti.ner.Token t, java.util.ArrayList<NounPhraseItem> items, com.pullenti.ner.core.NounPhraseParseAttr attrs) {
        ...
        for(int k = 0; k < 2; k++) {
            ...
            NounPhraseItem it = _new1446(t0, t, _canBeSurname);
    ...
    public static NounPhraseItem _new1446(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
