...
public class BlockTitleToken extends com.pullenti.ner.MetaToken {
    ...
    public String toString() {
        return typ.toString() + " " + ((String)com.pullenti.n2j.Utils.notnull(value, "")) + " " + getSourceText();
    }
    ...
    public static java.util.ArrayList<BlockTitleToken> tryAttachList(com.pullenti.ner.Token t) {
        ...
        if (content == null && intro == null && ((lits == null || lits.size() != 1))) 
            return null;
        java.util.ArrayList<BlockTitleToken> res = new java.util.ArrayList< >();
        ...
        if (content != null) {
            ...
            for(com.pullenti.ner.Token tt = content.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                ...
                if (btt.value != null) 
                    chapterNames.addStr(btt.value, null, new com.pullenti.morph.MorphLang(null), false);
            }
    ...
    public static BlockTitleToken tryAttach(com.pullenti.ner.Token t, boolean isContentItem, com.pullenti.ner.core.TerminCollection names) {
        ...
        if (li.numberEnd == null) 
            return null;
        BlockTitleToken res = _new463(t, li.getEndToken(), li.typ);
        if (res.typ == BlkTyps.UNDEFINED) {
            if (li.hasVerb || (li.words < 1)) 
                return null;
            if (!isContentItem) {
    ...
    public static BlockTitleToken _new463(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, BlkTyps _arg3) {
