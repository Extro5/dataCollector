...
public class PersonItemToken extends com.pullenti.ner.MetaToken {
    ...
    public static class MorphPersonItemVariant extends com.pullenti.morph.MorphBaseInfo {
        ...
        public String toString() {
            return ((String)com.pullenti.n2j.Utils.notnull(value, "?")) + ": " + super.toString();
        }
    
        public static MorphPersonItemVariant _new2364(String _arg1, com.pullenti.morph.MorphBaseInfo _arg2, boolean _arg3, String _arg4) {
    ...
    public static class MorphPersonItem {
        ...
        public java.util.ArrayList<com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant> vars = new java.util.ArrayList< >();
        ...
        public boolean isChinaSurname() {
            ...
            if (_term == null) 
                return false;
            if (m_LastnameAsian_MorphPersonItem.indexOf(_term) >= 0) 
                return true;
            String tr = com.pullenti.ner.person.PersonReferent._DelSurnameEnd(_term);
            if (m_LastnameAsian_MorphPersonItem.indexOf(tr) >= 0) 
                return true;
            if (m_LastnameAsian_MorphPersonItem.indexOf(_term + "Ь") >= 0) 
                return true;
            if (_term.charAt(_term.length() - 1) == 'Ь') {
                if (m_LastnameAsian_MorphPersonItem.indexOf(_term.substring(0, 0+(_term.length() - 1))) >= 0) 
                    return true;
            }
            return false;
        }
        ...
        public void mergeHiphen(MorphPersonItem second) {
            java.util.ArrayList<com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant> addvars = new java.util.ArrayList< >();
            for(com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant v : vars) {
                int ok = 0;
        ...
        public void mergeWithByHiphen(MorphPersonItem pi) {
            term = ((String)com.pullenti.n2j.Utils.notnull(term, "")) + "-" + ((String)com.pullenti.n2j.Utils.notnull(pi.term, ""));
            ...
            if (pi.vars.size() == 0) {
                if (pi.term != null) 
                    addPostfix(pi.term, com.pullenti.morph.MorphGender.UNDEFINED);
                return;
            }
            if (vars.size() == 0) {
                if (term != null) 
            ...
            java.util.ArrayList<com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant> res = new java.util.ArrayList< >();
            for(com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant v : vars) {
        ...
        public void correctLastnameVariants() {
            ...
            for(com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant v : vars) {
                if (v.value != null && (((com.pullenti.ner.person.internal.PersonItemToken.endsWithStdSurname_MorphPersonItem(v.value) || com.pullenti.morph.LanguageHelper.endsWith(v.value, "АЯ") || com.pullenti.morph.LanguageHelper.endsWith(v.value, "ОЙ")) || com.pullenti.morph.LanguageHelper.endsWith(v.value, "ИЙ") || com.pullenti.morph.LanguageHelper.endsWith(v.value, "ЫЙ")))) {
                ...
                for(int i = vars.size() - 1; i >= 0; i--) {
                    ...
                    if (vars.get(i).getGender() == com.pullenti.morph.MorphGender.UNDEFINED) {
                        ...
                        for(int j = 0; j < vars.size(); j++) {
                            if (j != i && com.pullenti.n2j.Utils.stringsEq(vars.get(j).value, vars.get(i).value) && vars.get(j).getGender() != com.pullenti.morph.MorphGender.UNDEFINED) {
                                del = true;
                                break;
                            }
                        }
                        ...
                        com.pullenti.ner.person.internal.PersonItemToken.SurnameTail t = com.pullenti.ner.person.internal.PersonItemToken.findTail_MorphPersonItem(vars.get(i).value);
                        if (t != null) {
        ...
        public static MorphPersonItem _new2313(boolean _arg1) {
            MorphPersonItem res = new MorphPersonItem();
            res.isHasStdPostfix = _arg1;
            return res;
        }
        public static MorphPersonItem _new2321(String _arg1) {
            MorphPersonItem res = new MorphPersonItem();
            res.term = _arg1;
            return res;
        }
        public static MorphPersonItem _new2324(String _arg1, boolean _arg2) {
            MorphPersonItem res = new MorphPersonItem();
            res.term = _arg1;
            res.isInOntology = _arg2;
            return res;
        }
        public static MorphPersonItem _new2354(boolean _arg1) {
            MorphPersonItem res = new MorphPersonItem();
    ...
    private void addPostfixInfo(String postfix, com.pullenti.morph.MorphGender gen) {
        ...
        if (firstname != null) 
            ...
            firstname = MorphPersonItem._new2313(true);
            firstname.vars.add(new MorphPersonItemVariant(value, com.pullenti.morph.MorphBaseInfo._new2314(gen), false));
            if (lastname == null) 
                lastname = firstname;
        }
        if (middlename != null) 
    ...
    public static PersonItemToken tryAttachLatin(com.pullenti.ner.Token t) {
        ...
        if (!tt.chars.isLetter()) 
            return null;
        if (com.pullenti.n2j.Utils.stringsEq(tt.term, "THE")) 
            return null;
        if (com.pullenti.n2j.Utils.stringsEq(tt.term, "JR") || com.pullenti.n2j.Utils.stringsEq(tt.term, "JNR") || com.pullenti.n2j.Utils.stringsEq(tt.term, "JUNIOR")) {
            com.pullenti.ner.Token t1 = tt;
            if (tt.getNext() != null && tt.getNext().isChar('.')) 
                t1 = tt.getNext();
            return _new2315(tt, t1, ItemType.SUFFIX, "JUNIOR");
        }
        if ((com.pullenti.n2j.Utils.stringsEq(tt.term, "SR") || com.pullenti.n2j.Utils.stringsEq(tt.term, "SNR") || com.pullenti.n2j.Utils.stringsEq(tt.term, "SENIOR")) || com.pullenti.n2j.Utils.stringsEq(tt.term, "FITZ") || com.pullenti.n2j.Utils.stringsEq(tt.term, "FILS")) {
            com.pullenti.ner.Token t1 = tt;
            if (tt.getNext() != null && tt.getNext().isChar('.')) 
                t1 = tt.getNext();
            return _new2315(tt, t1, ItemType.SUFFIX, "SENIOR");
        }
        boolean initials = (com.pullenti.n2j.Utils.stringsEq(tt.term, "YU") || com.pullenti.n2j.Utils.stringsEq(tt.term, "YA") || com.pullenti.n2j.Utils.stringsEq(tt.term, "CH")) || com.pullenti.n2j.Utils.stringsEq(tt.term, "SH");
        ...
        if (initials) {
            PersonItemToken rii = _new2317(tt, tt, ItemType.INITIAL, tt.term, tt.chars);
            if (tt.getNext() != null && tt.getNext().isChar('.')) 
        ...
        if (tt.getLengthChar() == 1) {
            ...
            if (tt.getNext().isChar('.')) 
                return _new2317(tt, tt.getNext(), ItemType.INITIAL, tt.term, tt.chars);
            if (!tt.getNext().isWhitespaceAfter() && !tt.isWhitespaceAfter() && ((com.pullenti.n2j.Utils.stringsEq(tt.term, "D") || com.pullenti.n2j.Utils.stringsEq(tt.term, "O") || com.pullenti.n2j.Utils.stringsEq(tt.term, "M")))) {
                if (com.pullenti.ner.core.BracketHelper.isBracket(tt.getNext(), false) && (tt.getNext().getNext() instanceof com.pullenti.ner.TextToken)) {
                    if (tt.getNext().getNext().chars.isLatinLetter()) {
                        ...
                        if (pit0 != null && pit0.typ == ItemType.VALUE) {
                            ...
                            String val = tt.term;
                            if (pit0.value != null) {
                                if (com.pullenti.n2j.Utils.stringsEq(val, "M") && pit0.value.startsWith("C")) {
            ...
            if (!com.pullenti.morph.LanguageHelper.isLatinVowel(tt.term.charAt(0)) || tt.getWhitespacesAfterCount() != 1) {
                ...
                if (nex != null && nex.typ == ItemType.VALUE) 
                    return _new2317(tt, tt, ItemType.INITIAL, tt.term, tt.chars);
                return null;
            }
            return _new2317(tt, tt, ItemType.VALUE, tt.term, tt.chars);
        }
        ...
        if (cla.isProperName() || ((cla.isProper() && ((tt.getMorph().getGender() == com.pullenti.morph.MorphGender.MASCULINE || tt.getMorph().getGender() == com.pullenti.morph.MorphGender.FEMINIE))))) {
            res.firstname = MorphPersonItem._new2321(res.value);
        ...
        if (cla.isProperSurname()) {
            res.lastname = MorphPersonItem._new2321(res.value);
            for(com.pullenti.morph.MorphBaseInfo wf : tt.getMorph().getItems()) {
                if ((((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(wf, com.pullenti.morph.MorphWordForm.class))).isInDictionary()) {
        ...
        if (ots != null) {
            if (ots.get(0).termin.ignoreTermsOrder) 
                return _new2323(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), ItemType.REFERENT, (com.pullenti.ner.person.PersonReferent)com.pullenti.n2j.Utils.cast(ots.get(0).item.tag, com.pullenti.ner.person.PersonReferent.class), ots.get(0).getMorph());
            res.lastname = MorphPersonItem._new2324(ots.get(0).termin.getCanonicText(), true);
            for(com.pullenti.ner.core.IntOntologyToken ot : ots) {
                if (ot.termin != null) {
                    ...
                    if (ot.termin.getGender() == com.pullenti.morph.MorphGender.MASCULINE || ot.termin.getGender() == com.pullenti.morph.MorphGender.FEMINIE) 
                        mi = com.pullenti.morph.MorphBaseInfo._new2314(ot.termin.getGender());
        ...
        if (res.value.startsWith("MAC")) {
            ...
            res.lastname = MorphPersonItem._new2313(true);
            res.lastname.vars.add(new MorphPersonItemVariant(res.value, new com.pullenti.morph.MorphBaseInfo(), true));
        }
        return res;
    }
    ...
    public static PersonItemToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnt, ParseAttr attrs, java.util.ArrayList<PersonItemToken> prevList) {
        ...
        if ((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 2 && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "JI")) && t.chars.isAllUpper() && !t.isWhitespaceAfter()) && t.getNext() != null && t.getNext().isChar('.')) {
            PersonItemToken re1 = _new2315(t, t.getNext(), ItemType.INITIAL, "Л");
            re1.chars.setCyrillicLetter(true);
            re1.chars.setAllUpper(true);
            return re1;
        }
        if ((((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 1 && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "J")) && t.chars.isAllUpper() && !t.isWhitespaceAfter()) && (t.getNext() instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).value == ((long)1)) && (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT && t.getNext().getNext() != null) && t.getNext().getNext().isChar('.')) {
            PersonItemToken re1 = _new2315(t, t.getNext().getNext(), ItemType.INITIAL, "Л");
            re1.chars.setCyrillicLetter(true);
            re1.chars.setAllUpper(true);
            return re1;
        }
        if ((((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 1 && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "I")) && t.chars.isAllUpper() && !t.isWhitespaceAfter()) && (t.getNext() instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).value == ((long)1)) && (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT && t.getNext().getNext() != null) && t.getNext().getNext().isChar('.')) {
            if (prevList != null && prevList.get(0).chars.isCyrillicLetter()) {
                PersonItemToken re1 = _new2315(t, t.getNext().getNext(), ItemType.INITIAL, "П");
                re1.chars.setCyrillicLetter(true);
                re1.chars.setAllUpper(true);
                return re1;
            }
        ...
        if (t.chars.isLatinLetter() && (((attrs.value()) & (ParseAttr.CANBELATIN.value()))) != (ParseAttr.NO.value())) {
            ...
            if (ots != null && (t instanceof com.pullenti.ner.TextToken)) {
                if (ots.get(0).termin.ignoreTermsOrder) 
                    return _new2323(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), ItemType.REFERENT, (com.pullenti.ner.person.PersonReferent)com.pullenti.n2j.Utils.cast(ots.get(0).item.tag, com.pullenti.ner.person.PersonReferent.class), ots.get(0).getMorph());
                res = _new2331(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, ots.get(0).chars);
                res.lastname = MorphPersonItem._new2324(ots.get(0).termin.getCanonicText(), true);
                for(com.pullenti.ner.core.IntOntologyToken ot : ots) {
                    if (ot.termin != null) {
                        com.pullenti.morph.MorphBaseInfo mi = ot.getMorph();
        ...
        if (((t instanceof com.pullenti.ner.NumberToken) && t.getLengthChar() == 1 && (((attrs.value()) & (ParseAttr.CANINITIALBEDIGIT.value()))) != (ParseAttr.NO.value())) && t.getNext() != null && t.getNext().isCharOf(".„")) {
            if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value == ((long)1)) 
                return _new2317(t, t.getNext(), ItemType.INITIAL, "І", com.pullenti.morph.CharsInfo._new2334(true));
            if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value == ((long)0)) 
                return _new2317(t, t.getNext(), ItemType.INITIAL, "О", com.pullenti.morph.CharsInfo._new2334(true));
            if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value == ((long)3)) 
                return _new2317(t, t.getNext(), ItemType.INITIAL, "З", com.pullenti.morph.CharsInfo._new2334(true));
        }
        if ((((t instanceof com.pullenti.ner.NumberToken) && t.getLengthChar() == 1 && (((attrs.value()) & (ParseAttr.CANINITIALBEDIGIT.value()))) != (ParseAttr.NO.value())) && t.getNext() != null && t.getNext().chars.isAllLower()) && !t.isWhitespaceAfter() && t.getNext().getLengthChar() > 2) {
            long num = (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value;
            if (num == ((long)3) && t.getNext().chars.isCyrillicLetter()) 
                return _new2317(t, t.getNext(), ItemType.VALUE, "З" + (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.TextToken.class))).term, com.pullenti.morph.CharsInfo._new2340(true, true));
            if (num == ((long)0) && t.getNext().chars.isCyrillicLetter()) 
                return _new2317(t, t.getNext(), ItemType.VALUE, "О" + (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.TextToken.class))).term, com.pullenti.morph.CharsInfo._new2340(true, true));
        }
        if (((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 1 && t.chars.isLetter()) && t.chars.isAllUpper() && (t.getWhitespacesAfterCount() < 2)) && (t.getNext() instanceof com.pullenti.ner.TextToken) && t.getNext().getLengthChar() == 1) && t.getNext().chars.isAllLower()) {
            ...
            int lat = 0;
            int cyr = 0;
            char ch = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).getSourceText().charAt(0);
            ...
            for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                ...
                t1 = tt;
                cou++;
                ch = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getSourceText().charAt(0);
                if (tt.chars.isCyrillicLetter()) {
                    cyr++;
                    if (((int)com.pullenti.morph.LanguageHelper.getLatForCyr(ch)) != 0) 
                        lat++;
            ...
            res = _new2315(t, t1, ItemType.VALUE, val.toString());
            res.chars = com.pullenti.morph.CharsInfo._new2345(true, isCyr, !isCyr, true);
            return res;
        }
        if ((((attrs.value()) & (ParseAttr.MUSTBEITEMALWAYS.value()))) != (ParseAttr.NO.value()) && (t instanceof com.pullenti.ner.TextToken) && !t.chars.isAllLower()) {
            res = _new2346(t, t, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
            return res;
        }
        return null;
    }
    ...
    private static PersonItemToken _tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnt, ParseAttr attrs, java.util.ArrayList<PersonItemToken> prevList) {
        ...
        if (tt == null) {
            if (t.chars.isLetter() && t.chars.isCapitalUpper() && (t instanceof com.pullenti.ner.ReferentToken)) {
                ...
                if (rt.getBeginToken() == rt.getEndToken() && !((rt.referent instanceof com.pullenti.ner.person.PersonReferent))) {
                    ...
                    if (res0 == null) {
                        res0 = _new2347(rt, rt, rt.referent.toString(true, t.kit.baseLanguage, 0).toUpperCase(), rt.chars, rt.getMorph());
                        res0.lastname = MorphPersonItem._new2321(res0.value);
                    }
                    else 
        ...
        if (tt.chars.isAllLower() && (((attrs.value()) & (ParseAttr.CANBELOWER.value()))) == (ParseAttr.NO.value())) {
            if (!M_SURPREFIXES.contains(tt.term)) {
                if (((com.pullenti.n2j.Utils.stringsEq(tt.term, "Д") && !tt.isWhitespaceAfter() && com.pullenti.ner.core.BracketHelper.isBracket(tt.getNext(), true)) && !tt.getNext().isWhitespaceAfter() && (tt.getNext().getNext() instanceof com.pullenti.ner.TextToken)) && tt.getNext().getNext().chars.isCapitalUpper()) {
                }
                else 
                    return null;
            }
        }
        if (tt.getLengthChar() == 1 || com.pullenti.n2j.Utils.stringsEq(tt.term, "ДЖ")) {
            if (tt.getNext() == null) 
                return null;
            String ini = tt.term;
            ...
            if (tt.getNext().isChar('.')) 
                return _new2317(tt, tt.getNext(), ItemType.INITIAL, ini, ci);
            if ((tt.getNext().isCharOf(",;„") && prevList != null && prevList.size() > 0) && prevList.get(prevList.size() - 1).typ == ItemType.INITIAL) 
                return _new2317(tt, tt, ItemType.INITIAL, ini, ci);
            if ((tt.getNext().getWhitespacesAfterCount() < 2) && (tt.getWhitespacesAfterCount() < 2) && ((com.pullenti.n2j.Utils.stringsEq(tt.term, "Д") || com.pullenti.n2j.Utils.stringsEq(tt.term, "О") || com.pullenti.n2j.Utils.stringsEq(tt.term, "Н")))) {
                if (com.pullenti.ner.core.BracketHelper.isBracket(tt.getNext(), false) && (tt.getNext().getNext() instanceof com.pullenti.ner.TextToken)) {
        ...
        if (ots != null) {
            if (ots.get(0).termin.ignoreTermsOrder) 
                return _new2323(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), ItemType.REFERENT, (com.pullenti.ner.person.PersonReferent)com.pullenti.n2j.Utils.cast(ots.get(0).item.tag, com.pullenti.ner.person.PersonReferent.class), ots.get(0).getMorph());
            res = _new2331(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), tt.term, ots.get(0).chars);
            res.lastname = MorphPersonItem._new2354(true);
            ...
            res = _new2347(t, t, tt.term, tt.chars, tt.getMorph());
            if (M_SURPREFIXES.contains(tt.term)) {
                if (((tt.isValue("БЕН", null) || tt.isValue("ВАН", null))) && (((attrs.value()) & (ParseAttr.ALTVAR.value()))) != (ParseAttr.NO.value()) && ((tt.getNext() == null || !tt.getNext().isHiphen()))) {
                    ...
                    if (tt.getNext() != null) {
                        ...
                        if (t1.isHiphen()) 
                            ...
                            tt = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t1, com.pullenti.ner.TextToken.class);
        ...
        if (!tt.chars.isAllUpper() && !tt.chars.isCapitalUpper()) {
        ...
        for(com.pullenti.morph.MorphBaseInfo wff : tt.getMorph().getItems()) {
            ...
            if (wf == null) 
                continue;
            if (wf._getClass().isAdjective() && wf.containsAttr("к.ф.", new com.pullenti.morph.MorphClass())) {
            ...
            else if (wf._getClass().isAdjective() && adj == null && (((wf.isInDictionary() || wf.normalCase.endsWith("ЫЙ") || wf.normalCase.endsWith("ИЙ")) || wf.normalCase.endsWith("АЯ") || wf.normalCase.endsWith("ЯЯ")))) 
                adj = wf;
            ...
            if (wf._getClass().isProperSurname() || surPrefix != null) {
                if (res.lastname == null) 
                    res.lastname = MorphPersonItem._new2321(tt.term);
                if (adj != null) {
                    if (!wf.isInDictionary() && adj.getNumber() == com.pullenti.morph.MorphNumber.SINGULAR) {
                        ...
                        if (com.pullenti.n2j.Utils.stringsEq(val, tt.term)) 
                            break;
                    }
                    adj = null;
                }
                ...
                if (com.pullenti.n2j.Utils.stringsNe(wf.normalCase, tt.term) && com.pullenti.morph.LanguageHelper.endsWith(tt.term, "ОВ")) {
                    v.value = tt.term;
                    v.setGender(com.pullenti.morph.MorphGender.MASCULINE);
                }
                else if ((wf.getNumber() == com.pullenti.morph.MorphNumber.PLURAL && wf.normalFull != null && com.pullenti.n2j.Utils.stringsNe(wf.normalFull, wf.normalCase)) && wf.normalFull.length() > 1) {
            ...
            if (wf._getClass().isProperName() && wf.getNumber() != com.pullenti.morph.MorphNumber.PLURAL) {
                ...
                if (t.getMorph().getLanguage().isUa()) {
                    ...
                    ok = !com.pullenti.morph.LanguageHelper.endsWith(wf.normalCase, "ОВ") && com.pullenti.n2j.Utils.stringsNe(wf.normalCase, "АЛЛ");
                    if (ok) {
                ...
                if (ok) {
                    if (res.firstname == null) 
                        res.firstname = MorphPersonItem._new2321(tt.term);
            ...
            if (!endsWithStdSurname_MorphPersonItem(tt.term)) {
                if (wf._getClass().isProperSecname()) {
                    if (res.middlename == null) 
                        res.middlename = MorphPersonItem._new2321(tt.term);
                    ...
                    if (com.pullenti.n2j.Utils.stringsEq(iii.value, tt.term)) 
        ...
        if (res.lastname != null) {
            for(MorphPersonItemVariant v : res.lastname.vars) {
                if (endsWithStdSurname_MorphPersonItem(v.value)) {
                    res.lastname.isLastnameHasStdTail = true;
                    break;
                }
            }
            if (!res.lastname.isInDictionary) {
                if (((!res.lastname.isInDictionary && !res.lastname.isLastnameHasStdTail)) || endsWithStdSurname_MorphPersonItem(tt.term)) {
                    ...
                    if (com.pullenti.morph.LanguageHelper.endsWithEx(tt.term, "ВА", "НА", null, null)) 
                        ...
                        res.lastname.vars.add(v);
                    if (endsWithStdSurname_MorphPersonItem(v.value) && !res.lastname.isInDictionary) 
                        res.lastname.isLastnameHasStdTail = true;
                }
            }
            ...
            for(com.pullenti.morph.MorphBaseInfo wf : tt.getMorph().getItems()) {
                if (!wf._getClass().isVerb()) {
                    if (wf.containsAttr("к.ф.", new com.pullenti.morph.MorphClass())) 
                        continue;
                    res.lastname.vars.add(new MorphPersonItemVariant((((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(wf, com.pullenti.morph.MorphWordForm.class))).normalCase, wf, true));
                    if (!res.lastname.isLastnameHasStdTail) 
                        res.lastname.isLastnameHasStdTail = endsWithStdSurname_MorphPersonItem((((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(wf, com.pullenti.morph.MorphWordForm.class))).normalCase);
                }
            }
            res.lastname.vars.add(new MorphPersonItemVariant(tt.term, null, true));
            if (!res.lastname.isLastnameHasStdTail) 
                res.lastname.isLastnameHasStdTail = endsWithStdSurname_MorphPersonItem(tt.term);
            if (surPrefix != null) {
        ...
        if (res.getBeginToken() == res.getEndToken()) {
            ...
            if (res.firstname != null && (res.getBeginToken() instanceof com.pullenti.ner.TextToken)) {
                if (com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(res.getBeginToken(), com.pullenti.ner.TextToken.class))).term, "ЛЮБОЙ")) 
                    res.firstname = null;
            }
                ...
                if (g != com.pullenti.morph.MorphGender.MASCULINE && g != com.pullenti.morph.MorphGender.FEMINIE) {
                    ...
                    for(ShortNameHelper.ShortnameVar kp : di) {
                        if (fi) {
                            ...
                            com.pullenti.morph.MorphBaseInfo mi = com.pullenti.morph.MorphBaseInfo._new2314(kp.gender);
                            res.firstname.vars.add(MorphPersonItemVariant._new2364(kp.name, mi, false, val));
                        }
                    }
                }
                else {
                    ...
                    for(ShortNameHelper.ShortnameVar kp : di) {
                        if (kp.gender == g) {
                            if ((++cou) < 2) {
                                ...
                                res.firstname.vars.add(i + 1, MorphPersonItemVariant._new2364(kp.name, res.firstname.vars.get(i), false, val));
                        }
                    }
                }
            }
        ...
        if (res.getEndToken().getNext() != null && res.getEndToken().getNext().isHiphen() && (res.getEndToken().getNext().getNext() instanceof com.pullenti.ner.TextToken)) {
            String ter = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(res.getEndToken().getNext().getNext(), com.pullenti.ner.TextToken.class))).term;
            if (M_ARABPOSTFIX.contains(ter) || M_ARABPOSTFIXFEM.contains(ter)) {
                ...
                if ((com.pullenti.n2j.Utils.stringsEq(ter, "ОГЛЫ") || com.pullenti.n2j.Utils.stringsEq(ter, "КЫЗЫ") || com.pullenti.n2j.Utils.stringsEq(ter, "ГЫЗЫ")) || com.pullenti.n2j.Utils.stringsEq(ter, "УГЛИ") || com.pullenti.n2j.Utils.stringsEq(ter, "КЗЫ")) {
        ...
        while((res.getEndToken().getWhitespacesAfterCount() < 3) && (res.getEndToken().getNext() instanceof com.pullenti.ner.TextToken)) {
            String ter = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(res.getEndToken().getNext(), com.pullenti.ner.TextToken.class))).term;
            if (((com.pullenti.n2j.Utils.stringsNe(ter, "АЛИ") && com.pullenti.n2j.Utils.stringsNe(ter, "ПАША"))) || res.getEndToken().getNext().chars.isAllLower()) {
                if (M_ARABPOSTFIX.contains(ter) || M_ARABPOSTFIXFEM.contains(ter)) {
    ...
    public static java.util.ArrayList<String> M_SURPREFIXES = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"АБД", "АБУ", "АЛ", "АЛЬ", "БИН", "БЕН", "ИБН", "ФОН", "ВАН", "ДЕ", "ДИ", "ДА", "ЛА", "ЛЕ", "ЛЯ", "ЭЛЬ"}));

    private static java.util.ArrayList<String> m_SurPrefixesLat = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"ABD", "AL", "BEN", "IBN", "VON", "VAN", "DE", "DI", "LA", "LE", "DA", "DE"}));

    public static java.util.ArrayList<String> M_ARABPOSTFIX = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"АГА", "АЛИ", "АР", "АС", "АШ", "БЕЙ", "БЕК", "ЗАДЕ", "ОГЛЫ", "УГЛИ", "ОЛЬ", "ООЛ", "ПАША", "УЛЬ", "УЛЫ", "ХАН", "ХАДЖИ", "ШАХ", "ЭД", "ЭЛЬ"}));

    public static java.util.ArrayList<String> M_ARABPOSTFIXFEM = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"АСУ", "АЗУ", "ГЫЗЫ", "ЗУЛЬ", "КЫЗЫ", "КЫС", "КЗЫ"}));
    ...
    public static java.util.ArrayList<PersonItemToken> tryAttachList(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnt, ParseAttr attrs, int maxCount) {
        ...
        if (pit == null) 
            return null;
        java.util.ArrayList<PersonItemToken> res = new java.util.ArrayList< >();
        res.add(pit);
        ...
        if ((t != null && t.isChar('.') && pit.typ == ItemType.VALUE) && pit.getLengthChar() > 3) {
            ...
            if (Character.isUpperCase(str.charAt(0)) && Character.isUpperCase(str.charAt(str.length() - 1))) {
                ...
                if (ok) {
                    ...
                    PersonItemToken pit2 = _new2315(t, t, ItemType.INITIAL, str.substring(str.length() - 1));
                    res.add(pit2);
                    t = t.getNext();
                }
            }
        ...
        for(; t != null; t = (t == null ? null : t.getNext())) {
            ...
            if (tt.isHiphen() && tt.getNext() != null) {
                ...
                if (pit0.firstname != null && pit11 != null && pit11.firstname != null) {
                    pit0.firstname.vars.addAll(pit11.firstname.vars);
                    ...
                    if (pit11 != null && pit11.lastname != null) {
                        if ((pit11.lastname.isInDictionary || pit11.lastname.isLastnameHasStdTail || pit11.lastname.isHasStdPostfix)) {
                            pit0.lastname.vars.addAll(pit11.lastname.vars);
                            tt = tt.getNext().getNext();
                            pit0.setEndToken(tt);
                            tt = tt.getNext();
                        }
                ...
                if (pit1.typ == ItemType.INITIAL) {
                    if (pit1.chars.isCyrillicLetter()) {
                        ...
                        if (v != ((char)0)) {
                            ...
                            ok = true;
                            pit1.chars = com.pullenti.morph.CharsInfo._new2367(true);
                        }
                            ...
                            if (v != ((char)0)) {
                                ...
                                ok = true;
                                pit.chars = com.pullenti.morph.CharsInfo._new2334(true);
                                pit = pit1;
                            }
                        }
                    }
                        ...
                        if (v != ((char)0)) {
                            pit1.value = String.valueOf(v);
                            ok = true;
                            pit1.chars = com.pullenti.morph.CharsInfo._new2334(true);
                        }
                        else if (pit.typ == ItemType.INITIAL) {
                            ...
                            if (v != ((char)0)) {
                                pit.value = String.valueOf(v);
                                ok = true;
                                pit.chars = com.pullenti.morph.CharsInfo._new2367(true);
                                pit = pit1;
                            }
                        }
                    }
        ...
        for(int i = 0; i < res.size(); i++) {
            if (res.get(i).firstname != null && res.get(i).getBeginToken().isValue("СВЕТА", null)) {
                ...
                if (res.get(i).lastname == null) {
                    res.get(i).lastname = MorphPersonItem._new2313(true);
    ...
    public static com.pullenti.ner.ReferentToken tryParsePerson(com.pullenti.ner.Token t, FioTemplateType prevPersTemplate) {
                ...
                if (tt1 != null && (tt1.getWhitespacesBeforeCount() < 2)) {
                    ...
                    if (pits0 != null && pits0.get(0).typ == ItemType.INITIAL) {
                        ...
                        if (str != null && str.startsWith(pits0.get(0).value)) {
                            com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2372(rt.referent, t, pits0.get(0).getEndToken(), FioTemplateType.SURNAMEI.value());
                    ...
                    if (((((tt1 instanceof com.pullenti.ner.TextToken) && tt1.getLengthChar() == 1 && tt1.chars.isAllUpper()) && tt1.chars.isCyrillicLetter() && (tt1.getNext() instanceof com.pullenti.ner.TextToken)) && (tt1.getWhitespacesAfterCount() < 2) && tt1.getNext().getLengthChar() == 1) && tt1.getNext().chars.isAllUpper() && tt1.getNext().chars.isCyrillicLetter()) {
                        String str = rt.referent.getStringValue(com.pullenti.ner.person.PersonReferent.ATTR_FIRSTNAME);
                        if (str != null && str.startsWith((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt1, com.pullenti.ner.TextToken.class))).term)) {
                            String str2 = rt.referent.getStringValue(com.pullenti.ner.person.PersonReferent.ATTR_MIDDLENAME);
                            if (str2 == null || str2.startsWith((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt1.getNext(), com.pullenti.ner.TextToken.class))).term)) {
                                com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2372(rt.referent, t, tt1.getNext(), FioTemplateType.NAMEISURNAME.value());
                                if (str2 == null) 
                                    rt.referent.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_MIDDLENAME, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt1.getNext(), com.pullenti.ner.TextToken.class))).term, false, 0);
        ...
        if (t.getReferent() != null && com.pullenti.n2j.Utils.stringsEq(t.getReferent().getTypeName(), "ORGANIZATION")) {
            com.pullenti.ner.ReferentToken rt = (com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class);
        ...
        if (pits != null && prevPersTemplate != FioTemplateType.UNDEFINED && pits.get(0).typ == ItemType.VALUE) {
            ...
            if (((tt1 instanceof com.pullenti.ner.TextToken) && tt1.chars.isLetter() && tt1.chars.isAllUpper()) && tt1.getLengthChar() == 1 && (tt1.getWhitespacesBeforeCount() < 2)) {
                PersonItemToken ii = _new2317(tt1, tt1, ItemType.INITIAL, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt1, com.pullenti.ner.TextToken.class))).term, tt1.chars);
                pits.add(ii);
            }
        ...
        if (pits != null && pits.size() > 1) {
            ...
            if (last != null) {
                ...
                if ((res.getEndToken().getWhitespacesAfterCount() < 2) && (res.getEndToken().getNext() instanceof com.pullenti.ner.NumberToken)) {
                    com.pullenti.ner.NumberToken num = (com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(res.getEndToken().getNext(), com.pullenti.ner.NumberToken.class);
                    if (num.value == ((long)2) || num.value == ((long)3)) {
                        if (num.getMorph()._getClass().isAdjective()) {
                            pers.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_NICKNAME, ((Long)num.value).toString(), false, 0);
                            res.setEndToken(res.getEndToken().getNext());
                        }
                    }
                }
        ...
        if (pits != null && pits.size() == 1 && pits.get(0).typ == ItemType.VALUE) {
            ...
            if (((tt instanceof com.pullenti.ner.TextToken) && tt.getLengthChar() == 2 && tt.chars.isAllUpper()) && tt.chars.isCyrillicLetter()) {
                ...
                pers.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_FIRSTNAME, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term.charAt(0), false, 0);
                pers.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_MIDDLENAME, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term.charAt(1), false, 0);
                com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2372(pers, t, tt, FioTemplateType.SURNAMEII.value());
                if (tt.getNext() != null && tt.getNext().isChar('.')) 
            ...
            if ((((((tt instanceof com.pullenti.ner.TextToken) && (tt.getWhitespacesBeforeCount() < 2) && tt.getLengthChar() == 1) && tt.chars.isAllUpper() && tt.chars.isCyrillicLetter()) && (tt.getNext() instanceof com.pullenti.ner.TextToken) && (tt.getWhitespacesAfterCount() < 2)) && tt.getNext().getLengthChar() == 1 && tt.getNext().chars.isAllUpper()) && tt.getNext().chars.isCyrillicLetter()) {
                com.pullenti.ner.person.PersonReferent pers = new com.pullenti.ner.person.PersonReferent();
                pers.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_LASTNAME, pits.get(0).value, false, 0);
                pers.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_FIRSTNAME, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term, false, 0);
                pers.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_MIDDLENAME, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt.getNext(), com.pullenti.ner.TextToken.class))).term, false, 0);
                com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2372(pers, t, tt.getNext(), FioTemplateType.SURNAMEII.value());
            ...
            if (comma && tt != null && (tt.getWhitespacesBeforeCount() < 2)) {
                ...
                if (pits1 != null && pits1.size() > 0 && pits1.get(0).typ == ItemType.INITIAL) {
                    ...
                    com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2372(pers, t, pits1.get(0).getEndToken(), FioTemplateType.SURNAMEI.value());
    ...
    public static void initialize_MorphPersonItem() {
        m_LastnameStdTails_MorphPersonItem = new java.util.ArrayList< >();
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ОВ", com.pullenti.morph.MorphGender.MASCULINE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ОВА", com.pullenti.morph.MorphGender.FEMINIE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ЕВ", com.pullenti.morph.MorphGender.MASCULINE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ЕВА", com.pullenti.morph.MorphGender.FEMINIE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ЄВ", com.pullenti.morph.MorphGender.MASCULINE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ЄВА", com.pullenti.morph.MorphGender.FEMINIE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ИН", com.pullenti.morph.MorphGender.MASCULINE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ИНА", com.pullenti.morph.MorphGender.FEMINIE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ІН", com.pullenti.morph.MorphGender.MASCULINE));
        m_LastnameStdTails_MorphPersonItem.add(new SurnameTail("ІНА", com.pullenti.morph.MorphGender.FEMINIE));
        for(String s : new String[] {"ЕР", "РН", "ДЗЕ", "ВИЛИ", "ЯН", "УК", "ЮК", "КО", "МАН", "АНН", "ЙН", "СКУ", "СКИ", "СЬКІ", "ИЛО", "ІЛО", "АЛО", "ИК", "СОН", "РА", "НДА", "НДО", "ЕС", "АС", "АВА", "ЛС", "ЛЮС", "ЛЬС", "ЙЗ", "ЕРГ", "ИНГ", "OR", "ER", "OV", "IN", "ERG"}) {
            m_LastnameStdTails_MorphPersonItem.add(new SurnameTail(s, com.pullenti.morph.MorphGender.UNDEFINED));
        }
        m_LatsnameSexStdTails_MorphPersonItem = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"ОВ", "ОВА", "ЕВ", "ЄВ", "ЕВА", "ЄВA", "ИН", "ИНА", "ІН", "ІНА", "ИЙ", "АЯ"}));
        m_LastnameAsian_MorphPersonItem = new java.util.ArrayList< >();
        for(String s : com.pullenti.n2j.Utils.split(ResourceHelper.getString("chinasurnames.txt"), String.valueOf('\n'), false)) {
            String ss = s.trim().toUpperCase().replace("Ё", "Е");
            if (!com.pullenti.n2j.Utils.isNullOrEmpty(ss)) 
                m_LastnameAsian_MorphPersonItem.add(ss);
        }
        java.util.ArrayList<String> m_ChinaSurs = new java.util.ArrayList(java.util.Arrays.asList(com.pullenti.n2j.Utils.split("Чон Чжао Цянь Сунь Ли Чжоу У Чжэн Ван Фэн Чэнь Чу Вэй Цзян Шэнь Хань Ян Чжу Цинь Ю Сюй Хэ Люй Ши Чжан Кун Цао Янь Хуа Цзинь Тао Ци Се Цзоу Юй Бай Шуй Доу Чжан Юнь Су Пань Гэ Си Фань Пэн Лан Лу Чан Ма Мяо Фан Жэнь Юань Лю Бао Ши Тан Фэй Лянь Цэнь Сюэ Лэй Хэ Ни Тэн Инь Ло Би Хао Ань Чан Лэ Фу Пи Бянь Кан Бу Гу Мэн Пин Хуан Му Сяо Яо Шао Чжань Мао Ди Ми Бэй Мин Ху Хван", String.valueOf(' '), false)));
        for(String s : m_ChinaSurs) {
            String ss = s.trim().toUpperCase().replace("Ё", "Е");
            if (!com.pullenti.n2j.Utils.isNullOrEmpty(ss)) {
                if (!m_LastnameAsian_MorphPersonItem.contains(ss)) 
                    m_LastnameAsian_MorphPersonItem.add(ss);
            }
        }
        java.util.Collections.sort(m_LastnameAsian_MorphPersonItem);
    }

    private static java.util.ArrayList<SurnameTail> m_LastnameStdTails_MorphPersonItem;

    private static java.util.ArrayList<String> m_LatsnameSexStdTails_MorphPersonItem;

    private static java.util.ArrayList<String> m_LastnameAsian_MorphPersonItem;

    private static SurnameTail findTail_MorphPersonItem(String val) {
        if (val == null) 
            return null;
        for(int i = 0; i < m_LastnameStdTails_MorphPersonItem.size(); i++) {
            if (com.pullenti.morph.LanguageHelper.endsWith(val, m_LastnameStdTails_MorphPersonItem.get(i).tail)) 
                return m_LastnameStdTails_MorphPersonItem.get(i);
        }
        return null;
    }

    public static boolean endsWithStdSurname_MorphPersonItem(String val) {
        return findTail_MorphPersonItem(val) != null;
    }
    ...
    public static PersonItemToken _new2315(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    }
    public static PersonItemToken _new2317(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, com.pullenti.morph.CharsInfo _arg5) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.chars = _arg5;
    ...
    public static PersonItemToken _new2323(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.person.PersonReferent _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.referent = _arg4;
        res.setMorph(_arg5);
    ...
    public static PersonItemToken _new2331(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.morph.CharsInfo _arg4) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.value = _arg3;
        res.chars = _arg4;
        return res;
    }
    public static PersonItemToken _new2346(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.value = _arg3;
        return res;
    }
    public static PersonItemToken _new2347(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.morph.CharsInfo _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.value = _arg3;
        res.chars = _arg4;
        res.setMorph(_arg5);
