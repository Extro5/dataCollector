...
public class DecreeHelper {
    ...
    public static java.time.LocalDateTime parseDateTime(String str) {
        if (com.pullenti.n2j.Utils.isNullOrEmpty(str)) 
            return null;
        try {
            String[] prts = com.pullenti.n2j.Utils.split(str, String.valueOf('.'), false);
            int y;
            com.pullenti.n2j.Outargwrapper<Integer> inoutarg794 = new com.pullenti.n2j.Outargwrapper< >();
            boolean inoutres795 = com.pullenti.n2j.Utils.parseInteger(prts[0], inoutarg794);
            y = (inoutarg794.value != null ? inoutarg794.value : 0);
            if (!inoutres795) 
                return null;
            int mon = 0;
            int day = 0;
            if (prts.length > 1) {
                com.pullenti.n2j.Outargwrapper<Integer> inoutarg792 = new com.pullenti.n2j.Outargwrapper< >();
                boolean inoutres793 = com.pullenti.n2j.Utils.parseInteger(prts[1], inoutarg792);
                mon = (inoutarg792.value != null ? inoutarg792.value : 0);
                if (inoutres793) {
                    if (prts.length > 2) {
                        com.pullenti.n2j.Outargwrapper<Integer> inoutarg791 = new com.pullenti.n2j.Outargwrapper< >();
                        com.pullenti.n2j.Utils.parseInteger(prts[2], inoutarg791);
                        day = (inoutarg791.value != null ? inoutarg791.value : 0);
                    }
                }
            }
            if (mon <= 0) 
            ...
            if (day <= 0) 
                day = 1;
            if (day > com.pullenti.n2j.Utils.daysInMonth(y, mon)) 
                day = com.pullenti.n2j.Utils.daysInMonth(y, mon);
            return java.time.LocalDateTime.of(y, mon, day, 0, 0);
        } catch(Exception ex) {
        }
        return null;
    }
    ...
    public static CanonicDecreeRefUri tryCreateCanonicDecreeRefUri(com.pullenti.ner.Token t) {
        ...
        if (dr != null) {
            if (dr.getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER) 
                return null;
            res = CanonicDecreeRefUri._new796(t.kit.getSofa().getText(), dr, t.beginChar, t.endChar);
            if ((t.getPrevious() != null && t.getPrevious().isChar('(') && t.getNext() != null) && t.getNext().isChar(')')) 
                return res;
            if ((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class))).miscAttrs != 0) 
                return res;
            ...
            if (rt.getBeginToken().isChar('(') && rt.getEndToken().isChar(')')) {
                res = CanonicDecreeRefUri._new796(t.kit.getSofa().getText(), dr, rt.getBeginToken().getNext().beginChar, rt.getEndToken().getPrevious().endChar);
                return res;
            }
            ...
            if ((t.getNext() != null && t.getNext().isCommaAnd() && (t.getNext().getNext() instanceof com.pullenti.ner.ReferentToken)) && (t.getNext().getNext().getReferent() instanceof com.pullenti.ner.decree.DecreeReferent)) {
                nextDecreeItems = DecreeToken.tryAttachList((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t.getNext().getNext(), com.pullenti.ner.ReferentToken.class))).getBeginToken(), null, 10, false);
                if (nextDecreeItems != null && nextDecreeItems.size() > 1) {
                    for(int i = 0; i < (nextDecreeItems.size() - 1); i++) {
                        if (nextDecreeItems.get(i).isNewlineAfter()) {
                            for(int indRemoveRange = i + 1 + nextDecreeItems.size() - i - 1 - 1, indMinIndex = i + 1; indRemoveRange >= indMinIndex; indRemoveRange--) nextDecreeItems.remove(indRemoveRange);
                            break;
                        }
                    }
                }
                ...
                if (li != null && li.size() > 0) {
                    ...
                    if ((nextDecreeItems != null && nextDecreeItems.size() > 1 && (nextDecreeItems.size() < li.size())) && nextDecreeItems.get(0).typ != DecreeToken.ItemType.TYP) {
                        ...
                        if (j >= nextDecreeItems.size()) {
                            for(int indRemoveRange = 0 + d - 1, indMinIndex = 0; indRemoveRange >= indMinIndex; indRemoveRange--) li.remove(indRemoveRange);
        ...
        if ((t.getPrevious() != null && t.getPrevious().isHiphen() && (t.getPrevious().getPrevious() instanceof com.pullenti.ner.ReferentToken)) && (t.getPrevious().getPrevious().getReferent() instanceof com.pullenti.ner.decree.DecreePartReferent)) {
            if (com.pullenti.ner.decree.DecreePartReferent.createRangeReferent((com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(t.getPrevious().getPrevious().getReferent(), com.pullenti.ner.decree.DecreePartReferent.class), dpr) != null) 
                return null;
        }
        ...
        if ((t.getNext() != null && t.getNext().isHiphen() && (t.getNext().getNext() instanceof com.pullenti.ner.ReferentToken)) && (t.getNext().getNext().getReferent() instanceof com.pullenti.ner.decree.DecreePartReferent)) {
            com.pullenti.ner.decree.DecreePartReferent diap = com.pullenti.ner.decree.DecreePartReferent.createRangeReferent((com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(dpr, com.pullenti.ner.decree.DecreePartReferent.class), (com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(t.getNext().getNext().getReferent(), com.pullenti.ner.decree.DecreePartReferent.class));
            if (diap != null) {
                dpr = diap;
                hasDiap = true;
                t1 = t.getNext().getNext();
                diapRef = (com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t1, com.pullenti.ner.ReferentToken.class);
            }
        }
        res = CanonicDecreeRefUri._new798(t.kit.getSofa().getText(), dpr, t.beginChar, t1.endChar, hasDiap);
        ...
        if (ptmin != PartToken.ItemType.PREFIX) {
            for(com.pullenti.ner.Token tt = (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken(); tt != null && tt.endChar <= res.endChar; tt = tt.getNext()) {
                    ...
                    if (pt != null && pt.typ == ptmin) {
                        ...
                        if (pt.endChar == t.endChar) {
                            if ((t.getNext() != null && t.getNext().isCommaAnd() && (t.getNext().getNext() instanceof com.pullenti.ner.ReferentToken)) && (t.getNext().getNext().getReferent() instanceof com.pullenti.ner.decree.DecreePartReferent)) {
                                com.pullenti.ner.Token tt1 = (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t.getNext().getNext(), com.pullenti.ner.ReferentToken.class))).getBeginToken();
                                boolean ok = true;
                    ...
                    if ((tt instanceof com.pullenti.ner.NumberToken) && tt.beginChar == res.beginChar) {
                        ...
                        if (tt.getNext() != null && tt.getNext().isHiphen()) {
                            if (tt.getNext().getNext() instanceof com.pullenti.ner.NumberToken) {
                                ...
                                res.endChar = (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt.getNext().getNext(), com.pullenti.ner.MetaToken.class))).getBeginToken().endChar;
                        }
                        return res;
                    }
    ...
    private static boolean _hasSameDecree(com.pullenti.ner.Token t, com.pullenti.ner.decree.DecreePartReferent dpr, boolean before) {
        ...
        if (t == null) 
            return false;
        com.pullenti.ner.decree.DecreePartReferent dpr0 = (com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreePartReferent.class);
        if (dpr0 == null) 
            return false;
        if (dpr0.getOwner() != dpr.getOwner()) 
            return false;
        if (dpr0.getOwner() == null) {
            if (com.pullenti.n2j.Utils.stringsNe(dpr0.getLocalTyp(), dpr.getLocalTyp())) 
                return false;
        }
    ...
    public static com.pullenti.ner.MetaToken checkNds(com.pullenti.ner.Token t, double nds, boolean ndsMustbeMoney) {
        if (t == null || nds <= 0) 
            return null;
        com.pullenti.ner.money.MoneyReferent m = (com.pullenti.ner.money.MoneyReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.money.MoneyReferent.class);
        if (m == null) 
            return null;
        ...
        for(tt = t.getNext(); tt != null; tt = tt.getNext()) {
            ...
            if (tt instanceof com.pullenti.ner.ReferentToken) {
                m1 = (com.pullenti.ner.money.MoneyReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.money.MoneyReferent.class);
                break;
            }
            if (tt instanceof com.pullenti.ner.NumberToken) {
                com.pullenti.ner.core.NumberExToken ne = com.pullenti.ner.core.NumberExToken.tryParseNumberWithPostfix(tt);
                if (ne != null && ne.exTyp == com.pullenti.ner.core.NumberExType.PERCENT) {
                    if (Math.abs(ne.realValue - nds) > 0.0001) {
                        ...
                        if (hasNds) 
                            ok = true;
                        if (ok) 
                            return com.pullenti.ner.MetaToken._new799(tt, ne.getEndToken(), "Размер НДС должен быть " + nds + "%, а не " + ne.realValue + "%");
                    }
        ...
        if (m1 == null) {
            if (ndsMustbeMoney) 
                return com.pullenti.ner.MetaToken._new799(ndsT0, ndsT1, "Размер НДС должен быть в денежном выражении");
            return null;
        }
        if (hasAll) 
            return null;
        double mustBe = m.getRealValue();
        mustBe = mustBe * ((nds / ((double)100)));
        if (incl) 
            mustBe /= ((((double)1) + ((nds / ((double)100)))));
        double dd = mustBe * ((double)100);
        dd -= ((double)((long)dd));
        dd /= ((double)100);
        mustBe -= dd;
        if (dd >= 0.005) 
        ...
        if (delta > 0.011) {
            if ((delta < 1) && m1.getRest() == 0 && m.getRest() == 0) {
                ...
                com.pullenti.ner.money.MoneyReferent mr = com.pullenti.ner.money.MoneyReferent._new801(m1.getCurrency(), mustBe);
                return com.pullenti.ner.MetaToken._new799(t, tt, "Размер НДС должен быть " + _outMoney(mr) + ", а не " + _outMoney(m1));
            }
        }
        if (incl) 
            return null;
        ...
        for(tt = tt.getNext(); tt != null; tt = tt.getNext()) {
            if (tt instanceof com.pullenti.ner.ReferentToken) {
                m2 = (com.pullenti.ner.money.MoneyReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.money.MoneyReferent.class);
                break;
            }
            if (!tt.chars.isLetter() || tt.getMorph()._getClass().isPreposition()) 
                continue;
        ...
        if (m2 != null && hasAll) {
            ...
            if (delta > 0.01) {
                ...
                return com.pullenti.ner.MetaToken._new799(t, tt, err);
            }
        }
        return null;
    }
