...
public class DateItemToken extends com.pullenti.ner.MetaToken {
     ...
     * @return 
     */
    public static DateItemToken tryAttach(com.pullenti.ner.Token t, java.util.ArrayList<DateItemToken> prev) {
        if (t == null) 
            return null;
        ...
        if (t0.isChar('_')) {
            ...
            DateItemToken res0 = _TryAttach(t.getNext(), prev);
            if (res0 != null) {
                res0.setBeginToken(t);
                return res0;
            }
        }
        DateItemToken res = _TryAttach(t, prev);
        if (res == null) 
            return null;
    ...
    private static DateItemToken _TryAttach(com.pullenti.ner.Token t, java.util.ArrayList<DateItemToken> prev) {
        if (t == null) 
            return null;
        ...
        if (nt != null) {
            ...
            DateItemToken res = _new643(begin, end, DateItemType.NUMBER, (int)nt.value, nt.getMorph());
            if ((res.intValue == 20 && (nt.getNext() instanceof com.pullenti.ner.NumberToken) && nt.getNext().getLengthChar() == 2) && prev != null) {
                int num = 2000 + ((int)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(nt.getNext(), com.pullenti.ner.NumberToken.class))).value);
                if ((num < 2030) && prev.size() > 0 && prev.get(prev.size() - 1).typ == DateItemType.MONTH) {
                    ...
                    if (nt.getWhitespacesAfterCount() == 1) 
                        ...
                        ok = true;
                    if (ok) {
                        nt = (com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(nt.getNext(), com.pullenti.ner.NumberToken.class);
                        res.setEndToken(nt);
                        res.intValue = num;
                    }
                }
        ...
        com.pullenti.ner.TextToken t0 = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class);
        if (t0 == null) 
            return null;
        ...
        if ((txt.charAt(0) == 'I' || txt.charAt(0) == 'X' || txt.charAt(0) == 'Х') || txt.charAt(0) == 'V') {
            ...
            if (lat != null && lat.getEndToken().getNext() != null) {
                com.pullenti.ner.Token tt = lat.getEndToken().getNext();
                if (tt.isValue("КВАРТАЛ", null) && lat.value > ((long)0) && lat.value <= ((long)4)) 
                    return _new644(t, tt, DateItemType.QUARTAL, (int)lat.value);
                if (tt.isValue("ПОЛУГОДИЕ", "ПІВРІЧЧЯ") && lat.value > ((long)0) && lat.value <= ((long)2)) 
                    return _new644(t, lat.getEndToken().getNext(), DateItemType.HALFYEAR, (int)lat.value);
                if (tt.isValue("ВЕК", "ВІК") || tt.isValue("СТОЛЕТИЕ", "СТОЛІТТЯ")) 
                    return _new644(t, lat.getEndToken().getNext(), DateItemType.CENTURY, (int)lat.value);
                if (tt.isValue("В", null) && tt.getNext() != null && tt.getNext().isChar('.')) {
                    if (prev != null && prev.size() > 0 && prev.get(prev.size() - 1).typ == DateItemType.POINTER) 
                        return _new644(t, tt.getNext(), DateItemType.CENTURY, (int)lat.value);
                ...
                if (tt.isHiphen()) {
                    ...
                    if (lat2 != null && lat2.value > lat.value && lat2.getEndToken().getNext() != null) {
                        if (lat2.getEndToken().getNext().isValue("ВЕК", "ВІК") || lat2.getEndToken().getNext().isValue("СТОЛЕТИЕ", "СТОЛІТТЯ")) 
                            return _new644(t, lat.getEndToken(), DateItemType.CENTURY, (int)lat.value);
                    }
                }
            }
        }
        if (t != null && t.isValue("НАПРИКІНЦІ", null)) 
            return _new650(t, t, DateItemType.POINTER, "конец");
        if (t != null && t.isValue("ДОНЕДАВНА", null)) 
            return _new650(t, t, DateItemType.POINTER, "сегодня");
        ...
        if ((tok != null && ((com.pullenti.ner.date.DatePointerType)tok.termin.tag) == com.pullenti.ner.date.DatePointerType.SUMMER && t.getMorph().getLanguage().isRu()) && (t instanceof com.pullenti.ner.TextToken)) {
            ...
            if (com.pullenti.n2j.Utils.stringsNe(str, "ЛЕТОМ") && com.pullenti.n2j.Utils.stringsNe(str, "ЛЕТА") && com.pullenti.n2j.Utils.stringsNe(str, "ЛЕТО")) 
                tok = null;
        }
        if (tok != null) 
            return _new644(t, tok.getEndToken(), DateItemType.POINTER, ((com.pullenti.ner.date.DatePointerType)tok.termin.tag).value());
        ...
        if (npt != null) {
            ...
            if (npt.noun.isValue("КВАРТАЛ", null)) 
                ...
                return _new650(t, npt.getEndToken(), DateItemType.POINTER, "начало");
            else if (npt.getEndToken().isValue("СЕРЕДИНА", null)) 
                return _new650(t, npt.getEndToken(), DateItemType.POINTER, "середина");
            else if (npt.getEndToken().isValue("КОНЕЦ", null) || npt.getEndToken().isValue("КІНЕЦЬ", null) || npt.getEndToken().isValue("НАПРИКІНЕЦЬ", null)) 
                return _new650(t, npt.getEndToken(), DateItemType.POINTER, "конец");
            else if (npt.getEndToken().isValue("ВРЕМЯ", null) && npt.adjectives.size() > 0 && npt.getEndToken().getPrevious().isValue("НАСТОЯЩЕЕ", null)) 
                return _new650(t, npt.getEndToken(), DateItemType.POINTER, "сегодня");
            else if (npt.getEndToken().isValue("ЧАС", null) && npt.adjectives.size() > 0 && npt.getEndToken().getPrevious().isValue("ДАНИЙ", null)) 
                return _new650(t, npt.getEndToken(), DateItemType.POINTER, "сегодня");
            if (_typ != DateItemType.NUMBER) {
                int delta = 0;
                if (npt.adjectives.size() > 0) {
                    if (npt.adjectives.get(0).isValue("ПОСЛЕДНИЙ", null) || npt.adjectives.get(0).isValue("ОСТАННІЙ", null)) 
                        return _new644(t0, npt.getEndToken(), _typ, (_typ == DateItemType.QUARTAL ? 4 : 2));
                    if (npt.adjectives.get(0).isValue("ПРЕДЫДУЩИЙ", null) || npt.adjectives.get(0).isValue("ПОПЕРЕДНІЙ", null)) 
                        delta = -1;
                ...
                for(com.pullenti.ner.Token tt = t.getPrevious(); tt != null; tt = tt.getPrevious()) {
                    if (cou > 200) 
                        break;
                    com.pullenti.ner.date.DateRangeReferent dr = (com.pullenti.ner.date.DateRangeReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.date.DateRangeReferent.class);
                    if (dr == null) 
                        continue;
                    if (_typ == DateItemType.QUARTAL) {
                        ...
                        if ((ii < 1) || ii > 4) 
                            continue;
                        return _new644(t0, npt.getEndToken(), _typ, ii);
                    }
        ...
        if (!Character.isLetterOrDigit(term.charAt(0))) {
            if (t0.isCharOf(".\\/:") || t0.isHiphen()) 
                return _new650(t0, t0, DateItemType.DELIM, term);
            else if (t0.isChar(',')) 
                return _new650(t0, t0, DateItemType.DELIM, term);
            else 
                return null;
        }
        if (com.pullenti.n2j.Utils.stringsEq(term, "O") || com.pullenti.n2j.Utils.stringsEq(term, "О")) {
            if ((t.getNext() instanceof com.pullenti.ner.NumberToken) && !t.isWhitespaceAfter() && ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).value < ((long)10))) 
                return _new644(t, t.getNext(), DateItemType.NUMBER, (int)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).value);
        }
        if (Character.isLetter(term.charAt(0))) {
            ...
            if (inf != null && (inf.termin.tag instanceof Integer)) 
                return _new665(inf.getBeginToken(), inf.getEndToken(), DateItemType.MONTH, (int)inf.termin.tag, inf.termin.lang);
        }
        return null;
    }
    ...
    public static void initialize() {
        ...
        com.pullenti.ner.core.Termin tt = com.pullenti.ner.core.Termin._new666("НОВАЯ ЭРА", com.pullenti.morph.MorphLang.RU, true, "НОВОЙ ЭРЫ");
        tt.addVariant("НАША ЭРА", true);
        tt.addAbridge("Н.Э.");
        m_NewAge.add(tt);
        tt = com.pullenti.ner.core.Termin._new666("НОВА ЕРА", com.pullenti.morph.MorphLang.UA, true, "НОВОЇ ЕРИ");
        ...
        m_Seasons.add(com.pullenti.ner.core.Termin._new668("ЗИМА", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.date.DatePointerType.WINTER));
        m_Seasons.add(com.pullenti.ner.core.Termin._new668("WINTER", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.date.DatePointerType.WINTER));
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new668("ВЕСНА", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.date.DatePointerType.SPRING);
        t.addVariant("ПРОВЕСНА", true);
        m_Seasons.add(t);
        m_Seasons.add(com.pullenti.ner.core.Termin._new668("SPRING", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.date.DatePointerType.SPRING));
        t = com.pullenti.ner.core.Termin._new668("ЛЕТО", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.date.DatePointerType.SUMMER);
        m_Seasons.add(t);
        t = com.pullenti.ner.core.Termin._new668("ЛІТО", com.pullenti.morph.MorphLang.UA, true, com.pullenti.ner.date.DatePointerType.SUMMER);
        m_Seasons.add(t);
        t = com.pullenti.ner.core.Termin._new668("ОСЕНЬ", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.date.DatePointerType.AUTUMN);
        m_Seasons.add(t);
        t = com.pullenti.ner.core.Termin._new668("AUTUMN", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.date.DatePointerType.AUTUMN);
        m_Seasons.add(t);
        t = com.pullenti.ner.core.Termin._new668("ОСІНЬ", com.pullenti.morph.MorphLang.UA, true, com.pullenti.ner.date.DatePointerType.AUTUMN);
        m_Seasons.add(t);
        ...
        for(int i = 0; i < months.length; i++) {
            t = com.pullenti.ner.core.Termin._new668(months[i], com.pullenti.morph.MorphLang.RU, true, i + 1);
            m_Monthes.add(t);
        }
        months = new String[] {"СІЧЕНЬ", "ЛЮТИЙ", "БЕРЕЗЕНЬ", "КВІТЕНЬ", "ТРАВЕНЬ", "ЧЕРВЕНЬ", "ЛИПЕНЬ", "СЕРПЕНЬ", "ВЕРЕСЕНЬ", "ЖОВТЕНЬ", "ЛИСТОПАД", "ГРУДЕНЬ"};
        for(int i = 0; i < months.length; i++) {
            t = com.pullenti.ner.core.Termin._new668(months[i], com.pullenti.morph.MorphLang.UA, true, i + 1);
            m_Monthes.add(t);
        }
        months = new String[] {"JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER"};
        for(int i = 0; i < months.length; i++) {
            t = com.pullenti.ner.core.Termin._new668(months[i], com.pullenti.morph.MorphLang.EN, true, i + 1);
            m_Monthes.add(t);
        }
        months = new String[] {"GENNAIO", "FEBBRAIO", "MARZO", "APRILE", "MAGGIO", "GUINGO", "LUGLIO", "AGOSTO", "SETTEMBRE", "OTTOBRE", "NOVEMBRE", "DICEMBRE"};
        for(int i = 0; i < months.length; i++) {
            t = com.pullenti.ner.core.Termin._new668(months[i], com.pullenti.morph.MorphLang.IT, true, i + 1);
            m_Monthes.add(t);
        }
        ...
        m_EmptyWords = new java.util.HashMap< >();
        ...
        com.pullenti.ner.core.Termin te = com.pullenti.ner.core.Termin._new668("SUNDAY", com.pullenti.morph.MorphLang.EN, true, 7);
        te.addAbridge("SUN");
        ...
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new668("MONDAY", com.pullenti.morph.MorphLang.EN, true, 1);
        te.addAbridge("MON");
        te.addVariant("ПОНЕДЕЛЬНИК", true);
        te.addAbridge("ПОН");
        te.addVariant("ПОНЕДІЛОК", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new668("TUESDAY", com.pullenti.morph.MorphLang.EN, true, 2);
        te.addAbridge("TUE");
        te.addVariant("ВТОРНИК", true);
        te.addAbridge("ВТ");
        te.addVariant("ВІВТОРОК", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new668("WEDNESDAY", com.pullenti.morph.MorphLang.EN, true, 3);
        te.addAbridge("WED");
        te.addVariant("СРЕДА", true);
        te.addAbridge("СР");
        te.addVariant("СЕРЕДА", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new668("THURSDAY", com.pullenti.morph.MorphLang.EN, true, 4);
        te.addAbridge("THU");
        te.addVariant("ЧЕТВЕРГ", true);
        te.addAbridge("ЧТ");
        te.addVariant("ЧЕТВЕР", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new668("FRIDAY", com.pullenti.morph.MorphLang.EN, true, 5);
        te.addAbridge("FRI");
        te.addVariant("ПЯТНИЦА", true);
        te.addAbridge("ПТ");
        te.addVariant("ПЯТНИЦЯ", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new668("SATURDAY", com.pullenti.morph.MorphLang.EN, true, 6);
        te.addAbridge("SAT");
    ...
    private static com.pullenti.ner.Token testYearRusWord(com.pullenti.ner.Token t0, boolean ignoreNewline) {
        ...
        if (((tt.getMorph().getLanguage().isRu() && ((tt.isValue("ГГ", null) || tt.isValue("Г", null))))) || ((tt.getMorph().getLanguage().isUa() && ((tt.isValue("Р", null) || tt.isValue("РР", null)))))) {
            if (tt.getNext() != null && tt.getNext().isChar('.')) {
                tt = tt.getNext();
                if ((tt.getNext() != null && ((((tt.getNext().isValue("Г", null) && tt.getNext().getMorph().getLanguage().isRu())) || ((tt.getNext().getMorph().getLanguage().isUa() && tt.getNext().isValue("Р", null))))) && tt.getNext().getNext() != null) && tt.getNext().getNext().isChar('.')) 
    ...
    public static java.util.ArrayList<DateItemToken> tryAttachList(com.pullenti.ner.Token t, int maxCount) {
        DateItemToken p = tryAttach(t, null);
        if (p == null) 
            return null;
        if (p.typ == DateItemType.DELIM) 
            return null;
        java.util.ArrayList<DateItemToken> res = new java.util.ArrayList< >();
        res.add(p);
        com.pullenti.ner.Token tt = p.getEndToken().getNext();
        while(tt != null) {
            if (tt instanceof com.pullenti.ner.TextToken) {
                if ((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).checkValue(m_EmptyWords) != null) {
                    tt = tt.getNext();
                    continue;
                }
            }
            DateItemToken p0 = tryAttach(tt, res);
            if (p0 == null) {
        ...
        if (res.size() > 0 && res.get(res.size() - 1).typ == DateItemType.NUMBER) {
            com.pullenti.ner.core.NumberExToken nex = com.pullenti.ner.core.NumberExToken.tryParseNumberWithPostfix(res.get(res.size() - 1).getBeginToken());
            if (nex != null && nex.exTyp != com.pullenti.ner.core.NumberExType.HOUR) {
                if (res.size() > 3 && res.get(res.size() - 2).typ == DateItemType.DELIM && com.pullenti.n2j.Utils.stringsEq(res.get(res.size() - 2).stringValue, ":")) {
                }
                else 
    ...
    public static DateItemToken _new643(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DateItemType _arg3, int _arg4, com.pullenti.ner.MorphCollection _arg5) {
    ...
    public static DateItemToken _new644(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DateItemType _arg3, int _arg4) {
        DateItemToken res = new DateItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.intValue = _arg4;
        return res;
    }
    public static DateItemToken _new650(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DateItemType _arg3, String _arg4) {
        DateItemToken res = new DateItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.stringValue = _arg4;
        return res;
    }
    public static DateItemToken _new665(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DateItemType _arg3, int _arg4, com.pullenti.morph.MorphLang _arg5) {
        DateItemToken res = new DateItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.intValue = _arg4;
        res.lang = _arg5;
