...
public class PhoneItemToken extends com.pullenti.ner.MetaToken {
    ...
    public boolean canBeCountryPrefix() {
        if (value != null && com.pullenti.n2j.Utils.stringsEq(PhoneHelper.getCountryPrefix(value), value)) 
            return true;
        else 
            return false;
    }
    ...
    private static PhoneItemToken _TryAttach(com.pullenti.ner.Token t0) {
        ...
        if (t0 instanceof com.pullenti.ner.NumberToken) {
            if (com.pullenti.ner.core.NumberExToken.tryParseNumberWithPostfix(t0) != null) {
                com.pullenti.ner.ReferentToken rt = t0.kit.processReferent("PHONE", t0.getNext());
                if (rt == null) 
                    return null;
            }
            if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t0, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT && !t0.getMorph()._getClass().isAdjective()) 
                return _new2408(t0, t0, PhoneItemType.NUMBER, t0.getSourceText());
            return null;
        }
        if (t0.isChar('.')) 
            return _new2408(t0, t0, PhoneItemType.DELIM, ".");
        if (t0.isHiphen()) 
            return _new2408(t0, t0, PhoneItemType.DELIM, "-");
        if (t0.isChar('+')) {
            if (!((t0.getNext() instanceof com.pullenti.ner.NumberToken)) || (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t0.getNext(), com.pullenti.ner.NumberToken.class))).typ != com.pullenti.ner.NumberSpellingType.DIGIT) 
                return null;
            else {
                ...
                if (i > 0) 
                    val = val.substring(i);
                return _new2408(t0, t0.getNext(), PhoneItemType.COUNTRYCODE, val);
            }
        }
        ...
        if (t0.isCharOf("(")) {
            if (t0.getNext() instanceof com.pullenti.ner.NumberToken) {
                ...
                for(; et != null; et = et.getNext()) {
                    if (et.isChar(')')) 
                        break;
                    if (((et instanceof com.pullenti.ner.NumberToken)) && (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(et, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT) 
                ...
                if (et == null || val.length() == 0) 
                    ...
                    return _new2413(t0, et, PhoneItemType.CITYCODE, val.toString(), true);
            }
            else {
                ...
                if (tt1 == null || tt1.termin.tag != null) {
                    ...
                    return _new2414(t0, tt1.getEndToken().getNext(), PhoneItemType.PREFIX, true, "");
                return null;
            }
        }
        if ((t0.isChar('/') && (t0.getNext() instanceof com.pullenti.ner.NumberToken) && t0.getNext().getNext() != null) && t0.getNext().getNext().isChar('/') && t0.getNext().getLengthChar() == 3) 
            return _new2413(t0, t0.getNext().getNext(), PhoneItemType.CITYCODE, ((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t0.getNext(), com.pullenti.ner.NumberToken.class))).value).toString(), true);
        ...
        PhoneItemToken res = _new2416(t0, t1, PhoneItemType.PREFIX, "", ki);
        while(true) {
    ...
    public static PhoneItemToken tryAttachAdditional(com.pullenti.ner.Token t0) {
        ...
        if (t.isChar(',')) 
            ...
            String val0 = (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getSourceText();
            ...
            if (val0.length() >= 3 && (val0.length() < 7)) 
                return _new2408(t, t1, PhoneItemType.ADDNUMBER, val0);
        }
        boolean br = false;
        if (t != null && t.isChar('(')) {
            br = true;
        ...
        if (!((t instanceof com.pullenti.ner.NumberToken))) 
            return null;
        String val = (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getSourceText();
        ...
        PhoneItemToken res = _new2408(t0, t, PhoneItemType.ADDNUMBER, val);
        return res;
    }
    ...
    public static java.util.ArrayList<PhoneItemToken> tryAttachAll(com.pullenti.ner.Token t0) {
        ...
        if (p == null || p.itemType == PhoneItemType.DELIM) 
            return null;
        java.util.ArrayList<PhoneItemToken> res = new java.util.ArrayList< >();
        res.add(p);
        ...
        for(t = p.getEndToken().getNext(); t != null; t = t.getNext()) {
            ...
            if (p.itemType == PhoneItemType.NUMBER && res.get(res.size() - 1).itemType == PhoneItemType.NUMBER) 
                res.add(_new2408(t, t, PhoneItemType.DELIM, " "));
            if (br) 
                p.isInBrackets = true;
            res.add(p);
            t = p.getEndToken();
    ...
    public static PhoneItemToken tryAttachAlternate(com.pullenti.ner.Token t0, com.pullenti.ner.phone.PhoneReferent ph0, java.util.ArrayList<PhoneItemToken> pli) {
        ...
        if (t0.isCharOf("\\/") && (t0.getNext() instanceof com.pullenti.ner.NumberToken) && (t0.getNext().endChar - t0.getNext().beginChar) <= 1) {
            ...
            if (pli1 != null && pli1.size() > 1) {
                ...
                if (pli1.size() <= pli.size()) {
                    ...
                    if (ii >= pli1.size()) 
                        return _new2408(t0, pli1.get(pli1.size() - 1).getEndToken(), PhoneItemType.ALT, num);
                }
            }
            return _new2408(t0, t0.getNext(), PhoneItemType.ALT, t0.getNext().getSourceText());
        }
        ...
        if ((t0.isChar('(') && (t0.getNext() instanceof com.pullenti.ner.NumberToken) && (t0.getNext().endChar - t0.getNext().beginChar) == 1) && t0.getNext().getNext() != null && t0.getNext().getNext().isChar(')')) 
            return _new2408(t0, t0.getNext().getNext(), PhoneItemType.ALT, t0.getNext().getSourceText());
    ...
    public static void initialize() {
        ...
        t = com.pullenti.ner.core.Termin._new2425("МОБИЛЬНЫЙ", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.phone.PhoneKind.MOBILE);
        t.addAbridge("МОБ.");
        t.addAbridge("Т.М.");
        t.addAbridge("М.Т.");
        t.addAbridge("М.");
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("СОТОВЫЙ", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.phone.PhoneKind.MOBILE);
        t.addAbridge("СОТ.");
        t.addAbridge("CELL.");
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("РАБОЧИЙ", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.phone.PhoneKind.WORK);
        t.addAbridge("РАБ.");
        t.addAbridge("Т.Р.");
        t.addAbridge("Р.Т.");
        m_PhoneTermins.add(t);
        ...
        t.addAbridge("Г.Т.");
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("ДОМАШНИЙ", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.phone.PhoneKind.HOME);
        t.addAbridge("ДОМ.");
        m_PhoneTermins.add(t);
        ...
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("ФАКС", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.phone.PhoneKind.FAX);
        t.addAbridge("Ф.");
        t.addAbridge("Т/ФАКС");
        ...
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("ПРИЕМНАЯ", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.phone.PhoneKind.WORK);
        m_PhoneTermins.add(t);
        t = new com.pullenti.ner.core.Termin("PHONE", com.pullenti.morph.MorphLang.EN, true);
        t.addAbridge("PH.");
        t.addVariant("TELEFON", true);
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("DIRECT LINE", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.phone.PhoneKind.WORK);
        t.addVariant("DIRECT LINES", true);
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("MOBILE", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.phone.PhoneKind.MOBILE);
        t.addAbridge("MOB.");
        t.addVariant("MOBIL", true);
        t.addAbridge("M.");
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("FAX", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.phone.PhoneKind.FAX);
        t.addAbridge("F.");
        m_PhoneTermins.add(t);
        t = com.pullenti.ner.core.Termin._new2425("HOME", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.phone.PhoneKind.HOME);
        m_PhoneTermins.add(t);
    ...
    public static PhoneItemToken _new2408(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PhoneItemType _arg3, String _arg4) {
        PhoneItemToken res = new PhoneItemToken(_arg1, _arg2);
        res.itemType = _arg3;
        res.value = _arg4;
        return res;
    }
    public static PhoneItemToken _new2413(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PhoneItemType _arg3, String _arg4, boolean _arg5) {
        PhoneItemToken res = new PhoneItemToken(_arg1, _arg2);
        res.itemType = _arg3;
        res.value = _arg4;
    ...
    public static PhoneItemToken _new2414(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PhoneItemType _arg3, boolean _arg4, String _arg5) {
        PhoneItemToken res = new PhoneItemToken(_arg1, _arg2);
        res.itemType = _arg3;
    ...
    public static PhoneItemToken _new2416(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PhoneItemType _arg3, String _arg4, com.pullenti.ner.phone.PhoneKind _arg5) {
        PhoneItemToken res = new PhoneItemToken(_arg1, _arg2);
        res.itemType = _arg3;
        res.value = _arg4;
        res.kind = _arg5;
