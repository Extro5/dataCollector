...
public class PersonAttrToken extends com.pullenti.ner.ReferentToken {
    ...
    public com.pullenti.ner.person.PersonPropertyReferent getPropRef() {
        return (com.pullenti.ner.person.PersonPropertyReferent)com.pullenti.n2j.Utils.cast(referent, com.pullenti.ner.person.PersonPropertyReferent.class);
    }
    ...
    public boolean canBeIndependentProperty() {
        ...
        if (getPropRef().findSlot(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, null, true) != null) {
            if (com.pullenti.n2j.Utils.stringsNe(getPropRef().getName(), "член")) 
                return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        if (getPropRef() != null) 
            res.append(" Ref: ").append(getPropRef().toString());
        ...
        if (!getMorph().getCase().isUndefined()) 
            res.append("; ").append(getMorph().getCase().toString());
        return res.toString();
    }
    ...
    public void saveToLocalOntology() {
        ...
        java.util.ArrayList<PersonAttrToken> li = new java.util.ArrayList< >();
    ...
    public static PersonAttrToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        ...
        Object olev = null;
        int lev = 0;
        com.pullenti.n2j.Outargwrapper<Object> inoutarg2191 = new com.pullenti.n2j.Outargwrapper< >();
        Boolean inoutres2192 = com.pullenti.n2j.Utils.tryGetValue(t.kit.miscData, "pat", inoutarg2191);
        olev = inoutarg2191.value;
        if (!inoutres2192) 
        ...
        if (res == null) {
            if (t.getMorph()._getClass().isNoun()) {
                com.pullenti.ner.geo.GeoAnalyzer aterr = (com.pullenti.ner.geo.GeoAnalyzer)com.pullenti.n2j.Utils.cast(t.kit.processor.findAnalyzer("GEO"), com.pullenti.ner.geo.GeoAnalyzer.class);
                if (aterr != null) {
                    com.pullenti.ner.ReferentToken rt = aterr.processCitizen(t);
                    if (rt != null) {
                        res = _new2188(rt.getBeginToken(), rt.getEndToken(), rt.getMorph());
            ...
            if (((((t instanceof com.pullenti.ner.TextToken)) && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "АК") && t.getNext() != null) && t.getNext().isChar('.') && t.getNext().getNext() != null) && !t.getNext().getNext().chars.isAllLower()) {
                res = _new2189(t, t.getNext(), PersonAttrTerminType.POSITION);
                res.setPropRef(com.pullenti.ner.person.PersonPropertyReferent._new2190("академик"));
                return res;
            }
                ...
                if (((t.isValue("ВИЦЕ", "ВІЦЕ") || t.isValue("ЭКС", "ЕКС") || t.isValue("ГЕН", null)) || t.isValue("VICE", null) || t.isValue("EX", null)) || t.isValue("DEPUTY", null)) {
                    ...
                    if (res != null && res.getPropRef() != null) {
                        ...
                        if (t.isValue("ГЕН", null)) 
                            ...
                            res.getPropRef().setName((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term.toLowerCase() + "-" + res.getPropRef().getName());
                        return res;
                    }
                }
            }
        ...
        if (res.typ == PersonAttrTerminType.PREFIX && (((((com.pullenti.n2j.Utils.stringsEq(res.value, "ГРАЖДАНИН") || com.pullenti.n2j.Utils.stringsEq(res.value, "ГРАЖДАНКА") || com.pullenti.n2j.Utils.stringsEq(res.value, "УРОЖЕНЕЦ")) || com.pullenti.n2j.Utils.stringsEq(res.value, "УРОЖЕНКА") || com.pullenti.n2j.Utils.stringsEq(res.value, "ГРОМАДЯНИН")) || com.pullenti.n2j.Utils.stringsEq(res.value, "ГРОМАДЯНКА") || com.pullenti.n2j.Utils.stringsEq(res.value, "УРОДЖЕНЕЦЬ")) || com.pullenti.n2j.Utils.stringsEq(res.value, "УРОДЖЕНКА"))) && res.getEndToken().getNext() != null) {
            ...
            if (r != null && com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameGeo)) {
                res.setEndToken(tt);
                res.setPropRef(new com.pullenti.ner.person.PersonPropertyReferent());
        ...
        if (com.pullenti.n2j.Utils.stringsEq(s, "глава книги")) 
            return null;
        if (com.pullenti.n2j.Utils.stringsEq(s, "глава") && res.getPropRef().findSlot(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, null, true) == null) 
            return null;
        if (((com.pullenti.n2j.Utils.stringsEq(s, "королева") || com.pullenti.n2j.Utils.stringsEq(s, "король") || com.pullenti.n2j.Utils.stringsEq(s, "князь"))) && res.chars.isCapitalUpper()) {
        ...
        if (com.pullenti.n2j.Utils.stringsEq(s, "друг") || s.startsWith("друг ")) {
            if (t.getPrevious() != null) {
        ...
        if (res.chars.isLatinLetter() && ((res.isDoubt || com.pullenti.n2j.Utils.stringsEq(s, "senior"))) && (res.getWhitespacesAfterCount() < 2)) {
            if (res.getPropRef() != null && res.getPropRef().getSlots().size() == 1) {
                ...
                if ((res2 != null && res2.chars.isLatinLetter() && res2.typ == res.typ) && res2.getPropRef() != null) {
                    res2.getPropRef().setName((((String)com.pullenti.n2j.Utils.notnull(res.getPropRef().getName(), "")) + " " + ((String)com.pullenti.n2j.Utils.notnull(res2.getPropRef().getName(), ""))).trim());
                    res2.setBeginToken(res.getBeginToken());
                    res = res2;
                }
            }
        }
        if (com.pullenti.n2j.Utils.stringsEq(res.getPropRef().getName(), "министр")) {
        ...
        for(com.pullenti.ner.Slot ss : res.getPropRef().getSlots()) {
            if (ss.getValue() instanceof com.pullenti.ner.Referent) {
                if (com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(ss.getValue(), com.pullenti.ner.Referent.class))).getTypeName(), objNameGeo)) {
                    containsGeo = true;
                    break;
                }
            }
        ...
        if (!containsGeo && (res.getEndToken().getWhitespacesAfterCount() < 2)) {
            if ((res.getEndToken().getNext() instanceof com.pullenti.ner.ReferentToken) && com.pullenti.n2j.Utils.stringsEq(res.getEndToken().getNext().getReferent().getTypeName(), objNameGeo)) {
        ...
        if (res.getEndToken().getWhitespacesAfterCount() < 2) {
            ...
            if (te != null && te.isValue("В", null)) {
                te = te.getNext();
                if ((te instanceof com.pullenti.ner.ReferentToken) && ((com.pullenti.n2j.Utils.stringsEq(te.getReferent().getTypeName(), objNameDate) || com.pullenti.n2j.Utils.stringsEq(te.getReferent().getTypeName(), objNameDateRange)))) 
                    res.setEndToken(te);
            }
            else if (te != null && te.isChar('(')) {
                te = te.getNext();
                if (((te instanceof com.pullenti.ner.ReferentToken) && ((com.pullenti.n2j.Utils.stringsEq(te.getReferent().getTypeName(), objNameDate) || com.pullenti.n2j.Utils.stringsEq(te.getReferent().getTypeName(), objNameDateRange))) && te.getNext() != null) && te.getNext().isChar(')')) 
        ...
        if (res.getPropRef() != null && com.pullenti.n2j.Utils.stringsEq(res.getPropRef().getName(), "отец")) {
        ...
        if (res.getPropRef() != null && res.getPropRef().getKind() == com.pullenti.ner.person.PersonPropertyKind.KING) {
            ...
            if (com.pullenti.n2j.Utils.stringsEq(res.getPropRef().getName(), "отец")) {
            ...
            if (t1 != null && t1.chars.isCapitalUpper() && t1.getMorph()._getClass().isAdjective()) {
                if ((((res.kingSurname = PersonItemToken.tryAttach(t1, locOnto, PersonItemToken.ParseAttr.IGNOREATTRS, null)))) != null) {
                    ...
                    if ((t1.getNext() != null && t1.getNext().isAnd() && t1.getNext().getNext() != null) && t1.getNext().getNext().isValue("ВСЕЯ", null)) {
                        ...
                        com.pullenti.ner.geo.GeoReferent _geo = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(((t1 == null ? null : t1.getReferent())), com.pullenti.ner.geo.GeoReferent.class);
                        if (_geo != null) {
                            res.setEndToken(t1);
            ...
            com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(res.getBeginToken(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);{
                    ...
                    if (tt0 != null) {
                        ...
                        for(com.pullenti.ner.Token tt = tt0.getPrevious(); tt != null && (cou < 200); tt = tt.getPrevious(),cou++) {
                            com.pullenti.ner.person.PersonPropertyReferent pr = (com.pullenti.ner.person.PersonPropertyReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.person.PersonPropertyReferent.class);
                            if (pr != null) {
                                if ((((tt.getMorph().getGender().value()) & (gen.value()))) == (com.pullenti.morph.MorphGender.UNDEFINED.value())) 
                                    continue;
                                break;
                            }
                            com.pullenti.ner.person.PersonReferent p = (com.pullenti.ner.person.PersonReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.person.PersonReferent.class);
                            if (p == null) 
                                continue;
                        ...
                        com.pullenti.ner.person.PersonAnalyzer pa = (com.pullenti.ner.person.PersonAnalyzer)com.pullenti.n2j.Utils.cast(res.kit.processor.findAnalyzer("PERSON"), com.pullenti.ner.person.PersonAnalyzer.class);
                        if (pa != null) {
                            com.pullenti.ner.Token t1 = res.getEndToken().getNext();
                            com.pullenti.ner.ReferentToken pr = com.pullenti.ner.person.PersonAnalyzer.tryAttachPerson(t1, (com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData)com.pullenti.n2j.Utils.cast(res.kit.getAnalyzerData(pa), com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData.class), false, 0, true);
                            if (pr != null && res.canHasPersonAfter == 1) {
                                if (pr.getBeginToken() == t1) {
                                    if (!pr.getMorph().getCase().isGenitive() && !pr.getMorph().getCase().isUndefined()) 
                                        ...
                                        if (com.pullenti.ner.person.PersonAnalyzer.tryAttachPerson(pr.getEndToken().getNext(), (com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData)com.pullenti.n2j.Utils.cast(res.kit.getAnalyzerData(pa), com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData.class), false, 0, true) != null) {
                                        }
                                        else 
                                            pr = null;
                                    }
            ...
            if (tok != null && tok.getEndToken() == res.getEndToken()) {
                ...
                for(com.pullenti.ner.Token tt = tok.getBeginToken().getPrevious(); tt != null; tt = tt.getPrevious()) {
                    ...
                    for(com.pullenti.ner.Referent r : li) {
                        if (((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ORGANIZATION") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "GEO"))) && r.getParentReferent() == null) {
                            if (!refs.contains(r)) {
                            ...
                            if ((((com.pullenti.ner.person.PersonPropertyReferent)com.pullenti.n2j.Utils.cast(r, com.pullenti.ner.person.PersonPropertyReferent.class))).findSlot(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, null, true) != null) 
                                breaks = true;
                        }
    ...
    private static PersonAttrToken _TryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        ...
        if (t.getMorph()._getClass().isPronoun() && (((t.isValue("ЕГО", "ЙОГО") || t.isValue("ЕЕ", "ЇЇ") || t.isValue("HIS", null)) || t.isValue("HER", null)))) {
            ...
            if (res1 != null && res1.getPropRef() != null) {
                ...
                for(com.pullenti.ner.Token tt2 = t.getPrevious(); tt2 != null && (k < 10); tt2 = tt2.getPrevious(),k++) {
                    ...
                    if (r == null) 
                        continue;
                    if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameOrg) || (r instanceof com.pullenti.ner.person.PersonReferent)) {
                        boolean ok = false;
        ...
        if (nta != null) {
            if (nta.getMorph()._getClass().isAdjective() || ((t.getPrevious() != null && t.getPrevious().isComma())) || ((nta.getEndToken().getNext() != null && nta.getEndToken().getNext().isCharOf(",.")))) 
                return _new2193(t, nta.getEndToken(), PersonAttrTerminType.OTHER, ((Long)nta.value).toString(), nta.getMorph());
        }
        if (t.isNewlineBefore()) {
            ...
            if (li != null && li.typ == com.pullenti.ner.mail.internal.MailLine.Types.BESTREGARDS) 
                return _new2195(li.getBeginToken(), li.getEndToken(), PersonAttrTerminType.BESTREGARDS, com.pullenti.ner.MorphCollection._new2194(com.pullenti.morph.MorphCase.NOMINATIVE));
        }
        ...
        if (tt == null) {
            ...
            if (nt != null) {
                if (((nt.value == ((long)1) || nt.value == ((long)2))) && nt.getMorph()._getClass().isAdjective()) {
                    ...
                    if (pat0 != null && pat0.getPropRef() != null) {
                        ...
                        for(com.pullenti.ner.Slot s : pat0.getPropRef().getSlots()) {
                            if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.person.PersonPropertyReferent.ATTR_NAME)) {
                                if ((s.getValue().toString().indexOf("глава") >= 0)) 
                                    return null;
                                pat0.getPropRef().uploadSlot(s, (pat0.getMorph().getGender() == com.pullenti.morph.MorphGender.FEMINIE || t.getMorph().getGender() == com.pullenti.morph.MorphGender.FEMINIE ? ((nt.value == ((long)1) ? "первая" : "вторая")) : ((nt.value == ((long)1) ? "первый" : "второй"))) + " " + s.getValue());
                            }
                        }
                        return pat0;
                    }
            ...
            if (t != null) 
                rr = t.getReferent();
            if (rr != null && (((rr instanceof com.pullenti.ner.geo.GeoReferent) || com.pullenti.n2j.Utils.stringsEq(rr.getTypeName(), "ORGANIZATION")))) {
        ...
        if ((com.pullenti.n2j.Utils.stringsEq(tt.term, "Г") || com.pullenti.n2j.Utils.stringsEq(tt.term, "ГР") || com.pullenti.n2j.Utils.stringsEq(tt.term, "М")) || com.pullenti.n2j.Utils.stringsEq(tt.term, "Д")) {
            if (tt.getNext() != null && tt.getNext().isHiphen() && (tt.getNext().getNext() instanceof com.pullenti.ner.TextToken)) {
                String pref = tt.term;
                String tail = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt.getNext().getNext(), com.pullenti.ner.TextToken.class))).term;
                java.util.ArrayList<com.pullenti.morph.MorphWordForm> vars = null;
                if (com.pullenti.n2j.Utils.stringsEq(pref, "Г")) 
                    vars = getStdForms(tail, "ГОСПОДИН", "ГОСПОЖА");
                else if (com.pullenti.n2j.Utils.stringsEq(pref, "ГР")) 
                    vars = getStdForms(tail, "ГРАЖДАНИН", "ГРАЖДАНКА");
                else if (com.pullenti.n2j.Utils.stringsEq(pref, "М")) 
                    vars = getStdForms(tail, "МИСТЕР", null);
                else if (com.pullenti.n2j.Utils.stringsEq(pref, "Д")) {
                ...
                if (vars != null) {
                    PersonAttrToken res = _new2189(tt, tt.getNext().getNext(), PersonAttrTerminType.PREFIX);
        ...
        if (com.pullenti.n2j.Utils.stringsEq(tt.term, "ГР") || com.pullenti.n2j.Utils.stringsEq(tt.term, "ГРАЖД")) {
            com.pullenti.ner.Token t1 = tt;
            if (tt.getNext() != null && tt.getNext().isChar('.')) 
                t1 = tt.getNext();
            if (t1.getNext() instanceof com.pullenti.ner.NumberToken) 
                return null;
            return _new2197(tt, t1, PersonAttrTerminType.PREFIX, (tt.getMorph().getLanguage().isUa() ? "ГРОМАДЯНИН" : "ГРАЖДАНИН"));
        }
        ...
        for(int step = 0; step < 2; step++) {
            ...
            if (toks == null && t.isValue("ВРИО", null)) {
                toks = new java.util.ArrayList< >();
                toks.add(com.pullenti.ner.core.TerminToken._new597(t, t, m_TerminVrio));
            }
                ...
                if (str.endsWith("MAN") || str.endsWith("PERSON") || str.endsWith("MIST")) {
                    toks = new java.util.ArrayList< >();
                    toks.add(com.pullenti.ner.core.TerminToken._new597(t, t, PersonAttrTermin._new2199(str, t.getMorph().getLanguage(), PersonAttrTerminType.POSITION)));
                }
                else if (com.pullenti.n2j.Utils.stringsEq(str, "MODEL") && (t.getWhitespacesAfterCount() < 2)) {
            ...
            if ((toks == null && step == 0 && t.chars.isLatinLetter()) && (t.getWhitespacesAfterCount() < 2)) {
                ...
                if (npt1 != null && npt1.getBeginToken() != npt1.getEndToken()) {
                    ...
                    if (npt1 != null) {
                        for(com.pullenti.ner.Token tt2 = npt1.getBeginToken(); tt2 != null && tt2.endChar <= npt1.endChar; tt2 = tt2.getNext()) {
                            ...
                            if (toks1 != null) {
                                ...
                                if (!(((PersonAttrTermin)com.pullenti.n2j.Utils.cast(toks.get(0).termin, PersonAttrTermin.class))).isDoubt) {
                    ...
                    if ((mc.isMisc() || mc.isPreposition() || mc.isConjunction()) || mc.isPersonalPronoun() || mc.isPronoun()) {
                        ...
                        if (toks1 != null && (((PersonAttrTermin)com.pullenti.n2j.Utils.cast(toks1.get(0).termin, PersonAttrTermin.class))).typ == PersonAttrTerminType.POSITION && (tt1.getWhitespacesBeforeCount() < 2)) {
                            step = 1;
                            toks = toks1;
                        }
                    }
            ...
            if (toks != null) {
                for(com.pullenti.ner.core.TerminToken tok : toks) {
                    if (((tok.getMorph()._getClass().isPreposition() || tok.getMorph().containsAttr("к.ф.", new com.pullenti.morph.MorphClass(null)))) && tok.getEndToken() == tok.getBeginToken()) 
                        continue;
                    PersonAttrTermin pat = (PersonAttrTermin)com.pullenti.n2j.Utils.cast(tok.termin, PersonAttrTermin.class);
                    if ((tok.getEndToken() instanceof com.pullenti.ner.TextToken) && pat.getCanonicText().startsWith((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tok.getEndToken(), com.pullenti.ner.TextToken.class))).term)) {
                    ...
                    if (pat.typ == PersonAttrTerminType.PREFIX) {
                        if (step == 0 || ((com.pullenti.n2j.Utils.stringsNe(pat.getCanonicText(), "ГРАЖДАНИН") && com.pullenti.n2j.Utils.stringsNe(pat.getCanonicText(), "ГРОМАДЯНИН")))) 
                            return _new2203(tok.getBeginToken(), tok.getEndToken(), PersonAttrTerminType.PREFIX, pat.getCanonicText(), tok.getMorph(), pat.getGender());
                    }
                    if (pat.typ == PersonAttrTerminType.BESTREGARDS) {
                        ...
                        return _new2195(tok.getBeginToken(), end, PersonAttrTerminType.BESTREGARDS, com.pullenti.ner.MorphCollection._new2194(com.pullenti.morph.MorphCase.NOMINATIVE));
                    }
                    if (pat.typ == PersonAttrTerminType.POSITION || pat.typ == PersonAttrTerminType.PREFIX || pat.typ == PersonAttrTerminType.KING) {
                        ...
                        if (res != null) {
                            ...
                            if (npt0 != null) {
                                ...
                                String na0 = npt0.getNormalCaseText(new com.pullenti.morph.MorphClass(null), true, com.pullenti.morph.MorphGender.UNDEFINED, false).toLowerCase();
                                ...
                                if (emptyAdj != null) {
                                    PersonAttrToken res1 = _new2206(res.getBeginToken(), res.getEndToken(), npt0.getMorph(), res);
            ...
            if (ppp != null) {
                if (t.beginChar < ppp.beginChar) {
                    ...
                    if (ppp.getPropRef() != null && ppp.getPropRef().getName() != null) 
                        ppp.getPropRef().setName((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term.toLowerCase() + "-" + ppp.getPropRef().getName());
                }
                return ppp;
            }
            if ((te != null && te.getPrevious().isHiphen() && !te.isWhitespaceAfter()) && !te.isWhitespaceBefore()) {
                if (com.pullenti.ner.core.BracketHelper.isBracket(te, false)) {
                    ...
                    if (br != null && (te instanceof com.pullenti.ner.TextToken)) {
                        ppp = _new2188(t, br.getEndToken(), br.getEndToken().getPrevious().getMorph());
                        ppp.setPropRef(new com.pullenti.ner.person.PersonPropertyReferent());
                        ppp.getPropRef().setName(((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term + "-" + com.pullenti.ner.core.MiscHelper.getTextValue(te.getNext(), br.getEndToken(), com.pullenti.ner.core.GetTextAttr.FIRSTNOUNGROUPTONOMINATIVE)).toLowerCase());
                        return ppp;
                    }
                }
            }
        ...
        if ((t instanceof com.pullenti.ner.TextToken) && t.chars.isLatinLetter()) {
            if (t.isValue("STATE", null)) {
                ...
                if (res1 != null && res1.getPropRef() != null) {
                    res1.setBeginToken(t);
                    res1.getPropRef().setName((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term.toLowerCase() + " " + res1.getPropRef().getName());
                    return res1;
                }
            }
        }
    ...
    private static String[] m_EmptyAdjs = new String[] {"УСПЕШНЫЙ", "ИЗВЕСТНЫЙ", "ЗНАМЕНИТЫЙ", "ИЗВЕСТНЕЙШИЙ", "ПОПУЛЯРНЫЙ", "ГЕНИАЛЬНЫЙ", "ТАЛАНТЛИВЫЙ", "МОЛОДОЙ", "УСПІШНИЙ", "ВІДОМИЙ", "ЗНАМЕНИТИЙ", "ВІДОМИЙ", "ПОПУЛЯРНИЙ", "ГЕНІАЛЬНИЙ", "ТАЛАНОВИТИЙ", "МОЛОДИЙ"};

    private static java.util.HashMap<String, java.util.ArrayList<com.pullenti.morph.MorphWordForm>> m_StdForms = new java.util.HashMap< >();
    ...
    private static java.util.ArrayList<com.pullenti.morph.MorphWordForm> getStdForms(String tail, String w1, String w2) {
        ...
        com.pullenti.n2j.Outargwrapper<java.util.ArrayList<com.pullenti.morph.MorphWordForm>> inoutarg2210 = new com.pullenti.n2j.Outargwrapper< >();
        Boolean inoutres2211 = com.pullenti.n2j.Utils.tryGetValue(m_StdForms, w1, inoutarg2210);
        li1 = inoutarg2210.value;
        if (!inoutres2211) {
            li1 = com.pullenti.morph.Morphology.getAllWordforms(w1, new com.pullenti.morph.MorphLang(null));
        ...
        if (w2 != null) {
            com.pullenti.n2j.Outargwrapper<java.util.ArrayList<com.pullenti.morph.MorphWordForm>> inoutarg2208 = new com.pullenti.n2j.Outargwrapper< >();
            Boolean inoutres2209 = com.pullenti.n2j.Utils.tryGetValue(m_StdForms, w2, inoutarg2208);
            li2 = inoutarg2208.value;
            if (!inoutres2209) {
                li2 = com.pullenti.morph.Morphology.getAllWordforms(w2, new com.pullenti.morph.MorphLang(null));
    ...
    private static PersonAttrToken createAttrPosition(com.pullenti.ner.core.TerminToken tok, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        PersonAttrTerminType2 ty2 = (((PersonAttrTermin)com.pullenti.n2j.Utils.cast(tok.termin, PersonAttrTermin.class))).typ2;
        if (ty2 == PersonAttrTerminType2.ABBR) {
            ...
            return _new2212(tok.getBeginToken(), tok.getEndToken(), pr0, PersonAttrTerminType.POSITION);
        }
        if (ty2 == PersonAttrTerminType2.IO || ty2 == PersonAttrTerminType2.IO2) {
            for(int k = 0; ; k++) {
                ...
                if (tt != null && tt.getMorph()._getClass().isPreposition()) 
                    tt = tt.getNext();
                PersonAttrToken resPat = _new2189(tok.getBeginToken(), tok.getEndToken(), PersonAttrTerminType.POSITION);
                ...
                if (tt != null && (tt.getReferent() instanceof com.pullenti.ner.person.PersonPropertyReferent)) {
                    ...
                    resPat.getPropRef().setHigher((com.pullenti.ner.person.PersonPropertyReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.person.PersonPropertyReferent.class));
                }
                else {
                    ...
                    if (ts.getMorph()._getClass().isPreposition()) {
                        if (ts.isValue("В", null) || ts.isValue("ПО", null)) {
                            if (ts.getNext() instanceof com.pullenti.ner.ReferentToken) {
                                ...
                                if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameGeo) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameOrg)) {
                ...
                com.pullenti.n2j.Outargwrapper<String> inoutarg2214 = new com.pullenti.n2j.Outargwrapper< >(nam);
                resPat.setBeginToken(_analizeVise(resPat.getBeginToken(), inoutarg2214));
                nam = inoutarg2214.value;
        ...
        if (ty2 == PersonAttrTerminType2.GRADE) {
            ...
            if (tok.getBeginToken().isValue("КАНДИДАТ", null)) {
                ...
                if (tt != null) {
                    ...
                    if (pat2 != null) {
                        PersonAttrToken res0 = _new2189(tok.getBeginToken(), pat2.getEndToken(), PersonAttrTerminType.POSITION);
                        res0.setPropRef(com.pullenti.ner.person.PersonPropertyReferent._new2190("кандидат"));
        ...
        com.pullenti.n2j.Outargwrapper<String> inoutarg2226 = new com.pullenti.n2j.Outargwrapper< >(name);
        t0 = _analizeVise(t0, inoutarg2226);
        name = inoutarg2226.value;
        ...
        if ((t1.getNext() != null && t1.getNext().isHiphen() && !t1.isWhitespaceAfter()) && !t1.getNext().isWhitespaceAfter()) {
            if (com.pullenti.morph.CharsInfo.ooEq(t1.getNext().getNext().chars, t1.chars) || m_Termins.tryParse(t1.getNext().getNext(), com.pullenti.ner.core.TerminParseAttr.NO) != null || ((t1.getNext().getNext().chars.isAllLower() && t1.getNext().getNext().chars.isCyrillicLetter()))) {
                ...
                if (npt != null && npt.getEndToken() == t1.getNext().getNext()) {
                    name = npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false).toLowerCase();
                    t1 = npt.getEndToken();
                }
            }
        }
        ...
        for(com.pullenti.ner.Token t = t1.getNext(); t != null; t = t.getNext()) {
            ...
            if (t.isNewlineBefore()) {
                ...
                if (t.getReferent() != null) {
                    if (com.pullenti.n2j.Utils.stringsEq(t.getReferent().getTypeName(), objNameOrg) || (t.getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) {
                        ...
                        if (zap && !and) {
                            ...
                            if (_isPerson(tt1.getNext())) 
                                ...
                                if (_isPerson(tt1.getNext().getNext())) 
                                    ...
                                    String ccc;
                                    com.pullenti.n2j.Outargwrapper<String> inoutarg2217 = new com.pullenti.n2j.Outargwrapper< >();
                                    com.pullenti.ner.Token ttt = tryAttachCategory(tt1.getNext().getNext(), inoutarg2217);
                                    ccc = inoutarg2217.value;
                                    if (ttt != null) 
                                        ok = true;
                                }
                            }
            ...
            if (pat != null) {
                ...
                else if (((tok.termin instanceof PersonAttrTermin) && (((PersonAttrTermin)com.pullenti.n2j.Utils.cast(tok.termin, PersonAttrTermin.class))).isDoubt && pat.getPropRef() != null) && pat.getPropRef().getSlots().size() == 1 && tok.chars.isLatinLetter() == pat.chars.isLatinLetter()) {
                    t1 = (tname1 = (t = pat.getEndToken()));
                    continue;
                }
                else if ((!tok.getMorph().getCase().isGenitive() && (tok.termin instanceof PersonAttrTermin) && (((PersonAttrTermin)com.pullenti.n2j.Utils.cast(tok.termin, PersonAttrTermin.class))).canHasPersonAfter == 1) && pat.getMorph().getCase().isGenitive()) {
            ...
            if ((te.chars.isLatinLetter() && te.getLengthChar() > 1 && !t0.chars.isLatinLetter()) && !te.chars.isAllLower()) {
                if (r == null || com.pullenti.n2j.Utils.stringsNe(r.getTypeName(), objNameOrg)) {
                    com.pullenti.n2j.Outargwrapper<String> inoutarg2218 = new com.pullenti.n2j.Outargwrapper< >();
                    com.pullenti.ner.Token tt = tryAttachCategory(t, inoutarg2218);
                    category = inoutarg2218.value;
            ...
            if (r != null) {
                if ((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameGeo) && te.getPrevious() != null && te.getPrevious().isValue("ДЕЛО", "СПРАВІ")) && te.getPrevious().getPrevious() != null && te.getPrevious().getPrevious().isValue("ПО", null)) {
                    t1 = (tname1 = (t = te));
                    continue;
                }
                if ((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameGeo) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameAddr) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameOrg)) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameTransport)) {
                    ...
                    boolean posol = ((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameGeo) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameOrg))) && com.pullenti.morph.LanguageHelper.endsWithEx(name, "посол", "представитель", null, null);
                    if (posol) {
                        t = t1;
                        continue;
                    }
                    if ((((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameGeo) && t1.getNext() != null && t1.getNext().getMorph()._getClass().isPreposition()) && t1.getNext().getNext() != null && !t1.getNext().isValue("О", null)) && !t1.getNext().isValue("ОБ", null) && (((attrs.value()) & (PersonAttrAttachAttrs.AFTERZAMESTITEL.value()))) == (PersonAttrAttachAttrs.NO.value())) && !(((PersonAttrTermin)com.pullenti.n2j.Utils.cast(tok.termin, PersonAttrTermin.class))).isBoss) {
                        if ((((r1 = t1.getNext().getNext().getReferent()))) != null) {
                            if (com.pullenti.n2j.Utils.stringsEq(r1.getTypeName(), objNameOrg)) {
                                pr.addSlot(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, r1, false, 0);
                                t = (t1 = t1.getNext().getNext());
                            }
                        }
                    }
                    if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameOrg)) {
                        for(t = te.getNext(); t != null; t = t.getNext()) {
                            ...
                            if (r == null) 
                                break;
                            if (com.pullenti.n2j.Utils.stringsNe(r.getTypeName(), objNameOrg)) 
                                break;
                            pr.addSlot(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, r, false, 0);
                            t = t.getNext();
                            t1 = t;
                        ...
                        for(; t != null; t = t.getNext()) {
                            ...
                            if (r == null) 
                                break;
                            if (com.pullenti.n2j.Utils.stringsNe(r.getTypeName(), objNameGeo)) {
                                if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameOrg) && t.getPrevious() != null && ((t.getPrevious().isValue("ОТ", null) || t.getPrevious().isValue("ВІД", null)))) {
                                }
                                else 
                                    break;
                            }
                ...
                t = t1;
                if (((tname0 == t && tname1 == null && t.getNext() != null) && (((attrs.value()) & (PersonAttrAttachAttrs.AFTERZAMESTITEL.value()))) == (PersonAttrAttachAttrs.NO.value()) && com.pullenti.n2j.Utils.stringsNe(name, "президент")) && t.getNext().isValue("ПО", null)) {
                    tname0 = t.getNext();
                    continue;
                }
                break;
            ...
            if (category == null) {
                com.pullenti.n2j.Outargwrapper<String> inoutarg2219 = new com.pullenti.n2j.Outargwrapper< >();
                com.pullenti.ner.Token tt = tryAttachCategory(t, inoutarg2219);
                category = inoutarg2219.value;
                if (tt != null && name != null) {
                    t = (t1 = tt);
                    continue;
                }
            }
            if (com.pullenti.n2j.Utils.stringsEq(name, "премьер")) 
                break;
            if (t instanceof com.pullenti.ner.TextToken) {
            ...
            if (t.chars.isCapitalUpper() || t.chars.isAllUpper()) {
                if (t.kit.miscData.containsKey("TestAttr")) {
                    ...
                    if (pits != null && pits.size() > 1) {
                        ...
                        java.util.ArrayList<PersonIdentityToken> li = PersonIdentityToken.tryAttach(pits, 0, com.pullenti.morph.MorphBaseInfo._new2220(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                        t.kit.miscData.remove("TestAttr");
                        if (li.size() > 0 && li.get(0).coef > 1) {
                            t.kit.miscData.put("TestAttr", null);
                            java.util.ArrayList<PersonIdentityToken> li1 = PersonIdentityToken.tryAttach(pits, iii, com.pullenti.morph.MorphBaseInfo._new2220(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                            t.kit.miscData.remove("TestAttr");
                            if (li1.size() == 0) 
                                break;
                            ...
                            t.kit.miscData.put("TestAttr", null);
                            java.util.ArrayList<PersonIdentityToken> li1 = PersonIdentityToken.tryAttach(pits, 1, com.pullenti.morph.MorphBaseInfo._new2220(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                            t.kit.miscData.remove("TestAttr");
            ...
            if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false)) {
                com.pullenti.ner.core.BracketSequenceToken br = com.pullenti.ner.core.BracketHelper.tryParse(t, com.pullenti.ner.core.BracketParseAttr.NO, 100);
                if ((br != null && t.getNext().getReferent() != null && com.pullenti.n2j.Utils.stringsEq(t.getNext().getReferent().getTypeName(), objNameOrg)) && t.getNext().getNext() == br.getEndToken()) {
            ...
            if (t.getMorph()._getClass().isPreposition()) {
                ...
                if (npt != null && _existsInDoctionary(npt.getEndToken())) {
                    ...
                    if ((t.isValue("ПО", null) && npt.getMorph().getCase().isDative() && !npt.noun.isValue("ИМЯ", "ІМЯ")) && !npt.noun.isValue("ПРОЗВИЩЕ", "ПРІЗВИСЬКО") && !npt.noun.isValue("ПРОЗВАНИЕ", "ПРОЗВАННЯ")) {
                        ...
                        ok = true;
                    else if (com.pullenti.n2j.Utils.stringsEq(name, "кандидат") && t.isValue("В", null)) 
                        ok = true;
                    if (ok) {
                        t = (t1 = (tname1 = npt.getEndToken()));
                        npt0 = npt;
            ...
            else if (t.isChar(',') && !t.isNewlineAfter() && npt0 != null) {
                npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt != null && !((com.pullenti.morph.MorphClass.ooBitand(npt.getMorph()._getClass(), npt0.getMorph()._getClass()))).isUndefined()) {
            ...
            if (t.chars.isAllUpper() && t.getLengthChar() > 1 && !t0.chars.isAllUpper()) {
                t1 = (tname1 = t);
                continue;
            }
            ...
            if (t instanceof com.pullenti.ner.NumberToken) {
                if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getBeginToken().isValue("МИЛЛИОНОВ", null) || (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getBeginToken().isValue("МІЛЬЙОНІВ", null)) {
                    t1 = (tname1 = t);
                    break;
                }
            }
            if (testPerson) {
                ...
                if ((((r = te.getReferent()))) != null) {
                    if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameGeo) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameOrg) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), objNameTransport)) {
                        t1 = (tname1 = t);
                        continue;
                    }
                }
                ...
                if (tname1 == tname0 || ((tname0.isValue("ЭТОТ", "ЦЕЙ") && tname0.getNext() == tname1))) {
                    ...
                    for(com.pullenti.ner.Token tt0 = t0.getPrevious(); tt0 != null; tt0 = tt0.getPrevious()) {
                        ...
                        for(com.pullenti.ner.Referent r0 : rs0) {
                            if (com.pullenti.n2j.Utils.stringsEq(r0.getTypeName(), objNameOrg)) {
                                hasOrg = true;
                    ...
                    if (_org != null) {
                        pr.addSlot(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, _org, false, 0);
                        tname1 = null;
                    }
                }
            }
        ...
        if (category != null) 
            ...
            com.pullenti.n2j.Outargwrapper<String> inoutarg2223 = new com.pullenti.n2j.Outargwrapper< >();
            com.pullenti.ner.Token tt = tryAttachCategory(t1.getNext(), inoutarg2223);
            category = inoutarg2223.value;
            if (tt != null) {
                name = name + " " + category;
                t1 = tt;
            }
        ...
        pr.setName(name);
        PersonAttrToken res = _new2224(t0, t1, PersonAttrTerminType.POSITION, pr, tok.getMorph());
        res.setBeIndependentProperty((((PersonAttrTermin)com.pullenti.n2j.Utils.cast(tok.termin, PersonAttrTermin.class))).canBeUniqueIdentifier);
        int i = name.indexOf("заместитель ");
        if (i < 0) 
            i = name.indexOf("заступник ");
        if (i >= 0) {
            i += 11;
            PersonAttrToken res1 = _new2195(t0, t1, PersonAttrTerminType.POSITION, tok.getMorph());
            res1.setPropRef(new com.pullenti.ner.person.PersonPropertyReferent());
    ...
    private static com.pullenti.ner.Token _analizeVise(com.pullenti.ner.Token t0, com.pullenti.n2j.Outargwrapper<String> name) {
        if (t0 == null) 
            return null;
        if (t0.getPrevious() != null && t0.getPrevious().isHiphen() && (t0.getPrevious().getPrevious() instanceof com.pullenti.ner.TextToken)) {
            ...
            if (t0.getPrevious() != null && t0.getPrevious().getPrevious() != null) {
                if (t0.getPrevious().getPrevious().isValue("ЭКС", "ЕКС")) {
                    ...
                    if (npt00 != null) {
                        name.value = npt00.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false).toLowerCase();
                        t0 = t0.getPrevious().getPrevious();
                    }
                }
            }
    ...
    private static com.pullenti.ner.Token tryAttachCategory(com.pullenti.ner.Token t, com.pullenti.n2j.Outargwrapper<String> cat) {
        cat.value = null;
    ...
    private static PersonAttrToken createAttrGrade(com.pullenti.ner.core.TerminToken tok) {
        ...
        return _new2227(tok.getBeginToken(), t1, PersonAttrTerminType.POSITION, pr, tok.getMorph(), false);
    }
    ...
    public static com.pullenti.ner.person.PersonPropertyKind checkKind(com.pullenti.ner.person.PersonPropertyReferent pr) {
        ...
        if (n == null) 
            return com.pullenti.ner.person.PersonPropertyKind.UNDEFINED;
        n = n.toUpperCase();
        for(String nn : com.pullenti.n2j.Utils.split(n, String.valueOf(' ') + String.valueOf('-'), false)) {
            ...
            if (li != null && li.size() > 0) {
                PersonAttrTermin pat = (PersonAttrTermin)com.pullenti.n2j.Utils.cast(li.get(0), PersonAttrTermin.class);
                if (pat.isBoss) 
                    return com.pullenti.ner.person.PersonPropertyKind.BOSS;
                if (pat.isKin) 
                    return com.pullenti.ner.person.PersonPropertyKind.KIN;
                if (pat.typ == PersonAttrTerminType.KING) {
                    if (com.pullenti.n2j.Utils.stringsNe(n, "ДОН")) 
                        return com.pullenti.ner.person.PersonPropertyKind.KING;
                }
                if (pat.isMilitaryRank) {
                    if (com.pullenti.n2j.Utils.stringsEq(nn, "КАПИТАН") || com.pullenti.n2j.Utils.stringsEq(nn, "CAPTAIN") || com.pullenti.n2j.Utils.stringsEq(nn, "КАПІТАН")) {
                        com.pullenti.ner.Referent _org = (com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(pr.getValue(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF), com.pullenti.ner.Referent.class);
                        if (_org != null && com.pullenti.n2j.Utils.stringsEq(_org.getTypeName(), "ORGANIZATION")) 
                            continue;
                    }
    ...
    public static com.pullenti.ner.core.TerminToken tryAttachWord(com.pullenti.ner.Token t) {
        ...
        if (tok != null && com.pullenti.n2j.Utils.stringsEq(tok.termin.getCanonicText(), "ГРАФ")) {
    ...
    public static void initialize() throws Exception, java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException {
        ...
        m_Termins.add(PersonAttrTermin._new2228("ТОВАРИЩ", PersonAttrTerminType.PREFIX));
        m_Termins.add(PersonAttrTermin._new2199("ТОВАРИШ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX));
        for(String s : new String[] {"ГОСПОДИН", "ГРАЖДАНИН", "УРОЖЕНЕЦ", "МИСТЕР", "СЭР", "СЕНЬОР", "МОНСЕНЬОР", "СИНЬОР", "МЕСЬЕ", "МСЬЕ", "ДОН", "МАЭСТРО", "МЭТР"}) {
            t = PersonAttrTermin._new2230(s, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
            if (com.pullenti.n2j.Utils.stringsEq(s, "ГРАЖДАНИН")) {
                t.addAbridge("ГР.");
                t.addAbridge("ГРАЖД.");
                t.addAbridge("ГР-Н");
            }
        ...
        for(String s : new String[] {"ПАН", "ГРОМАДЯНИН", "УРОДЖЕНЕЦЬ", "МІСТЕР", "СЕР", "СЕНЬЙОР", "МОНСЕНЬЙОР", "МЕСЬЄ", "МЕТР", "МАЕСТРО"}) {
            t = PersonAttrTermin._new2231(s, com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
            if (com.pullenti.n2j.Utils.stringsEq(s, "ГРОМАДЯНИН")) {
                t.addAbridge("ГР.");
                t.addAbridge("ГР-Н");
            }
            m_Termins.add(t);
        ...
        for(String s : new String[] {"ГОСПОЖА", "ПАНИ", "ГРАЖДАНКА", "УРОЖЕНКА", "СЕНЬОРА", "СЕНЬОРИТА", "СИНЬОРА", "СИНЬОРИТА", "МИСС", "МИССИС", "МАДАМ", "МАДЕМУАЗЕЛЬ", "ФРАУ", "ФРОЙЛЯЙН", "ЛЕДИ", "ДОННА"}) {
            t = PersonAttrTermin._new2230(s, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
            if (com.pullenti.n2j.Utils.stringsEq(s, "ГРАЖДАНКА")) {
                t.addAbridge("ГР.");
                t.addAbridge("ГРАЖД.");
                t.addAbridge("ГР-КА");
            }
        ...
        for(String s : new String[] {"ПАНІ", "ГРОМАДЯНКА", "УРОДЖЕНКА", "СЕНЬЙОРА", "СЕНЬЙОРА", "МІС", "МІСІС", "МАДАМ", "МАДЕМУАЗЕЛЬ", "ФРАУ", "ФРОЙЛЯЙН", "ЛЕДІ"}) {
            t = PersonAttrTermin._new2231(s, com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
            if (com.pullenti.n2j.Utils.stringsEq(s, "ГРОМАДЯНКА")) {
                t.addAbridge("ГР.");
                t.addAbridge("ГР-КА");
            }
            m_Termins.add(t);
        }
        t = PersonAttrTermin._new2231("MISTER", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("MR");
        t.addAbridge("MR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2231("MISSIS", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("MRS");
        t.addAbridge("MSR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2231("MISS", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("MS");
        t.addAbridge("MS.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2228("БЕЗРАБОТНЫЙ", PersonAttrTerminType.POSITION);
        ...
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("БЕЗРОБІТНИЙ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        ...
        m_Termins.add(t);
        t = PersonAttrTermin._new2239("ЗАМЕСТИТЕЛЬ", "заместитель", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        t.addVariant("ЗАМЕСТИТЕЛЬНИЦА", false);
        t.addAbridge("ЗАМ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2240("ЗАСТУПНИК", com.pullenti.morph.MorphLang.UA, "заступник", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        t.addVariant("ЗАСТУПНИЦЯ", false);
        t.addAbridge("ЗАМ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2239("УПОЛНОМОЧЕННЫЙ", "уполномоченный", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2240("УПОВНОВАЖЕНИЙ", com.pullenti.morph.MorphLang.UA, "уповноважений", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2239("ЭКС-УПОЛНОМОЧЕННЫЙ", "экс-уполномоченный", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2240("ЕКС-УПОВНОВАЖЕНИЙ", com.pullenti.morph.MorphLang.UA, "екс-уповноважений", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2245("ИСПОЛНЯЮЩИЙ ОБЯЗАННОСТИ", PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("И.О.");
        t.setCanonicText((t.acronym = "ИО"));
        m_Termins.add(t);
        t = PersonAttrTermin._new2246("ВИКОНУЮЧИЙ ОБОВЯЗКИ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("В.О.");
        t.setCanonicText((t.acronym = "ВО"));
        m_Termins.add(t);
        t = PersonAttrTermin._new2245("ВРЕМЕННО ИСПОЛНЯЮЩИЙ ОБЯЗАННОСТИ", PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("ВР.И.О.");
        t.setCanonicText((t.acronym = "ВРИО"));
        m_TerminVrio = t;
        m_Termins.add(t);
        t = PersonAttrTermin._new2228("ЗАВЕДУЮЩИЙ", PersonAttrTerminType.POSITION);
        t.addAbridge("ЗАВЕД.");
        t.addAbridge("ЗАВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("ЗАВІДУВАЧ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ЗАВІД.");
        t.addAbridge("ЗАВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2228("СОТРУДНИК", PersonAttrTerminType.POSITION);
        t.addAbridge("СОТРУДН.");
        t.addAbridge("СОТР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("СПІВРОБІТНИК", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("СПІВРОБ.");
        t.addAbridge("СПІВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2228("АКАДЕМИК", PersonAttrTerminType.POSITION);
        t.addAbridge("АКАД.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("АКАДЕМІК", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("АКАД.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2228("ЧЛЕН-КОРРЕСПОНДЕНТ", PersonAttrTerminType.POSITION);
        t.addAbridge("ЧЛ.-КОРР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("ЧЛЕН-КОРЕСПОНДЕНТ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ЧЛ.-КОР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2228("ДОЦЕНТ", PersonAttrTerminType.POSITION);
        t.addAbridge("ДОЦ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2228("ПРОФЕССОР", PersonAttrTerminType.POSITION);
        t.addAbridge("ПРОФ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("ПРОФЕСОР", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ПРОФ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("PROFESSOR", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.POSITION);
        t.addAbridge("PROF.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2245("КАНДИДАТ", PersonAttrTerminType2.GRADE, PersonAttrTerminType.POSITION);
        t.addAbridge("КАНД.");
        t.addAbridge("КАН.");
        t.addAbridge("К-Т");
        t.addAbridge("К.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2245("ДОКТОР", PersonAttrTerminType2.GRADE, PersonAttrTerminType.POSITION);
        t.addAbridge("ДОКТ.");
        t.addAbridge("ДОК.");
        t.addAbridge("Д-Р");
        t.addAbridge("Д.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("DOCTOR", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX);
        t.addAbridge("DR");
        t.addAbridge("DR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2228("ДОКТОРАНТ", PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2199("ДОКТОРАНТ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        for(String s : new String[] {"КФН", "КТН", "КХН"}) {
            t = PersonAttrTermin._new2265(s, "кандидат наук", PersonAttrTerminType.POSITION, PersonAttrTerminType2.ABBR);
            m_Termins.add(t);
        }
        for(String s : new String[] {"ГЛАВНЫЙ", "МЛАДШИЙ", "СТАРШИЙ", "ВЕДУЩИЙ", "НАУЧНЫЙ"}) {
            t = PersonAttrTermin._new2245(s, PersonAttrTerminType2.ADJ, PersonAttrTerminType.POSITION);
            t.addAllAbridges(0, 0, 2);
            m_Termins.add(t);
        }
        for(String s : new String[] {"ГОЛОВНИЙ", "МОЛОДШИЙ", "СТАРШИЙ", "ПРОВІДНИЙ", "НАУКОВИЙ"}) {
            t = PersonAttrTermin._new2267(s, PersonAttrTerminType2.ADJ, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            t.addAllAbridges(0, 0, 2);
            m_Termins.add(t);
        }
        for(String s : new String[] {"НЫНЕШНИЙ", "НОВЫЙ", "CURRENT", "NEW"}) {
            t = PersonAttrTermin._new2245(s, PersonAttrTerminType2.IGNOREDADJ, PersonAttrTerminType.POSITION);
            m_Termins.add(t);
        }
        for(String s : new String[] {"НИНІШНІЙ", "НОВИЙ"}) {
            t = PersonAttrTermin._new2267(s, PersonAttrTerminType2.IGNOREDADJ, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            m_Termins.add(t);
        }
        for(String s : new String[] {"ТОГДАШНИЙ", "БЫВШИЙ", "ПРЕДЫДУЩИЙ", "FORMER", "PREVIOUS", "THEN"}) {
            t = PersonAttrTermin._new2245(s, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
            m_Termins.add(t);
        }
        for(String s : new String[] {"ТОДІШНІЙ", "КОЛИШНІЙ"}) {
            t = PersonAttrTermin._new2267(s, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            m_Termins.add(t);
        }
    ...
    private static byte[] deflate(byte[] zip) throws java.io.IOException {
        try (com.pullenti.n2j.MemoryStream unzip = new com.pullenti.n2j.MemoryStream()) {
            com.pullenti.n2j.MemoryStream _data = new com.pullenti.n2j.MemoryStream(zip);
            _data.setPosition((long)0);
    ...
    private static void loadAttrs(com.pullenti.ner.core.TerminCollection termins, byte[] dat, com.pullenti.morph.MorphLang lang) throws java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException {
        ...
        try (com.pullenti.n2j.MemoryStream tmp = new com.pullenti.n2j.MemoryStream(deflate(dat))) {
            ...
            for(org.w3c.dom.Node x : (new com.pullenti.n2j.XmlNodeListWrapper(xml.doc.getDocumentElement().getChildNodes())).arr) {
                org.w3c.dom.Node a = com.pullenti.n2j.Utils.getXmlAttrByName(x, "v");
                if (a == null) 
                    continue;
                String val = a.getNodeValue();
                if (val == null) 
                    continue;
                String attrs = (com.pullenti.n2j.Utils.getXmlAttrByName(x, "a") == null ? "" : ((String)com.pullenti.n2j.Utils.notnull(com.pullenti.n2j.Utils.getXmlAttrByName(x, "a").getTextContent(), "")));
                if (com.pullenti.n2j.Utils.stringsEq(val, "ОТЕЦ")) {
                }
                PersonAttrTermin pat = PersonAttrTermin._new2272(val, PersonAttrTerminType.POSITION, lang);
                ...
                if (com.pullenti.n2j.Utils.getXmlAttrByName(x, "alt") != null) {
                    pat.addVariant((val = com.pullenti.n2j.Utils.getXmlAttrByName(x, "alt").getTextContent()), false);
                    if (val.indexOf('.') > 0) 
                        pat.addAbridge(val);
                }
                if (x.getChildNodes().getLength() > 0) {
                    for(org.w3c.dom.Node xx : (new com.pullenti.n2j.XmlNodeListWrapper(x.getChildNodes())).arr) {
                        if (com.pullenti.n2j.Utils.stringsEq(xx.getNodeName(), "alt")) {
    ...
    public static PersonAttrToken _new2188(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.setMorph(_arg3);
        return res;
    }
    public static PersonAttrToken _new2189(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }
    public static PersonAttrToken _new2193(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.age = _arg4;
        res.setMorph(_arg5);
    ...
    public static PersonAttrToken _new2195(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.MorphCollection _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        return res;
    }
    public static PersonAttrToken _new2197(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    }
    public static PersonAttrToken _new2203(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5, com.pullenti.morph.MorphGender _arg6) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static PersonAttrToken _new2206(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, PersonAttrToken _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.setMorph(_arg3);
        res.higherPropRef = _arg4;
        return res;
    }
    public static PersonAttrToken _new2212(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.person.PersonPropertyReferent _arg3, PersonAttrTerminType _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.setPropRef(_arg3);
        res.typ = _arg4;
        return res;
    }
    public static PersonAttrToken _new2224(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.person.PersonPropertyReferent _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
    ...
    public static PersonAttrToken _new2227(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.person.PersonPropertyReferent _arg4, com.pullenti.ner.MorphCollection _arg5, boolean _arg6) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setPropRef(_arg4);
        res.setMorph(_arg5);
