...
public class MiscHelper {
    ...
    public static boolean isNotMoreThanOneError(String value, com.pullenti.ner.Token t) {
        ...
        if (t instanceof com.pullenti.ner.TextToken) {
            ...
            if (t.isValue(value, null)) 
                return true;
            if (isNotMoreThanOneError(value, tt.term, true)) 
                return true;
            for(com.pullenti.morph.MorphBaseInfo wf : tt.getMorph().getItems()) {
                if (wf instanceof com.pullenti.morph.MorphWordForm) {
                    if (isNotMoreThanOneError(value, (((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(wf, com.pullenti.morph.MorphWordForm.class))).normalCase, true)) 
                        return true;
                }
            }
        }
        else if ((t instanceof com.pullenti.ner.MetaToken) && (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken() == (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getEndToken()) 
            return isNotMoreThanOneError(value, (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken());
        else if (isNotMoreThanOneError(value, t.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false), true)) 
            return true;
        return false;
    }

    private static boolean isNotMoreThanOneError(String pattern, String test, boolean tmp) {
    ...
    public static com.pullenti.ner.Token tryAttachWordByLetters(String word, com.pullenti.ner.Token t, boolean useMorphVariants) {
        ...
        int i = 0;
        int j;
        for(; t1 != null; t1 = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t1.getNext(), com.pullenti.ner.TextToken.class)) {
            String s = t1.term;
            ...
            if (j < s.length()) {
                ...
                for(com.pullenti.ner.Token tt = t1; tt != null; tt = tt.getNext()) {
                    if (!((tt instanceof com.pullenti.ner.TextToken)) || !tt.chars.isLetter() || tt.isNewlineBefore()) 
                        break;
                    t1 = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class);
                    tmp.append(t1.term);
                }
                    ...
                    for(com.pullenti.morph.MorphToken l : li) {
                        if (l.wordForms != null) {
                            for(com.pullenti.morph.MorphWordForm wf : l.wordForms) {
                                if (com.pullenti.n2j.Utils.stringsEq(wf.normalCase, word) || com.pullenti.n2j.Utils.stringsEq(wf.normalFull, word)) 
                                    return t1;
                            }
                        }
                    }
    ...
    public static boolean canBeEquals(String s1, String s2, boolean ignoreNonletters, boolean ignoreCase, boolean checkMorphEquAfterFirstNoun) {
        if (com.pullenti.n2j.Utils.isNullOrEmpty(s1) || com.pullenti.n2j.Utils.isNullOrEmpty(s2)) 
            return false;
        if (com.pullenti.n2j.Utils.stringsEq(s1, s2)) 
            return true;
        AnalysisKit ak1 = new AnalysisKit(new com.pullenti.ner.SourceOfAnalysis(s1), false, new com.pullenti.morph.MorphLang(null), null);
        AnalysisKit ak2 = new AnalysisKit(new com.pullenti.ner.SourceOfAnalysis(s2), false, new com.pullenti.morph.MorphLang(null), null);
        ...
        while(t1 != null || t2 != null) {
            if (t1 != null) {
                if (t1 instanceof com.pullenti.ner.TextToken) {
                    if (!t1.chars.isLetter()) {
                        if (t1.isHiphen()) 
                            wasNoun = false;
                        if (((!t1.isCharOf("()") && !t1.isHiphen())) || ignoreNonletters) {
                            t1 = t1.getNext();
                            continue;
                        }
                    }
            ...
            if (t2 != null) {
                if (t2 instanceof com.pullenti.ner.TextToken) {
                    if (!t2.chars.isLetter()) {
                        if (t2.isHiphen()) 
                            wasNoun = false;
                        if (((!t2.isCharOf("()") && !t2.isHiphen())) || ignoreNonletters) {
                            t2 = t2.getNext();
                            continue;
                        }
                    }
            ...
            if (t1 instanceof com.pullenti.ner.NumberToken) {
                if (!((t2 instanceof com.pullenti.ner.NumberToken))) 
                    break;
                if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t1, com.pullenti.ner.NumberToken.class))).value != (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t2, com.pullenti.ner.NumberToken.class))).value) 
                    break;
                t1 = t1.getNext();
                t2 = t2.getNext();
                continue;
            ...
            if (!((t1 instanceof com.pullenti.ner.TextToken)) || !((t2 instanceof com.pullenti.ner.TextToken))) 
                break;
            if (!ignoreCase) {
                if (com.pullenti.morph.CharsInfo.ooNoteq(t1.chars, t2.chars)) 
                    return false;
            }
            boolean ok = false;
            if (wasNoun && checkMorphEquAfterFirstNoun) {
                if (com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t1, com.pullenti.ner.TextToken.class))).term, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t2, com.pullenti.ner.TextToken.class))).term)) 
                    ok = true;
            }
            else {
                com.pullenti.ner.TextToken tt = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t1, com.pullenti.ner.TextToken.class);
    ...
    public static boolean canBeStartOfSentence(com.pullenti.ner.Token t) {
        ...
        if (t.getPrevious().isChar('.')) {
            ...
            if ((t.getPrevious().getPrevious() instanceof com.pullenti.ner.NumberToken) && t.getPrevious().isWhitespaceBefore()) {
                if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t.getPrevious().getPrevious(), com.pullenti.ner.NumberToken.class))).typ != com.pullenti.ner.NumberSpellingType.WORDS) 
                    return false;
            }
            return true;
        }
    ...
    public static com.pullenti.ner.Token checkNumberPrefix(com.pullenti.ner.Token t) {
        ...
        if ((((t.isValue("РЕГИСТРАЦИОННЫЙ", "РЕЄСТРАЦІЙНИЙ") || t.isValue("ГОСУДАРСТВЕННЫЙ", "ДЕРЖАВНИЙ") || t.isValue("ТРАНЗИТНЫЙ", "ТРАНЗИТНИЙ")) || t.isValue("ДЕЛО", null) || t.isValue("СПРАВА", null))) && (t.getNext() instanceof com.pullenti.ner.TextToken)) {
            t = t.getNext();
            s = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term;
        }
        else if (com.pullenti.n2j.Utils.stringsEq(s, "РЕГ") || com.pullenti.n2j.Utils.stringsEq(s, "ГОС") || com.pullenti.n2j.Utils.stringsEq(s, "ТРАНЗ")) {
            if (t.getNext() != null && t.getNext().isChar('.')) 
                t = t.getNext();
        ...
        if ((com.pullenti.n2j.Utils.stringsEq(s, "НОМЕР") || com.pullenti.n2j.Utils.stringsEq(s, "№") || com.pullenti.n2j.Utils.stringsEq(s, "N")) || com.pullenti.n2j.Utils.stringsEq(s, "NO") || com.pullenti.n2j.Utils.stringsEq(s, "NN")) {
            t1 = t.getNext();
        ...
        else if (com.pullenti.n2j.Utils.stringsEq(s, "НОМ")) {
            t1 = t.getNext();
            if (t1 != null && t1.isChar('.')) 
                t1 = t1.getNext();
        }
    ...
    public static String convertFirstCharUpperAndOtherLower(String str) {
        ...
        int i;
        boolean up = true;
        com.pullenti.n2j.Utils.replace(fStrTmp, " .", ".");
        ...
        for(i = 0; i < name.length(); i++) {
            if (Character.isDigit(name.charAt(i))) 
                ...
                if ((j - i) > 2) {
                    ...
                    if (com.pullenti.n2j.Utils.stringsNe(w, "ПРИ")) 
    ...
    private static java.util.ArrayList<String> _ConvertWord(String str, boolean latinToRus) {
        ...
        java.util.ArrayList<java.util.ArrayList<String>> vars = new java.util.ArrayList< >();
        int i;
        int j;
        for(i = 0; i < str.length(); i++) {
            java.util.ArrayList<String> v = new java.util.ArrayList< >();
            if (latinToRus) 
                j = com.pullenti.ner.internal.RusLatAccord.findAccordsLatToRus(str, i, v);
            else 
                j = com.pullenti.ner.internal.RusLatAccord.findAccordsRusToLat(str, i, v);
            if (j < 1) {
                j = 1;
        ...
        StringBuilder fStrTmp = new StringBuilder();
        java.util.ArrayList<Integer> inds = new java.util.ArrayList< >(vars.size());
        ...
        while(true) {
            ...
            for(i = inds.size() - 1; i >= 0; i--) {
                com.pullenti.n2j.Utils.putArrayValue(inds, i, inds.get(i) + 1);
                if (inds.get(i) < vars.get(i).size()) 
                    break;
                com.pullenti.n2j.Utils.putArrayValue(inds, i, 0);
            }
            if (i < 0) 
                break;
        }
    ...
    public static boolean testAcronym(com.pullenti.ner.Token acr, com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        ...
        if (begin == null || end == null || begin.endChar >= end.beginChar) 
            return false;
        String str = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(acr, com.pullenti.ner.TextToken.class))).term;
        int i = 0;
    ...
    public static class CyrLatWord {
        ...
        public String toString() {
            if (cyrWord != null && latWord != null) 
                ...
                return (String)com.pullenti.n2j.Utils.notnull(latWord, "?");
        }
    ...
    public static CyrLatWord getCyrLatWord(com.pullenti.ner.Token t, int maxLen) {
        ...
        if (tt == null) {
            ...
            if ((rt != null && (rt.getLengthChar() < 3) && rt.getBeginToken() == rt.getEndToken()) && (rt.getBeginToken() instanceof com.pullenti.ner.TextToken)) 
                tt = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(rt.getBeginToken(), com.pullenti.ner.TextToken.class);
            else 
                return null;
        }
    ...
    public static boolean canBeEqualCyrAndLatTS(com.pullenti.ner.Token t, String str) {
        if (t == null || com.pullenti.n2j.Utils.isNullOrEmpty(str)) 
            return false;
        com.pullenti.ner.TextToken tt = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class);
        if (tt == null) 
            return false;
        if (canBeEqualCyrAndLatSS(tt.term, str)) 
            return true;
        for(com.pullenti.morph.MorphBaseInfo wf : tt.getMorph().getItems()) {
            if ((wf instanceof com.pullenti.morph.MorphWordForm) && canBeEqualCyrAndLatSS((((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(wf, com.pullenti.morph.MorphWordForm.class))).normalCase, str)) 
                return true;
        }
        return false;
    }
    ...
    public static boolean canBeEqualCyrAndLatTT(com.pullenti.ner.Token t1, com.pullenti.ner.Token t2) {
        com.pullenti.ner.TextToken tt1 = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t1, com.pullenti.ner.TextToken.class);
        com.pullenti.ner.TextToken tt2 = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t2, com.pullenti.ner.TextToken.class);
        if (tt1 == null || tt2 == null) 
            return false;
        if (canBeEqualCyrAndLatTS(t2, tt1.term)) 
            return true;
        for(com.pullenti.morph.MorphBaseInfo wf : tt1.getMorph().getItems()) {
            if ((wf instanceof com.pullenti.morph.MorphWordForm) && canBeEqualCyrAndLatTS(t2, (((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(wf, com.pullenti.morph.MorphWordForm.class))).normalCase)) 
                return true;
        }
        return false;
    }
    ...
    public static boolean canBeEqualCyrAndLatSS(String str1, String str2) {
        if (com.pullenti.n2j.Utils.isNullOrEmpty(str1) || com.pullenti.n2j.Utils.isNullOrEmpty(str2)) 
            return false;
        if (com.pullenti.morph.LanguageHelper.isCyrillicChar(str1.charAt(0)) && com.pullenti.morph.LanguageHelper.isLatinChar(str2.charAt(0))) 
            return com.pullenti.ner.internal.RusLatAccord.canBeEquals(str1, str2);
        if (com.pullenti.morph.LanguageHelper.isCyrillicChar(str2.charAt(0)) && com.pullenti.morph.LanguageHelper.isLatinChar(str1.charAt(0))) 
            return com.pullenti.ner.internal.RusLatAccord.canBeEquals(str2, str1);
        return false;
    }
    ...
    private static String _getTextValue_(com.pullenti.ner.Token begin, com.pullenti.ner.Token end, GetTextAttr attrs, com.pullenti.ner.Referent r) {
        ...
        if ((begin instanceof com.pullenti.ner.MetaToken) && !((begin instanceof com.pullenti.ner.NumberToken))) {
            String str = _getTextValue_((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(begin, com.pullenti.ner.MetaToken.class))).getBeginToken(), (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(begin, com.pullenti.ner.MetaToken.class))).getEndToken(), attrs, begin.getReferent());
            if (str != null) {
                if (end == begin) 
                    return str;
                if ((end instanceof com.pullenti.ner.MetaToken) && !((end instanceof com.pullenti.ner.NumberToken)) && begin.getNext() == end) {
                    if ((((attrs.value()) & (GetTextAttr.FIRSTNOUNGROUPTONOMINATIVE.value()))) == (GetTextAttr.FIRSTNOUNGROUPTONOMINATIVE.value()) || (((attrs.value()) & (GetTextAttr.FIRSTNOUNGROUPTONOMINATIVESINGLE.value()))) == (GetTextAttr.FIRSTNOUNGROUPTONOMINATIVESINGLE.value())) {
                        ...
                        String str0 = _getTextValue_((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(begin, com.pullenti.ner.MetaToken.class))).getBeginToken(), (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(begin, com.pullenti.ner.MetaToken.class))).getEndToken(), attrs1, begin.getReferent());
                        String str1 = _getTextValue_((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(end, com.pullenti.ner.MetaToken.class))).getBeginToken(), (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(end, com.pullenti.ner.MetaToken.class))).getEndToken(), attrs1, begin.getReferent());
                        com.pullenti.ner.AnalysisResult ar0 = com.pullenti.ner.ProcessorService.getEmptyProcessor().process(new com.pullenti.ner.SourceOfAnalysis(str0 + " " + str1), null, new com.pullenti.morph.MorphLang(null));
        ...
        if ((((attrs.value()) & (((GetTextAttr.FIRSTNOUNGROUPTONOMINATIVE.value()) | (GetTextAttr.FIRSTNOUNGROUPTONOMINATIVESINGLE.value()))))) != (GetTextAttr.NO.value())) {
            ...
            if (npt != null && npt.endChar <= end.endChar) {
                String str = npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), (((attrs.value()) & (GetTextAttr.FIRSTNOUNGROUPTONOMINATIVESINGLE.value()))) != (GetTextAttr.NO.value()), npt.getMorph().getGender(), keepChars);
                if (str != null) {
                            ...
                            if (it.getGender() == npt.getMorph().getGender() || (((it.getGender().value()) & (npt.getMorph().getGender().value()))) != (com.pullenti.morph.MorphGender.UNDEFINED.value())) {
                                if (!((com.pullenti.morph.MorphCase.ooBitand(it.getCase(), npt.getMorph().getCase()))).isUndefined()) {
                                    if (it.getNumber() == npt.getMorph().getNumber() || (((it.getNumber().value()) & (npt.getMorph().getNumber().value()))) != (com.pullenti.morph.MorphNumber.UNDEFINED.value())) {
                                        String var = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(te.getNext(), com.pullenti.ner.TextToken.class))).term;
                                        if (it instanceof com.pullenti.morph.MorphWordForm) 
                                            var = (((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(it, com.pullenti.morph.MorphWordForm.class))).normalCase;
                                        com.pullenti.morph.MorphBaseInfo bi = com.pullenti.morph.MorphBaseInfo._new486(com.pullenti.morph.MorphClass.ADJECTIVE, npt.getMorph().getGender(), npt.getMorph().getNumber(), npt.getMorph().getLanguage());
                                        var = com.pullenti.morph.Morphology.getWordform(var, bi);
                                        if (var != null) {
                                            var = corrChars(var, te.getNext().chars, keepChars, (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(te.getNext(), com.pullenti.ner.TextToken.class));
        ...
        for(com.pullenti.ner.Token t = begin; t != null && t.endChar <= end.endChar; t = t.getNext()) {
            ...
            if ((((attrs.value()) & (GetTextAttr.IGNOREGEOREFERENT.value()))) != (GetTextAttr.NO.value())) {
                if ((t instanceof com.pullenti.ner.ReferentToken) && t.getReferent() != null) {
                    if (com.pullenti.n2j.Utils.stringsEq(t.getReferent().getTypeName(), "GEO")) 
                        continue;
                }
            }
            if (t instanceof com.pullenti.ner.NumberToken) {
                if ((((attrs.value()) & (GetTextAttr.NORMALIZENUMBERS.value()))) != (GetTextAttr.NO.value())) {
                    if (Character.isDigit(res.charAt(res.length() - 1))) 
                        res.append(' ');
                    res.append((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value);
                    continue;
                }
            }
            if (t instanceof com.pullenti.ner.MetaToken) {
                String str = _getTextValue_((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken(), (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getEndToken(), attrs, t.getReferent());
                if (!com.pullenti.n2j.Utils.isNullOrEmpty(str)) {
            ...
            if (t.isHiphen()) {
                ...
                res.append((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
        }
        for(int i = res.length() - 1; i >= 0; i--) {
            if (res.charAt(i) == '*' || com.pullenti.n2j.Utils.isWhitespace(res.charAt(i))) 
                res.setLength(res.length() - 1);
    ...
    public static boolean isEngAdjSuffix(com.pullenti.ner.Token t) {
        ...
        if (!BracketHelper.isBracket(t, true)) 
            return false;
        if ((t.getNext() instanceof com.pullenti.ner.TextToken) && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.TextToken.class))).term, "S")) 
            return true;
        return false;
    }
    ...
    public static boolean isEngArticle(com.pullenti.ner.Token t) {
        ...
        return ((com.pullenti.n2j.Utils.stringsEq(str, "THE") || com.pullenti.n2j.Utils.stringsEq(str, "A") || com.pullenti.n2j.Utils.stringsEq(str, "AN")) || com.pullenti.n2j.Utils.stringsEq(str, "DER") || com.pullenti.n2j.Utils.stringsEq(str, "DIE")) || com.pullenti.n2j.Utils.stringsEq(str, "DAS");
    }
    ...
    private static boolean hasNotAllUpper(com.pullenti.ner.Token b, com.pullenti.ner.Token e) {
        for(com.pullenti.ner.Token t = b; t != null && t.endChar <= e.endChar; t = t.getNext()) {
            if (t instanceof com.pullenti.ner.TextToken) {
                ...
                if (hasNotAllUpper((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken(), (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getEndToken())) 
                    return true;
            }
        }
        return false;
    ...
    private static String restChars(com.pullenti.ner.TextToken t, com.pullenti.ner.Referent r) {
        ...
        if (com.pullenti.n2j.Utils.stringsEq(t.term, "Г") || com.pullenti.n2j.Utils.stringsEq(t.term, "ГГ")) {
            if (t.getPrevious() instanceof com.pullenti.ner.NumberToken) 
                return t.term.toLowerCase();
        }
        else if (com.pullenti.n2j.Utils.stringsEq(t.term, "X")) {
            if ((t.getPrevious() instanceof com.pullenti.ner.NumberToken) || ((t.getPrevious() != null && t.getPrevious().isHiphen()))) 
                return t.term.toLowerCase();
        }
        else if (com.pullenti.n2j.Utils.stringsEq(t.term, "N") || com.pullenti.n2j.Utils.stringsEq(t.term, "№")) 
            return t.term;
        ...
        if (stat == null || ((r != null && ((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DATE") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DATERANGE")))))) 
    ...
    public static String getTextMorphVarBySample(String txt, com.pullenti.ner.Token beginSample, boolean useMorphSample, boolean useRegisterSample) {
        if (com.pullenti.n2j.Utils.isNullOrEmpty(txt)) 
            return txt;
        ...
        com.pullenti.ner.AnalysisResult ar = com.pullenti.ner.ProcessorService.getEmptyProcessor().process(new com.pullenti.ner.SourceOfAnalysis(txt), null, new com.pullenti.morph.MorphLang(null));
        ...
        for(com.pullenti.ner.Token t = ar.firstToken; t != null; t = t.getNext(),t0 = (t0 == null ? null : t0.getNext())) {
            ...
            if ((t instanceof com.pullenti.ner.TextToken) && t.chars.isLetter()) {
                word = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term;
        ...
        if (npt != null) {
            for(com.pullenti.ner.Token t = npt.getBeginToken(); t != null && t.endChar <= npt.endChar; t = t.getNext()) {
                ...
                if (t instanceof com.pullenti.ner.NumberToken) 
                    ...
                    if (word == null) 
                        word = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).lemma;
                    if (!t.chars.isLetter()) {
                    }
                    else {
                        com.pullenti.morph.MorphBaseInfo mbi = com.pullenti.morph.MorphBaseInfo._new487(npt.getMorph().getGender(), cas, com.pullenti.morph.MorphNumber.SINGULAR);
                        if (pluralNumber) 
