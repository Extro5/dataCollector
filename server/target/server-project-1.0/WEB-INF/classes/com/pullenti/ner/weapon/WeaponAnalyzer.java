...
public class WeaponAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.HashMap<String, byte[]> getImages() {
        ...
        res.put(com.pullenti.ner.weapon.internal.MetaWeapon.IMAGEID, com.pullenti.ner.business.internal.ResourceHelper.getBytes("weapon.jpg"));
        return res;
    }
    ...
    public com.pullenti.ner.Referent createReferent(String type) {
        if (com.pullenti.n2j.Utils.stringsEq(type, WeaponReferent.OBJ_TYPENAME)) 
            ...
            if (rts != null) {
                for(com.pullenti.ner.ReferentToken rt : rts) {
                    ...
                    for(com.pullenti.ner.Slot s : rt.referent.getSlots()) {
                        if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_MODEL)) {
                            String mod = s.getValue().toString();
                            for(int k = 0; k < 2; k++) {
                                if (!Character.isDigit(mod.charAt(0))) {
                                    java.util.ArrayList<com.pullenti.ner.Referent> li;
                                    com.pullenti.n2j.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> inoutarg2725 = new com.pullenti.n2j.Outargwrapper< >();
                                    Boolean inoutres2726 = com.pullenti.n2j.Utils.tryGetValue(objsByModel, mod, inoutarg2725);
                                    li = inoutarg2725.value;
                                    if (!inoutres2726) 
                        ...
                        else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_NAME)) 
    ...
    private java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttach(java.util.ArrayList<com.pullenti.ner.weapon.internal.WeaponItemToken> its, boolean attach) {
        ...
        if (noun == null) {
            for(com.pullenti.ner.Token tt = its.get(0).getBeginToken().getPrevious(); tt != null; tt = tt.getPrevious()) {
                if ((((prev = (WeaponReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), WeaponReferent.class)))) != null) {
                    java.util.ArrayList<com.pullenti.ner.Slot> addSlots = new java.util.ArrayList< >();
                    for(com.pullenti.ner.Slot s : prev.getSlots()) {
                        if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_TYPE)) 
                            tr.addSlot(s.getTypeName(), s.getValue(), false, 0);
                        else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_BRAND) || com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_BRAND) || com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_MODEL)) {
            ...
            for(com.pullenti.ner.Token tt = its.get(0).getBeginToken().getPrevious(); tt != null && (cou < 100); tt = tt.getPrevious(),cou++) {
                if ((((prev = (WeaponReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), WeaponReferent.class)))) != null) {
                    ...
                    for(com.pullenti.ner.Slot s : prev.getSlots()) {
                        if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_TYPE)) 
                            tr.addSlot(s.getTypeName(), s.getValue(), false, 0);
                        else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_BRAND) || com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_BRAND)) {
                            if (tr.findSlot(s.getTypeName(), null, true) == null) 
                                addSlots.add(s);
                        }
                    }
