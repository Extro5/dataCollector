...
public class BracketHelper {
    ...
    public static boolean canBeEndOfSequence(com.pullenti.ner.Token t, boolean quotesOnly, com.pullenti.ner.Token openT, boolean ignoreWhitespaces) {
        ...
        if (openT instanceof com.pullenti.ner.TextToken) {
            char ch0 = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(openT, com.pullenti.ner.TextToken.class))).term.charAt(0);
        ...
        if (t.isCharOf(m_OpenChars)) {
            if (quotsOnly) {
                if (t instanceof com.pullenti.ner.TextToken) {
                    if (m_Quotes.indexOf((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term.charAt(0)) < 0) 
                        return false;
                }
            }
            return true;
    ...
    public static class Bracket {
        ...
        public Bracket(com.pullenti.ner.Token t) {
            source = t;
            if (t instanceof com.pullenti.ner.TextToken) 
                _char = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term.charAt(0);
    ...
    public static BracketSequenceToken tryParse(com.pullenti.ner.Token t, BracketParseAttr typ, int maxTokens) {
        ...
        if (!canBeStartOfSequence(t0, false, false)) 
            return null;
        java.util.ArrayList<Bracket> brList = new java.util.ArrayList< >();
        ...
        for(t = t0.getNext(); t != null; t = t.getNext()) {
                ...
                if ((((typ.value()) & (BracketParseAttr.CANCONTAINSVERBS.value()))) == (BracketParseAttr.NO.value())) {
                    if (t.getMorph().getLanguage().isCyrillic()) {
                        if (com.pullenti.morph.MorphClass.ooEq(t.getMorphClassInDictionary(), com.pullenti.morph.MorphClass.VERB)) {
                            if (!t.getMorph()._getClass().isAdjective() && !t.getMorph().containsAttr("страд.з.", new com.pullenti.morph.MorphClass(null))) {
                                if (t.chars.isAllLower()) {
                                    String norm = t.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false);
                    ...
                    if (r != null && com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ADDRESS")) {
                        if (!t0.isChar('(')) 
                            break;
                    }
                }
            ...
            if (t.isNewlineBefore()) {
                ...
                if ((t.getPrevious() instanceof com.pullenti.ner.MetaToken) && canBeEndOfSequence((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t.getPrevious(), com.pullenti.ner.MetaToken.class))).getEndToken(), false, null, false)) 
                    break;
            }
            if (crlf > 1) {
                if (brList.size() > 1) 
        ...
        if ((brList.size() == 1 && brList.get(0).canBeOpen && (last instanceof com.pullenti.ner.MetaToken)) && last.isNewlineAfter()) {
            if (BracketHelper.canBeEndOfSequence((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(last, com.pullenti.ner.MetaToken.class))).getEndToken(), false, null, false)) 
        ...
        while(brList.size() > 3) {
            ...
            if ((brList.get(i).canBeClose && brList.get(i - 1).canBeOpen && !canBeCloseChar(brList.get(i)._char, brList.get(0)._char)) && canBeCloseChar(brList.get(i)._char, brList.get(i - 1)._char)) {
                for(int indRemoveRange = brList.size() - 2 + 2 - 1, indMinIndex = brList.size() - 2; indRemoveRange >= indMinIndex; indRemoveRange--) brList.remove(indRemoveRange);
                continue;
            }
            break;
        }
                ...
                if ((brList.get(i).canBeOpen && !brList.get(i).canBeClose && brList.get(i + 1).canBeClose) && !brList.get(i + 1).canBeOpen) {
                    ...
                    if (mustBeCloseChar(brList.get(i + 1)._char, brList.get(i)._char) || brList.get(i)._char != brList.get(0)._char) {
                        ...
                        if ((i == 1 && ((i + 2) < brList.size()) && brList.get(i + 2)._char == ')') && brList.get(i + 1)._char != ')' && canBeCloseChar(brList.get(i + 1)._char, brList.get(i - 1)._char)) 
                            com.pullenti.n2j.Utils.putArrayValue(brList, i + 2, brList.get(i + 1));
                    }
                    else if (i > 1 && ((i + 2) < brList.size()) && mustBeCloseChar(brList.get(i + 2)._char, brList.get(i - 1)._char)) 
                        ok = true;
                    if (ok) {
                        if (internals == null) 
                            internals = new java.util.ArrayList< >();
                        internals.add(new BracketSequenceToken(brList.get(i).source, brList.get(i + 1).source));
                        for(int indRemoveRange = i + 2 - 1, indMinIndex = i; indRemoveRange >= indMinIndex; indRemoveRange--) brList.remove(indRemoveRange);
                        changed = true;
                        break;
                    }
                }
        ...
        if (res == null) {
            ...
            for(com.pullenti.ner.Token tt = t0.getNext(); tt != null; tt = tt.getNext(),cou++) {
                ...
                if (mt.getEndToken() instanceof com.pullenti.ner.TextToken) {
                    if ((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(mt.getEndToken(), com.pullenti.ner.TextToken.class))).isCharOf(m_CloseChars)) {
                        Bracket bb = new Bracket((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(mt.getEndToken(), com.pullenti.ner.TextToken.class));
