...
public class MorphCollection extends com.pullenti.morph.MorphBaseInfo {
    ...
    public MorphCollection(MorphCollection source) {
        ...
        for(com.pullenti.morph.MorphBaseInfo it : source.getItems()) {
            ...
            if (it instanceof com.pullenti.morph.MorphWordForm) 
                mi = (com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast((((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(it, com.pullenti.morph.MorphWordForm.class))).clone(), com.pullenti.morph.MorphWordForm.class);
            else {
    ...
    public MorphCollection clone() {
        ...
        if (m_Items != null) {
            res.m_Items = new java.util.ArrayList< >();
            try {
                res.m_Items.addAll(m_Items);
            } catch(Exception ex) {
            }
        }
        if (!m_NeedRecalc) {
    ...
    private static java.util.ArrayList<com.pullenti.morph.MorphBaseInfo> m_EmptyItems = new java.util.ArrayList< >();

    /**
     * Морфологические варианты
     */
    public Iterable<com.pullenti.morph.MorphBaseInfo> getItems() {
        return (java.util.ArrayList<com.pullenti.morph.MorphBaseInfo>)com.pullenti.n2j.Utils.notnull(m_Items, m_EmptyItems);
    }
        ...
        if (m_Items != null) {
            for(com.pullenti.morph.MorphBaseInfo it : m_Items) {
                ...
                if (it._getClass().isVerb()) {
                    if (it instanceof com.pullenti.morph.MorphWordForm) {
                        com.pullenti.morph.MorphVoice v = (((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(it, com.pullenti.morph.MorphWordForm.class))).misc.getVoice();
    ...
    @Override
    public boolean checkAccord(com.pullenti.morph.MorphBaseInfo v, boolean ignoreGender) {
        for(com.pullenti.morph.MorphBaseInfo it : getItems()) {
            if (it.checkAccord(v, ignoreGender)) 
                return true;
        }
        return super.checkAccord(v, ignoreGender);
    }

    public boolean check(com.pullenti.morph.MorphClass cl) {
        return ((((int)_getClass().value) & ((int)cl.value))) != 0;
    }
    ...
    public void removeItems(com.pullenti.morph.MorphCase cas) {
        ...
        for(int i = m_Items.size() - 1; i >= 0; i--) {
            if (((com.pullenti.morph.MorphCase.ooBitand(m_Items.get(i).getCase(), cas))).isUndefined()) {
                ...
                com.pullenti.n2j.Utils.putArrayValue(m_Items, i, (com.pullenti.morph.MorphBaseInfo)com.pullenti.n2j.Utils.cast(m_Items.get(i).clone(), com.pullenti.morph.MorphBaseInfo.class));
    ...
    public void removeItemsByPreposition(Token prep) {
        if (!((prep instanceof TextToken))) 
            return;
        com.pullenti.morph.MorphCase mc = com.pullenti.morph.LanguageHelper.getCaseAfterPreposition((((TextToken)com.pullenti.n2j.Utils.cast(prep, TextToken.class))).lemma);
        if (((com.pullenti.morph.MorphCase.ooBitand(mc, getCase()))).isUndefined()) 
            return;
        removeItems(mc);
    }
    ...
    public void removeNotInDictionaryItems() {
        if (m_Items == null) 
            return;
        for(int i = m_Items.size() - 1; i >= 0; i--) {
            if ((m_Items.get(i) instanceof com.pullenti.morph.MorphWordForm) && !(((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(m_Items.get(i), com.pullenti.morph.MorphWordForm.class))).isInDictionary()) {
                m_Items.remove(i);
                m_NeedRecalc = true;
            }
        }
    ...
    public void deserialize(com.pullenti.n2j.Stream stream) throws java.io.IOException {
        m_Class = com.pullenti.morph.MorphClass._new63(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream));
        m_Case = com.pullenti.morph.MorphCase._new48(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream));
        ...
        m_Language = com.pullenti.morph.MorphLang._new6(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream));
        int cou = com.pullenti.ner.core.internal.SerializerHelper.deserializeInt(stream);
        m_Items = new java.util.ArrayList< >();
        for(int i = 0; i < cou; i++) {
            com.pullenti.morph.MorphBaseInfo it = deserializeItem(stream);
            if (it != null) 
                m_Items.add(it);
        }
        m_NeedRecalc = false;
    ...
    private void serializeItem(com.pullenti.n2j.Stream stream, com.pullenti.morph.MorphBaseInfo bi) throws java.io.IOException {
        byte ty = (byte)0;
        ...
        com.pullenti.morph.MorphWordForm wf = (com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(bi, com.pullenti.morph.MorphWordForm.class);
        if (wf == null) 
            return;
    ...
    private com.pullenti.morph.MorphBaseInfo deserializeItem(com.pullenti.n2j.Stream stream) throws java.io.IOException {
        int ty = stream.read();
        com.pullenti.morph.MorphBaseInfo res = (ty == 0 ? new com.pullenti.morph.MorphBaseInfo() : new com.pullenti.morph.MorphWordForm());
        res._setClass(com.pullenti.morph.MorphClass._new63(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream)));
        res.setCase(com.pullenti.morph.MorphCase._new48(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream)));
        ...
        res.setLanguage(com.pullenti.morph.MorphLang._new6(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream)));
        if (ty == 0) 
            return res;
        com.pullenti.morph.MorphWordForm wf = (com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(res, com.pullenti.morph.MorphWordForm.class);
    ...
    public static MorphCollection _new568(com.pullenti.morph.MorphClass _arg1) {
        MorphCollection res = new MorphCollection(null);
        res._setClass(_arg1);
        return res;
    }
    public static MorphCollection _new2143(com.pullenti.morph.MorphGender _arg1) {
        MorphCollection res = new MorphCollection(null);
        res.setGender(_arg1);
        return res;
    }
    public static MorphCollection _new2194(com.pullenti.morph.MorphCase _arg1) {
        MorphCollection res = new MorphCollection(null);
        res.setCase(_arg1);
        return res;
    }
