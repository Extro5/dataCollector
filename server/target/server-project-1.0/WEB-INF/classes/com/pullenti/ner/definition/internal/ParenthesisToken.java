...
public class ParenthesisToken extends com.pullenti.ner.MetaToken {
    ...
    public static ParenthesisToken tryAttach(com.pullenti.ner.Token t) {
        ...
        if (mc.isAdverb()) 
            ...
            if (t.getMorph().containsAttr("сравн.", new com.pullenti.morph.MorphClass(null)) && t.getMorph().containsAttr("кач.прил.", new com.pullenti.morph.MorphClass(null))) 
                ok = true;
        }
        if (ok && t.getNext() != null) {
            ...
            if (com.pullenti.morph.MorphClass.ooEq(t1.getMorphClassInDictionary(), com.pullenti.morph.MorphClass.VERB)) {
                if (t1.getMorph().containsAttr("н.вр.", new com.pullenti.morph.MorphClass(null)) && t1.getMorph().containsAttr("нес.в.", new com.pullenti.morph.MorphClass(null)) && t1.getMorph().containsAttr("дейст.з.", new com.pullenti.morph.MorphClass(null))) 
        ...
        if (t1 != null) {
            ...
            if (r != null) {
                ParenthesisToken res = _new1053(t, t1, r);
    ...
    public static ParenthesisToken _new1053(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Referent _arg3) {
