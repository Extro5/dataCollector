...
public class EditionHelper {
    ...
    public static void analizeEditions(FragToken root) {
        ...
        if (root.isExpired || ((root.itok != null && root.itok.isExpired))) {
            ...
            if (root.referents == null) 
                root.referents = new java.util.ArrayList< >();
            for(com.pullenti.ner.Token tt = root.getBeginToken(); tt != null && tt.endChar <= root.endChar; tt = tt.getNext()) {
                com.pullenti.ner.decree.DecreeReferent dec = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.decree.DecreeReferent.class);
                if (dec != null) {
    ...
    private static int _canBeEditionFor(FragToken fr, FragToken edt) {
        ...
        if (fr.number == 0) 
            return -1;
        if (com.pullenti.n2j.Utils.stringsEq(fr.getNumberString(), pt.values.get(0).value)) 
            return 1;
