...
public class NamedItemToken extends com.pullenti.ner.MetaToken {
    ...
    public static java.util.ArrayList<NamedItemToken> tryParseList(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto) {
        ...
        if (ne == null) 
            return null;
        java.util.ArrayList<NamedItemToken> res = new java.util.ArrayList< >();
        res.add(ne);
    ...
    public static NamedItemToken tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto) {
        ...
        if (t instanceof com.pullenti.ner.ReferentToken) {
            ...
            if ((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "PERSON") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "PERSONPROPERTY") || (r instanceof com.pullenti.ner.geo.GeoReferent)) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ORGANIZATION")) 
                return _new1586(t, t, r, t.getMorph());
            return null;
        }
        ...
        if (typ != null) {
            if (!((t instanceof com.pullenti.ner.TextToken))) 
                return null;
            NamedItemToken res = _new1587(typ.getBeginToken(), typ.getEndToken(), typ.getMorph(), typ.chars);
        ...
        if (nam != null) {
            if (nam.getBeginToken().chars.isAllLower()) 
                return null;
            NamedItemToken res = _new1587(nam.getBeginToken(), nam.getEndToken(), nam.getMorph(), nam.chars);
            ...
            if (ok) {
                res.isWellknown = true;
                res.typeValue = (String)com.pullenti.n2j.Utils.cast(nam.termin.tag2, String.class);
            }
            return res;
        }
        ...
        if (adj != null) {
            if (adj.getMorph()._getClass().isNoun()) {
                if (adj.getEndToken().isValue("ВОСТОК", null)) {
                    if (adj.getBeginToken() == adj.getEndToken()) 
                        return null;
                    NamedItemToken re = _new1589(t, adj.getEndToken(), adj.getMorph());
            ...
            if ((adj.getEndToken().getNext() instanceof com.pullenti.ner.ReferentToken) && (adj.getEndToken().getNext().getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) {
                NamedItemToken re = _new1589(t, adj.getEndToken().getNext(), adj.getEndToken().getNext().getMorph());
                re.kind = com.pullenti.ner.named.NamedEntityKind.LOCATION;
        ...
        if (((t instanceof com.pullenti.ner.TextToken) && t.chars.isLetter() && !t.chars.isAllLower()) && t.getLengthChar() > 2) {
            NamedItemToken res = _new1589(t, t, t.getMorph());
            ...
            if (str.endsWith("О") || str.endsWith("И") || str.endsWith("Ы")) 
                ...
                res.nameValue = t.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false);
            res.chars = t.chars;
            if (((!t.isWhitespaceAfter() && t.getNext() != null && t.getNext().isHiphen()) && (t.getNext().getNext() instanceof com.pullenti.ner.TextToken) && !t.getNext().getNext().isWhitespaceAfter()) && t.chars.isCyrillicLetter() == t.getNext().getNext().chars.isCyrillicLetter()) {
                ...
                res.nameValue = res.nameValue + "-" + t.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false);
            }
            return res;
        }
        return null;
    ...
    public static void initialize() {
        ...
        for(String s : new String[] {"ПЛАНЕТА", "ЗВЕЗДА", "КОМЕТА", "МЕТЕОРИТ", "СОЗВЕЗДИЕ", "ГАЛАКТИКА"}) {
            t = new com.pullenti.ner.core.Termin(null, new com.pullenti.morph.MorphLang(null), false);
        ...
        for(String s : new String[] {"СОЛНЦЕ", "МЕРКУРИЙ", "ВЕНЕРА", "ЗЕМЛЯ", "МАРС", "ЮПИТЕР", "САТУРН", "УРАН", "НЕПТУН", "ПЛУТОН", "ЛУНА", "ДЕЙМОС", "ФОБОС", "Ио", "Ганимед", "Каллисто"}) {
            t = new com.pullenti.ner.core.Termin(null, new com.pullenti.morph.MorphLang(null), false);
            t.initByNormalText(s.toUpperCase(), new com.pullenti.morph.MorphLang(null));
            t.tag = com.pullenti.ner.named.NamedEntityKind.PLANET;
            m_Names.add(t);
        }
        ...
        t = com.pullenti.ner.core.Termin._new118("МЕЖДУНАРОДНАЯ КОСМИЧЕСКАЯ СТАНЦИЯ", com.pullenti.ner.named.NamedEntityKind.BUILDING);
        t.acronym = "МКС";
        m_Names.add(t);
    }
    ...
    public static NamedItemToken _new1586(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Referent _arg3, com.pullenti.ner.MorphCollection _arg4) {
        NamedItemToken res = new NamedItemToken(_arg1, _arg2);
        res.ref = _arg3;
        res.setMorph(_arg4);
        return res;
    }
    public static NamedItemToken _new1587(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, com.pullenti.morph.CharsInfo _arg4) {
        NamedItemToken res = new NamedItemToken(_arg1, _arg2);
        res.setMorph(_arg3);
        res.chars = _arg4;
        return res;
    }
    public static NamedItemToken _new1589(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3) {
        NamedItemToken res = new NamedItemToken(_arg1, _arg2);
        res.setMorph(_arg3);
        return res;
    }
