...
public class StreetDefineHelper {
    ...
    public static AddressItemToken tryParseStreet(java.util.ArrayList<StreetItemToken> sli, boolean extOntoRegim, boolean forMetro) {
        ...
        for(i = 0; i < sli.size(); i++) {
            if (i == 0 && sli.get(i).typ == StreetItemType.FIX && ((sli.size() == 1 || sli.get(1).typ != StreetItemType.NOUN))) 
                ...
                if ((i == 0 && com.pullenti.n2j.Utils.stringsEq(sli.get(i).termin.getCanonicText(), "УЛИЦА") && ((i + 2) < sli.size())) && sli.get(i + 1).typ == StreetItemType.NOUN && com.pullenti.n2j.Utils.stringsEq(sli.get(i + 1).termin.getCanonicText(), "МИКРОРАЙОН")) {
                    sli.get(i + 1).setBeginToken(sli.get(i).getBeginToken());
                    sli.remove(i);
                }
                if (com.pullenti.n2j.Utils.stringsEq(sli.get(i).termin.getCanonicText(), "МЕТРО")) {
                    if ((i + 1) < sli.size()) {
                        java.util.ArrayList<StreetItemToken> sli1 = new java.util.ArrayList< >();
                ...
                if (i == 0 && (i + 1) >= sli.size() && ((com.pullenti.n2j.Utils.stringsEq(sli.get(i).termin.getCanonicText(), "ВОЕННЫЙ ГОРОДОК") || com.pullenti.n2j.Utils.stringsEq(sli.get(i).termin.getCanonicText(), "ПРОМЗОНА")))) {
                    ...
                    return AddressItemToken._new86(AddressItemToken.ItemType.STREET, sli.get(0).getBeginToken(), sli.get(0).getEndToken(), stri0, true);
                }
                if (i == 0 && (i + 1) >= sli.size() && com.pullenti.n2j.Utils.stringsEq(sli.get(i).termin.getCanonicText(), "МИКРОРАЙОН")) {
                    com.pullenti.ner.address.StreetReferent stri0 = new com.pullenti.ner.address.StreetReferent();
                    stri0.addSlot(com.pullenti.ner.address.StreetReferent.ATTR_TYP, sli.get(i).termin.getCanonicText().toLowerCase(), false, 0);
                    return AddressItemToken._new86(AddressItemToken.ItemType.STREET, sli.get(0).getBeginToken(), sli.get(0).getEndToken(), stri0, true);
                }
                if (com.pullenti.n2j.Utils.stringsEq(sli.get(i).termin.getCanonicText(), "ПЛОЩАДЬ") || com.pullenti.n2j.Utils.stringsEq(sli.get(i).termin.getCanonicText(), "ПЛОЩА")) {
        ...
        boolean isMicroRaion = (com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "МИКРОРАЙОН") || com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "МІКРОРАЙОН") || com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "КВАРТАЛ")) || com.pullenti.morph.LanguageHelper.endsWith(noun.termin.getCanonicText(), "ГОРОДОК");
        int before = 0;
        int after = 0;
        for(j = 0; j < i; j++) {
        ...
        java.util.ArrayList<StreetItemToken> rli = new java.util.ArrayList< >();
        int n0;
        int n1;
        if (before > after) {
            if (com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "МЕТРО")) 
                return null;
            ...
            number = (sli.get(0).number == null ? sli.get(0).value : ((Long)sli.get(0).number.value).toString());
            ...
            if (num) {
                number = (sli.get(2).number == null ? sli.get(2).value : ((Long)sli.get(2).number.value).toString());
                if (sli.get(2).isNumberKm) 
                    number += "км";
                rli.add(sli.get(2));
            }
            else 
                for(int indRemoveRange = 2 + sli.size() - 2 - 1, indMinIndex = 2; indRemoveRange >= indMinIndex; indRemoveRange--) sli.remove(indRemoveRange);
        }
        else 
            return null;
            ...
            if (sli.get(j).typ == StreetItemType.NUMBER) {
                ...
                if (number != null) {
                    if (name != null && name.typ == StreetItemType.STDNAME) {
                        secNumber = (sli.get(j).number == null ? sli.get(j).value : ((Long)sli.get(j).number.value).toString());
                ...
                if (sli.get(j).number != null && sli.get(j).number.typ == com.pullenti.ner.NumberSpellingType.DIGIT && !sli.get(j).number.getMorph()._getClass().isAdjective()) {
                    if (sli.get(j).getWhitespacesBeforeCount() > 2 && j > 0) 
                        break;
                    if (sli.get(j).number != null && sli.get(j).number.value > ((long)20)) {
                        if (j > n0) {
                ...
                number = (sli.get(j).number == null ? sli.get(j).value : ((Long)sli.get(j).number.value).toString());
                if (sli.get(j).isNumberKm) 
                    number += "км";
                rli.add(sli.get(j));
            }
                ...
                if (number != null || age != null) 
                    break;
                age = ((Long)sli.get(j).number.value).toString();
                rli.add(sli.get(j));
            }
                ...
                if ((sli.get(0) == noun && ((com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "УЛИЦА") || com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ВУЛИЦЯ"))) && j > 0) && name == null) {
                    altNoun = noun;
                    noun = sli.get(j);
                    rli.add(sli.get(j));
                }
        ...
        if (((n1 < i) && number == null && ((i + 1) < sli.size())) && sli.get(i + 1).typ == StreetItemType.NUMBER && sli.get(i + 1).numberHasPrefix) {
            number = (sli.get(i + 1).number == null ? sli.get(i + 1).value : sli.get(i + 1).number.toString());
            rli.add(sli.get(i + 1));
        }
        else if ((((i < n0) && ((name != null || adj != null)) && (j < sli.size())) && sli.get(j).typ == StreetItemType.NOUN && ((com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "УЛИЦА") || com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ВУЛИЦЯ")))) && (((com.pullenti.n2j.Utils.stringsEq(sli.get(j).termin.getCanonicText(), "ПЛОЩАДЬ") || com.pullenti.n2j.Utils.stringsEq(sli.get(j).termin.getCanonicText(), "БУЛЬВАР") || com.pullenti.n2j.Utils.stringsEq(sli.get(j).termin.getCanonicText(), "ПЛОЩА")) || com.pullenti.n2j.Utils.stringsEq(sli.get(j).termin.getCanonicText(), "МАЙДАН") || (j + 1) == sli.size()))) {
            altNoun = noun;
            noun = sli.get(j);
            rli.add(sli.get(j));
        }
        if (name == null) {
            ...
            if (noun.isAbridge) {
                ...
                else if (noun.termin != null && ((com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ПРОЕЗД") || com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ПРОЇЗД")))) {
                }
        ...
        if (!forMetro) {
            ...
            if (noun.altTermin != null) {
                if (com.pullenti.n2j.Utils.stringsEq(noun.altTermin.getCanonicText(), "ПРОСПЕКТ") && number != null) {
                }
                else 
        ...
        AddressItemToken res = AddressItemToken._new83(AddressItemToken.ItemType.STREET, rli.get(0).getBeginToken(), rli.get(0).getEndToken(), street);
        ...
        if (forMetro && rli.contains(noun) && com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "МЕТРО")) 
            rli.remove(noun);
        ...
        if (name != null && name.value != null) {
            ...
            if (isAdj) {
                    ...
                    if (t == name.getEndToken()) {
                        ...
                        if (!noun.isAbridge) {
                            if (!noun.getMorph().getCase().isUndefined() && !noun.getMorph().getCase().isNominative()) 
                                isPadez = true;
                            else if (com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ШОССЕ") || com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ШОСЕ")) 
                                isPadez = true;
                        }
                ...
                for(com.pullenti.ner.Token t = name.getBeginToken(); t != null; t = t.getNext()) {
                    ...
                    if ((t instanceof com.pullenti.ner.TextToken) && !t.isHiphen()) {
                        if (name.termin != null) {
                            ...
                            com.pullenti.n2j.Utils.putArrayValue(nits, nits.size() - 1, nits.get(nits.size() - 1) + (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
                        else {
                            nits.add((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
                ...
                strNam = String.join(" ", nits.toArray(new String[nits.size()]));
        ...
        if (adj != null) {
            ...
            if (name != null && (((name.getMorph().getNumber().value()) & (com.pullenti.morph.MorphNumber.PLURAL.value()))) != (com.pullenti.morph.MorphNumber.UNDEFINED.value())) 
                s = com.pullenti.morph.Morphology.getWordform(adj.termin.getCanonicText(), com.pullenti.morph.MorphBaseInfo._new210(com.pullenti.morph.MorphClass.ADJECTIVE, com.pullenti.morph.MorphNumber.PLURAL));
            else if (adjGen != com.pullenti.morph.MorphGender.UNDEFINED) 
                s = com.pullenti.morph.Morphology.getWordform(adj.termin.getCanonicText(), com.pullenti.morph.MorphBaseInfo._new211(com.pullenti.morph.MorphClass.ADJECTIVE, adjGen));
            else if ((((adj.getMorph().getGender().value()) & (gen.value()))) == (com.pullenti.morph.MorphGender.UNDEFINED.value())) 
                s = com.pullenti.morph.Morphology.getWordform(adj.termin.getCanonicText(), com.pullenti.morph.MorphBaseInfo._new211(com.pullenti.morph.MorphClass.ADJECTIVE, adj.getMorph().getGender()));
            else 
                s = com.pullenti.morph.Morphology.getWordform(adj.termin.getCanonicText(), com.pullenti.morph.MorphBaseInfo._new211(com.pullenti.morph.MorphClass.ADJECTIVE, gen));
            adjStr = s;
        ...
        if (s1.length() < 3) {
            if (street.getNumber() != null) {
                ...
                if (isMicroRaion) {
                    ...
                    if (!com.pullenti.n2j.Utils.isNullOrEmpty(s2)) 
        ...
        if (com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ПЛОЩАДЬ") || com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "КВАРТАЛ") || com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ПЛОЩА")) {
            res.isDoubt = true;
        ...
        if (com.pullenti.morph.LanguageHelper.endsWith(noun.termin.getCanonicText(), "ГОРОДОК")) {
            for(com.pullenti.ner.Slot s : street.getSlots()) {
                if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.address.StreetReferent.ATTR_TYP)) 
                    street.uploadSlot(s, "микрорайон");
                else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.address.StreetReferent.ATTR_NAME)) 
        ...
        if (res.isDoubt) {
            if (noun.isRoad()) {
                if (street.getNumber() != null && street.getNumber().toUpperCase().endsWith("КМ".toUpperCase())) 
                    res.isDoubt = false;
            ...
            else if (com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "ПРОЕЗД") && street.findSlot(com.pullenti.ner.address.StreetReferent.ATTR_NAME, "ПРОЕКТИРУЕМЫЙ", true) != null) 
                res.isDoubt = false;
            for(com.pullenti.ner.Token tt0 = res.getBeginToken().getPrevious(); tt0 != null; tt0 = tt0.getPrevious()) {
                if (tt0.isCharOf(",,") || tt0.isCommaAnd()) 
                    continue;
                com.pullenti.ner.address.StreetReferent str0 = (com.pullenti.ner.address.StreetReferent)com.pullenti.n2j.Utils.cast(tt0.getReferent(), com.pullenti.ner.address.StreetReferent.class);
                if (str0 != null) 
                    res.isDoubt = false;
                break;
            }
        }
        if (com.pullenti.n2j.Utils.stringsEq(noun.termin.getCanonicText(), "КВАРТАЛ") && (res.getWhitespacesAfterCount() < 2) && number == null) {
    ...
    private static AddressItemToken tryDetectNonNoun(java.util.ArrayList<StreetItemToken> sli, boolean ontoRegim, boolean forMetro) {
        ...
        if (sli.size() == 1 && sli.get(0).typ == StreetItemType.NAME && ((ontoRegim || forMetro))) {
            ...
            AddressItemToken res0 = AddressItemToken._new86(AddressItemToken.ItemType.STREET, sli.get(0).getBeginToken(), sli.get(0).getEndToken(), street, true);
        ...
        if (sli.size() == 1 && ((sli.get(0).typ == StreetItemType.STDNAME || sli.get(0).typ == StreetItemType.NAME))) {
            if (!ontoRegim) {
                ...
                for(tt = sli.get(0).getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                    ...
                    if (!tt.isAnd() && !isStreetBefore) 
                        break;
                    java.util.ArrayList<StreetItemToken> tmp = new java.util.ArrayList< >();
                    tmp.add(sli.get(0));
                    tmp.add(noun);
        ...
        if (val == null) {
            if (sli.get(i1).existStreet != null) {
                ...
                com.pullenti.ner.TextToken te = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(sli.get(i1).getBeginToken(), com.pullenti.ner.TextToken.class);
                if (te != null) {
                    for(com.pullenti.morph.MorphBaseInfo wf : te.getMorph().getItems()) {
                        if (wf._getClass().isAdjective() && wf.getGender() == com.pullenti.morph.MorphGender.FEMINIE) {
                            val = (((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(wf, com.pullenti.morph.MorphWordForm.class))).normalCase;
                            break;
                        }
                    }
                }
        ...
        if (sli.get(i1).termin != null && ((StreetItemType)sli.get(i1).termin.tag) == StreetItemType.FIX) {
            ...
            if (ait.typ == AddressItemToken.ItemType.HOUSE && ait.value != null) 
                ...
                return null;
            else if (((com.pullenti.n2j.Utils.stringsEq(val, "ТАБЛИЦА") || com.pullenti.n2j.Utils.stringsEq(val, "РИСУНОК") || com.pullenti.n2j.Utils.stringsEq(val, "ДИАГРАММА")) || com.pullenti.n2j.Utils.stringsEq(val, "ТАБЛИЦЯ") || com.pullenti.n2j.Utils.stringsEq(val, "МАЛЮНОК")) || com.pullenti.n2j.Utils.stringsEq(val, "ДІАГРАМА")) 
                return null;
            else if (ait.typ == AddressItemToken.ItemType.NUMBER && (ait.getBeginToken().getWhitespacesBeforeCount() < 2)) {
                com.pullenti.ner.NumberToken nt = (com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(ait.getBeginToken(), com.pullenti.ner.NumberToken.class);
                if (nt == null || nt.typ != com.pullenti.ner.NumberSpellingType.DIGIT || nt.getMorph()._getClass().isAdjective()) 
                    return null;
                ...
                if (nt.value > ((long)100)) 
                    return null;
                com.pullenti.ner.core.NumberExToken nex = com.pullenti.ner.core.NumberExToken.tryParseNumberWithPostfix(ait.getBeginToken());
                if (nex != null) 
                    return null;
        ...
        if (sli.size() > 1) {
            if (sli.get(0).typ == StreetItemType.NUMBER || sli.get(0).typ == StreetItemType.AGE) 
                street.setNumber((sli.get(0).number == null ? sli.get(0).value : ((Long)sli.get(0).number.value).toString()));
            else if (sli.get(1).typ == StreetItemType.NUMBER || sli.get(1).typ == StreetItemType.AGE) 
                street.setNumber((sli.get(1).number == null ? sli.get(1).value : ((Long)sli.get(1).number.value).toString()));
            else {
        ...
        return AddressItemToken._new86(AddressItemToken.ItemType.STREET, sli.get(0).getBeginToken(), sli.get(sli.size() - 1).getEndToken(), street, doubt);
    }
    ...
    private static AddressItemToken _tryParseFix(java.util.ArrayList<StreetItemToken> sits) {
        if ((sits.size() < 1) || sits.get(0).termin == null) 
            return null;
        if (com.pullenti.n2j.Utils.stringsEq(sits.get(0).termin.acronym, "МКАД")) {
            ...
            if (sits.size() > 1 && sits.get(1).typ == StreetItemType.NUMBER) {
                String num = (sits.get(1).number == null ? sits.get(1).value : ((Long)sits.get(1).number.value).toString());
            ...
            return AddressItemToken._new83(AddressItemToken.ItemType.STREET, t0, t1, str);
        }
        if (com.pullenti.ner.geo.internal.MiscLocationHelper.checkGeoObjectBefore(sits.get(0).getBeginToken()) || AddressItemToken.checkHouseAfter(sits.get(0).getEndToken().getNext(), false, true)) {
            ...
            return AddressItemToken._new83(AddressItemToken.ItemType.STREET, sits.get(0).getBeginToken(), sits.get(0).getEndToken(), str);
        }
        return null;
    }
