...
public class CityAttachHelper {
    ...
    public static com.pullenti.ner.ReferentToken tryAttachCity(java.util.ArrayList<CityItemToken> li, com.pullenti.ner.core.AnalyzerDataWithOntology ad, boolean always) {
        ...
        com.pullenti.n2j.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> inoutarg1066 = new com.pullenti.n2j.Outargwrapper< >();
        com.pullenti.ner.ReferentToken res = try1(li, inoutarg1066, ad);
        oi = inoutarg1066.value;
        if (res == null) {
            com.pullenti.n2j.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> inoutarg1062 = new com.pullenti.n2j.Outargwrapper< >();
            res = _tryNounName(li, inoutarg1062, false);
            oi = inoutarg1062.value;
        }
        if (res == null) {
            com.pullenti.n2j.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> inoutarg1063 = new com.pullenti.n2j.Outargwrapper< >();
            res = _tryNameExist(li, inoutarg1063, false);
            oi = inoutarg1063.value;
        }
        if (res == null) 
            res = try4(li);
        if (res == null && always) {
            com.pullenti.n2j.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> inoutarg1064 = new com.pullenti.n2j.Outargwrapper< >();
            res = _tryNounName(li, inoutarg1064, true);
            oi = inoutarg1064.value;
        }
        if (res == null && always) {
            if (com.pullenti.ner.address.internal.AddressItemToken.tryAttachOrg(li.get(0).getBeginToken()) != null) {
            }
            else {
                com.pullenti.n2j.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> inoutarg1065 = new com.pullenti.n2j.Outargwrapper< >();
                res = _tryNameExist(li, inoutarg1065, true);
                oi = inoutarg1065.value;
            }
        }
        if (res == null) 
            return null;
    ...
    private static com.pullenti.ner.ReferentToken try1(java.util.ArrayList<CityItemToken> li, com.pullenti.n2j.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> oi, com.pullenti.ner.core.AnalyzerDataWithOntology ad) {
        oi.value = null;
        ...
        if (!ok) 
            return null;
        if (i < li.size()) 
            for(int indRemoveRange = i + li.size() - i - 1, indMinIndex = i; indRemoveRange >= indMinIndex; indRemoveRange--) li.remove(indRemoveRange);
                ...
                if (typ == null) {
                    ...
                    if (!com.pullenti.morph.LanguageHelper.endsWithEx(typ, "ПУНКТ", "ПОСЕЛЕНИЕ", "ПОСЕЛЕННЯ", "ПОСЕЛОК")) {
                        if (!com.pullenti.morph.LanguageHelper.endsWith(typ, "CITY")) {
                            if (com.pullenti.n2j.Utils.stringsEq(typ, "СТАНЦИЯ") && ((MiscLocationHelper.checkGeoObjectBefore(li.get(0).getBeginToken())))) {
                            }
                    ...
                    if (li.get(0).getBeginToken().getMorph()._getClass().isAdjective()) 
                        li.get(0).value = com.pullenti.ner.core.ProperNameHelper.getName(li.get(0).getBeginToken(), li.get(0).getEndToken(), com.pullenti.morph.MorphClass.ADJECTIVE, li.get(1).getMorph().getCase(), li.get(1).getMorph().getGender(), false, false);
                }
            }
        }
        else if (oi.value.referent instanceof com.pullenti.ner.geo.GeoReferent) 
            rt = com.pullenti.ner.ReferentToken._new709((com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(oi.value.referent, com.pullenti.ner.geo.GeoReferent.class), li.get(0).getBeginToken(), li.get(li.size() - 1).getEndToken(), mc);
        else if (typ == null) 
            typ = oi.value.typ;
        if (rt == null) {
            ...
            if (alttyp != null) 
                city.addTyp(alttyp);
            rt = com.pullenti.ner.ReferentToken._new709(city, li.get(0).getBeginToken(), li.get(li.size() - 1).getEndToken(), mc);
        }
        if ((rt.referent instanceof com.pullenti.ner.geo.GeoReferent) && li.size() == 1 && (((com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(rt.referent, com.pullenti.ner.geo.GeoReferent.class))).isCity()) {
    ...
    private static com.pullenti.ner.ReferentToken _tryNounName(java.util.ArrayList<CityItemToken> li, com.pullenti.n2j.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> oi, boolean always) {
        oi.value = null;
        ...
        String probAdj = null;
        int i1 = 1;
        com.pullenti.ner.Referent org = null;
        if ((typ != null && li.get(i1).typ == CityItemToken.ItemType.NOUN && ((i1 + 1) < li.size())) && li.get(0).getWhitespacesAfterCount() <= 1 && (((com.pullenti.morph.LanguageHelper.endsWith(typ, "ПОСЕЛОК") || com.pullenti.morph.LanguageHelper.endsWith(typ, "СЕЛИЩЕ") || com.pullenti.n2j.Utils.stringsEq(typ, "ДЕРЕВНЯ")) || com.pullenti.n2j.Utils.stringsEq(typ, "СЕЛО")))) {
            ...
            if (com.pullenti.n2j.Utils.stringsEq(typ2, "СТАНЦИЯ") && li.get(i1).getBeginToken().isValue("СТ", null) && ((i1 + 1) < li.size())) {
        ...
        String name = (String)com.pullenti.n2j.Utils.notnull(li.get(i1).value, ((li.get(i1).ontoItem == null ? null : li.get(i1).ontoItem.getCanonicText())));
        String altName = li.get(i1).altValue;
        if (name == null) 
            return null;
        com.pullenti.ner.MorphCollection mc = li.get(0).getMorph();
        if (i1 == 1 && li.get(i1).typ == CityItemToken.ItemType.CITY && ((com.pullenti.n2j.Utils.stringsEq(li.get(0).value, "ГОРОД") || com.pullenti.n2j.Utils.stringsEq(li.get(0).value, "МІСТО") || li.get(0).typ == CityItemToken.ItemType.MISC))) {
            ...
            if (name.length() > 2 || oi.value.miscAttr != null) {
                if (!li.get(1).doubtful || ((oi.value != null && oi.value.miscAttr != null))) 
                    ...
                    if (li.get(0).geoObjectBefore || li.get(1).geoObjectAfter) 
                        ...
                        ok = true;
                    else if ((li.get(1).getWhitespacesBeforeCount() < 2) && li.get(1).isNewlineAfter() && li.get(1).ontoItem != null) 
                        ok = true;
                }
            ...
            if (((com.pullenti.n2j.Utils.stringsEq(li.get(0).value, "АДМИНИСТРАЦИЯ") || com.pullenti.n2j.Utils.stringsEq(li.get(0).value, "АДМІНІСТРАЦІЯ"))) && i1 == 1) 
                return null;
            ...
            if (!li.get(0).doubtful) {
                ...
                if (li.get(i1).doubtful && !li.get(i1).geoObjectAfter && !li.get(0).geoObjectBefore) {
                    if (li.get(i1).getMorph().getCase().isGenitive()) {
                        if (((li.get(0).getBeginToken().getPrevious() == null || MiscLocationHelper.checkGeoObjectBefore(li.get(0).getBeginToken()))) && ((li.get(i1).getEndToken().getNext() == null || MiscLocationHelper.checkGeoObjectAfter(li.get(i1).getEndToken().getNext()) || com.pullenti.ner.address.internal.AddressItemToken.checkHouseAfter(li.get(i1).getEndToken().getNext(), false, true)))) {
                        }
                        else 
                            ok = false;
                    }
                    ...
                    if (npt.getEndToken().endChar > li.get(i1).endChar && npt.adjectives.size() > 0 && !npt.adjectives.get(0).getEndToken().getNext().isComma()) 
                        ...
                        if (li.get(0).getBeginToken().getPrevious() != null) {
                            ...
                            if (ttt.isComma() && ttt.getPrevious() != null) 
                                ttt = ttt.getPrevious();
                            com.pullenti.ner.geo.GeoReferent _geo = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(ttt.getReferent(), com.pullenti.ner.geo.GeoReferent.class);
        ...
        if (li.size() > (i1 + 1)) 
            for(int indRemoveRange = i1 + 1 + li.size() - i1 - 1 - 1, indMinIndex = i1 + 1; indRemoveRange >= indMinIndex; indRemoveRange--) li.remove(indRemoveRange);
        com.pullenti.ner.geo.GeoReferent city = new com.pullenti.ner.geo.GeoReferent();
        if (oi.value != null && oi.value.referent != null) {
            city = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(oi.value.referent.clone(), com.pullenti.ner.geo.GeoReferent.class);
        ...
        if (!li.get(0).getMorph().getCase().isUndefined() && li.get(0).getMorph().getGender() != com.pullenti.morph.MorphGender.UNDEFINED) {
            if (li.get(i1).getEndToken().getMorph()._getClass().isAdjective() && li.get(i1).getBeginToken() == li.get(i1).getEndToken()) {
                String nam = com.pullenti.ner.core.ProperNameHelper.getName(li.get(i1).getBeginToken(), li.get(i1).getEndToken(), com.pullenti.morph.MorphClass.ADJECTIVE, li.get(0).getMorph().getCase(), li.get(0).getMorph().getGender(), false, false);
                if (nam != null && com.pullenti.n2j.Utils.stringsNe(nam, name)) 
                    name = nam;
            }
        }
        ...
        if (li.get(0).typ == CityItemToken.ItemType.MISC) 
            li.remove(0);
        com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new709(city, li.get(0).getBeginToken(), li.get(li.size() - 1).getEndToken(), mc);
        if (res.getEndToken().getNext() != null && res.getEndToken().getNext().isHiphen() && (res.getEndToken().getNext().getNext() instanceof com.pullenti.ner.NumberToken)) {
            com.pullenti.ner.NumberToken num = (com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(res.getEndToken().getNext().getNext(), com.pullenti.ner.NumberToken.class);
            if (num.typ == com.pullenti.ner.NumberSpellingType.DIGIT && !num.getMorph()._getClass().isAdjective() && (num.value < ((long)50))) {
                for(com.pullenti.ner.Slot s : city.getSlots()) {
                    if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.geo.GeoReferent.ATTR_NAME)) 
                        city.uploadSlot(s, s.getValue().toString() + "-" + num.value);
                }
                res.setEndToken(num);
            }
        }
     ...
     * @return 
     */
    private static com.pullenti.ner.ReferentToken _tryNameExist(java.util.ArrayList<CityItemToken> li, com.pullenti.n2j.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> oi, boolean always) {
        oi.value = null;
        if (li == null || li.get(0).typ != CityItemToken.ItemType.CITY) 
            return null;
        oi.value = li.get(0).ontoItem;
        com.pullenti.ner.TextToken tt = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(li.get(0).getBeginToken(), com.pullenti.ner.TextToken.class);
        if (tt == null) 
            return null;
        boolean ok = false;
        ...
        if (nam == null) 
            return null;
        if (com.pullenti.n2j.Utils.stringsEq(nam, "РИМ")) {
            if (com.pullenti.n2j.Utils.stringsEq(tt.term, "РИМ")) {
                if ((tt.getNext() instanceof com.pullenti.ner.TextToken) && tt.getNext().getMorphClassInDictionary().isProperSecname()) {
                }
                else 
                    ok = true;
            }
            else if (tt.getPrevious() != null && tt.getPrevious().isValue("В", null) && com.pullenti.n2j.Utils.stringsEq(tt.term, "РИМЕ")) 
                ok = true;
        }
        ...
        if (oi.value != null && (oi.value.referent instanceof com.pullenti.ner.geo.GeoReferent) && !oi.value.owner.isExtOntology) 
            city = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(oi.value.referent, com.pullenti.ner.geo.GeoReferent.class);
        else {
            city = new com.pullenti.ner.geo.GeoReferent();
            city.addName(nam);
            if (oi.value != null && (oi.value.referent instanceof com.pullenti.ner.geo.GeoReferent)) 
                city.mergeSlots2((com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(oi.value.referent, com.pullenti.ner.geo.GeoReferent.class), li.get(0).kit.baseLanguage);
            if (!city.isCity()) 
                city.addTypCity(li.get(0).kit.baseLanguage);
        }
        return com.pullenti.ner.ReferentToken._new709(city, li.get(0).getBeginToken(), li.get(0).getEndToken(), li.get(0).getMorph());
    }

    private static com.pullenti.ner.ReferentToken try4(java.util.ArrayList<CityItemToken> li) {
        if ((li.size() > 0 && li.get(0).typ == CityItemToken.ItemType.NOUN && ((com.pullenti.n2j.Utils.stringsNe(li.get(0).value, "ГОРОД") && com.pullenti.n2j.Utils.stringsNe(li.get(0).value, "МІСТО") && com.pullenti.n2j.Utils.stringsNe(li.get(0).value, "CITY")))) && ((!li.get(0).doubtful || li.get(0).geoObjectBefore))) {
    ...
    public static boolean checkYearAfter(com.pullenti.ner.Token tt) {
        ...
        if (tt != null && tt.isNewlineAfter()) {
            if (tt instanceof com.pullenti.ner.NumberToken) {
                long year = (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).value;
                if (year > ((long)1990) && (year < ((long)2100))) 
                    return true;
            }
            else if (tt.getReferent() != null && com.pullenti.n2j.Utils.stringsEq(tt.getReferent().getTypeName(), "DATE")) 
                return true;
        }
        return false;
    }
