...
public class PartToken extends com.pullenti.ner.MetaToken {
        ...
        while(tt != null) {
            ...
            if (p0 == null) {
                ...
                if ((tt instanceof com.pullenti.ner.NumberToken) && delim) {
                    ...
                    if (p0 == null) 
                        break;
                    p0.values.add(PartValue._new979(tt, tt, ((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).value).toString()));
                    for(int ii = 0; ii < 2; ii++) {
                        if ((tt.getNext() != null && tt.getNext().isChar('.') && (tt.getNext().getNext() instanceof com.pullenti.ner.NumberToken)) && !tt.isWhitespaceAfter() && !tt.getNext().isWhitespaceAfter()) {
                            p0.values.get(0).setEndToken(p0.setEndToken(tt.getNext().getNext()));
                            p0.values.get(0).value += ("." + (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt.getNext().getNext(), com.pullenti.ner.NumberToken.class))).value);
                            tt = tt.getNext().getNext();
                        }
                    }
                }
    ...
    public static int getNumber(String str) {
        if (com.pullenti.n2j.Utils.isNullOrEmpty(str)) 
            return 0;
        int i;
        com.pullenti.n2j.Outargwrapper<Integer> inoutarg1033 = new com.pullenti.n2j.Outargwrapper< >();
        boolean inoutres1034 = com.pullenti.n2j.Utils.parseInteger(str, inoutarg1033);
        i = (inoutarg1033.value != null ? inoutarg1033.value : 0);
        if (inoutres1034) 
            return i;
        ...
        if (((int)ch) < 0x80) {
            ...
            if ((ch == 'Z' && str.length() > 2 && str.charAt(1) == '.') && Character.isDigit(str.charAt(2))) {
                int n;
                com.pullenti.n2j.Outargwrapper<Integer> inoutarg1029 = new com.pullenti.n2j.Outargwrapper< >();
                boolean inoutres1030 = com.pullenti.n2j.Utils.parseInteger(str.substring(2), inoutarg1029);
                n = (inoutarg1029.value != null ? inoutarg1029.value : 0);
                if (inoutres1030) 
                    i += n;
            }
        }
            ...
            if ((ch == 'Я' && str.length() > 2 && str.charAt(1) == '.') && Character.isDigit(str.charAt(2))) {
                int n;
                com.pullenti.n2j.Outargwrapper<Integer> inoutarg1031 = new com.pullenti.n2j.Outargwrapper< >();
                boolean inoutres1032 = com.pullenti.n2j.Utils.parseInteger(str.substring(2), inoutarg1031);
                n = (inoutarg1031.value != null ? inoutarg1031.value : 0);
                if (inoutres1032) 
                    i += n;
            }
        }
