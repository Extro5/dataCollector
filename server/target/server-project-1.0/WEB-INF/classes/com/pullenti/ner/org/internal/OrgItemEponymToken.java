...
public class OrgItemEponymToken extends com.pullenti.ner.MetaToken {
    ...
    public java.util.ArrayList<String> eponyms = new java.util.ArrayList< >();
    ...
    public static OrgItemEponymToken tryAttach(com.pullenti.ner.Token t, boolean mustHasPrefix) {
        ...
        if (tt == null) {
            ...
            if (r1 != null && com.pullenti.n2j.Utils.stringsEq(r1.getTypeName(), "DATE")) {
                String str = r1.toString().toUpperCase();
                if ((com.pullenti.n2j.Utils.stringsEq(str, "1 МАЯ") || com.pullenti.n2j.Utils.stringsEq(str, "7 ОКТЯБРЯ") || com.pullenti.n2j.Utils.stringsEq(str, "9 МАЯ")) || com.pullenti.n2j.Utils.stringsEq(str, "8 МАРТА")) {
                    OrgItemEponymToken dt = _new1636(t, t, new java.util.ArrayList< >());
                    dt.eponyms.add(str);
                    return dt;
                }
            }
            ...
            if ((age != null && (((age.getEndToken().getNext() instanceof com.pullenti.ner.TextToken) || (age.getEndToken().getNext() instanceof com.pullenti.ner.ReferentToken))) && (age.getWhitespacesAfterCount() < 3)) && !age.getEndToken().getNext().chars.isAllLower() && age.getEndToken().getNext().chars.isCyrillicLetter()) {
                OrgItemEponymToken dt = _new1636(t, age.getEndToken().getNext(), new java.util.ArrayList< >());
                dt.eponyms.add(((Long)age.value).toString() + " " + dt.getEndToken().getSourceText().toUpperCase());
                return dt;
            }
            return null;
        }
        ...
        if (com.pullenti.n2j.Utils.stringsEq(tt.term, "ИМЕНИ") || com.pullenti.n2j.Utils.stringsEq(tt.term, "ІМЕНІ")) {
            t1 = t.getNext();
            full = true;
            hasName = true;
        }
        else if (((com.pullenti.n2j.Utils.stringsEq(tt.term, "ИМ") || com.pullenti.n2j.Utils.stringsEq(tt.term, "ІМ"))) && tt.getNext() != null) {
        ...
        if ((r != null && com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DATE") && full) && r.findSlot("DAY", null, true) != null && r.findSlot("YEAR", null, true) == null) {
            OrgItemEponymToken dt = _new1636(t, t1, new java.util.ArrayList< >());
        ...
        if (cl.isNoun() || cl.isAdjective()) {
            ...
            if (rt != null && com.pullenti.n2j.Utils.stringsEq(rt.referent.getTypeName(), "PERSON") && rt.getBeginToken() != rt.getEndToken()) {
        ...
        if (nt != null && nt.typ == com.pullenti.ner.NumberSpellingType.AGE) {
            ...
            if (npt != null) {
                String s = ((Long)nt.value).toString() + "-" + (t.kit.baseLanguage.isUa() ? "РОКІВ" : "ЛЕТ") + " " + com.pullenti.ner.core.MiscHelper.getTextValue(npt.getBeginToken(), npt.getEndToken(), com.pullenti.ner.core.GetTextAttr.NO);
                OrgItemEponymToken res = new OrgItemEponymToken(t, npt.getEndToken());
                res.eponyms.add(s);
                return res;
            }
        }
        java.util.ArrayList<PersonItemToken> its = tryAttach_PersonItemToken(t1);
        if (its == null) {
        ...
        java.util.ArrayList<String> eponims = new java.util.ArrayList< >();
        int i = 0;
        int j;
    ...
    public static class PersonItemToken extends com.pullenti.ner.MetaToken {
        ...
        public com.pullenti.ner.org.internal.OrgItemEponymToken.PersonItemType typ = com.pullenti.ner.org.internal.OrgItemEponymToken.PersonItemType.SURNAME;
    
        public String value;
    
        @Override
        public String toString() {
            return typ.toString() + " " + ((String)com.pullenti.n2j.Utils.notnull(value, ""));
        }
    
        public static PersonItemToken _new1640(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.org.internal.OrgItemEponymToken.PersonItemType _arg3, String _arg4) {
            PersonItemToken res = new PersonItemToken(_arg1, _arg2);
            res.typ = _arg3;
            res.value = _arg4;
            return res;
        }
        public static PersonItemToken _new1641(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.org.internal.OrgItemEponymToken.PersonItemType _arg3) {
            PersonItemToken res = new PersonItemToken(_arg1, _arg2);
            res.typ = _arg3;
            return res;
        }
    ...
    public static java.util.ArrayList<PersonItemToken> tryAttach_PersonItemToken(com.pullenti.ner.Token t) {
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (!Character.isLetter(s.charAt(0))) 
                break;
            if (((s.length() == 1 || com.pullenti.n2j.Utils.stringsEq(s, "ДЖ"))) && !tt.chars.isAllLower()) {
                com.pullenti.ner.Token t1 = t;
                if (t1.getNext() != null && t1.getNext().isChar('.')) 
                    t1 = t1.getNext();
                res.add(PersonItemToken._new1640(t, t1, PersonItemType.INITIAL, s));
                t = t1;
                continue;
            }
            if (tt.isAnd()) {
                res.add(PersonItemToken._new1641(t, t, PersonItemType.AND));
                continue;
            }
            ...
            if (tt.chars.isAllLower()) {
                ...
                if (t1.getNext() != null && !t1.isWhitespaceAfter() && t1.getNext().isChar('.')) 
                    t1 = t1.getNext();
                res.add(PersonItemToken._new1640(t, t1, PersonItemType.LOCASEWORD, s));
                t = t1;
                continue;
            }
            if (tt.getMorph()._getClass().isProperName()) 
                res.add(PersonItemToken._new1640(t, t, PersonItemType.NAME, s));
                ...
                res.add(PersonItemToken._new1640(t, t.getNext().getNext(), PersonItemType.SURNAME, s + "-" + (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t.getNext().getNext(), com.pullenti.ner.TextToken.class))).term));
                t = t.getNext().getNext();
            }
            else 
                res.add(PersonItemToken._new1640(t, t, PersonItemType.SURNAME, s));
        }
    ...
    public static OrgItemEponymToken _new1636(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, java.util.ArrayList<String> _arg3) {
