...
public class UriItemToken extends com.pullenti.ner.MetaToken {
    ...
    public static UriItemToken attachISOContent(com.pullenti.ner.Token t0, String specChars) {
        ...
        if (txt.length() == 0) 
            return null;
        return _new2642(t0, t1, txt.toString());
    }
    ...
    private static UriItemToken _AttachUriContent(com.pullenti.ner.Token t0, String _chars, boolean canBeWhitespaces) {
                ...
                if (t.getPrevious().isHiphen()) {
                    ...
                    for(; tt1 != null; tt1 = tt1.getNext()) {
                        ...
                        if (!((tt1 instanceof com.pullenti.ner.TextToken))) 
                            break;
                        String term1 = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt1, com.pullenti.ner.TextToken.class))).term;
                        if (((com.pullenti.n2j.Utils.stringsEq(term1, "HTM") || com.pullenti.n2j.Utils.stringsEq(term1, "HTML") || com.pullenti.n2j.Utils.stringsEq(term1, "SHTML")) || com.pullenti.n2j.Utils.stringsEq(term1, "ASP") || com.pullenti.n2j.Utils.stringsEq(term1, "ASPX")) || com.pullenti.n2j.Utils.stringsEq(term1, "JSP")) {
                            ok = true;
                            break;
                        }
        ...
        if (tmp.startsWith("\\\\")) {
            com.pullenti.n2j.Utils.replace(txt, "\\\\", "//");
            tmp = txt.toString();
        }
        if (tmp.startsWith("//")) 
            tmp = tmp.substring(2);
        if (com.pullenti.n2j.Utils.stringsCompare(tmp, "WWW", true) == 0) 
            return null;
        UriItemToken res = _new2642(t0, t1, txt.toString());
        return res;
    }
    ...
    public static UriItemToken attachDomainName(com.pullenti.ner.Token t0, boolean _check, boolean canBeWhitspaces) {
        ...
        for(com.pullenti.ner.Token t = t0; t != null; t = t.getNext()) {
            ...
            if (t instanceof com.pullenti.ner.NumberToken) {
                ...
                txt.append(nt.getSourceText());
                t1 = t;
                if (nt.typ == com.pullenti.ner.NumberSpellingType.DIGIT && nt.value >= ((long)0) && (nt.value < ((long)256))) 
                    ipCount++;
                else 
                    isIp = false;
                continue;
            ...
            if (tt == null) 
                break;
            String src = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term;
            char ch = src.charAt(0);
            if (!Character.isLetter(ch)) {
                if (".-_".indexOf(ch) < 0) 
                    break;
        ...
        if (_check) {
            boolean ok = isIp;
            if (!isIp) {
                if (com.pullenti.n2j.Utils.stringsEq(txt.toString(), "localhost")) 
                    ok = true;
            }
        ...
        return _new2642(t0, t1, txt.toString().toLowerCase());
    }
    ...
    public static java.util.ArrayList<UriItemToken> attachMailUsers(com.pullenti.ner.Token t1) {
        ...
        if (txt.length() == 0) 
            return null;
        java.util.ArrayList<UriItemToken> res = new java.util.ArrayList< >();
        res.add(_new2642(t0, t1, txt.toString().toLowerCase()));
        return res;
    }
    ...
    public static UriItemToken attachUrl(com.pullenti.ner.Token t0) {
        ...
        if (t1.getNext() != null && t1.getNext().isChar(':') && (t1.getNext().getNext() instanceof com.pullenti.ner.NumberToken)) {
            ...
            txt.append(":").append((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t1, com.pullenti.ner.NumberToken.class))).value);
        }
    ...
    public static UriItemToken attachISBN(com.pullenti.ner.Token t0) {
        ...
        for(com.pullenti.ner.Token t = t0; t != null; t = t.getNext()) {
            ...
            if (tt == null) 
                break;
            String s = tt.term;
            if (com.pullenti.n2j.Utils.stringsNe(s, "-") && com.pullenti.n2j.Utils.stringsNe(s, "Х") && com.pullenti.n2j.Utils.stringsNe(s, "X")) 
                break;
            if (com.pullenti.n2j.Utils.stringsEq(s, "Х")) 
                s = "X";
            txt.append(s);
            t1 = t;
            if (com.pullenti.n2j.Utils.stringsNe(s, "-")) 
                break;
        }
        int i;
        int dig = 0;
    ...
    public static void initialize() {
        ...
        for(String domainGroup : domainGroups) {
            for(String domain : com.pullenti.n2j.Utils.split(domainGroup.toUpperCase(), String.valueOf(separator), true)) {
                m_StdGroups.add(new com.pullenti.ner.core.Termin(domain, com.pullenti.morph.MorphLang.UNKNOWN, true));
            }
        }
    }

    public static UriItemToken _new2642(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
