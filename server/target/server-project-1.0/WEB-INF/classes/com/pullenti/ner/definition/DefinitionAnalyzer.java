...
public class DefinitionAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public com.pullenti.ner.Referent createReferent(String type) {
        if (com.pullenti.n2j.Utils.stringsEq(type, DefinitionReferent.OBJ_TYPENAME)) 
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        java.util.HashMap<String, Boolean> oh = new java.util.HashMap< >();
            ...
            for(com.pullenti.ner.ExtOntologyItem it : kit.ontology.items) {
                if (it.referent instanceof DefinitionReferent) {
                    ...
                    if (!oh.containsKey(termin)) {
                        oh.put(termin, true);
                        onto.add(com.pullenti.ner.core.Termin._new1054(termin, termin));
                    }
                }
            }
        ...
        for(com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            if (!ok) 
                continue;
            java.util.ArrayList<com.pullenti.ner.ReferentToken> prs = tryAttach(t, glosRegime, onto, maxChar);
            if (prs == null) 
                prs = tryAttachEnd(t, onto, maxChar);
            if (prs != null) {
    ...
    public com.pullenti.ner.ReferentToken processReferent(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        java.util.ArrayList<com.pullenti.ner.ReferentToken> li = tryAttach(begin, false, null, 0);
    ...
    public java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttach(com.pullenti.ner.Token t, boolean glosRegime, com.pullenti.ner.core.TerminCollection onto, int maxChar) {
        if (t == null) 
            return null;
        com.pullenti.ner.Token t0 = t;
        ...
        if ((t != null && t.isValue("УТРАТИТЬ", null) && t.getNext() != null) && t.getNext().isValue("СИЛА", null)) {
            for(; t != null; t = t.getNext()) {
                if (t.isNewlineAfter()) {
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> re0 = new java.util.ArrayList< >();
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (!((t instanceof com.pullenti.ner.TextToken))) {
                ...
                if (r != null && ((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DECREE") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DECREEPART")))) {
                    _decree = r;
                    if (l0 == null) {
                ...
                if (r != null && (((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ORGANIZATION") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "PERSONPROPERTY") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "STREET")) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "GEO")))) {
                    if (l0 == null) 
                        l0 = t;
                    l1 = t;
                    continue;
            ...
            if (pt != null && pt.ref != null) {
                if (com.pullenti.n2j.Utils.stringsEq(pt.ref.getTypeName(), "DECREE") || com.pullenti.n2j.Utils.stringsEq(pt.ref.getTypeName(), "DECREEPART")) 
                    _decree = pt.ref;
                t = pt.getEndToken().getNext();
                if (l0 == null) 
                    continue;
            ...
            if (npt == null) {
                ...
                if (!t.chars.isAllLower() && t.getMorphClassInDictionary().isUndefined()) {
                }
                else 
                    continue;
            }
        ...
        if (t.isHiphen() || t.isCharOf(":") || ((canNextSent && t.isChar('.')))) {
            if ((t.getNext() instanceof com.pullenti.ner.TextToken) && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t.getNext(), com.pullenti.ner.TextToken.class))).term, "ЭТО")) {
                ok = 2;
                t = t.getNext().getNext();
            }
            else if (glosRegime) {
                ...
                java.util.ArrayList<com.pullenti.ner.ReferentToken> rt0 = tryAttach(t.getNext(), false, null, maxChar);
                if (rt0 != null) {
                    for(com.pullenti.ner.ReferentToken rt : rt0) {
                        if (coef == DefinitionKind.DEFINITION && (((DefinitionReferent)com.pullenti.n2j.Utils.cast(rt.referent, DefinitionReferent.class))).getKind() == DefinitionKind.ASSERTATION) 
                            (((DefinitionReferent)com.pullenti.n2j.Utils.cast(rt.referent, DefinitionReferent.class))).setKind(coef);
                    }
                    return rt0;
                }
            }
        }
        else if (com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "ЭТО")) {
        ...
        normalLeft = true;
        String nam = (String)com.pullenti.n2j.Utils.notnull(name0, com.pullenti.ner.core.MiscHelper.getTextValue(l0, l1, (normalLeft ? com.pullenti.ner.core.GetTextAttr.FIRSTNOUNGROUPTONOMINATIVESINGLE : com.pullenti.ner.core.GetTextAttr.NO)));
        if (nam == null) 
            return null;
        if (l0 == l1 && l0.getMorph()._getClass().isAdjective() && l0.getMorph().getCase().isInstrumental()) {
            if (t != null && t.isValue("ТАКОЙ", null)) {
                ...
                if (npt != null && npt.getMorph().getCase().isNominative()) {
                    ...
                    nam = str + " " + npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false);
                }
            }
        }
        if (_decree != null) {
        ...
        if (miscToken != null) {
            if (miscToken.getMorph()._getClass().isNoun()) 
                dr.addSlot(DefinitionReferent.ATTR_TERMIN_ADD, (String)com.pullenti.n2j.Utils.cast(miscToken.tag, String.class), false, 0);
            else 
                dr.addSlot(DefinitionReferent.ATTR_MISC, (String)com.pullenti.n2j.Utils.cast(miscToken.tag, String.class), false, 0);
        }
        com.pullenti.ner.Token t1 = null;
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.isChar('(') && (t.getNext() instanceof com.pullenti.ner.ReferentToken)) {
                ...
                if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DECREE") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DECREEPART")) {
                    _decree = r;
                    t1 = (t = t.getNext());
                    while(t.getNext() != null) {
                        if (t.getNext().isCommaAnd() && (t.getNext().getNext() instanceof com.pullenti.ner.ReferentToken) && ((com.pullenti.n2j.Utils.stringsEq(t.getNext().getNext().getReferent().getTypeName(), "DECREE") || com.pullenti.n2j.Utils.stringsEq(t.getNext().getNext().getReferent().getTypeName(), "DECREEPART")))) 
            ...
            if (t.isChar(':') && t.isWhitespaceAfter()) {
                ...
                if (mt != null) {
                    multiParts = new java.util.ArrayList< >();
                    multiParts.add(mt);
        ...
        if (multiParts != null) {
            java.util.ArrayList<com.pullenti.ner.ReferentToken> res1 = new java.util.ArrayList< >();
    ...
    private java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttachEnd(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection onto, int maxChar) {
        ...
        if ((((l1.endChar - l0.endChar)) * 2) > ((r1.endChar - r0.endChar))) 
            return null;
        DefinitionReferent dr = DefinitionReferent._new1055(DefinitionKind.DEFINITION);
    ...
    private static com.pullenti.ner.MetaToken _tryAttachMiscToken(com.pullenti.ner.Token t) {
        ...
        if (t.isValue("КАК", null)) {
            ...
            if (t1 != null) {
                com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new799(t, t1, com.pullenti.ner.core.MiscHelper.getTextValue(t, t1, com.pullenti.ner.core.GetTextAttr.KEEPQUOTES));
        ...
        if (npt != null) {
            if (m_MiscFirstWords.tryParse(npt.noun.getBeginToken(), com.pullenti.ner.core.TerminParseAttr.NO) != null) {
                com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new799(t, npt.getEndToken(), npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), true, com.pullenti.morph.MorphGender.UNDEFINED, false));
        ...
        if (t.isValue("В", null)) {
            ...
            if (npt != null) {
                if (npt.noun.isValue("СМЫСЛ", null)) {
                    com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new799(t, npt.getEndToken(), com.pullenti.ner.core.MiscHelper.getTextValue(t, npt.getEndToken(), com.pullenti.ner.core.GetTextAttr.NO));
                    res.getMorph()._setClass(com.pullenti.morph.MorphClass.NOUN);
                    return res;
                }
            }
    ...
    public static int calcSemanticCoef(String text1, String text2) {
        com.pullenti.ner.AnalysisResult ar1 = m_Proc0.process(new com.pullenti.ner.SourceOfAnalysis(text1), null, new com.pullenti.morph.MorphLang(null));
        if (ar1 == null || ar1.firstToken == null) 
            return 0;
        com.pullenti.ner.AnalysisResult ar2 = m_Proc0.process(new com.pullenti.ner.SourceOfAnalysis(text2), null, new com.pullenti.morph.MorphLang(null));
        if (ar2 == null || ar2.firstToken == null) 
            return 0;
        java.util.ArrayList<String> terms1 = new java.util.ArrayList< >();
        java.util.ArrayList<String> terms2 = new java.util.ArrayList< >();
        for(int k = 0; k < 2; k++) {
            ...
            for(com.pullenti.ner.Token t = ((k == 0 ? ar1.firstToken : ar2.firstToken)); t != null; t = t.getNext()) {
                com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt != null) {
                    String term = npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                    if (term == null) 
                        continue;
     ...
     */
    public static java.util.ArrayList<String> getConcepts(String txt) {
        com.pullenti.ner.AnalysisResult ar = m_Proc0.process(new com.pullenti.ner.SourceOfAnalysis(txt), null, new com.pullenti.morph.MorphLang(null));
        ...
        if (ar != null) {
            for(com.pullenti.ner.Token t = ar.firstToken; t != null; t = t.getNext()) {
                ...
                if (npt != null) 
                    t1 = npt.getEndToken();
                else if ((t instanceof com.pullenti.ner.TextToken) && (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).isPureVerb()) 
                    t1 = t;
                if (t1 == null) 
                    continue;
                ...
                for(com.pullenti.ner.Token tt = t; tt != null && tt.endChar <= t1.endChar; tt = tt.getNext()) {
                    ...
                    if (tt.isCommaAnd() || t.getMorph()._getClass().isPreposition()) 
                        continue;
                    String w = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getLemma();
                    if (w.length() < 3) 
                        continue;
                    java.util.ArrayList<com.pullenti.morph.DerivateGroup> dg = com.pullenti.morph.Explanatory.findDerivates(w, true, new com.pullenti.morph.MorphLang());
