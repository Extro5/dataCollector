...
public class ReferentToken extends MetaToken {
    ...
    public static ReferentToken _new1201(Referent _arg1, Token _arg2, Token _arg3, MorphCollection _arg4, com.pullenti.ner.core.AnalyzerData _arg5) {
        ReferentToken res = new ReferentToken(_arg1, _arg2, _arg3, null);
        res.setMorph(_arg4);
        res.data = _arg5;
        return res;
    }
    public static ReferentToken _new2273(Referent _arg1, Token _arg2, Token _arg3, MorphCollection _arg4, int _arg5) {
        ReferentToken res = new ReferentToken(_arg1, _arg2, _arg3, null);
        res.setMorph(_arg4);
        res.miscAttrs = _arg5;
        return res;
    }
    public static ReferentToken _new2372(Referent _arg1, Token _arg2, Token _arg3, int _arg4) {
        ReferentToken res = new ReferentToken(_arg1, _arg2, _arg3, null);
        res.miscAttrs = _arg4;
        return res;
    }
    public static ReferentToken _new2382(Referent _arg1, Token _arg2, Token _arg3, MorphCollection _arg4, Object _arg5) {
        ReferentToken res = new ReferentToken(_arg1, _arg2, _arg3, null);
        res.setMorph(_arg4);
        res.tag = _arg5;
        return res;
