...
public class PersonHelper {
    ...
    public static com.pullenti.ner.ReferentToken createReferentToken(com.pullenti.ner.person.PersonReferent p, com.pullenti.ner.Token begin, com.pullenti.ner.Token end, com.pullenti.ner.MorphCollection _morph, java.util.ArrayList<PersonAttrToken> attrs, com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData ad, boolean forAttribute, boolean afterBePredicate) {
        ...
        if (attrs != null) {
            ...
            if (com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(begin.getPrevious(), com.pullenti.ner.TextToken.class))).term, "ИП")) {
        ...
        if (forAttribute) 
            return com.pullenti.ner.ReferentToken._new2273(p, begin, end, _morph, p.m_PersonIdentityTyp.value());
        if ((begin.getPrevious() != null && begin.getPrevious().isCommaAnd() && (begin.getPrevious().getPrevious() instanceof com.pullenti.ner.ReferentToken)) && (begin.getPrevious().getPrevious().getReferent() instanceof com.pullenti.ner.person.PersonReferent)) {
            com.pullenti.ner.ReferentToken rt00 = (com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(begin.getPrevious().getPrevious(), com.pullenti.ner.ReferentToken.class);
            for(com.pullenti.ner.Token ttt = rt00; ttt != null; ) {
                ...
                if (!ttt.getPrevious().isCommaAnd() || !((ttt.getPrevious().getPrevious().getReferent() instanceof com.pullenti.ner.person.PersonReferent))) 
                    break;
                rt00 = (com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(ttt.getPrevious().getPrevious(), com.pullenti.ner.ReferentToken.class);
                ttt = rt00;
            }
            if (rt00.getBeginToken().getReferent() instanceof com.pullenti.ner.person.PersonPropertyReferent) {
                boolean ok = false;
                if ((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(rt00.getBeginToken(), com.pullenti.ner.ReferentToken.class))).getEndToken().getNext() != null && (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(rt00.getBeginToken(), com.pullenti.ner.ReferentToken.class))).getEndToken().getNext().isChar(':')) 
                    ok = true;
        ...
        for(com.pullenti.ner.Token t = end.getNext(); t != null; t = t.getNext()) {
            ...
            if (t.isChar('(') && t == end.getNext()) {
                ...
                if ((pit1 != null && t.chars.isCapitalUpper() && pit1.getEndToken().getNext() != null) && (t instanceof com.pullenti.ner.TextToken) && pit1.getEndToken().getNext().isChar(')')) {
                    if (pit1.lastname != null) {
                        com.pullenti.morph.MorphBaseInfo inf = com.pullenti.morph.MorphBaseInfo._new2220(com.pullenti.morph.MorphCase.NOMINATIVE);
                        if (p.isMale()) 
                ...
                t = t.getNext();
                if ((t instanceof com.pullenti.ner.TextToken) && (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).isValue("WHO", null)) 
                    continue;
            }
            else if ((t instanceof com.pullenti.ner.TextToken) && (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).isVerbBe()) 
                t = t.getNext();
            ...
            if (attr == null) {
                if ((t != null && t.getReferent() != null && com.pullenti.n2j.Utils.stringsEq(t.getReferent().getTypeName(), "GEO")) && attrs1 != null && openBr) 
                    continue;
            ...
            if (attrs1 == null) {
                ...
                attrs1 = new java.util.ArrayList< >();
            }
            attrs1.add(attr);
        ...
        for(com.pullenti.ner.Token t = end.getNext(); t != null; t = t.getNext()) {
            ...
            if (r != null) {
                if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "PHONE") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "URI") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ADDRESS")) {
                    String ty = r.getStringValue("SCHEME");
                    if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "URI")) {
                        if ((com.pullenti.n2j.Utils.stringsNe(ty, "mailto") && com.pullenti.n2j.Utils.stringsNe(ty, "skype") && com.pullenti.n2j.Utils.stringsNe(ty, "ICQ")) && com.pullenti.n2j.Utils.stringsNe(ty, "http")) 
                            break;
                    }
                    p.addContact(r);
                    end = t;
            ...
            if (r != null && com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ORGANIZATION")) {
                ...
                for(com.pullenti.ner.Slot s : p.getSlots()) {
                    if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.person.PersonReferent.ATTR_ATTR) && (s.getValue() instanceof com.pullenti.ner.person.PersonPropertyReferent)) {
                        com.pullenti.ner.person.PersonPropertyReferent pr = (com.pullenti.ner.person.PersonPropertyReferent)com.pullenti.n2j.Utils.cast(s.getValue(), com.pullenti.ner.person.PersonPropertyReferent.class);
                        if (pr.findSlot(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, r, true) != null) {
                            exist = true;
                            break;
                        }
                    }
                    else if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.person.PersonReferent.ATTR_ATTR) && (s.getValue() instanceof PersonAttrToken)) {
                        PersonAttrToken pr = (PersonAttrToken)com.pullenti.n2j.Utils.cast(s.getValue(), PersonAttrToken.class);
                ...
                if (!exist) {
                    ...
                    pat.setPropRef(com.pullenti.ner.person.PersonPropertyReferent._new2190("сотрудник"));
    ...
    private static com.pullenti.ner.Token correctTailAttributes(com.pullenti.ner.person.PersonReferent p, com.pullenti.ner.Token t0) {
        ...
        if (t != null && t.getReferent() != null) {
            com.pullenti.ner.Referent r = t.getReferent();
            if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DATE")) {
        ...
        if (die && t != null) {
            ...
            if (ag != null) {
                if (p != null) 
                    p.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_AGE, ((Long)ag.value).toString(), false, 0);
        ...
        if (t.isChar('(')) {
            ...
            if (br != null) {
                ...
                if (t1 instanceof com.pullenti.ner.ReferentToken) {
                    ...
                    if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DATERANGE") && t1.getNext() == br.getEndToken()) {
                        com.pullenti.ner.Referent bd = (com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(r.getValue("FROM"), com.pullenti.ner.Referent.class);
                        com.pullenti.ner.Referent to = (com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(r.getValue("TO"), com.pullenti.ner.Referent.class);
                        if (bd != null && to != null) {
                            if (p != null) {
                    ...
                    else if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DATE") && t1.getNext() == br.getEndToken()) {
                        if (p != null) 
                            p.addSlot(com.pullenti.ner.person.PersonReferent.ATTR_BORN, r, false, 0);
                        t = (res = br.getEndToken());
                    }
