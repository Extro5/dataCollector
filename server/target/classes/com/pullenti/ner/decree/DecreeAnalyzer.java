...
public class DecreeAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.HashMap<String, byte[]> getImages() {
        ...
        res.put(com.pullenti.ner.decree.internal.MetaDecree.DECREEIMAGEID, com.pullenti.ner.decree.internal.ResourceHelper.getBytes("decree.png"));
        res.put(com.pullenti.ner.decree.internal.MetaDecree.STANDADRIMAGEID, com.pullenti.ner.decree.internal.ResourceHelper.getBytes("decreestd.png"));
        res.put(com.pullenti.ner.decree.internal.MetaDecreePart.PARTIMAGEID, com.pullenti.ner.decree.internal.ResourceHelper.getBytes("part.png"));
        res.put(com.pullenti.ner.decree.internal.MetaDecreePart.PARTLOCIMAGEID, com.pullenti.ner.decree.internal.ResourceHelper.getBytes("document_into.png"));
        res.put(com.pullenti.ner.decree.internal.MetaDecree.PUBLISHIMAGEID, com.pullenti.ner.decree.internal.ResourceHelper.getBytes("publish.png"));
        res.put(com.pullenti.ner.decree.internal.MetaDecreeChange.IMAGEID, com.pullenti.ner.decree.internal.ResourceHelper.getBytes("decreechange.png"));
        res.put(com.pullenti.ner.decree.internal.MetaDecreeChangeValue.IMAGEID, com.pullenti.ner.decree.internal.ResourceHelper.getBytes("decreechangevalue.png"));
        return res;
    }
    ...
    public Iterable<String> getUsedExternObjectTypes() {
        return java.util.Arrays.asList(new String[] {com.pullenti.ner.date.DateReferent.OBJ_TYPENAME, com.pullenti.ner.geo.GeoReferent.OBJ_TYPENAME, com.pullenti.ner.org.OrganizationReferent.OBJ_TYPENAME, com.pullenti.ner.person.PersonReferent.OBJ_TYPENAME});
    }


    @Override
    public com.pullenti.ner.Referent createReferent(String type) {
        if (com.pullenti.n2j.Utils.stringsEq(type, DecreeReferent.OBJ_TYPENAME)) 
            return new DecreeReferent();
        if (com.pullenti.n2j.Utils.stringsEq(type, DecreePartReferent.OBJ_TYPENAME)) 
            return new DecreePartReferent();
        if (com.pullenti.n2j.Utils.stringsEq(type, DecreeChangeReferent.OBJ_TYPENAME)) 
            return new DecreeChangeReferent();
        if (com.pullenti.n2j.Utils.stringsEq(type, DecreeChangeValueReferent.OBJ_TYPENAME)) 
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        for(com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext(),lastDecDist++) {
            ...
            if (tok != null) {
                DecreeReferent dec0 = (DecreeReferent)com.pullenti.n2j.Utils.cast(tok.termin.tag, DecreeReferent.class);
                com.pullenti.ner.ReferentToken rt0 = new com.pullenti.ner.ReferentToken((com.pullenti.ner.Referent)com.pullenti.n2j.Utils.cast(tok.termin.tag, com.pullenti.ner.Referent.class), tok.getBeginToken(), tok.getEndToken(), null);
                if (dec0 != null && (rt0.getEndToken().getNext() instanceof com.pullenti.ner.ReferentToken) && (rt0.getEndToken().getNext().getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) {
                    com.pullenti.ner.geo.GeoReferent geo0 = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(dec0.getValue(DecreeReferent.ATTR_GEO), com.pullenti.ner.geo.GeoReferent.class);
                    com.pullenti.ner.geo.GeoReferent geo1 = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(rt0.getEndToken().getNext().getReferent(), com.pullenti.ner.geo.GeoReferent.class);
                    if (geo0 == null) {
            ...
            if (dts == null || dts.size() == 0 || ((dts.size() == 1 && dts.get(0).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP))) {
                ...
                if (rt0 != null) {
                    ...
                    else if ((((mt = (com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(rt0.tag, com.pullenti.ner.MetaToken.class)))) != null) {
                        if (aliases != null) {
                            com.pullenti.ner.core.Termin term = new com.pullenti.ner.core.Termin(null, new com.pullenti.morph.MorphLang(null), false);
                            term.initBy(mt.getBeginToken(), mt.getEndToken().getPrevious(), rt0.referent, false);
                            aliases.add(term);
            ...
            if (dts.get(0).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP && com.pullenti.ner.decree.internal.DecreeToken.getKind(dts.get(0).value) == DecreeKind.PUBLISHER) {
                java.util.ArrayList<com.pullenti.ner.ReferentToken> rts = tryAttachPulishers(dts);
                if (rts != null) {
                    for(int i = 0; i < rts.size(); i++) {
                        com.pullenti.ner.ReferentToken rtt = rts.get(i);
                        if (rtt.referent instanceof DecreePartReferent) 
                            (((DecreePartReferent)com.pullenti.n2j.Utils.cast(rtt.referent, DecreePartReferent.class))).setOwner((DecreeReferent)com.pullenti.n2j.Utils.cast(ad.registerReferent((((DecreePartReferent)com.pullenti.n2j.Utils.cast(rtt.referent, DecreePartReferent.class))).getOwner()), DecreeReferent.class));
                    ...
                    if (mt != null) {
                        for(com.pullenti.ner.Token tt = dts.get(0).getBeginToken().getPrevious(); tt != null; tt = tt.getPrevious()) {
                            if (tt.isComma()) 
                                continue;
                            DecreeReferent d = (DecreeReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), DecreeReferent.class);
                            if (d != null) {
                                if (aliases != null) {
                                    com.pullenti.ner.core.Termin term = new com.pullenti.ner.core.Termin(null, new com.pullenti.morph.MorphLang(null), false);
            ...
            if (rtli != null) {
                for(int ii = 0; ii < rtli.size(); ii++) {
                    ...
                    else if ((((mt = (com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(rt.tag, com.pullenti.ner.MetaToken.class)))) != null) {
                        if (aliases != null) {
                            com.pullenti.ner.core.Termin term = new com.pullenti.ner.core.Termin(null, new com.pullenti.morph.MorphLang(null), false);
                            term.initBy(mt.getBeginToken(), mt.getEndToken().getPrevious(), rt.referent, false);
                            aliases.add(term);
                ...
                if (dts.get(0).chars.isCapitalUpper() && !dts.get(0).isDoubtful) {
                    ...
                    if (baseTyp != null && dts.get(0).ref != null) {
                        DecreeReferent drr = (DecreeReferent)com.pullenti.n2j.Utils.cast(dts.get(0).ref.getReferent(), DecreeReferent.class);
                        if (drr != null) {
                            if (com.pullenti.n2j.Utils.stringsEq(baseTyp.value, drr.getTyp0()) || com.pullenti.n2j.Utils.stringsEq(baseTyp.value, drr.getTyp())) 
                                continue;
                        }
                    }
        ...
        if (ad.getReferents().size() > 0) {
            for(com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                DecreeReferent dr = (DecreeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), DecreeReferent.class);
                if (dr == null) 
                    continue;
                ...
                for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                    ...
                    dr = (DecreeReferent)com.pullenti.n2j.Utils.cast(tt.getNext().getReferent(), DecreeReferent.class);
                    li.add(dr);
                    tt = tt.getNext();
                }
                if (li == null) 
                ...
                for(i = li.size() - 1; i > 0; i--) {
                    if (com.pullenti.n2j.Utils.stringsEq(li.get(i).getTyp(), li.get(i - 1).getTyp())) {
                        if (li.get(i).getDate() != null && li.get(i - 1).getDate() == null) 
                            li.get(i - 1).addSlot(DecreeReferent.ATTR_DATE, li.get(i).getValue(DecreeReferent.ATTR_DATE), false, 0);
                    }
                }
                ...
                if (i == (li.size() - 1)) {
                    for(i = li.size() - 1; i > 0; i--) {
                        if (com.pullenti.n2j.Utils.stringsEq(li.get(i - 1).getTyp(), li.get(i).getTyp())) 
                            li.get(i - 1).addName(li.get(i));
                    }
                }
            }
        }
        java.util.ArrayList<DecreePartReferent> undefinedDecrees = new java.util.ArrayList< >();
        DecreeChangeReferent rootChange = null;
        DecreeChangeReferent lastChange = null;
        java.util.ArrayList<com.pullenti.ner.Referent> changeStack = new java.util.ArrayList< >();
        ...
        for(com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            if (rts != null) {
                for(com.pullenti.ner.MetaToken kp : rts) {
                    java.util.ArrayList<DecreePartReferent> dprList = (java.util.ArrayList<DecreePartReferent>)com.pullenti.n2j.Utils.cast(kp.tag, java.util.ArrayList.class);
                    if (dprList == null) 
                        continue;
                    for(int i = 0; i < dprList.size(); i++) {
                            ...
                            while(changeStack.size() > 0) {
                                if (dr.isAllItemsLessLevel(changeStack.get(0), false)) {
                                    if (changeStack.get(0) instanceof DecreePartReferent) 
                                        dr.addHighLevelInfo((DecreePartReferent)com.pullenti.n2j.Utils.cast(changeStack.get(0), DecreePartReferent.class));
                                    break;
                                }
                                if (changeStack.get(0) instanceof DecreePartReferent) 
                        ...
                        if (lastChange != null && lastChange.getOwners().size() > 0) {
                            DecreePartReferent dr0 = (DecreePartReferent)com.pullenti.n2j.Utils.cast(lastChange.getOwners().get(0), DecreePartReferent.class);
                        ...
                        dr = (DecreePartReferent)com.pullenti.n2j.Utils.cast(ad.registerReferent(dr), DecreePartReferent.class);
                        if (dprs == null) 
                            dprs = new java.util.ArrayList< >();
                        dprs.add(dr);
            ...
            if (dcht != null && hasStartChange > 0) {
                ...
                if (dcht.typ == com.pullenti.ner.decree.internal.DecreeChangeTokenTyp.STARTMULTU) {
                    ...
                    if (changeStack.size() > 0 || dcht.decree != null) {
                        rootChange = (DecreeChangeReferent)com.pullenti.n2j.Utils.cast(ad.registerReferent(DecreeChangeReferent._new1035(DecreeChangeKind.CONTAINER)), DecreeChangeReferent.class);
                ...
                if (dprs != null && dprs.size() > 0) {
                    ...
                    if (chrt == null && expireRegime) {
                        chrt = new java.util.ArrayList< >();
                        DecreeChangeReferent dcr = DecreeChangeReferent._new1035(DecreeChangeKind.EXPIRE);
                    ...
                    if (dcht.partTyp != com.pullenti.ner.decree.internal.PartToken.ItemType.UNDEFINED) {
                        for(com.pullenti.ner.Referent ss : changeStack) {
                            if (ss instanceof DecreePartReferent) {
                                if ((((DecreePartReferent)com.pullenti.n2j.Utils.cast(ss, DecreePartReferent.class))).isAllItemsOverThisLevel(dcht.partTyp)) {
                                    ee = true;
                ...
                if ((chrt == null && ((expireRegime || dcht.actKind == DecreeChangeKind.EXPIRE)) && dcht.decree != null) && dprs == null) {
                    ...
                    for(com.pullenti.ner.Token tt = dcht.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                        ...
                        if (tt.getReferent() instanceof DecreeReferent) {
                            dcr = DecreeChangeReferent._new1035(DecreeChangeKind.EXPIRE);
                ...
                if (chrt != null) {
                    for(com.pullenti.ner.ReferentToken rt : chrt) {
                        ...
                        if (rt.referent instanceof DecreeChangeReferent) {
                            lastChange = (DecreeChangeReferent)com.pullenti.n2j.Utils.cast(rt.referent, DecreeChangeReferent.class);
                            if (dprs != null) {
                                int ii;
    ...
    public static com.pullenti.ner.ReferentToken tryAttachApproved(com.pullenti.ner.Token t, com.pullenti.ner.core.AnalyzerData ad) {
        ...
        if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false)) {
            ...
            if (br != null) {
                com.pullenti.ner.ReferentToken rt0 = _tryAttachApproved(br.getEndToken().getNext(), ad);
                if (rt0 == null) 
                    return null;
                DecreeReferent dr = (DecreeReferent)com.pullenti.n2j.Utils.cast(rt0.referent, DecreeReferent.class);
                rt0.setBeginToken(t);
        ...
        for(tt = tt.getNext(); tt != null; tt = tt.getNext()) {
            ...
            if ((((tt instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).value == ((long)1))) || tt.isValue("ДРУГОЙ", null)) {
            ...
            if (com.pullenti.ner.decree.internal.DecreeToken.isKeyword(tt, false) != null && tt.chars.isCapitalUpper()) 
                break;
            com.pullenti.ner.ReferentToken rt0 = _tryAttachApproved(tt, ad);
            if (rt0 != null) {
                ...
                if (dt != null && dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP && (((DecreeReferent)com.pullenti.n2j.Utils.cast(rt0.referent, DecreeReferent.class))).getTyp() == null) {
                    (((DecreeReferent)com.pullenti.n2j.Utils.cast(rt0.referent, DecreeReferent.class))).setTyp(dt.value);
                ...
                if (nam != null) 
                    (((DecreeReferent)com.pullenti.n2j.Utils.cast(rt0.referent, DecreeReferent.class))).addNameStr(nam);
                rt0.setBeginToken(t);
                rt0.tag = alias;
                return rt0;
            }
    ...
    private static com.pullenti.ner.ReferentToken _tryAttachApproved(com.pullenti.ner.Token t, com.pullenti.ner.core.AnalyzerData ad) {
        if (t == null) 
            return null;
        if (!t.isCharOf("(,") || t.getNext() == null) 
            return null;
        ...
        for(; t != null; t = t.getNext()) {
            if (t.isCommaAnd() || t.getMorph()._getClass().isPreposition()) 
                continue;
            if ((t.getReferent() instanceof com.pullenti.ner.geo.GeoReferent) && (((com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.geo.GeoReferent.class))).isCity()) 
                continue;
        ...
        Object olev = null;
        int lev = 0;
        com.pullenti.n2j.Outargwrapper<Object> inoutarg1039 = new com.pullenti.n2j.Outargwrapper< >();
        Boolean inoutres1040 = com.pullenti.n2j.Utils.tryGetValue(kit.miscData, "dovr", inoutarg1039);
        olev = inoutarg1039.value;
        if (!inoutres1040) 
    ...
    private static DecreeReferent _getDecree(com.pullenti.ner.Token t) {
        if (!((t instanceof com.pullenti.ner.ReferentToken))) 
            return null;
        com.pullenti.ner.Referent r = t.getReferent();
        if (r instanceof DecreeReferent) 
            return (DecreeReferent)com.pullenti.n2j.Utils.cast(r, DecreeReferent.class);
        if (r instanceof DecreePartReferent) 
            return (((DecreePartReferent)com.pullenti.n2j.Utils.cast(r, DecreePartReferent.class))).getOwner();
        return null;
    }

    private static com.pullenti.ner.Token _checkOtherTyp(com.pullenti.ner.Token t, boolean first) {
        if (t == null) 
            return null;
    ...
    private java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttachPulishers(java.util.ArrayList<com.pullenti.ner.decree.internal.DecreeToken> dts) {
        ...
        com.pullenti.ner.ReferentToken org = null;
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (pt != null) {
                ...
                if (pub == null) {
                    ...
                    if (org != null) 
                        pub.addSlot(DecreeReferent.ATTR_SOURCE, org.referent, false, 0).setTag(org.getSourceText());
                    if (_date != null) 
                        pub.addDate(_date);
                    pub.addNumber(num);
                    res.add(new com.pullenti.ner.ReferentToken(pub, (com.pullenti.ner.Token)com.pullenti.n2j.Utils.notnull(t0, t), pt.getBeginToken().getPrevious(), null));
                }
                if (pubPart == null) {
                    pubPart = DecreePartReferent._new1041(pub);
                ...
                if (com.pullenti.n2j.Utils.stringsEq(pubPart.getClause(), "6878")) {
                }
                pubPart0 = pubPart;
            ...
            if (t instanceof com.pullenti.ner.NumberToken) {
                ...
                if (rt != null) {
                    _date = com.pullenti.ner.decree.internal.DecreeToken._new805(rt.getBeginToken(), rt.getEndToken(), com.pullenti.ner.decree.internal.DecreeToken.ItemType.DATE);
                    _date.ref = rt;
                    pub0 = null;
                    pubPart0 = null;
                    if (t0 == null) 
                ...
                if (t.getNext() != null && t.getNext().isChar(';')) {
                    if (pubPart0 != null && pubPart0.getClause() != null && pub0 != null) {
                        ...
                        pubPart0 = pubPart;
                        pubPart0.setClause(((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value).toString());
    ...
    private static java.util.ArrayList<com.pullenti.ner.ReferentToken> _TryAttach(java.util.ArrayList<com.pullenti.ner.decree.internal.DecreeToken> dts, com.pullenti.ner.decree.internal.DecreeToken baseTyp, boolean afterDecree, com.pullenti.ner.core.AnalyzerData ad) {
        ...
        if (dts.size() == 1) {
            if (dts.get(0).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.DECREEREF && dts.get(0).ref != null) {
                if (baseTyp != null) {
                    ...
                    DecreeReferent dre = (DecreeReferent)com.pullenti.n2j.Utils.cast(re, DecreeReferent.class);
                    if (dre == null && (re instanceof DecreePartReferent)) 
                        dre = (((DecreePartReferent)com.pullenti.n2j.Utils.cast(re, DecreePartReferent.class))).getOwner();
                    if (dre != null) {
                        if (com.pullenti.n2j.Utils.stringsEq(dre.getTyp(), baseTyp.value) || com.pullenti.n2j.Utils.stringsEq(dre.getTyp0(), baseTyp.value)) 
                            return null;
                    }
                }
                java.util.ArrayList<com.pullenti.ner.ReferentToken> reli = new java.util.ArrayList< >();
        ...
        for(com.pullenti.ner.Token t = dts.get(0).getBeginToken().getPrevious(); t != null; t = t.getPrevious()) {
            ...
            if (!t.chars.isLetter()) 
                continue;
            dec0 = (DecreeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), DecreeReferent.class);
            if (dec0 != null) {
        ...
        for(i = 0; i < dts.size(); i++) {
            if (dts.get(i).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) {
                ...
                if (dec.getTyp() != null) {
                    if (((com.pullenti.n2j.Utils.stringsEq(dec.getTyp(), "РЕШЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(dec.getTyp(), "РІШЕННЯ"))) && com.pullenti.n2j.Utils.stringsEq(dts.get(i).value, "ПРОТОКОЛ")) {
                    }
                    else if (com.pullenti.n2j.Utils.stringsEq(dec.getTyp(), dts.get(i).value) && com.pullenti.n2j.Utils.stringsEq(dec.getTyp(), "ГОСТ")) 
                        continue;
                    else 
                        break;
                }
                if (com.pullenti.ner.decree.internal.DecreeToken.getKind(dts.get(i).value) == DecreeKind.KODEX) {
                    if (i > 0) 
                        break;
                    if (com.pullenti.n2j.Utils.stringsNe(dts.get(i).value, "ОСНОВЫ ЗАКОНОДАТЕЛЬСТВА") && com.pullenti.n2j.Utils.stringsNe(dts.get(i).value, "ОСНОВИ ЗАКОНОДАВСТВА")) 
                        kodeks = true;
                    else 
                        kodeks = false;
                }
                ...
                if (i == (dts.size() - 1)) {
                    if (!dts.get(i).getBeginToken().isValue("ОТ", "ВІД")) {
                        ...
                        if ((ty == DecreeKind.KONVENTION || ty == DecreeKind.CONTRACT || com.pullenti.n2j.Utils.stringsEq(dec.getTyp0(), "ПИСЬМО")) || com.pullenti.n2j.Utils.stringsEq(dec.getTyp0(), "ЛИСТ")) {
                        }
                        else 
                            break;
                    }
                ...
                if (dts.get(i).isNewlineBefore() && !dts.get(i).getBeginToken().chars.isAllLower() && dts.get(i).getBeginToken().chars.isLetter()) 
                    break;
            }
                ...
                if (dts.get(i).value != null && dts.get(i).value.toUpperCase().startsWith("ПР".toUpperCase()) && dec.getTyp() == null) 
                ...
                if (dts.get(i).children != null) {
                    ...
                    for(com.pullenti.ner.Slot s : dec.getSlots()) {
                        if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), DecreeReferent.ATTR_SOURCE)) 
                            cou++;
                    }
                ...
                if (dts.get(i).ref != null) {
                    ...
                    if (ty == DecreeKind.USTAV) {
                        if (!((dts.get(i).ref.referent instanceof com.pullenti.ner.org.OrganizationReferent))) 
                            break;
                    }
        ...
        if (dec.getTyp() == null || ((dec0 != null && dts.get(0).typ != com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP))) {
            if (dec0 != null) {
                ...
                if (dec.findSlot(DecreeReferent.ATTR_DATE, null, true) == null && dec0.getDate() != null) 
                    dec.addSlot(DecreeReferent.ATTR_DATE, dec0.getValue(DecreeReferent.ATTR_DATE), false, 0);
                com.pullenti.ner.Slot sl;
                if (dec.findSlot(DecreeReferent.ATTR_SOURCE, null, true) == null && (((sl = dec0.findSlot(DecreeReferent.ATTR_SOURCE, null, true)))) != null) 
        ...
        if (((et.getNext() != null && et.getNext().isChar('<') && (et.getNext().getNext() instanceof com.pullenti.ner.ReferentToken)) && et.getNext().getNext().getNext() != null && et.getNext().getNext().getNext().isChar('>')) && com.pullenti.n2j.Utils.stringsEq(et.getNext().getNext().getReferent().getTypeName(), "URI")) 
        ...
        if ((dec.findSlot(DecreeReferent.ATTR_NAME, null, true) == null && (i < dts.size()) && dts.get(i).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) && dec.getKind() == DecreeKind.PROJECT) {
            java.util.ArrayList<com.pullenti.ner.decree.internal.DecreeToken> dts1 = new java.util.ArrayList(dts);
            for(int indRemoveRange = 0 + i - 1, indMinIndex = 0; indRemoveRange >= indMinIndex; indRemoveRange--) dts1.remove(indRemoveRange);
        ...
        if (dec.findSlot(DecreeReferent.ATTR_SOURCE, null, true) == null) {
            ...
            if ((tt0 != null && tt0.isValue("В", "У") && tt0.getPrevious() != null) && (tt0.getPrevious().getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) 
        ...
        if (!dec.checkCorrection(isNounDoubt)) {
            ...
            if (sl != null && (((((com.pullenti.n2j.Utils.stringsEq(ty, "ПОСТАНОВЛЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(ty, "ПОСТАНОВА") || com.pullenti.n2j.Utils.stringsEq(ty, "ОПРЕДЕЛЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(ty, "ВИЗНАЧЕННЯ") || com.pullenti.n2j.Utils.stringsEq(ty, "РЕШЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(ty, "РІШЕННЯ") || com.pullenti.n2j.Utils.stringsEq(ty, "ПРИГОВОР")) || com.pullenti.n2j.Utils.stringsEq(ty, "ВИРОК")))) 
                    ...
                    if (ad != null) {
                        for(com.pullenti.ner.Referent r : ad.getReferents()) {
                            if (r.findSlot(DecreeReferent.ATTR_NUMBER, num, true) != null) {
                                if (r.canBeEquals(dec, com.pullenti.ner.Referent.EqualType.WITHINONETEXT)) {
                                    eqDecs++;
                                    dr0 = (DecreeReferent)com.pullenti.n2j.Utils.cast(r, DecreeReferent.class);
                                }
                            }
                        }
                    }
        ...
        if (rt.chars.isAllLower()) {
            if (com.pullenti.n2j.Utils.stringsEq(dec.getTyp0(), "ДЕКЛАРАЦИЯ") || com.pullenti.n2j.Utils.stringsEq(dec.getTyp0(), "ДЕКЛАРАЦІЯ")) 
                return null;
            if (((com.pullenti.n2j.Utils.stringsEq(dec.getTyp0(), "КОНСТИТУЦИЯ") || com.pullenti.n2j.Utils.stringsEq(dec.getTyp0(), "КОНСТИТУЦІЯ"))) && rt.getBeginToken() == rt.getEndToken()) {
                boolean ok1 = false;
                int cou = 10;
        ...
        if (num != null && ((num.indexOf('/') > 0 || num.indexOf(',') > 0))) {
            int cou = 0;
            for(com.pullenti.ner.Slot s : dec.getSlots()) {
                if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), DecreeReferent.ATTR_NUMBER)) 
                    cou++;
            }
            if (cou == 1) {
                int owns = 0;
                ...
                if (owns > 1) {
                    String[] nums = com.pullenti.n2j.Utils.split(num, String.valueOf('/'), false);
                    String[] nums2 = com.pullenti.n2j.Utils.split(num, String.valueOf(','), false);
                    String strNum = null;
        ...
        if (dec.getKind() == DecreeKind.PROGRAM && dec.findSlot(DecreeReferent.ATTR_DATE, null, true) == null) {
            if (rt.getBeginToken().getPrevious() != null && rt.getBeginToken().getPrevious().isValue("ПАСПОРТ", null)) {
                ...
                for(com.pullenti.ner.Token tt = rt.getEndToken().getNext(); tt != null && (cou < 1000); tt = (tt == null ? null : tt.getNext())) {
                    ...
                    if (dtok != null && dtok.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP && ((com.pullenti.n2j.Utils.stringsEq(dtok.value, "ПРОГРАММА") || com.pullenti.n2j.Utils.stringsEq(dtok.value, "ПРОГРАМА")))) 
        ...
        if (rt.getEndToken().getNext() != null && rt.getEndToken().getNext().isChar('(')) {
            ...
            for(com.pullenti.ner.Token tt = rt.getEndToken().getNext().getNext(); tt != null; tt = tt.getNext()) {
                ...
                if (r instanceof com.pullenti.ner.date.DateReferent) {
                    dt = (com.pullenti.ner.date.DateReferent)com.pullenti.n2j.Utils.cast(r, com.pullenti.ner.date.DateReferent.class);
                    continue;
                }
        ...
        java.util.ArrayList<com.pullenti.ner.ReferentToken> rtLi = new java.util.ArrayList< >();
        rtLi.add(rt);
        ...
        if ((dts.size() == 2 && dts.get(0).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP && dts.get(0).typKind == DecreeKind.STANDARD) && dts.get(1).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER) {
            for(com.pullenti.ner.Token ttt = dts.get(1).getEndToken().getNext(); ttt != null; ttt = ttt.getNext()) {
                ...
                if (nu == null || nu.typ != com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER) 
                    break;
                DecreeReferent dr1 = DecreeReferent._new1044(dec.getTyp());
                dr1.addNumber(nu);
    ...
    public static java.util.ArrayList<com.pullenti.ner.MetaToken> tryAttachParts(java.util.ArrayList<com.pullenti.ner.decree.internal.PartToken> parts, com.pullenti.ner.decree.internal.DecreeToken baseTyp, com.pullenti.ner.Referent _defOwner) {
        ...
        if (parts.get(parts.size() - 1).typ != com.pullenti.ner.decree.internal.PartToken.ItemType.SUBPROGRAM && parts.get(parts.size() - 1).typ != com.pullenti.ner.decree.internal.PartToken.ItemType.ADDAGREE) {
            thisDec = tryAttach_ThisDecree(parts.get(parts.size() - 1), baseTyp);
            if (thisDec != null) {
                if ((_defOwner instanceof DecreeReferent) && ((com.pullenti.n2j.Utils.stringsEq((((DecreeReferent)com.pullenti.n2j.Utils.cast(_defOwner, DecreeReferent.class))).getTyp0(), thisDec.typ) || parts.get(0).typ == com.pullenti.ner.decree.internal.PartToken.ItemType.APPENDIX))) {
                }
                else 
                    _defOwner = null;
            }
            if (thisDec == null && _defOwner == null) 
                thisDec = tryAttachBack_ThisDecree(parts.get(0).getBeginToken(), baseTyp);
            if (thisDec == null) {
            ...
            if (parts.size() > 1) 
                for(int indRemoveRange = 0 + parts.size() - 1 - 1, indMinIndex = 0; indRemoveRange >= indMinIndex; indRemoveRange--) parts.remove(indRemoveRange);
            isProgram = true;
        }
        DecreeReferent defOwner = (DecreeReferent)com.pullenti.n2j.Utils.cast(_defOwner, DecreeReferent.class);
        if (_defOwner instanceof DecreePartReferent) 
            defOwner = (((DecreePartReferent)com.pullenti.n2j.Utils.cast(_defOwner, DecreePartReferent.class))).getOwner();
        java.util.ArrayList<com.pullenti.ner.ReferentToken> res = new java.util.ArrayList< >();
        ...
        java.util.ArrayList<com.pullenti.ner.decree.internal.PartToken> asc = new java.util.ArrayList< >();
        java.util.ArrayList<com.pullenti.ner.decree.internal.PartToken> desc = new java.util.ArrayList< >();
        java.util.ArrayList<com.pullenti.ner.decree.internal.PartToken.ItemType> typs = new java.util.ArrayList< >();
        int ascCount = 0;
        int descCount = 0;
        int terminators = 0;
        ...
        for(i = 0; i < parts.size(); i++) {
            ...
            while(true) {
                ...
                res.add(rt);
                java.util.ArrayList<com.pullenti.ner.Slot> slList = new java.util.ArrayList< >();
                for(com.pullenti.ner.decree.internal.PartToken p : li) {
                    ...
                    if (nam != null) {
                        com.pullenti.ner.Slot sl = com.pullenti.ner.Slot._new1045(nam, p, 1);
                        slList.add(sl);
                        if (p.ind < p.values.size()) {
                            sl.setValue(p.values.get(p.ind));
                            if (com.pullenti.n2j.Utils.isNullOrEmpty(p.values.get(p.ind).value)) 
                                sl.setValue("0");
                        }
                        else 
                            sl.setValue("0");
        ...
        for(j = res.size() - 1; j > 0; j--) {
            DecreePartReferent d0 = (DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(j).referent, DecreePartReferent.class);
            DecreePartReferent d = (DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(j - 1).referent, DecreePartReferent.class);
            ...
            if (br != null) {
                if (te.getNext().getMorph()._getClass().isAdverb()) {
                    ...
                    if (owner == null && te.getNext().getNext() == br.getEndToken()) {
                        owner = (DecreeReferent)com.pullenti.n2j.Utils.cast(te.getNext().getReferent(), DecreeReferent.class);
                        te = br.getEndToken();
                    }
                }
                else {
                    ...
                    if (s != null) {
                        ...
                        (((DecreePartReferent)com.pullenti.n2j.Utils.cast(rt.referent, DecreePartReferent.class))).addName(s);
                        rt.setEndToken(br.getEndToken());
        ...
        if (owner == null && (te instanceof com.pullenti.ner.ReferentToken)) {
            if ((((owner = (DecreeReferent)com.pullenti.n2j.Utils.cast(te.getReferent(), DecreeReferent.class)))) != null) 
        ...
        if (te != null && te.isValue("К", null) && te.getNext() != null) {
            if (te.getNext().getReferent() instanceof DecreeReferent) {
                te = te.getNext();
                res.get(res.size() - 1).setEndToken(te);
                owner = (DecreeReferent)com.pullenti.n2j.Utils.cast(te.getReferent(), DecreeReferent.class);
            }
        ...
        if (owner == null && thisDec != null) {
            ...
            if (tt0.getPrevious() != null) {
                if ((((owner = (DecreeReferent)com.pullenti.n2j.Utils.cast(tt0.getPrevious().getReferent(), DecreeReferent.class)))) != null) {
                    if (com.pullenti.n2j.Utils.stringsEq(thisDec.typ, owner.getTyp0())) 
                        thisDec = null;
                    else 
                        owner = null;
                }
        ...
        if ((thisDec == null || !thisDec.hasThisRef)) {
            ...
            for(tt = parts.get(0).getBeginToken().getPrevious(); tt != null; tt = tt.getPrevious(),coefBefore++) {
                ...
                if (dr != null && dr.getKind() != DecreeKind.PUBLISHER) {
                    if (ugolDelo && ((com.pullenti.n2j.Utils.stringsEq(dr.getName(), "УГОЛОВНЫЙ КОДЕКС") || com.pullenti.n2j.Utils.stringsEq(dr.getName(), "КРИМІНАЛЬНИЙ КОДЕКС")))) 
                        coefBefore = 0;
                    ...
                    if (thisDec != null) {
                        DecreePartReferent dpr = (DecreePartReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), DecreePartReferent.class);
                        if (com.pullenti.n2j.Utils.stringsEq(thisDec.typ, dr.getTyp()) || com.pullenti.n2j.Utils.stringsEq(thisDec.typ, dr.getTyp0())) {
                        }
                        else if ((thisDec.hasOtherRef && dpr != null && dpr.getClause() != null) && com.pullenti.n2j.Utils.stringsEq(thisDec.typ, "СТАТЬЯ")) {
                            for(com.pullenti.ner.ReferentToken r : res) {
                                DecreePartReferent dpr0 = (DecreePartReferent)com.pullenti.n2j.Utils.cast(r.referent, DecreePartReferent.class);
                ...
                if (dr != null) 
                    continue;
                DecreePartReferent dpr2 = (DecreePartReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), DecreePartReferent.class);
                if (dpr2 != null) {
                    bt = tt;
                    break;
                }
            ...
            for(tt = tt0; tt != null; tt = tt.getNext(),coefAfter++) {
                ...
                DecreeReferent dr = (DecreeReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), DecreeReferent.class);
                if (dr != null && dr.getKind() != DecreeKind.PUBLISHER) {
                    if (dr.getKind() == DecreeKind.PROGRAM) {
                        if (isProgram) {
                            at = tt;
                ...
                if (at != null) {
                    ...
                    if (at instanceof com.pullenti.ner.TextToken) {
                        if (at.tag instanceof String) 
                            locTyp = (String)com.pullenti.n2j.Utils.cast(at.tag, String.class);
                        else 
                            locTyp = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(at, com.pullenti.ner.TextToken.class))).lemma;
                    }
                }
                else if (bt != null) {
                    owner = _getDecree(bt);
                    ownerPaer = (DecreePartReferent)com.pullenti.n2j.Utils.cast(bt.getReferent(), DecreePartReferent.class);
            ...
            if (((bt != null && parts.size() == 1 && parts.get(0).typ == com.pullenti.ner.decree.internal.PartToken.ItemType.DOCPART) && (bt.getReferent() instanceof DecreePartReferent) && (((DecreePartReferent)com.pullenti.n2j.Utils.cast(bt.getReferent(), DecreePartReferent.class))).getClause() != null) && res.size() == 1 && owner == (((DecreePartReferent)com.pullenti.n2j.Utils.cast(bt.getReferent(), DecreePartReferent.class))).getOwner()) {
                for(com.pullenti.ner.Slot s : res.get(0).referent.getSlots()) {
                    if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), DecreePartReferent.ATTR_DOCPART)) 
                        s.setTypeName(DecreePartReferent.ATTR_PART);
                }
                (((DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(0).referent, DecreePartReferent.class))).addHighLevelInfo((DecreePartReferent)com.pullenti.n2j.Utils.cast(bt.getReferent(), DecreePartReferent.class));
            }
        }
        if (owner == null) {
            ...
            for(com.pullenti.ner.ReferentToken r : res) {
                DecreePartReferent dr = (DecreePartReferent)com.pullenti.n2j.Utils.cast(r.referent, DecreePartReferent.class);
                if (thisDec != null) {
        ...
        if (res.size() > 0) {
            ...
            else if ((isProgram && parts.get(0).values.size() > 0 && tt.isTableControlChar()) && com.pullenti.ner.core.MiscHelper.canBeStartOfSentence(tt.getNext())) {
        ...
        if (ownerPaer != null) {
            for(int ii = 0; ii < res.size(); ii++) {
                (((DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(ii).referent, DecreePartReferent.class))).addHighLevelInfo((ii == 0 ? ownerPaer : (DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(ii - 1).referent, DecreePartReferent.class)));
            }
        }
        if (res.size() == 1 && (((DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(0).referent, DecreePartReferent.class))).getName() == null) {
                    ...
                    for(tt = res.get(0).getBeginToken().getPrevious().getPrevious().getPrevious(); tt != null; tt = tt.getPrevious()) {
                        ...
                        if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(tt, false, false)) {
                            if (tt.getNext().chars.isLetter() && !tt.getNext().chars.isAllLower()) {
                                (((DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(0).referent, DecreePartReferent.class))).addName(com.pullenti.ner.core.MiscHelper.getTextValue(tt, res.get(0).getBeginToken().getPrevious().getPrevious(), com.pullenti.ner.core.GetTextAttr.NO));
        ...
        if (isProgram) {
            for(i = res.size() - 1; i >= 0; i--) {
                DecreePartReferent pa = (DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(i).referent, DecreePartReferent.class);
        ...
        java.util.ArrayList<com.pullenti.ner.MetaToken> res1 = new java.util.ArrayList< >();
        for(i = 0; i < res.size(); i++) {
            java.util.ArrayList<DecreePartReferent> li = new java.util.ArrayList< >();
            for(j = i; j < res.size(); j++) {
                if (res.get(j).getBeginToken() != res.get(i).getBeginToken()) 
                    break;
                else 
                    li.add((DecreePartReferent)com.pullenti.n2j.Utils.cast(res.get(j).referent, DecreePartReferent.class));
            }
            ...
            res1.add(com.pullenti.ner.MetaToken._new799(res.get(i).getBeginToken(), et, li));
            i = j - 1;
        }
        return res1;
    }
    ...
    public static class ThisDecree extends com.pullenti.ner.MetaToken {
        ...
        public String toString() {
            return ((String)com.pullenti.n2j.Utils.notnull(typ, "?")) + " (" + (hasThisRef ? "This" : ((hasOtherRef ? "Other" : "?"))) + ")";
        }
    
        public static ThisDecree _new1047(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3, String _arg4) {
            ThisDecree res = new ThisDecree(_arg1, _arg2);
            res.hasThisRef = _arg3;
            res.typ = _arg4;
            return res;
        }
        public static ThisDecree _new1048(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.decree.DecreeReferent _arg3) {
            ThisDecree res = new ThisDecree(_arg1, _arg2);
            res.real = _arg3;
            return res;
        }
    ...
    public static ThisDecree tryAttachBack_ThisDecree(com.pullenti.ner.Token t, com.pullenti.ner.decree.internal.DecreeToken baseTyp) {
        if (t == null) 
            return null;
        ...
        for(com.pullenti.ner.Token tt = t; tt != null; tt = tt.getPrevious()) {
            ...
            res.typ = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getLemma();
            t = tt.getPrevious();
            ...
            if (!res.hasThisRef && tt.isNewlineAfter()) 
                return null;
            if (baseTyp != null && com.pullenti.n2j.Utils.stringsEq(baseTyp.value, res.typ)) 
                res.hasThisRef = true;
            return res;
        }
        if (ukaz != null) {
            if (baseTyp != null && baseTyp.value != null && (((baseTyp.value.indexOf("ДОГОВОР") >= 0) || (baseTyp.value.indexOf("ДОГОВІР") >= 0)))) 
                return ThisDecree._new1047(ukaz, ukaz, true, baseTyp.value);
        }
        return null;
    }

    public static ThisDecree tryAttach_ThisDecree(com.pullenti.ner.decree.internal.PartToken dtok, com.pullenti.ner.decree.internal.DecreeToken baseTyp) {
        ...
        if (!((tt instanceof com.pullenti.ner.TextToken))) {
            if ((tt instanceof com.pullenti.ner.ReferentToken) && (tt.getReferent() instanceof DecreeReferent)) 
                return ThisDecree._new1048(t, tt, (DecreeReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), DecreeReferent.class));
            return null;
        }
        ...
        if (tt.isChar('.') && (tt.getPrevious() instanceof com.pullenti.ner.TextToken)) 
            res.typ = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt.getPrevious(), com.pullenti.ner.TextToken.class))).getLemma();
