...
public class DecreeChangeToken extends com.pullenti.ner.MetaToken {
    ...
    public String toString() {
        ...
        if (decree != null) 
            tmp.append(" Ref=").append(decree.toString(true, new com.pullenti.morph.MorphLang(null), 0));
        if (changeVal != null) 
            tmp.append(" ChangeVal=").append(changeVal.toString(true, new com.pullenti.morph.MorphLang(null), 0));
        return tmp.toString();
    }
    ...
    public static DecreeChangeToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.decree.DecreeChangeReferent main, boolean ignoreNewlines, java.util.ArrayList<com.pullenti.ner.Referent> changeStack, boolean isInEdition) {
        ...
        if (t.isNewlineBefore() && !ignoreNewlines) {
            for(tt = t; tt != null; tt = tt.getNext()) {
                if (tt == t && com.pullenti.ner.core.BracketHelper.isBracket(tt, false) && !tt.isChar('(')) 
                    ...
                    break;
                else if ((tt instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT) {
                    if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).value == ((long)98)) {
                    }
                }
                else if (tt.isHiphen()) {
                }
        ...
        if (((tt instanceof com.pullenti.ner.TextToken) && t.isNewlineBefore() && !ignoreNewlines) && tt.isValue("ВНЕСТИ", "УНЕСТИ") && ((((tt.getNext() != null && tt.getNext().isValue("В", "ДО"))) || com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term, "ВНЕСТИ") || com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term, "УНЕСТИ")))) {
            res = _new756(tt, tt, DecreeChangeTokenTyp.STARTMULTU);
            ...
            for(tt = tt.getNext(); tt != null; tt = tt.getNext()) {
                ...
                if (tt.getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) {
                    if (res.decree != null && tt.getReferent() != res.decree) 
                        break;
                    res.decree = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.decree.DecreeReferent.class);
                    res.setEndToken(tt);
                    continue;
                }
        ...
        if (((!ignoreNewlines && t.isNewlineBefore() && ((tt.isValue("ПРИЗНАТЬ", "ВИЗНАТИ") || tt.isValue("СЧИТАТЬ", "ВВАЖАТИ")))) && tt.getNext() != null && tt.getNext().isValue("УТРАТИТЬ", "ВТРАТИТИ")) && tt.getNext().getNext() != null && tt.getNext().getNext().isValue("СИЛА", "ЧИННІСТЬ")) {
            res = _new757(tt, tt.getNext().getNext(), DecreeChangeTokenTyp.ACTION, com.pullenti.ner.decree.DecreeChangeKind.EXPIRE);
        ...
        if ((!ignoreNewlines && ((t.isNewlineBefore() || tt == t)) && tt.isValue("УТРАТИТЬ", "ВТРАТИТИ")) && tt.getNext() != null && tt.getNext().isValue("СИЛА", "ЧИННІСТЬ")) {
            res = _new756(tt, tt.getNext(), DecreeChangeTokenTyp.UNDEFINED);
            for(tt = tt.getNext(); tt != null; tt = tt.getNext()) {
                res.setEndToken(tt);
        ...
        if (!ignoreNewlines && t.isNewlineBefore()) {
            ...
            res = _new756(tt, tt, DecreeChangeTokenTyp.STARTSINGLE);
            for(; tt != null; tt = tt.getNext()) {
                ...
                if (tt.isValue("ТЕКСТ", null)) {
                    ...
                    if (pt != null && pt.getEndToken().getNext() != null && pt.getEndToken().getNext().isValue("СЧИТАТЬ", "ВВАЖАТИ")) {
                        ...
                        if (changeStack != null && changeStack.size() > 0 && (changeStack.get(0) instanceof com.pullenti.ner.decree.DecreePartReferent)) 
                            res.realPart = (com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(changeStack.get(0), com.pullenti.ner.decree.DecreePartReferent.class);
                    ...
                    if (tt1 != null && tt1.getMorph().getCase().isInstrumental()) {
                        ...
                        if (pt != null && pt.typ != PartToken.ItemType.PREFIX) {
                            ...
                            if (res.newParts == null) 
                                res.newParts = new java.util.ArrayList< >();
                            res.newParts.add(pt);
                ...
                if (li == null && tt.isValue("ПРИМЕЧАНИЕ", "ПРИМІТКА")) {
                    ...
                    li.add(PartToken._new760(tt, tt, PartToken.ItemType.NOTICE));
                }
                ...
                if (pt0 != null && ((res.hasName || pt0.typ == PartToken.ItemType.APPENDIX)) && pt0.typ != PartToken.ItemType.PREFIX) {
                    ...
                    if (pt0.typ == PartToken.ItemType.APPENDIX && res.parts == null) {
                        res.parts = new java.util.ArrayList< >();
                        res.parts.add(pt0);
                    }
                    continue;
                }
                        ...
                        if (main != null && res.decree == null && res.decreeTok == null) {
                            ...
                            for(com.pullenti.ner.Referent v : main.getOwners()) {
                                if (v instanceof com.pullenti.ner.decree.DecreeReferent) {
                                    dec = (com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(v, com.pullenti.ner.decree.DecreeReferent.class);
                                    break;
                                }
                                else if (v instanceof com.pullenti.ner.decree.DecreePartReferent) {
                                    dec = (((com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(v, com.pullenti.ner.decree.DecreePartReferent.class))).getOwner();
                                    if (dec != null) 
                                        break;
                                }
                            }
                            if (dec != null && com.pullenti.n2j.Utils.stringsEq(dec.getTyp0(), dts.get(0).value)) {
                                res.decree = dec;
                ...
                if (tt == res.getBeginToken() && main != null) {
                    ...
                    if (npt != null) {
                        ...
                        if ((tt1 != null && tt1.isValue("ИЗЛОЖИТЬ", "ВИКЛАСТИ") && tt1.getNext() != null) && tt1.getNext().isValue("В", null)) {
                            PartToken pt = PartToken._new760(tt, npt.getEndToken(), PartToken.ItemType.APPENDIX);
                            pt.name = npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false);
                            res.parts = new java.util.ArrayList< >();
                            res.parts.add(pt);
                            res.setEndToken(pt.getEndToken());
                            break;
        ...
        if (tok != null) {
            if (tok.termin.tag instanceof com.pullenti.ner.decree.DecreeChangeKind) {
                res = _new757(tt, tok.getEndToken(), DecreeChangeTokenTyp.ACTION, (com.pullenti.ner.decree.DecreeChangeKind)tok.termin.tag);
            ...
            if (tok.termin.tag instanceof com.pullenti.ner.decree.DecreeChangeValueKind) {
                res = _new756(tt, tok.getEndToken(), DecreeChangeTokenTyp.VALUE);
                res.changeVal = new com.pullenti.ner.decree.DecreeChangeValueReferent();
                ...
                if (res.changeVal.getKind() == com.pullenti.ner.decree.DecreeChangeValueKind.SEQUENCE || res.changeVal.getKind() == com.pullenti.ner.decree.DecreeChangeValueKind.FOOTNOTE) {
                    if (tt instanceof com.pullenti.ner.NumberToken) {
                        res.changeVal.setNumber(((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).value).toString());
                        res.setEndToken(tt);
                        tt = tt.getNext();
                    }
                    else if (res.getBeginToken() instanceof com.pullenti.ner.NumberToken) 
                        res.changeVal.setNumber(((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(res.getBeginToken(), com.pullenti.ner.NumberToken.class))).value).toString());
                    else if (res.getBeginToken().getMorph()._getClass().isAdjective()) 
                        res.changeVal.setNumber(res.getBeginToken().getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false));
                        ...
                        res.changeVal.setNumber(((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt.getNext(), com.pullenti.ner.NumberToken.class))).value).toString());
                        res.setEndToken((tt = tt.getNext().getNext()));
                        tt = tt.getNext();
                    }
                }
                ...
                if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(tt, true, false)) 
                    canBeStart = true;
                else if ((tt instanceof com.pullenti.ner.MetaToken) && com.pullenti.ner.core.BracketHelper.canBeStartOfSequence((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.MetaToken.class))).getBeginToken(), true, false)) 
                    canBeStart = true;
                ...
                if (canBeStart) {
                    for(com.pullenti.ner.Token ttt = (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(tt, true, false) ? tt.getNext() : tt); ttt != null; ttt = ttt.getNext()) {
                        ...
                        else if (((ttt instanceof com.pullenti.ner.MetaToken)) && com.pullenti.ner.core.BracketHelper.isBracket((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(ttt, com.pullenti.ner.MetaToken.class))).getEndToken(), true)) {
                        }
                        else 
                            continue;
        ...
        if (((isNexChange > 0 && com.pullenti.ner.core.BracketHelper.isBracket(t, true))) || ((isNexChange > 1 && t.isValue("ПРИЛОЖЕНИЕ", "ДОДАТОК")))) {
            res = _new756(t, t, DecreeChangeTokenTyp.VALUE);
            res.changeVal = com.pullenti.ner.decree.DecreeChangeValueReferent._new765(com.pullenti.ner.decree.DecreeChangeValueKind.TEXT);
            if (isInEdition) 
                return res;
            ...
            for(tt = t.getNext(); tt != null; tt = tt.getNext()) {
                ...
                com.pullenti.ner.instrument.internal.InstrToken1 instr = com.pullenti.ner.instrument.internal.InstrToken1.parse(tt.getNext(), true, null, 0, null, false, 0, false);
                ...
                if (com.pullenti.ner.core.BracketHelper.isBracket(tt1, true)) 
                    tt1 = tt1.getPrevious();
                else if ((tt1 instanceof com.pullenti.ner.MetaToken) && com.pullenti.ner.core.BracketHelper.isBracket((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt1, com.pullenti.ner.MetaToken.class))).getEndToken(), true)) {
                }
                else 
                    continue;
                if (isDoubt) {
    ...
    private static java.util.ArrayList<DecreeChangeToken> tryAttachList(com.pullenti.ner.Token t) {
        ...
        if (d0 == null) 
            return null;
        java.util.ArrayList<DecreeChangeToken> res = new java.util.ArrayList< >();
        res.add(d0);
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (d == null) {
                ...
                if (t.isChar(':') && ((!t.isNewlineAfter() || res.get(res.size() - 1).actKind == com.pullenti.ner.decree.DecreeChangeKind.NEW))) 
                    continue;
                if ((t instanceof com.pullenti.ner.TextToken) && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "ТЕКСТОМ")) 
                    continue;
                java.util.ArrayList<PartToken> pts = PartToken.tryAttachList(t, false, 40);
                if (pts != null) 
                    d = _new766(pts.get(0).getBeginToken(), pts.get(pts.size() - 1).getEndToken(), DecreeChangeTokenTyp.UNDEFINED, pts);
                else {
                    ...
                    if (pt != null) {
                        ...
                        if (t.getPrevious() != null && t.getPrevious().isValue("НОВЫЙ", "НОВИЙ")) {
                            d.newParts = new java.util.ArrayList< >();
                            d.newParts.add(pt);
                        }
                        else 
                            d.partTyp = pt.typ;
                ...
                if (dcr.getKind() == com.pullenti.ner.decree.DecreeChangeKind.APPEND && tok.newParts != null) {
                    for(PartToken np : tok.newParts) {
                        ...
                        if (dpr instanceof com.pullenti.ner.decree.DecreePartReferent) {
                            if (!(((com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(dpr, com.pullenti.ner.decree.DecreePartReferent.class))).isAllItemsOverThisLevel(np.typ)) {
                        ...
                        if (np.values.size() == 0) {
                            if (eqLevVal == null) 
                                ...
                                int n;
                                com.pullenti.n2j.Outargwrapper<Integer> inoutarg789 = new com.pullenti.n2j.Outargwrapper< >();
                                boolean inoutres790 = com.pullenti.n2j.Utils.parseInteger(eqLevVal, inoutarg789);
                                n = (inoutarg789.value != null ? inoutarg789.value : 0);
                                if (inoutres790) 
    ...
    public static DecreeChangeToken _new756(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DecreeChangeTokenTyp _arg3) {
        DecreeChangeToken res = new DecreeChangeToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }
    public static DecreeChangeToken _new757(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DecreeChangeTokenTyp _arg3, com.pullenti.ner.decree.DecreeChangeKind _arg4) {
        DecreeChangeToken res = new DecreeChangeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.actKind = _arg4;
        return res;
    }
    public static DecreeChangeToken _new766(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DecreeChangeTokenTyp _arg3, java.util.ArrayList<PartToken> _arg4) {
        DecreeChangeToken res = new DecreeChangeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.parts = _arg4;
        return res;
    ...
    static {
        ...
        t = com.pullenti.ner.core.Termin._new118("ИЗЛОЖИТЬ В СЛЕДУЮЩЕЙ РЕДАКЦИИ", com.pullenti.ner.decree.DecreeChangeKind.NEW);
        t.addVariant("ИЗЛОЖИВ ЕГО В СЛЕДУЮЩЕЙ РЕДАКЦИИ", false);
        t.addVariant("ИЗЛОЖИТЬ В РЕДАКЦИИ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("ВИКЛАСТИ В НАСТУПНІЙ РЕДАКЦІЇ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.NEW);
        ...
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("ПРИЗНАТЬ УТРАТИВШИМ СИЛУ", com.pullenti.ner.decree.DecreeChangeKind.EXPIRE);
        t.addVariant("СЧИТАТЬ УТРАТИВШИМ СИЛУ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("ВИЗНАТИ таким, що ВТРАТИВ ЧИННІСТЬ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.EXPIRE);
        t.addVariant("ВВАЖАТИ таким, що ВТРАТИВ ЧИННІСТЬ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("ИСКЛЮЧИТЬ", com.pullenti.ner.decree.DecreeChangeKind.REMOVE);
        t.addVariant("ИСКЛЮЧИВ ИЗ НЕГО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("ВИКЛЮЧИТИ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.REMOVE);
        t.addVariant("ВИКЛЮЧИВШИ З НЬОГО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("СЧИТАТЬ", com.pullenti.ner.decree.DecreeChangeKind.CONSIDER);
        t.addVariant("СЧИТАТЬ СООТВЕТСТВЕННО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("ВВАЖАТИ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.CONSIDER);
        t.addVariant("ВВАЖАТИ ВІДПОВІДНО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("ЗАМЕНИТЬ", com.pullenti.ner.decree.DecreeChangeKind.EXCHANGE);
        t.addVariant("ЗАМЕНИВ В НЕМ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("ЗАМІНИТИ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.EXCHANGE);
        t.addVariant("ЗАМІНИВШИ В НЬОМУ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("ДОПОЛНИТЬ", com.pullenti.ner.decree.DecreeChangeKind.APPEND);
        t.addVariant("ДОПОЛНИВ ЕГО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("ДОПОВНИТИ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.APPEND);
        t.addVariant("ДОПОВНИВШИ ЙОГО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("СЛОВО", com.pullenti.ner.decree.DecreeChangeValueKind.WORDS);
        t.addVariant("АББРЕВИАТУРА", false);
        t.addVariant("АБРЕВІАТУРА", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("ЦИФРА", com.pullenti.ner.decree.DecreeChangeValueKind.NUMBERS);
        t.addVariant("ЧИСЛО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("ПРЕДЛОЖЕНИЕ", com.pullenti.ner.decree.DecreeChangeValueKind.SEQUENCE);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("ПРОПОЗИЦІЯ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeValueKind.SEQUENCE);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("СНОСКА", com.pullenti.ner.decree.DecreeChangeValueKind.FOOTNOTE);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("ВИНОСКА", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeValueKind.FOOTNOTE);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("БЛОК", com.pullenti.ner.decree.DecreeChangeValueKind.BLOCK);
        t.addVariant("БЛОК СО СЛОВАМИ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("БЛОК", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeValueKind.BLOCK);
        t.addVariant("БЛОК ЗІ СЛОВАМИ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new118("В СООТВЕТСТВУЮЩИХ ЧИСЛЕ И ПАДЕЖЕ", com.pullenti.ner.decree.DecreeChangeValueKind.ROBUSTWORDS);
        t.addVariant("В СООТВЕТСТВУЮЩЕМ ПАДЕЖЕ", false);
        t.addVariant("В СООТВЕТСТВУЮЩЕМ ЧИСЛЕ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new459("У ВІДПОВІДНОМУ ЧИСЛІ ТА ВІДМІНКУ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeValueKind.ROBUSTWORDS);
