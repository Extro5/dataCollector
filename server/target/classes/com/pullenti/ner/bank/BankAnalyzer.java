...
public class BankAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public com.pullenti.ner.Referent createReferent(String type) {
        if (com.pullenti.n2j.Utils.stringsEq(type, BankDataReferent.OBJ_TYPENAME)) 
    ...
    private static boolean _isBankReq(String txt) {
        if (((((((com.pullenti.n2j.Utils.stringsEq(txt, "Р/С") || com.pullenti.n2j.Utils.stringsEq(txt, "К/С") || com.pullenti.n2j.Utils.stringsEq(txt, "Л/С")) || com.pullenti.n2j.Utils.stringsEq(txt, "ОКФС") || com.pullenti.n2j.Utils.stringsEq(txt, "ОКАТО")) || com.pullenti.n2j.Utils.stringsEq(txt, "ОГРН") || com.pullenti.n2j.Utils.stringsEq(txt, "БИК")) || com.pullenti.n2j.Utils.stringsEq(txt, "SWIFT") || com.pullenti.n2j.Utils.stringsEq(txt, "ОКПО")) || com.pullenti.n2j.Utils.stringsEq(txt, "ОКВЭД") || com.pullenti.n2j.Utils.stringsEq(txt, "ОКОНХ")) || com.pullenti.n2j.Utils.stringsEq(txt, "КБК") || com.pullenti.n2j.Utils.stringsEq(txt, "ИНН")) || com.pullenti.n2j.Utils.stringsEq(txt, "КПП")) 
            return true;
        else 
            return false;
    }
    ...
    private com.pullenti.ner.ReferentToken tryAttach(com.pullenti.ner.Token t, boolean keyWord) {
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.isValue("БАНК", null)) {
                if ((t instanceof com.pullenti.ner.ReferentToken) && com.pullenti.n2j.Utils.stringsEq(t.getReferent().getTypeName(), "ORGANIZATION")) 
                    bankKeyword = true;
                ...
                if (tt != null) {
                    ...
                    else if (tt.getReferent() != null && com.pullenti.n2j.Utils.stringsEq(tt.getReferent().getTypeName(), "ORGANIZATION")) 
                        t = tt;
                }
            }
            ...
            if (r != null && com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ORGANIZATION")) {
                ...
                for(com.pullenti.ner.Referent rr = r; rr != null && (kk < 4); rr = rr.getParentReferent(),kk++) {
                    isBank = com.pullenti.n2j.Utils.stringsCompare((String)com.pullenti.n2j.Utils.notnull(rr.getStringValue("KIND"), ""), "Bank", true) == 0;
                    if (isBank) 
                        break;
                }
                ...
                if (!isBank && uris != null && urisKeys.contains("ИНН")) 
                    return null;
                if ((lastUri != null && com.pullenti.n2j.Utils.stringsEq(lastUri.getScheme(), "К/С") && t.getPrevious() != null) && t.getPrevious().isValue("В", null)) {
                    corOrg = r;
                    t1 = t;
                }
            ...
            if (r instanceof com.pullenti.ner.uri.UriReferent) {
                com.pullenti.ner.uri.UriReferent u = (com.pullenti.ner.uri.UriReferent)com.pullenti.n2j.Utils.cast(r, com.pullenti.ner.uri.UriReferent.class);
                if (uris == null) {
                    if (!_isBankReq(u.getScheme())) 
                        return null;
                    if (com.pullenti.n2j.Utils.stringsEq(u.getScheme(), "ИНН") && t.isNewlineAfter()) 
                        return null;
                    uris = new java.util.ArrayList< >();
                    urisKeys = new java.util.ArrayList< >();
                }
                else {
                    if (!_isBankReq(u.getScheme())) 
                        break;
                    if (urisKeys.contains(u.getScheme())) 
                        break;
                    if (com.pullenti.n2j.Utils.stringsEq(u.getScheme(), "ИНН")) {
                        if (empty > 0) 
                            break;
                    }
                }
                ...
                return null;
            if (r != null && ((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "GEO") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ADDRESS")))) {
                empty++;
                continue;
            }
        ...
        if (org0 != null && com.pullenti.n2j.Utils.stringsEq(org0.getTypeName(), "ORGANIZATION")) {
            for(com.pullenti.ner.Slot s : org0.getSlots()) {
                if (s.getValue() instanceof com.pullenti.ner.uri.UriReferent) {
                    com.pullenti.ner.uri.UriReferent u = (com.pullenti.ner.uri.UriReferent)com.pullenti.n2j.Utils.cast(s.getValue(), com.pullenti.ner.uri.UriReferent.class);
                    if (_isBankReq(u.getScheme())) {
                        if (!urisKeys.contains(u.getScheme())) 
                            bdr.addSlot(BankDataReferent.ATTR_ITEM, u, false, 0);
                    }
    ...
    public static void initialize() {
        ...
        com.pullenti.ner.core.Termin t = new com.pullenti.ner.core.Termin("БАНКОВСКИЕ РЕКВИЗИТЫ", new com.pullenti.morph.MorphLang(null), false);
