...
public class BookLinkAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.HashMap<String, byte[]> getImages() {
        ...
        res.put(com.pullenti.ner.booklink.internal.MetaBookLink.IMAGEID, com.pullenti.ner.booklink.internal.ResourceHelper.getBytes("booklink.png"));
        res.put(com.pullenti.ner.booklink.internal.MetaBookLinkRef.IMAGEID, com.pullenti.ner.booklink.internal.ResourceHelper.getBytes("booklinkref.png"));
        res.put(com.pullenti.ner.booklink.internal.MetaBookLinkRef.IMAGEIDINLINE, com.pullenti.ner.booklink.internal.ResourceHelper.getBytes("booklinkrefinline.png"));
        res.put(com.pullenti.ner.booklink.internal.MetaBookLinkRef.IMAGEIDLAST, com.pullenti.ner.booklink.internal.ResourceHelper.getBytes("booklinkreflast.png"));
        return res;
    }
    ...
    public com.pullenti.ner.Referent createReferent(String type) {
        if (com.pullenti.n2j.Utils.stringsEq(type, BookLinkReferent.OBJ_TYPENAME)) 
            return new BookLinkReferent();
        if (com.pullenti.n2j.Utils.stringsEq(type, BookLinkRefReferent.OBJ_TYPENAME)) 
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) throws NumberFormatException {
        ...
        int isLitBlock = 0;
        java.util.HashMap<String, java.util.ArrayList<BookLinkRefReferent>> refsByNum = new java.util.HashMap< >();
        ...
        for(com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                    ...
                    if (br.isNewlineAfter() || ((br.getEndToken().getNext() != null && br.getEndToken().getNext().isCharOf(".;")))) {
                        ...
                        if (rts != null && rts.size() >= 1) {
                            if (rts.size() > 1) {
                                ...
                                (((BookLinkRefReferent)com.pullenti.n2j.Utils.cast(rts.get(0).referent, BookLinkRefReferent.class))).setBook((BookLinkReferent)com.pullenti.n2j.Utils.cast(rts.get(1).referent, BookLinkReferent.class));
                            ...
                            (((BookLinkRefReferent)com.pullenti.n2j.Utils.cast(rts.get(0).referent, BookLinkRefReferent.class))).setTyp(BookLinkRefType.INLINE);
            ...
            BookLinkRefReferent re = (BookLinkRefReferent)com.pullenti.n2j.Utils.cast(rts.get(0).referent, BookLinkRefReferent.class);
            re = (BookLinkRefReferent)com.pullenti.n2j.Utils.cast(ad.registerReferent(re), BookLinkRefReferent.class);
            rts.get(0).referent = re;
            kit.embedToken(rts.get(0));
            t = rts.get(0);
            if (re.getNumber() != null) {
                java.util.ArrayList<BookLinkRefReferent> li;
                com.pullenti.n2j.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>> inoutarg385 = new com.pullenti.n2j.Outargwrapper< >();
                Boolean inoutres386 = com.pullenti.n2j.Utils.tryGetValue(refsByNum, re.getNumber(), inoutarg385);
                li = inoutarg385.value;
                if (!inoutres386) 
                    refsByNum.put(re.getNumber(), (li = new java.util.ArrayList< >()));
                li.add(re);
            }
        }
        for(com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            if (rt == null) 
                continue;
            BookLinkRefReferent re = (BookLinkRefReferent)com.pullenti.n2j.Utils.cast(rt.referent, BookLinkRefReferent.class);
            java.util.ArrayList<BookLinkRefReferent> li;
            com.pullenti.n2j.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>> inoutarg387 = new com.pullenti.n2j.Outargwrapper< >();
            Boolean inoutres388 = com.pullenti.n2j.Utils.tryGetValue(refsByNum, (String)com.pullenti.n2j.Utils.notnull(re.getNumber(), ""), inoutarg387);
            li = inoutarg387.value;
            if (!inoutres388) 
                continue;
            int i;
            for(i = 0; i < li.size(); i++) {
    ...
    private static com.pullenti.ner.ReferentToken tryParseShortInline(com.pullenti.ner.Token t) {
        ...
        if (t.isChar('[') && !t.isNewlineBefore()) {
            com.pullenti.ner.booklink.internal.BookLinkToken bb = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(t);
        ...
        if (t.isChar('(')) {
            com.pullenti.ner.booklink.internal.BookLinkToken bbb = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(t.getNext());
            if (bbb == null) 
                return null;
                ...
                for(com.pullenti.ner.Token tt = bbb.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                    ...
                    if (tt.isChar('[')) {
                        if (((tt.getNext() instanceof com.pullenti.ner.NumberToken) && tt.getNext().getNext() != null && tt.getNext().getNext().isChar(']')) && tt.getNext().getNext() != null && tt.getNext().getNext().getNext().isChar(')')) {
                            re = new BookLinkRefReferent();
                            re.setNumber(((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt.getNext(), com.pullenti.ner.NumberToken.class))).value).toString());
                    ...
                    if ((tt instanceof com.pullenti.ner.NumberToken) && tt.getNext() != null && tt.getNext().isChar(')')) {
                        re = new BookLinkRefReferent();
                        re.setNumber(((Long)(((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).value).toString());
            ...
            if (bbb.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.NUMBER) {
                ...
                if (tt1 != null && tt1.isComma()) 
                    tt1 = tt1.getNext();
                com.pullenti.ner.booklink.internal.BookLinkToken bbb2 = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(tt1);
    ...
    private static java.util.ArrayList<com.pullenti.ner.ReferentToken> tryParse(com.pullenti.ner.Token t, boolean isInLit, int maxChar) throws NumberFormatException {
        ...
        com.pullenti.ner.booklink.internal.BookLinkToken blt = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(t);
        if (blt == null) 
        ...
        if (isBracketRegime) 
            ...
            if (!t.isWhitespaceBefore()) {
                if (t instanceof com.pullenti.ner.NumberToken) {
                    long n = (((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value;
                    if ((((n == ((long)3) || n == ((long)0))) && !t.isWhitespaceAfter() && (t.getNext() instanceof com.pullenti.ner.TextToken)) && t.getNext().chars.isAllLower()) {
                    }
                    else 
                        return null;
                }
                    ...
                    else if (isInLit && r != null && com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DECREE")) {
                    }
                    else 
                        return null;
                }
            ...
            for(; t != null; t = t.getNext()) {
                ...
                if (!t.chars.isLetter()) 
                    continue;
                com.pullenti.ner.booklink.internal.BookLinkToken bbb = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(t);
                if (bbb != null) {
            ...
            if (specSee != null && specSee.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.TAMZE) {
                ...
                for(com.pullenti.ner.Token tt = t0; tt != null && max > 0; tt = tt.getPrevious(),max--) {
                    if (tt.getReferent() instanceof BookLinkRefReferent) {
                        bookPrev = (((BookLinkRefReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), BookLinkRefReferent.class))).getBook();
                        break;
                    }
                }
            }
            ...
            if (blt1 != null && blt1.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.PERSON) 
                ...
                for(com.pullenti.ner.Token tt = t; tt != null; tt = (tt == null ? null : tt.getNext())) {
                    if (tt.isNewlineBefore()) 
                        break;
                    if (isInLit && tt.getReferent() != null && com.pullenti.n2j.Utils.stringsEq(tt.getReferent().getTypeName(), "DECREE")) {
                        ok = true;
                        decree = tt;
                        break;
                    }
                    com.pullenti.ner.booklink.internal.BookLinkToken bbb = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(tt);
                    if (bbb == null) 
                        continue;
                    ...
                    if (bbb.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.DELIMETER) {
                        ...
                        bbb = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(tt);
                        if (bbb != null) {
        ...
        java.util.ArrayList<com.pullenti.ner.ReferentToken> corrAuthors = new java.util.ArrayList< >();
        ...
        if (regtyp == RegionTyp.AUTHORS) {
            for(; t != null; t = t.getNext()) {
                ...
                if (blt == null) {
                    if ((t.getReferent() instanceof com.pullenti.ner.org.OrganizationReferent) && blt00 != null) {
                        com.pullenti.ner.booklink.internal.BookLinkToken bbb2 = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(t.getNext());
                        if (bbb2 != null) {
                            if (bbb2.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.YEAR) {
                                ...
                                res.setYear(com.pullenti.n2j.Utils.parseInteger(bbb2.value));
                                coef += 0.5;
                ...
                if (blt.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.PERSON) {
                    ...
                    com.pullenti.ner.booklink.internal.BookLinkToken bbb2 = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(tt2);
                    if (bbb2 != null) {
                        if (bbb2.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.YEAR) {
                            res.setYear(com.pullenti.n2j.Utils.parseInteger(bbb2.value));
                            coef += 0.5;
                    ...
                    if (blt00 != null && ((blt00.getEndToken().getNext() == blt.getBeginToken() || blt.getBeginToken().getPrevious().isChar('.')))) {
                        ...
                        com.pullenti.ner.booklink.internal.BookLinkToken nex = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(tt11);
                        if (nex != null && nex.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.ANDOTHERS) {
                            ...
                            if (tt11.isCharOf(",.;") && tt11.getNext() != null) 
                                tt11 = tt11.getNext();
                            nex = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(tt11);
                    ...
                    if (t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) 
                        corrAuthors.add((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class));
                    blt00 = blt;
        ...
        if (startOfName == null) {
            ...
            if (t.chars.isLatinLetter() && !isElectrRes && num == null) {
                if (res.getValue(BookLinkReferent.ATTR_AUTHOR) == null) 
                    return null;
            }
        }
        ...
        String nextNum = null;
        int nn;
        com.pullenti.n2j.Outargwrapper<Integer> inoutarg393 = new com.pullenti.n2j.Outargwrapper< >();
        boolean inoutres394 = com.pullenti.n2j.Utils.parseInteger((String)com.pullenti.n2j.Utils.notnull(num, ""), inoutarg393);
        nn = (inoutarg393.value != null ? inoutarg393.value : 0);
        if (inoutres394) 
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.isNewlineBefore() && t != tn0) {
                if (br != null && (t.endChar < br.endChar)) {
                    ...
                    if (t.getNewlinesBeforeCount() > 1) 
                        break;
                    if ((t instanceof com.pullenti.ner.NumberToken) && num != null) {
                        if (com.pullenti.n2j.Utils.stringsEq(num, ((Long)((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).value - ((long)1))).toString())) 
                            break;
                    }
                    else if (num != null) {
                    }
            ...
            if (t.isCharOf(".;") && t.getWhitespacesAfterCount() > 0) {
                ...
                for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                    com.pullenti.ner.booklink.internal.BookLinkToken blt0 = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(tt);
                    if (blt0 == null) {
                        if (tt.isNewlineBefore()) 
                            break;
            ...
            blt = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(t);
            if (blt == null) {
                tn1 = t;
                continue;
            }
        ...
        if (tn1 == null && startOfName == null) {
            if (isElectrRes) {
                ...
                java.util.ArrayList<com.pullenti.ner.ReferentToken> rts0 = new java.util.ArrayList< >();
                BookLinkRefReferent bref0 = BookLinkRefReferent._new389(uriRe);
                if (num != null) 
                    bref0.setNumber(num);
                ...
                for(; t != null; t = t.getNext()) {
                    if (t.isNewlineBefore()) 
                        break;
                    com.pullenti.ner.booklink.internal.BookLinkToken blt0 = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(t);
                    if (blt0 != null) {
                        if (blt0.ref instanceof com.pullenti.ner.uri.UriReferent) {
                            uriRe.addSlot(BookLinkReferent.ATTR_URL, (com.pullenti.ner.uri.UriReferent)com.pullenti.n2j.Utils.cast(blt0.ref, com.pullenti.ner.uri.UriReferent.class), false, 0);
                            ok = true;
                        }
                        t = blt0.getEndToken();
                    }
            ...
            if (decree != null && num != null) {
                java.util.ArrayList<com.pullenti.ner.ReferentToken> rts0 = new java.util.ArrayList< >();
                BookLinkRefReferent bref0 = BookLinkRefReferent._new389(decree.getReferent());
                if (num != null) 
                    bref0.setNumber(num);
            ...
            if (bookPrev != null) {
                ...
                if (blt0 != null && blt0.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.PAGERANGE) {
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> rts0 = new java.util.ArrayList< >();
                    BookLinkRefReferent bref0 = BookLinkRefReferent._new389(bookPrev);
                    if (num != null) 
                        bref0.setNumber(num);
        ...
        if (com.pullenti.n2j.Utils.stringsEq(res.getLang(), "EN")) {
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.isNewlineBefore() && !t.isChar('/') && !t.getPrevious().isChar('/')) {
                ...
                if (t.getPrevious().isCharOf(":")) {
                    ...
                    for(com.pullenti.ner.Token tt = t.getNext(); tt != null && mmm > 0; tt = tt.getNext(),mmm--) {
                        if (tt.isNewlineBefore()) {
                            com.pullenti.ner.booklink.internal.BookLinkToken blt2 = com.pullenti.ner.booklink.internal.BookLinkToken.tryParse(tt);
                            if (blt2 != null && blt2.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.NUMBER && com.pullenti.n2j.Utils.stringsEq(blt2.value, nextNum)) {
                                ok = true;
                                break;
                            }
                            if (blt2 != null) {
            ...
            if (blt.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.ELECTRONRES || blt.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.URL) {
                ...
                if (blt.ref instanceof com.pullenti.ner.uri.UriReferent) 
                    res.addSlot(BookLinkReferent.ATTR_URL, (com.pullenti.ner.uri.UriReferent)com.pullenti.n2j.Utils.cast(blt.ref, com.pullenti.ner.uri.UriReferent.class), false, 0);
            }
            else if (blt.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.YEAR) {
                if (res.getYear() == 0) {
                    res.setYear(com.pullenti.n2j.Utils.parseInteger(blt.value));
                    coef += 0.5;
                }
            }
        ...
        for(com.pullenti.ner.ReferentToken rr : corrAuthors) {
            ...
            if (pits0.get(0).typ == com.pullenti.ner.person.internal.PersonItemToken.ItemType.VALUE) {
                ...
                for(int i = rr.referent.getSlots().size() - 1; i >= 0; i--) {
                    ...
                    if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.person.PersonReferent.ATTR_LASTNAME)) {
                        String ln = (String)com.pullenti.n2j.Utils.cast(s.getValue(), String.class);
                        if (ln == null) 
                            continue;
                        if (com.pullenti.n2j.Utils.stringsEq(ln, pits0.get(0).value)) {
                            exi = true;
                            continue;
                        }
                        if (ln.indexOf('-') > 0) 
        ...
        java.util.ArrayList<com.pullenti.ner.ReferentToken> rts = new java.util.ArrayList< >();
        BookLinkRefReferent bref = BookLinkRefReferent._new389(res);
        if (num != null) 
            bref.setNumber(num);
