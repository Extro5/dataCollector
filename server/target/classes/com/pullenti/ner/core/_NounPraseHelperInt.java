...
public class _NounPraseHelperInt {
    ...
    public static NounPhraseToken tryParse(com.pullenti.ner.Token first, NounPhraseParseAttr typ, int maxCharPos) {
        ...
        if (first.getNotNounPhrase()) {
            if ((((typ.value()) & ((((NounPhraseParseAttr.IGNOREPARTICIPLES.value()) | (NounPhraseParseAttr.REFERENTCANBENOUN.value()) | (NounPhraseParseAttr.PARSEPRONOUNS.value())) | (NounPhraseParseAttr.PARSEADVERBS.value()) | (NounPhraseParseAttr.PARSENUMERICASADJECTIVE.value()))))) == (NounPhraseParseAttr.NO.value())) 
                return null;
        }
        int cou = 0;
        for(com.pullenti.ner.Token t = first; t != null; t = t.getNext()) {
            if (maxCharPos > 0 && t.beginChar > maxCharPos) 
                break;
            if (t.getMorph().getLanguage().isCyrillic() || (((t instanceof com.pullenti.ner.NumberToken) && t.getMorph()._getClass().isAdjective() && !t.chars.isLatinLetter())) || (((t instanceof com.pullenti.ner.ReferentToken) && (((typ.value()) & (NounPhraseParseAttr.REFERENTCANBENOUN.value()))) != (NounPhraseParseAttr.NO.value())))) {
    ...
    private static NounPhraseToken tryParseRu(com.pullenti.ner.Token first, NounPhraseParseAttr typ, int maxCharPos) {
        if (first == null) 
            return null;
        java.util.ArrayList<com.pullenti.ner.internal.NounPhraseItem> items = null;
        ...
        for(com.pullenti.ner.Token t = first; t != null; t = t.getNext()) {
            ...
            if (t.chars.isLatinLetter()) 
                break;
            if ((t instanceof com.pullenti.ner.ReferentToken) && (((typ.value()) & (NounPhraseParseAttr.REFERENTCANBENOUN.value()))) == (NounPhraseParseAttr.NO.value())) 
                break;
            com.pullenti.ner.internal.NounPhraseItem it = com.pullenti.ner.internal.NounPhraseItem.tryParse(t, items, typ);
            if (it == null || ((!it.canBeAdj && !it.canBeNoun))) {
                if ((((typ.value()) & (NounPhraseParseAttr.PARSEADVERBS.value()))) != (NounPhraseParseAttr.NO.value()) && (t instanceof com.pullenti.ner.TextToken) && t.getMorph()._getClass().isAdverb()) {
                    ...
                    if (adverbs == null) 
                        adverbs = new java.util.ArrayList< >();
                    adverbs.add((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class));
                    continue;
                }
                break;
            }
            ...
            if (items == null) 
                ...
                com.pullenti.ner.internal.NounPhraseItem it0 = items.get(items.size() - 1);
                if (it0.canBeNoun && it0.isPersonalPronoun()) {
                    if (it.isPronoun()) 
                        break;
                    if (it0.getBeginToken().getPrevious() != null && it0.getBeginToken().getPrevious().getMorphClassInDictionary().isVerb() && !it0.getBeginToken().getPrevious().getMorphClassInDictionary().isAdjective()) {
        ...
        if (items.size() == 1 && items.get(0).canBeAdj) {
            ...
            if (and) {
                ...
                if (npt1 != null && npt1.adjectives.size() > 0) {
                    boolean ok1 = false;
                    for(com.pullenti.ner.internal.NounPhraseItemTextVar av : items.get(0).adjMorph) {
                        for(com.pullenti.ner.internal.NounPhraseItemTextVar v : (((com.pullenti.ner.internal.NounPhraseItem)com.pullenti.n2j.Utils.cast(npt1.noun, com.pullenti.ner.internal.NounPhraseItem.class))).nounMorph) {
        ...
        com.pullenti.ner.internal.NounPhraseItem last1 = items.get(items.size() - 1);
        boolean check = true;
        for(com.pullenti.ner.internal.NounPhraseItem it : items) {
            if (!it.canBeAdj) {
                check = false;
                break;
            }
        ...
        if ((tt1 != null && check && ((tt1.getMorph()._getClass().isPreposition() || tt1.getMorph().getCase().isInstrumental()))) && (tt1.getWhitespacesBeforeCount() < 2)) {
            ...
            if (inp != null) {
                ...
                if (npt1 != null) {
                    boolean ok = true;
                    for(com.pullenti.ner.internal.NounPhraseItem it : items) {
                        if (!com.pullenti.ner.internal.NounPhraseItem.tryAccordAdjAndNoun(it, (com.pullenti.ner.internal.NounPhraseItem)com.pullenti.n2j.Utils.cast(npt1.noun, com.pullenti.ner.internal.NounPhraseItem.class))) {
                            ok = false;
                            break;
                        }
                    }
                    if (ok) {
                        ...
                        if (adverbs != null) {
                            if (npt1.adverbs == null) 
                                ...
                                npt1.adverbs.addAll(0, adverbs);
                        }
                        return npt1;
                    }
                }
                if (tt1 != null && tt1.getMorph()._getClass().isNoun()) {
                    com.pullenti.ner.internal.NounPhraseItem it = com.pullenti.ner.internal.NounPhraseItem.tryParse(tt1, items, typ);
        ...
        if (ok2) {
            com.pullenti.ner.internal.NounPhraseItem it = com.pullenti.ner.internal.NounPhraseItem.tryParse(items.get(0).getEndToken().getNext(), null, typ);
            if (it != null && it.canBeAdj && it.getBeginToken().chars.isAllLower()) {
                ...
                if (ok2 && com.pullenti.ner.internal.NounPhraseItem.tryAccordAdjAndNoun(it, items.get(0))) {
        ...
        com.pullenti.ner.internal.NounPhraseItem noun = null;
        com.pullenti.ner.internal.NounPhraseItem adjAfter = null;
        for(int i = items.size() - 1; i >= 0; i--) {
            if (items.get(i).canBeNoun) {
                ...
                noun = items.get(i);
                for(int indRemoveRange = i + items.size() - i - 1, indMinIndex = i; indRemoveRange >= indMinIndex; indRemoveRange--) items.remove(indRemoveRange);
                if (adjAfter != null) 
                    items.add(adjAfter);
                break;
            }
        ...
        if (adverbs != null) {
            for(com.pullenti.ner.TextToken a : adverbs) {
                if (a.beginChar < noun.beginChar) {
                    if (res.adverbs == null) 
                        res.adverbs = new java.util.ArrayList< >();
                    res.adverbs.add(a);
                }
            }
        }
        ...
        for(com.pullenti.ner.internal.NounPhraseItemTextVar v : noun.nounMorph) {
        ...
        if (items.size() > 0) {
            java.util.ArrayList<com.pullenti.morph.MorphBaseInfo> okList = new java.util.ArrayList< >();
            boolean isNumNot = false;
            for(com.pullenti.ner.internal.NounPhraseItemTextVar vv : noun.nounMorph) {
                int i;
                com.pullenti.ner.internal.NounPhraseItemTextVar v = vv;
                for(i = 0; i < items.size(); i++) {
                    boolean ok = false;
                    for(com.pullenti.ner.internal.NounPhraseItemTextVar av : items.get(i).adjMorph) {
                        if (v.checkAccord(av, false)) {
                            ok = true;
                    ...
                    if (!ok) {
                        if (items.get(i).canBeNumericAdj() && items.get(i).tryAccordVar(v)) {
                            ok = true;
                            v = (com.pullenti.ner.internal.NounPhraseItemTextVar)com.pullenti.n2j.Utils.cast(v.clone(), com.pullenti.ner.internal.NounPhraseItemTextVar.class);
                            v.setNumber(com.pullenti.morph.MorphNumber.PLURAL);
                            isNumNot = true;
                            v.setCase(new com.pullenti.morph.MorphCase(null));
                            for(com.pullenti.ner.internal.NounPhraseItemTextVar a : items.get(i).adjMorph) {
        ...
        for(int i = 0; i < items.size(); i++) {
            ...
            com.pullenti.ner.TextToken tt = (com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(items.get(i).getBeginToken(), com.pullenti.ner.TextToken.class);
            if (tt != null && !tt.term.startsWith("ВЫСШ")) {
                ...
                for(com.pullenti.morph.MorphBaseInfo wf : tt.getMorph().getItems()) {
                    if (wf._getClass().isAdjective()) {
                        if (wf.containsAttr("прев.", new com.pullenti.morph.MorphClass())) {
                            if ((((typ.value()) & (NounPhraseParseAttr.IGNOREADJBEST.value()))) != (NounPhraseParseAttr.NO.value())) 
                                err = true;
                        }
                        if (wf.containsAttr("к.ф.", new com.pullenti.morph.MorphClass()) && tt.getMorph()._getClass().isPersonalPronoun()) 
                            return null;
                    }
                }
                if (err) 
            ...
            if (res.getMorph().getCase().isNominative()) {
                ...
                if (!com.pullenti.n2j.Utils.isNullOrEmpty(v)) {
                    if (com.pullenti.n2j.Utils.stringsNe(items.get(i).getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false), v)) {
                        com.pullenti.ner.internal.NounPhraseItemTextVar wf = new com.pullenti.ner.internal.NounPhraseItemTextVar(items.get(i).getMorph(), null);
                        wf.normalValue = v;
        ...
        if (res.adjectives.size() > 0) {
            ...
            if ((zap + and) > 0) {
                ...
                com.pullenti.ner.internal.NounPhraseItem last = (com.pullenti.ner.internal.NounPhraseItem)com.pullenti.n2j.Utils.cast(res.adjectives.get(res.adjectives.size() - 1), com.pullenti.ner.internal.NounPhraseItem.class);
                if (last.isPronoun() && !lastAnd) 
                    return null;
            }
        }
        if (stat != null) {
            for(com.pullenti.ner.internal.NounPhraseItem adj : items) {
                if (adj.getMorph().getItemsCount() > 1) {
                    com.pullenti.ner.internal.NounPhraseItemTextVar w1 = (com.pullenti.ner.internal.NounPhraseItemTextVar)com.pullenti.n2j.Utils.cast(adj.getMorph().getIndexerItem(0), com.pullenti.ner.internal.NounPhraseItemTextVar.class);
                    com.pullenti.ner.internal.NounPhraseItemTextVar w2 = (com.pullenti.ner.internal.NounPhraseItemTextVar)com.pullenti.n2j.Utils.cast(adj.getMorph().getIndexerItem(1), com.pullenti.ner.internal.NounPhraseItemTextVar.class);
                    ...
                    int i1 = 0;
                    int i2 = 0;
                    com.pullenti.n2j.Outargwrapper<Integer> inoutarg471 = new com.pullenti.n2j.Outargwrapper< >();
                    com.pullenti.n2j.Utils.tryGetValue(stat, l1, inoutarg471);
                    i1 = (inoutarg471.value != null ? inoutarg471.value : 0);
                    com.pullenti.n2j.Outargwrapper<Integer> inoutarg470 = new com.pullenti.n2j.Outargwrapper< >();
                    com.pullenti.n2j.Utils.tryGetValue(stat, l2, inoutarg470);
                    i2 = (inoutarg470.value != null ? inoutarg470.value : 0);
                    if (i1 < i2) {
                    ...
                    if (((tt.getMorph()._getClass().isNoun() || tt.getMorph()._getClass().isProper())) && comma) {
                        for(com.pullenti.morph.MorphBaseInfo it : res.getBeginToken().getMorph().getItems()) {
                            if (it._getClass().isVerb() && (it instanceof com.pullenti.morph.MorphWordForm)) {
                                if (tt.getMorph().checkAccord(it, false)) {
                                    if (res.getMorph().getCase().isInstrumental()) 
                                        return null;
                                    java.util.ArrayList<com.pullenti.morph.DerivateWord> ews = com.pullenti.morph.Explanatory.findWords((((com.pullenti.morph.MorphWordForm)com.pullenti.n2j.Utils.cast(it, com.pullenti.morph.MorphWordForm.class))).normalCase, tt.getMorph().getLanguage());
                                    if (ews != null) {
                                        for(com.pullenti.morph.DerivateWord ew : ews) {
                                            if (ew.nexts != null) {
                                                com.pullenti.morph.MorphCase cm;
                                                com.pullenti.n2j.Outargwrapper<com.pullenti.morph.MorphCase> inoutarg472 = new com.pullenti.n2j.Outargwrapper< >();
                                                Boolean inoutres473 = com.pullenti.n2j.Utils.tryGetValue(ew.nexts, "", inoutarg472);
    ...
    private static NounPhraseToken tryParseEn(com.pullenti.ner.Token first, NounPhraseParseAttr typ, int maxCharPos) {
        ...
        for(com.pullenti.ner.Token t = first; t != null; t = t.getNext()) {
            ...
            if (((hasArticle || hasProp)) && items == null) {
            }
            else {
            ...
            if (items == null) 
                items = new java.util.ArrayList< >();
            com.pullenti.ner.internal.NounPhraseItem it = new com.pullenti.ner.internal.NounPhraseItem(t, t);
            if (mc.isNoun()) 
                it.canBeNoun = true;
            if (mc.isAdjective() || mc.isPronoun()) 
                it.canBeAdj = true;
            items.add(it);
            t = it.getEndToken();
            if (items.size() == 1) {
        ...
        if (items == null) 
            return null;
        com.pullenti.ner.internal.NounPhraseItem noun = items.get(items.size() - 1);
        NounPhraseToken res = new NounPhraseToken(first, noun.getEndToken());
        res.noun = noun;
        res.setMorph(new com.pullenti.ner.MorphCollection(null));
        for(com.pullenti.morph.MorphBaseInfo v : noun.getEndToken().getMorph().getItems()) {
            ...
            if (v._getClass().isProper() && noun.getBeginToken().chars.isAllLower()) 
                continue;
            com.pullenti.morph.MorphBaseInfo vv = (com.pullenti.morph.MorphBaseInfo)com.pullenti.n2j.Utils.cast(v.clone(), com.pullenti.morph.MorphBaseInfo.class);
        ...
        if (res.getMorph().getItemsCount() == 0 && hasArticle) 
            res.getMorph().addItem(com.pullenti.morph.MorphBaseInfo._new210(com.pullenti.morph.MorphClass.NOUN, com.pullenti.morph.MorphNumber.SINGULAR));
