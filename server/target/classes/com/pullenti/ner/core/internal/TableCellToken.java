...
public class TableCellToken extends com.pullenti.ner.MetaToken {
    ...
    public java.util.ArrayList<TableCellToken> getLines() {
        java.util.ArrayList<TableCellToken> res = new java.util.ArrayList< >();
    ...
    public static TableCellToken _new468(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, int _arg3, int _arg4) {
