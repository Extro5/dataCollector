...
public class InstrToken extends com.pullenti.ner.MetaToken {
    ...
    public static void initialize() {
        ...
        t = new com.pullenti.ner.core.Termin("МЕСТО ПЕЧАТИ", new com.pullenti.morph.MorphLang(null), false);
        t.addAbridge("М.П.");
        t.addAbridge("M.П.");
        m_Ontology.add(t);
        ...
        t.addAbridge("M.П.");
        m_Ontology.add(t);
        t = new com.pullenti.ner.core.Termin("ПОДПИСЬ", new com.pullenti.morph.MorphLang(null), false);
        m_Ontology.add(t);
        t = new com.pullenti.ner.core.Termin("ПІДПИС", com.pullenti.morph.MorphLang.UA, false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("ФАМИЛИЯ ИМЯ ОТЧЕСТВО", "ФИО");
        t.addAbridge("Ф.И.О.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1356("ПРІЗВИЩЕ ІМЯ ПО БАТЬКОВІ", com.pullenti.morph.MorphLang.UA, "ФИО");
        m_Ontology.add(t);
        t = new com.pullenti.ner.core.Termin("ФАМИЛИЯ", new com.pullenti.morph.MorphLang(null), false);
        t.addAbridge("ФАМ.");
        m_Ontology.add(t);
        t = new com.pullenti.ner.core.Termin("ПРІЗВИЩЕ", com.pullenti.morph.MorphLang.UA, false);
        t.addAbridge("ФАМ.");
        m_Ontology.add(t);
        m_Ontology.add(new com.pullenti.ner.core.Termin("ИМЯ", new com.pullenti.morph.MorphLang(null), false));
    ...
    public boolean isPurePerson() {
        if (ref instanceof com.pullenti.ner.ReferentToken) {
            com.pullenti.ner.ReferentToken rt = (com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(ref, com.pullenti.ner.ReferentToken.class);
    ...
    private static InstrToken _correctPerson(InstrToken res) {
        ...
        for(com.pullenti.ner.Token t = res.getEndToken().getNext(); t != null; t = t.getNext()) {
            if ((t instanceof com.pullenti.ner.ReferentToken) && (res.ref instanceof com.pullenti.ner.ReferentToken)) {
                boolean ok = false;
                if (t.getReferent() == (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(res.ref, com.pullenti.ner.ReferentToken.class))).referent) 
                    ok = true;
                com.pullenti.ner.instrument.InstrumentParticipant ip = (com.pullenti.ner.instrument.InstrumentParticipant)com.pullenti.n2j.Utils.cast((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(res.ref, com.pullenti.ner.ReferentToken.class))).referent, com.pullenti.ner.instrument.InstrumentParticipant.class);
                if (ip != null && ip.containsRef(t.getReferent())) 
                    ok = true;
                if (!ok && t.getPrevious() != null && t.getPrevious().isTableControlChar()) {
                    if (((((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(res.ref, com.pullenti.ner.ReferentToken.class))).referent instanceof com.pullenti.ner.person.PersonPropertyReferent) && (t.getReferent() instanceof com.pullenti.ner.person.PersonReferent)) {
                        ok = true;
                        res.ref = t;
                    }
                }
            ...
            if (tok != null) {
                if ((((com.pullenti.n2j.Utils.stringsEq(tok.termin.getCanonicText(), "ПОДПИСЬ") || com.pullenti.n2j.Utils.stringsEq(tok.termin.getCanonicText(), "ПІДПИС"))) && t.isNewlineBefore() && t.getNext() != null) && t.getNext().isValue("СТОРОНА", null)) 
                    break;
        ...
        com.pullenti.ner.ReferentToken rt0 = (com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(res.ref, com.pullenti.ner.ReferentToken.class);
        if (rt0 != null && (rt0.referent instanceof com.pullenti.ner.instrument.InstrumentParticipant)) {
            for(com.pullenti.ner.Token tt = res.getBeginToken(); tt != null && tt.endChar <= res.endChar; tt = tt.getNext()) {
                if ((tt.getReferent() instanceof com.pullenti.ner.person.PersonReferent) || (tt.getReferent() instanceof com.pullenti.ner.person.PersonPropertyReferent)) {
                    ...
                    for(com.pullenti.ner.Token ttt = (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.MetaToken.class))).getBeginToken(); ttt != null && ttt.endChar <= tt.endChar; ttt = ttt.getNext()) {
    ...
    public static InstrToken parse(com.pullenti.ner.Token t, int maxChar, InstrToken prev) {
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (isStartOfLine && t == t0) {
                ...
                if ((t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) || (t.getReferent() instanceof com.pullenti.ner.person.PersonPropertyReferent) || (t.getReferent() instanceof com.pullenti.ner.instrument.InstrumentParticipant)) 
                    return _correctPerson(_new1357(t00, t, ILTypes.PERSON, t));
                boolean isRef = false;
                if (t.getReferent() instanceof com.pullenti.ner.person.PersonPropertyReferent) {
                    ...
                    if (rt != null) {
                        if (rt.referent instanceof com.pullenti.ner.person.PersonReferent) 
                            return _new1358(t00, rt.getEndToken(), ILTypes.PERSON);
                ...
                for(; tt != null; tt = tt.getNext()) {
                    ...
                    if (re instanceof com.pullenti.ner.person.PersonReferent) 
                        return _new1357(t00, tt, ILTypes.PERSON, tt);
                ...
                if (tt == null && isRef) 
                    return _new1357(t00, (com.pullenti.ner.Token)com.pullenti.n2j.Utils.notnull(t11, t), ILTypes.PERSON, t);
            }
            ...
            if (dt != null) {
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP && !t.chars.isAllLower()) {
                    ...
                    for(com.pullenti.ner.Token tt = dt.getEndToken(); tt != null; tt = tt.getNext()) {
                        if (tt.isNewlineBefore()) 
                            break;
                        else if ((tt instanceof com.pullenti.ner.TextToken) && (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt, com.pullenti.ner.TextToken.class))).isPureVerb()) {
                            _hasVerb = true;
                            break;
                        }
                    }
                    if (!_hasVerb) {
                        InstrToken res2 = _new1361(t0, dt.getEndToken(), ILTypes.TYP, (String)com.pullenti.n2j.Utils.notnull(dt.fullValue, dt.value));
                        if (com.pullenti.n2j.Utils.stringsEq(res2.value, "ДОПОЛНИТЕЛЬНОЕ СОГЛАШЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(res2.value, "ДОДАТКОВА УГОДА")) {
                ...
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER) {
                    if (t != t0) 
                        break;
                    return _new1361(t0, dt.getEndToken(), ILTypes.REGNUMBER, dt.value);
                }
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.ORG) {
                    if (t != t0) 
                        break;
                    return _new1363(t0, dt.getEndToken(), ILTypes.ORGANIZATION, dt.ref, dt.value);
                }
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TERR) {
                    if (t != t0) 
                        break;
                    InstrToken re = _new1363(t0, dt.getEndToken(), ILTypes.GEO, dt.ref, dt.value);
                ...
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.OWNER) {
                    ...
                    if (dt.ref != null && dt.ref.referent.toString().startsWith("агент")) 
                        dt = null;
                    if (dt != null) {
                        InstrToken res1 = _new1363(t0, dt.getEndToken(), ILTypes.PERSON, dt.ref, dt.value);
            ...
            if (r instanceof com.pullenti.ner.date.DateReferent) {
                ...
                if (t != t0) 
                    break;
                return _new1357(t, t, ILTypes.DATE, t);
            }
            if (r instanceof com.pullenti.ner.instrument.InstrumentParticipant) {
                for(com.pullenti.ner.Token tt = (((com.pullenti.ner.ReferentToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.ReferentToken.class))).getBeginToken(); tt != null && (tt.endChar < t.endChar); tt = tt.getNext()) {
                    com.pullenti.ner.Referent rr = tt.getReferent();
                    if (rr == null) 
                        continue;
                    if ((rr instanceof com.pullenti.ner.org.OrganizationReferent) || (rr instanceof com.pullenti.ner.bank.BankDataReferent) || (rr instanceof com.pullenti.ner.uri.UriReferent)) {
                        r = null;
                        break;
                    }
                }
            ...
            if ((r instanceof com.pullenti.ner.person.PersonReferent) || (r instanceof com.pullenti.ner.person.PersonPropertyReferent) || (r instanceof com.pullenti.ner.instrument.InstrumentParticipant)) {
                ...
                InstrToken res1 = _new1357(t, t, ILTypes.PERSON, t);
                return _correctPerson(res1);
            }
            if (r instanceof com.pullenti.ner.org.OrganizationReferent) {
                if (t != t0) 
                    break;
                return _new1357(t, t, ILTypes.ORGANIZATION, t);
            }
            if (r instanceof com.pullenti.ner.decree.DecreePartReferent) {
                com.pullenti.ner.decree.DecreePartReferent dpr = (com.pullenti.ner.decree.DecreePartReferent)com.pullenti.n2j.Utils.cast(r, com.pullenti.ner.decree.DecreePartReferent.class);
                if (dpr.getAppendix() != null) {
                    if (t.isNewlineBefore() || isStartOfLine) {
                        if (t.isNewlineAfter() || t.getWhitespacesBeforeCount() > 30) 
                            return _new1361(t, t, ILTypes.APPENDIX, "ПРИЛОЖЕНИЕ");
                        boolean ok = true;
            ...
            if ((r instanceof com.pullenti.ner.decree.DecreeReferent) && (((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(r, com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER && t == t0) {
                InstrToken res1 = _new1358(t, t, ILTypes.APPROVED);
                for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                    if (tt.isCharOf(",;")) 
                        continue;
                    if ((tt.getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) && (((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(tt.getReferent(), com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER) 
                        res1.setEndToken(t);
                    else 
                        break;
                }
            ...
            if (t.isValue("ЗА", null) && t.getNext() != null && t.isNewlineBefore()) {
                ...
                if ((rr instanceof com.pullenti.ner.person.PersonReferent) || (rr instanceof com.pullenti.ner.person.PersonPropertyReferent) || (rr instanceof com.pullenti.ner.instrument.InstrumentParticipant)) {
                    if (t != t0) 
                        break;
                    InstrToken res1 = _new1357(t, t.getNext(), ILTypes.PERSON, t.getNext());
                    t = t.getNext().getNext();
            ...
            for(int ii = 0; ii < m_Directives.size(); ii++) {
                if (t.isValue(m_Directives.get(ii), null)) {
                    if (t.getNext() != null && t.getNext().isValue("СЛЕДУЮЩЕЕ", "НАСТУПНЕ")) {
                        ...
                        if (ok) 
                            return _new1361(t, t11, ILTypes.DIRECTIVE, m_DirectivesNorm.get(ii));
                    }
                    if (t.isNewlineAfter() || ((t.getNext() != null && t.getNext().isChar(':') && t.getNext().isNewlineAfter()))) {
                        if (t != t0) 
                            break;
                        if (!t.isNewlineBefore()) {
                            if ((com.pullenti.n2j.Utils.stringsNe(m_DirectivesNorm.get(ii), "ПРИКАЗ") && com.pullenti.n2j.Utils.stringsNe(m_DirectivesNorm.get(ii), "ПОСТАНОВЛЕНИЕ") && com.pullenti.n2j.Utils.stringsNe(m_DirectivesNorm.get(ii), "НАКАЗ")) && com.pullenti.n2j.Utils.stringsNe(m_DirectivesNorm.get(ii), "ПОСТАНОВУ")) 
                                break;
                        }
                        return _new1361(t, (t.isNewlineAfter() ? t : t.getNext()), ILTypes.DIRECTIVE, m_DirectivesNorm.get(ii));
                    }
                    break;
                }
            }
                ...
                for(String d : m_Directives) {
                    ...
                    if (t11 != null) {
                        if (t11.getNext() != null && t11.getNext().isChar(':')) 
                            t11 = t11.getNext();
                        return _new1358(t, t11, ILTypes.DIRECTIVE);
                    }
                }
            }
            com.pullenti.ner.Token tte = ((t instanceof com.pullenti.ner.MetaToken) ? (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken() : t);
            String term = (tte instanceof com.pullenti.ner.TextToken ? (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tte, com.pullenti.ner.TextToken.class))).term : null);
            if (isStartOfLine && !tte.chars.isAllLower() && t == t0) {
                ...
                if (npt != null && ((com.pullenti.n2j.Utils.stringsEq(term, "ПРИЛОЖЕНИЯ") || com.pullenti.n2j.Utils.stringsEq(term, "ДОДАТКИ")))) 
                    npt = null;
                if (npt != null && npt.getMorph().getCase().isNominative() && (npt.getEndToken() instanceof com.pullenti.ner.TextToken)) {
                    String term1 = (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(npt.getEndToken(), com.pullenti.ner.TextToken.class))).term;
                    if (((com.pullenti.n2j.Utils.stringsEq(term1, "ПРИЛОЖЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(term1, "ДОДАТОК") || com.pullenti.n2j.Utils.stringsEq(term1, "МНЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(term1, "ДУМКА") || com.pullenti.n2j.Utils.stringsEq(term1, "АКТ")) || com.pullenti.n2j.Utils.stringsEq(term1, "ФОРМА") || com.pullenti.n2j.Utils.stringsEq(term, "ЗАЯВКА")) {
                        ...
                        if (tt1 == null) 
                            ...
                            ok = false;
                        else if (tt1 == t.getNext() && ((tt1.isChar(':') || ((tt1.isValue("НА", null) && com.pullenti.n2j.Utils.stringsNe(term1, "ЗАЯВКА")))))) 
                            ok = false;
                        if (ok) {
                        ...
                        if (ok) 
                            return _new1361(t, t, ILTypes.APPENDIX, term1);
                    }
                }
            }
            boolean app = false;
            if ((((com.pullenti.n2j.Utils.stringsEq(term, "ОСОБОЕ") || com.pullenti.n2j.Utils.stringsEq(term, "ОСОБЛИВЕ"))) && t.getNext() != null && t.getNext().isValue("МНЕНИЕ", "ДУМКА")) && t == t0 && isStartOfLine) 
                app = true;
            if ((((com.pullenti.n2j.Utils.stringsEq(term, "ДОПОЛНИТЕЛЬНОЕ") || com.pullenti.n2j.Utils.stringsEq(term, "ДОДАТКОВА"))) && t.getNext() != null && t.getNext().isValue("СОГЛАШЕНИЕ", "УГОДА")) && t == t0 && isStartOfLine) 
                app = true;
            if (app) {
                for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                    if (tt.isNewlineBefore()) 
                ...
                if (app) 
                    return _new1358(t, t.getNext(), ILTypes.APPENDIX);
            }
            if (!t.chars.isAllLower() && t == t0) {
                ...
                if (tt != null) {
                    if (tt.getNext() != null && (tt.getNext().getReferent() instanceof com.pullenti.ner.decree.DecreeReferent)) 
                        return _new1357(t, tt, ILTypes.APPROVED, tt.getNext().getReferent());
                    ...
                    if (dt1 != null && dt1.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) 
                        return _new1358(t, tt, ILTypes.APPROVED);
                }
            }
            t1 = t;
        }
        if (t1 == null) 
            return null;
        InstrToken res = _new1358(t00, t1, ILTypes.UNDEFINED);
        res.noWords = true;
    ...
    public static com.pullenti.ner.Token _checkApproved(com.pullenti.ner.Token t) {
        ...
        if (t.getMorph().containsAttr("инф.", new com.pullenti.morph.MorphClass(null)) && t.getMorph().containsAttr("сов.в.", new com.pullenti.morph.MorphClass(null))) 
            return null;
        if (t.getMorph().containsAttr("возвр.", new com.pullenti.morph.MorphClass(null))) 
            return null;
        com.pullenti.ner.Token t0 = t;
        ...
        for(t = t.getNext(); t != null; t = t.getNext()) {
            ...
            com.pullenti.ner.Token tt = _checkApproved(t);
            if (tt != null) {
                if (!tt.isNewlineBefore() && com.pullenti.n2j.Utils.stringsNe(tt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false), t0.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false))) {
                    t1 = (tt = t);
                    continue;
                }
            }
    ...
    public static java.util.ArrayList<String> m_Directives = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"ПРИКАЗЫВАТЬ", "ОПРЕДЕЛЯТЬ", "ОПРЕДЕЛИТЬ", "ПОСТАНОВЛЯТЬ", "ПОСТАНОВИТЬ", "УСТАНОВИТЬ", "РЕШИЛ", "РЕШИТЬ", "ПРОСИТЬ", "ПРИГОВАРИВАТЬ", "ПРИГОВОРИТЬ", "НАКАЗУВАТИ", "ВИЗНАЧАТИ", "ВИЗНАЧИТИ", "УХВАЛЮВАТИ", "ПОСТАНОВЛЯТИ", "ПОСТАНОВИТИ", "ВСТАНОВИТИ", "ВИРІШИВ", "ВИРІШИТИ", "ПРОСИТИ", "ПРИМОВЛЯТИ", "ЗАСУДИТИ"}));

    public static java.util.ArrayList<String> m_DirectivesNorm = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"ПРИКАЗ", "ОПРЕДЕЛЕНИЕ", "ОПРЕДЕЛЕНИЕ", "ПОСТАНОВЛЕНИЕ", "ПОСТАНОВЛЕНИЕ", "УСТАНОВЛЕНИЕ", "РЕШЕНИЕ", "РЕШЕНИЕ", "ЗАЯВЛЕНИЕ", "ПРИГОВОР", "ПРИГОВОР", "НАКАЗ", "УХВАЛА", "УХВАЛА", "ПОСТАНОВА", "ПОСТАНОВА", "ПОСТАНОВА", "ВСТАНОВЛЕННЯ", "РІШЕННЯ", "РІШЕННЯ", "ЗАЯВА", "ВИРОК", "ВИРОК"}));

    public static InstrToken _new1357(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ILTypes _arg3, Object _arg4) {
        InstrToken res = new InstrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        return res;
    }
    public static InstrToken _new1358(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ILTypes _arg3) {
        InstrToken res = new InstrToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }
    public static InstrToken _new1361(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ILTypes _arg3, String _arg4) {
        InstrToken res = new InstrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    }
    public static InstrToken _new1363(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ILTypes _arg3, Object _arg4, String _arg5) {
        InstrToken res = new InstrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        res.value = _arg5;
